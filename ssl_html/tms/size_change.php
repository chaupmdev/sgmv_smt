...
Sgmov_Lib::useView('tms/SizeChange');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Tms_SizeChange();
$forms = $view->execute();
...
Sgmov_Component_Log::debug('####################### 200-2');
...
?>
            <div class="section other">
                <form action="/tms/size_change_check_input" data-feature-id="<?php echo Sgmov_View_Tms_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Tms_Common::GAMEN_ID_EVE001; ?>" method="post">
...
<?php
Sgmov_Component_Log::debug('####################### 200-3');
Sgmov_Component_Log::debug($eve001Out);
                        ///////////////////////////////////////////////
                        // 顧客情報入力エリア
                        ///////////////////////////////////////////////
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/tms/js/input.js?<?php echo $strSysdate; ?>"></script>
</body>
</html>
