...
Sgmov_Lib::useView('ata/Input');
/**#@-*/

// 処理を実行
$view = new Sgmov_View_Ata_Input();
$forms = $view->execute();
...
/**
 * フォーム
 * @var Sgmov_Form_Ata002Out
 */
$ata002Out = $forms['outForm'];
            ...
            <dl id="globalNav">
                ...
                <dd>
                    <ul>
                        ...
                        <li class="nav02">
<?php if($ata002Out->honsha_user_flag() === '1'){ ?>
...
<?php } ?>
    ...
    <div id="topWrap">
        ...
        <h3 class="register_ttl">ツアー会社情報の登録</h3>
...
<?php } ?>
<?php if (isset($e) && $e->hasErrorForId('top_travel_agency_cd')) { ?>
                <p class="red">ツアー会社コード<?php echo $e->getMessage('top_travel_agency_cd'); ?></p>
<?php } ?>
<?php if (isset($e) && $e->hasErrorForId('top_travel_agency_name')) { ?>
                <p class="red">船名<?php echo $e->getMessage('top_travel_agency_name'); ?></p>
<?php } ?>
                <ul class="register_item" id="travel_agency_item">
                    <li id="travel_agency_item_01" class="clearfix">
                        <fieldset>
                            <legend>ツアー会社コード</legend>
                            <input autocapitalize="off"<?php if (isset($e) && $e->hasErrorForId('top_travel_agency_cd')) { echo ' class="bg_red"'; } ?> id="travel_agency_cd" inputmode="numeric" name="travel_agency_cd" type="text" value="<?php echo $ata002Out->travel_agency_cd(); ?>" />
                        </fieldset>
                    </li>
                    <li id="travel_agency_item_02">
                        <fieldset>
                            <legend>船名</legend>
                            <input autocapitalize="off"<?php if (isset($e) && $e->hasErrorForId('top_travel_agency_name')) { echo ' class="bg_red"'; } ?> id="travel_agency_name" name="travel_agency_name" type="text" value="<?php echo $ata002Out->travel_agency_name(); ?>" />
                        </fieldset>
                    </li>
                </ul>
                <input id="travel_agency_id" name="travel_agency_id" type="hidden" value="<?php echo $ata002Out->travel_agency_id(); ?>" />
    ...
    <!--<![endif]-->
    <script charset="UTF-8" type="text/javascript" src="/common/js/ataInput.js"></script>
</body>
</html>