...
//                    htmlCode += "<img src='/"+dirDiv+"/images/about_boxsize.png' width='100%' style='visibility:hidden;'/>";
                ...
                htmlCode += "</td>";
                if($('input[name="comiket_div"]:checked').val() ==  G_DEV_INDIVIDUAL) {
                   // htmlCode += "<img class='dispSeigyoPC' src='/twf/images/about_boxsize.png' width='100%'/>";
                }
                htmlCode += "</tr></table>";
                // 搬入
                $('.comiket-box-outbound-num').append(htmlCode);
                ...
                htmlCode2 += "</td>";
                if($('input[name="comiket_div"]:checked').val() ==  G_DEV_INDIVIDUAL) {
                  //  htmlCode2 += "<img class='dispSeigyoPC' src='/twf/images/about_boxsize.png' width='100%'/>";
                }
                htmlCode2 += "</tr></table>";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function getBuildingBoothPositionApi(isChangeFlg) {
        sgwns.api('/yid/api/building_booth_position.php', getFormData(), (function (data) {
