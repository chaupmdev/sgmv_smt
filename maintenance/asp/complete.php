...
Sgmov_Lib::useView('asp/Complete');
/**#@-*/

// 処理を実行
$view = new Sgmov_View_Asp_Complete();
$forms = $view->execute();

/**
 * フォーム
 * @var Sgmov_Form_Asp011Out
 */
$asp011Out = $forms['outForm'];
?>
...
<?php if($asp011Out->sp_kind() === Sgmov_View_Asp_Common::SP_LIST_KIND_EXTRA){ ?>
<body id="priceCat">
<?php } else if($asp011Out->sp_kind() === Sgmov_View_Asp_Common::SP_LIST_KIND_CAMPAIGN){ ?>
<body id="campaignCat">
<?php } ?>
...
<?php if($asp011Out->honsha_user_flag() === '1'){ ?>
...
<?php } ?>
	...
	<tr>
        ...
        <td align="right"><a id='back_to_list' href="<?php echo $asp011Out->sp_list_url(); ?>">← 一覧に戻る</a></td>
        <td><img src="/common/img/spacer.gif" width="10" height="1" alt=""></td>
	</tr>
	<tr>
		<td colspan="3"><img src="/common/img/spacer.gif" width="1" height="10" alt=""></td>
	...
	<tr>
		...
		<td>
			<table class="inner" width="880">
				<tr>
<?php if($asp011Out->sp_kind() === Sgmov_View_Asp_Common::SP_LIST_KIND_EXTRA){ ?>
                    <td>閑散・繁忙期料金設定を完了いたしました。</td>
<?php } else if($asp011Out->sp_kind() === Sgmov_View_Asp_Common::SP_LIST_KIND_CAMPAIGN){ ?>
                    <td>キャンペーン設定を完了いたしました。</td>
<?php } ?>
				</tr>
				<tr>
				...
				<tr>
					<td align="center"><a href="<?php echo $asp011Out->sp_list_url(); ?>">一覧に戻る</a></td>
				</tr>
			</table>
		</td>
		<td><img src="/common/img/spacer.gif" width="10" height="1" alt=""></td>
