...
// 処理を実行
$view = new Sgmov_View_Mdr_Complete();
$eveOutForm = array();
$eventData = array();
$eventsubData = array();
...
<!--
                    ...
                    <div class ="fs20px">
                        <a class="button_link2 clr-blue" href="/mdr/pdf/manual/<?php echo $eventData['name']; ?><?php echo $eventsubData['name']; ?>.pdf" target="_blank">
...
-->
                ...
                <?php if(!empty($existsComiketId)): ?>
                    <b>引き続き搬出申込される方は<a href="/mdr/input2/<?php echo $existsComiketId; ?>" class ="clr-blue fwb txt-underline" target="_self">こちら</a></b>
                <?php else : ?>
                    <b>引き続き宅配をご利用される方は<a href="/mdr/input" target="_self" class ="clr-blue fwb txt-underline">こちら</a></b>
                <?php endif;?>                    
