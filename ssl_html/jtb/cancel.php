...
// 処理を実行
$view = new Sgmov_View_Jtb_Cancel();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/<?=$dirDiv?>/cancel_comp" data-feature-id="<?php echo Sgmov_View_Jtb_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Jtb_Common::GAMEN_ID_JTB001 ?>" method="post">
