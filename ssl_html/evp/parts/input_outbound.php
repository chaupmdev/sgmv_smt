...
?>
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_detail_outbound_delivery_date')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <input type="hidden" id="hid_minus_number_date" name="hid_minus_number_date" value="0" />
                                    <br/>
                                    <br/>
    ...
    <?php
            echo Sgmov_View_Evp_Input::_createPulldown($eve001Out->comiket_detail_outbound_delivery_time_cds(), $eve001Out->comiket_detail_outbound_delivery_time_lbls(), $eve001Out->comiket_detail_outbound_delivery_time_sel());
    ?>
                                            </select>
                                        </span>
                                        <br/>
                            ...
                            <dl class="class_comiket_detail_outbound_collect_date">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_detail_outbound_collect_date')) { echo ' class="form_error"'; } ?> class="comiket_detail_outbound_collect_date_input_part">
                                    <div style="white-space: normal;">
                                        <!-- <strong class="red">※ 九州・四国・中国・北海道・青森エリアの方は2021年12月25日（土）まで選択できます。</strong> -->
                                        <strong class="red">
                                        【選択可能日の範囲について】<br/>
                                        ・1日目(12月29日)：12月17日(火)～12月23日(月) 、九州・四国・中国・北海道・青森・沖縄エリアの方は12月22日(日)まで選択できます。<br/>
                                        ・2日目(12月30日)：12月17日(火)～12月24日(火) 、九州・四国・中国・北海道・青森・沖縄エリアの方は12月23日(月)まで選択できます。
                                        </strong>
                                    </div>
                            ...
                            <dl>
                                ...
                                >
                                    ...
                                    <div style="margin-top: 5px;">
                                        <input id="comiket_detail_caremark_flg"  class="class_comiket_detail_caremark_flg" style="transform:scale(1.3)" <?php if ($eve001Out->comiket_detail_caremark_flg() == '1') { ?> checked="checked" <?php } ?> name="comiket_detail_caremark_flg" type="checkbox"/>
