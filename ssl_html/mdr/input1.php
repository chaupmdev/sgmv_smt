...
?>
            <div class="section other">
                <form action="/mdr/check_input" data-feature-id="<?php echo Sgmov_View_Mdr_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Mdr_Common::GAMEN_ID_MDR001 ?>" method="post">
