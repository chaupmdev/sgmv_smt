                        ...
                        <div id="transactions" class="accordion">
                            ...
                            <div id="transactions_contents" class="ac_content">
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        <p>
                                            お帰り後、ご自宅で荷物の破損などを確認した場合は、<br/>
                                            <span style="color:#F00;"><strong>03-5857-2462（SGムービング<?=$dispItemInfo['eventsub_selected_data']['name']?>係）（受付時間:平日10時～17時）</strong></span>へご連絡ください。
                                            <!--
                                            佐川急便株式会社
                                            <br />
