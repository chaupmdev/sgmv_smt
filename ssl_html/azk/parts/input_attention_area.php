                                ...
                                <dl>
                                    ...
                                    <dd>
                                        ...
                                        <p>
                                            ...
                                            <br />
                                            <span style="color:#F00;"><strong>03-5857-2462(SGムービング&nbsp;手荷物預かりサービス係)(受付時間:平日10時～17時)</strong></span>へご連絡ください。
                                        </p>
                                    </dd>
                                </dl>
                               <!--  <dl>
                                ...
                                <dl>
                                    <dt>キャンセル：</dt>
                                    <dd>
                                        手荷物預かりサービスをキャンセルされたい場合は、お手数ですがお客様ご自身でSGムービングにご連絡頂き、キャンセルをお申し出ください。
