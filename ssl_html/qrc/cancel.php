...
Sgmov_Lib::useView($dirDiv . '/Cancel');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Qrc_Cancel();
$forms = $view->execute();
...
<body>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            ?>
                <div class="err_msg">
                    <p class="sentence br attention">[!エラー]クレジットカード決済処理でエラーが発生しました。<br>入力内容をご確認ください。</p>
                    <ul>
                        <?php
                        // エラー表示
                    ...
                    <p class="under">
                        ...
                        ?>
                        <br />TEL: 03-5534-1080(受付時間:平日10時～17時)<?php if ($qrc001Out->eventsub_cd_sel() == '4') : ?>※年内は12月28日まで<?php endif; ?>
                    </p>
                </div>
            ...
            <div class="section other">
                <form action="/<?= $dirDiv ?>/cancel_comp" data-feature-id="<?php echo Sgmov_View_Qrc_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Qrc_Common::GAMEN_ID_QRC001 ?>" method="post">
