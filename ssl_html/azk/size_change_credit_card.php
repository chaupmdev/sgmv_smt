...
<head>
    ...
    <title>催事・イベント手荷物預かりサービスの個数・サイズ変更お申し込み│ＳＧムービング株式会社＜ＳＧホールディングスグループ＞</title>
   ...
   <!--  <div id="breadcrumb">
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <form action="/azk/size_change_check_credit_card" method="post">
...
?>
                    ...
                    <div class="btn_area">
                        <a class="back" href="/azk/size_change/?clr=1">修正する</a>
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/azk/js/credit_card.js"></script>
    <script>
        $(function() {
