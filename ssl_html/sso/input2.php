...
Sgmov_Lib::useView('sso/Input2');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Sso_Input2();
$forms = $view->execute();
...
$userType = isset($_SESSION['SSO_LOGIN']['user_type']) ? $_SESSION['SSO_LOGIN']['user_type'] : -1;
...
?>
    ...
    <link href="/sso/css/eve.css?<?php echo $strSysdate; ?>" rel="stylesheet" type="text/css" />
    <!--[if lt IE 9]>
...
?>
                ...
                <p class="under">
                    ...
                    <br />
                    <?php
                            $selectedEventNmae = Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
                            if(!empty($selectedEventNmae)) {
                                $selectedEventNmae .= '係';
                            }
//                            echo $selectedEventNmae;
                            echo 'シーフードショー大阪・アグリフードＥＸＰＯ大阪 係';
                    ?>
...
?>
            <div class="section other">
                <form action="/sso/check_input2" data-feature-id="<?php echo Sgmov_View_Sso_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Sso_Common::GAMEN_ID_EVE001 ?>" method="post">
...
<?php
        ...
        echo '<br><br><img src="/sso/images/logo.gif">';
        }
?>
...
<!--    <div class="eventsub_dl_link pasete_tag">
        ...
        <a style="color: blue;" class="paste_tag_link" href="/sso/pdf/paste_tag/paste_tag_<?php echo $eve001Out->eventsub_cd_sel(); ?>.pdf" target="_blank">貼付票（例）</a>
    </div>
    <br/>
    ...
    <div class="eventsub_dl_link manual" >
        <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
        <a style="color: blue;" class="manual_link" href="/sso/pdf/manual/<?php echo $eventName; ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">説明書</a>
    </div>
</div>
<?php endif; ?>
<!--                                                </td>
...
<!--                                                    <div class="pc_dl_area">
                                                        ...
                                                        <div class="eventsub_dl_link manual">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;" class="manual_link" href="/sso/pdf/manual/<?php echo $eventName; ?>.pdf" target="_blank">説明書</a>
                                                        </div>
                                                    </div>-->
                                    <!--</div>-->
<!--                                                </td>
...
<!--                                        <br/>-->
                            ...
                            <?php if ($eve001Out->comiket_div() == Sgmov_View_Sso_Common::COMIKET_DEV_BUSINESS) : // 法人?>
                                <dl>
                                ...
                                <?php if($eventsubInfo["is_booth_display"]) : ?>
                                    <dl>
                                        ...
                                        <dd>
                                            ...
                                            <input type="hidden" name="comiket_booth_name" value="<?php echo $eve001Out->comiket_booth_name(); ?>" />
                                        </dd>
                                    </dl>
                                <?php endif; ?>
...
?>
                                                                    ...
                                                                    <?php endif; ?>
                                                                    <input type="hidden" name="comiket_booth_num" value="<?php echo $eve001Out->comiket_booth_num(); ?>" />
...
<!--                    <div class="gray_block">
                    ...
                    <?php if ($eve001Out->comiket_div() == Sgmov_View_Sso_Common::COMIKET_DEV_INDIVIDUA) : ?>
...
?>
    <script charset="UTF-8" type="text/javascript" src="/sso/js/define.js" id="definejs-arg"
    data-G_DEV_INDIVIDUAL="<?php echo Sgmov_View_Sso_Common::COMIKET_DEV_INDIVIDUA; ?>"
    data-G_DEV_BUSINESS="<?php echo Sgmov_View_Sso_Common::COMIKET_DEV_BUSINESS; ?>"
    ></script>
    <script charset="UTF-8" type="text/javascript" src="/sso/js/input2.js?<?php echo $strSysdate; ?>"></script>
</body>
</html>
