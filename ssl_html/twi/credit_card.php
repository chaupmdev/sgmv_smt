...
// 処理を実行
$view = new Sgmov_View_Twi_CreditCard();
$forms = $view->execute();
...
<head>
    ...
    <title>テーブルウェア・フェスティバル開催会場からの宅配便お申込み│ＳＧムービング株式会社＜ＳＧホールディングスグループ＞</title>
...
<?php } ?>
                    ...
                    <div class="result02" style="font-size:134%;text-align: center;">
                        <span style="white-space: nowrap;">お支払い総額（仕分け特別料金含む）：</span>
...
<?php
        echo Sgmov_View_Twi_CreditCard::_createPulldown($eveOutForm->card_expire_month_cds(), $eveOutForm->card_expire_month_lbls(), $eveOutForm->card_expire_month_cd_sel());
?>
                                </select>
                                月
                            </label>
...
<?php
        echo Sgmov_View_Twi_CreditCard::_createPulldown($eveOutForm->card_expire_year_cds(), $eveOutForm->card_expire_year_lbls(), $eveOutForm->card_expire_year_cd_sel());
?>
                                    </select>
                                    年
                                </label>
                    ...
                    <div class="btn_area">
                        ...
                        if(empty($comiketId)): ?>
                            <a class="back" href="/<?=$dirDiv?>/input/?clr=1">修正する</a>
                        <?php else: ?>
                            <a class="back" href="/<?=$dirDiv?>/input2/?clr=1">修正する</a>
                        <?php endif; ?>
