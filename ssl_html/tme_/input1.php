...
?>
            <div class="section other">
                <form action="/tme/check_input" data-feature-id="<?php echo Sgmov_View_Eve_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Eve_Common::GAMEN_ID_EVE001 ?>" method="post">
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/tme/js/input.js?<?php echo $strSysdate; ?>"></script>
</body>
</html>
