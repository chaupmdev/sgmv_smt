 ...
 */
class Sgmov_View_Yid_CreditCard extends Sgmov_View_Yid_Common {
    ...
    public function executeInner() {
        ...
        // チケットを発行
        $ticket = $session->publishTicket(self::FEATURE_ID, self::GAMEN_ID_TWF002);
     ...
     * @param Sgmov_Form_Eve002In $sessionForm 入力フォーム
     * @return Sgmov_Form_Eve002Out 出力フォーム
     */
    public function _createOutFormByInForm($inForm) {
        ...
        $outForm->raw_term_fr = date('Y-m-d');
