...
Sgmov_Lib::useView('azk/Input2');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Azk_Input2();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/azk/check_input2" data-feature-id="<?php echo Sgmov_View_Azk_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Azk_Common::GAMEN_ID_AZK001 ?>" method="post">
...
<?php
                        ...
                        // 手荷物お預かり
                        ///////////////////////////////////////////////
                        include_once dirname(__FILE__) . '/parts/input2_azuke.php';
?>
...
?>
    ...
    ></script>
    <script charset="UTF-8" type="text/javascript" src="/azk/js/input2.js?<?php echo $strSysdate; ?>"></script>
