...
<?php
            echo Sgmov_View_Zzy_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
?>
                                    &nbsp;&nbsp;
                                    </span>
...
<?php
            echo Sgmov_View_Zzy_Input::_createPulldown($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel(), $eve001Out->eve_timeover_flg(), $eve001Out->eve_timeover_date());
?>
                                        </select>
...
<?php
            echo Sgmov_View_Zzy_Input::_createPulldown($eve001Out->eventsub_cds(), $eve001Out->eventsub_lbls(), $eve001Out->eventsub_cd_sel());
?>
                                        </select>
                                            <br/>
<?php
        ...
        //if(strpos($eventName,'ベイクルーズグループ　ファミリーセール') !== false){
        //echo '<img src="/zzy/images/logo.png" style = "max-width:60%;">';
        //}
?>
<?php
    // キャッシュ対策
...
<?php if ($eve001Out->input_mode() != '002') {  // 入力モードが"002"(コミケ)なら説明書のリンクは表示しない ?>
                                                      <!--   <div class="eventsub_dl_link manual" >
                                                            ...
                                                            <a style="color: blue;" class="manual_link" href="/zzy/pdf/manual/<?php //echo $eventName; ?><?php //echo $eventsubName; ?>.pdf<?php //echo '?' . $strSysdate; ?>" target="_blank">宅配便WEB申込みのご案内</a>
                                                        </div> -->
<?php } ?>
                                                    </div>
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_pref')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <select name="comiket_pref_cd_sel">
                                        <option value="">選択してください</option>
<?php
        echo Sgmov_View_Zzy_Input::_createPulldown($eve001Out->comiket_pref_cds(), $eve001Out->comiket_pref_lbls(), $eve001Out->comiket_pref_cd_sel());
?>
                                    </select>
                                </dd>
                            </dl>
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_mail')) { echo ' class="form_error"'; } ?>>
                                    <?php 
                                        $mail = $eve001Out->comiket_mail();
//                                        if($eve001Out->comiket_mail() == ""):
//                                            $mail = "a_sasaki011@sagawa-exp.co.jp";
//                                        endif;
                                    ?>
                                    <input class="w_220" maxlength="100" autocapitalize="off" inputmode="email" name="comiket_mail" data-pattern="^[!-~]+$" placeholder="例）ringo@sagawa.com" type="<?php echo $inputTypeEmail; ?>" value="<?php echo $mail; ?>" />
                                    <br class="sp_only" /><br>
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_mail_retype')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <?php 
                                        $cnfrmmail = $eve001Out->comiket_mail_retype();
//                                        if($eve001Out->comiket_mail_retype() == ""):
//                                            $cnfrmmail = "a_sasaki011@sagawa-exp.co.jp";
//                                        endif;
                                    ?>
                                    <input class="w_220" maxlength="100" autocapitalize="off" inputmode="email" name="comiket_mail_retype" data-pattern="^[!-~]+$" placeholder="例）ringo@sagawa.com" type="<?php echo $inputTypeEmail; ?>" value="<?php echo $cnfrmmail; ?>" oncopy="return false" onpaste="return false" oncontextmenu="return false"/>
                                    <br/>
                                    <br/>
                                  <!--   <strong class="red">
                                        ※確認のため、再入力をお願いいたします。
