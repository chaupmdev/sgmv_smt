 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Dsn_Input extends Sgmov_View_Dsn_Common {
    ...
    public function executeInner() {
        ...
        if ($this->isSecurityTaio()) {
            ...
            if (!isset($_SESSION[self::LOGIN_ID]['user_type'])) {
                Sgmov_Component_Redirect::redirectPublicSsl('/event/userSelect?event_nm='.$this->_DirDiv);
            }   
        }
...
//            // チェックデジットチェック
       ...
       // }
        ...
        // チケット発行
        $ticket = $session->publishTicket(self::FEATURE_ID, self::GAMEN_ID_DSN001);
