                            ...
                            ?>>
                                <tr>
                                        ...
                                        <table id = "comiket_box_buppan_num_ary" style="margin-left: 8px;" class="buppanTable">
                                            ...
                                            <?php foreach ($dispItemInfo['input_buppan_lbls'] as $key => $value) : ?>
                                                    <tr class="box_<?php echo $value['size_display']; ?>">
                                                        ...
                                                        <td class="comiket_box_item_value" style="white-space: nowrap;"><input autocapitalize="off" class="number-only comiket_box_item_value_input" maxlength="2" inputmode="numeric" name="comiket_box_buppan_num_ary[<?php echo $value['id'] ?>]" data-pattern="^d+$" placeholder="例）1" type="text"  style="min-width: 60px;"  value="<?php echo $twf001Out->comiket_box_buppan_num_ary($value["id"]); ?>">枚</td>
                                                    </tr>
                                            <?php endforeach; ?>
                                            </tbody>
                                        </table>
                                    ...
                                    <td class="dispSeigyoPC" style='vertical-align: middle;text-align: right;'>
                                        <?php if ($twf001Out->comiket_div() == Sgmov_View_Twf_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
                                            <img src='/twf/images/about_boxsize.png' width='80%'/>
                                        <?php else: ?>
            ...
            echo ' class="form_error"';
                ...
                <div class="comiket_detail_buppan_collect_date_parts" style="display:<?php echo $displaySetting; ?>">
                    <select name="comiket_detail_buppan_collect_date_year_sel"
                            ...
                            _selected="<?php echo @$twf001Out->comiket_detail_buppan_collect_date_year_sel(); ?>"
                            _first="年を選択"
                    ...
                    <select name="comiket_detail_buppan_collect_date_month_sel"
                            ...
                            _gid="buppan_collect_date"
                            _selected="<?php echo @$twf001Out->comiket_detail_buppan_collect_date_month_sel(); ?>"
                            _first="月を選択"
                            style="background-color: white;"
                            >
                    </select>月
                    <select name="comiket_detail_buppan_collect_date_day_sel"
                            ...
                            _gid="buppan_collect_date"
                            _selected="<?php echo @$twf001Out->comiket_detail_buppan_collect_date_day_sel(); ?>"
                            _first="日を選択"
                            style="background-color: white;"
                            >
                    </select>日
