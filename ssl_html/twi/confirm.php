...
// 処理を実行
$view = new Sgmov_View_Twi_Confirm();
$forms = $view->execute();
...
<head>
    ...
    <meta name="Description" content="テーブルウェア・フェスティバル開催会場からの宅配便お申込み（個人用）のご案内です。[旅行カバン等のお荷物承ります]フォームにもれなくご入力をお願いいたします。前日23時までにお支払の確認ができたお客様につきましては、翌日より集荷が可能となります。" />
    <meta name="author" content="SG MOVING Co.,Ltd" />
    <meta name="copyright" content="SG MOVING Co.,Ltd All rights reserved." />
    <title>テーブルウェア・フェスティバル開催会場からの宅配便お申込み（個人用）｜お問い合わせ│ＳＧムービング株式会社＜ＳＧホールディングスグループ＞</title>
...
?>
    <div id="breadcrumb">
        <ul class="wrap">
            ...
            <li class="current">テーブルウェア・フェスティバル開催会場からの宅配便お申込み</li>
        </ul>
    </div>
    <div id="main">
        <div class="wrap clearfix">
            <h1 class="page_title">テーブルウェア・フェスティバル開催会場からの宅配便お申込み</h1>
            <p class="sentence">
            ...
            <div class="section">
                <form action="/<?=$dirDiv?>/complete" data-feature-id="<?php echo Sgmov_View_Twi_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Twi_Common::GAMEN_ID_TWI001 ?>" method="post">
...
<?php
        $eventName = Sgmov_View_Twi_Confirm::_getLabelSelectPulldownData($eveOutForm->event_cds(), $eveOutForm->event_lbls(), $eveOutForm->event_cd_sel());
        echo $eventName;
?>
                                                    &nbsp;
...
<?php
        $eventsubName = Sgmov_View_Twi_Confirm::_getLabelSelectPulldownData($eveOutForm->eventsub_cds(), $eveOutForm->eventsub_lbls(), $eveOutForm->eventsub_cd_sel());
        echo $eventsubName;
?>
                                                    </span>
                                                </td>
                                    ...
                                    <?php foreach($dispItemInfo['comiket_div_lbls'] as $key => $val) : ?>
                                        <?php if ($eveOutForm->comiket_div() == $key) : ?>
                                            <?php if($eveOutForm->event_cd_sel() == '2') :  // コミケの場合?>
                                                ...
                                                <?php if($eveOutForm->comiket_div() == Sgmov_View_Twi_Common::COMIKET_DEV_BUSINESS) : ?>
                                                <?php $val = '請求書にて請求'; ?>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                            <?php echo $val; ?>
                            ...
                            <?php if ($eveOutForm->comiket_div() == Sgmov_View_Twi_Common::COMIKET_DEV_BUSINESS) : // 法人 and 顧客コードを使用する ?>
                                <dl>
...
<?php
    ...
    if(empty($comiketId)){
        $building_name = Sgmov_View_Twi_Confirm::_getLabelSelectPulldownData($eveOutForm->building_name_ids(), $eveOutForm->building_name_lbls(), $eveOutForm->building_name_sel());
        $boothPosition = Sgmov_View_Twi_Confirm::_getLabelSelectPulldownData($eveOutForm->building_booth_position_ids()
    ...
    if($building_name == "その他"){
        ...
        $building_name .='<span style="font-size: 0.5em;">ホール</span>&nbsp;&nbsp; ';
    }
?>
                                            ...
                                            <table style="width:100%;">
                                                <tr>
                                                    <td style="padding-right: 20px;">
                                                        ...
                                                        <?php
                                                            echo(Sgmov_View_Twi_Confirm::_getLabelSelectPulldownData($eveOutForm->raw_building_booth_ids
                                                                                                    , $eveOutForm->raw_building_booth_lbls
                                                                                                    , $eveOutForm->comiket_booth_num()
                                                                                                    )
                                                            );
                                                        ?>
...
<?php /**********************************************************************************************************************/ ?>
                            <div class="dl_block input-outbound comiket_block">
                                ...
                                <dl>
                                    ...
                                    <dd>
<?php
        echo Sgmov_View_Twi_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_detail_outbound_pref_cds(), $eveOutForm->comiket_detail_outbound_pref_lbls(), $eveOutForm->comiket_detail_outbound_pref_cd_sel());
?>
                                    </dd>
                                </dl>
                                <dl>
                                ...
                                <dl style="display: none">
                                    ...
                                    <dd>
                                        ...
                                        （<?php echo Sgmov_View_Twi_Confirm::_getWeek($eveOutForm->comiket_detail_outbound_collect_date_year_sel(), $eveOutForm->comiket_detail_outbound_collect_date_month_sel(), $eveOutForm->comiket_detail_outbound_collect_date_day_sel()); ?>）
                                        &nbsp;
...
<?php
        if ( $view->checkColAndDelTime("outbound", $eveOutForm->comiket_div(), $eveOutForm->comiket_detail_outbound_service_sel(), $dispItemInfo["eventsub_selected_data"]) ) {
            echo Sgmov_View_Twi_Confirm::_getTimeFormatSelectPulldownData($eveOutForm->comiket_detail_outbound_collect_time_cds(), $eveOutForm->comiket_detail_outbound_collect_time_lbls(), $eveOutForm->comiket_detail_outbound_collect_time_sel());
        }
?>
                                    </dd>
                                </dl>
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        ...
                                        （<?php echo Sgmov_View_Twi_Confirm::_getWeek($eveOutForm->comiket_detail_outbound_delivery_date_year_sel(), $eveOutForm->comiket_detail_outbound_delivery_date_month_sel(), $eveOutForm->comiket_detail_outbound_delivery_date_day_sel()); ?>）
                                        &nbsp;
<?php
        echo Sgmov_View_Twi_Confirm::_getTimeFormatSelectPulldownData($eveOutForm->comiket_detail_outbound_delivery_time_cds(), $eveOutForm->comiket_detail_outbound_delivery_time_lbls(), $eveOutForm->comiket_detail_outbound_delivery_time_sel());
?>
                                    </dd>
                                </dl>
                                        ...
                                        <table>
                                            <tr>
                                                <td class='box_table_td' style='vertical-align: middle;width:40%;'>
                                                    <table>
                                                        <?php // if($eveOutForm->comiket_div() == Sgmov_View_Twi_Common::COMIKET_DEV_INDIVIDUA) : ?>
                                                            <table>
                                                ...
                                                <td style='padding-top:5px;'>
                                                    <?php if($eveOutForm->comiket_div() == Sgmov_View_Twi_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <?php if ($eveOutForm->comiket_detail_outbound_service_sel() == "2") : // カーゴ ?>
                                    <dl class="service-outbound-item" service-id="2">
                                        ...
                                        <dd>
<?php
                                                echo Sgmov_View_Twi_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_cargo_outbound_num_cds(), $eveOutForm->comiket_cargo_outbound_num_lbls(), $eveOutForm->comiket_cargo_outbound_num_sel());
?>台
                                ...
                                <?php if ($eveOutForm->comiket_detail_outbound_service_sel() == "3") : // 貸切 ?>
                                    <dl class="service-outbound-item" service-id="3">
                                        ...
                                        <dd>
                                            ...
                                            <?php elseif($eveOutForm->comiket_div() == Sgmov_View_Twi_Common::COMIKET_DEV_BUSINESS) : // 法人  ?>
                                                <div class="comiket-charter-outbound-num" div-id="<?php echo Sgmov_View_Twi_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                                    <table>
...
<?php /**********************************************************************************************************************/ ?>
                            <div style="" class="input-inbound input-inbound-title">お届け先</div>
<?php /**********************************************************************************************************************/ ?>
                            <div class="dl_block input-inbound comiket_block">
                                ...
                                <dl>
                                    ...
                                    <dd>
<?php
        echo Sgmov_View_Twi_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_detail_inbound_pref_cds(), $eveOutForm->comiket_detail_inbound_pref_lbls(), $eveOutForm->comiket_detail_inbound_pref_cd_sel());
?>
                                    </dd>
                                </dl>
                                <dl>
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        ...
                                        （<?php echo Sgmov_View_Twi_Confirm::_getWeek($eveOutForm->comiket_detail_inbound_collect_date_year_sel(), $eveOutForm->comiket_detail_inbound_collect_date_month_sel(), $eveOutForm->comiket_detail_inbound_collect_date_day_sel()); ?>）
                                        &nbsp;
<?php
        echo Sgmov_View_Twi_Confirm::_getTimeFormatSelectPulldownData($eveOutForm->comiket_detail_inbound_collect_time_cds(), $eveOutForm->comiket_detail_inbound_collect_time_lbls(), $eveOutForm->comiket_detail_inbound_collect_time_sel());
?>
                                    </dd>
                                </dl>
                                <dl style="display: none;">
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        ...
                                        （<?php echo Sgmov_View_Twi_Confirm::_getWeek($eveOutForm->comiket_detail_inbound_delivery_date_year_sel(), $eveOutForm->comiket_detail_inbound_delivery_date_month_sel(), $eveOutForm->comiket_detail_inbound_delivery_date_day_sel()); ?>）
                                        &nbsp;
<?php
        if ( $view->checkColAndDelTime("inbound", $eveOutForm->comiket_div(), $eveOutForm->comiket_detail_inbound_service_sel(), $dispItemInfo["eventsub_selected_data"]) ) :
            echo Sgmov_View_Twi_Confirm::_getTimeFormatSelectPulldownDataForInBound($eveOutForm->comiket_detail_inbound_delivery_time_cds(), $eveOutForm->comiket_detail_inbound_delivery_time_lbls(), $eveOutForm->comiket_detail_inbound_delivery_time_sel());
        endif;
?>
                                        <br/>
                                        <br/>
                                ...
                                <?php if ($eveOutForm->comiket_detail_inbound_service_sel() == "2") : // カーゴ ?>
                                    <dl class="service-outbound-item" service-id="2">
                                        ...
                                        <dd>
<?php
                                                echo Sgmov_View_Twi_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_cargo_inbound_num_cds(), $eveOutForm->comiket_cargo_inbound_num_lbls(), $eveOutForm->comiket_cargo_inbound_num_sel());
?>台
                                        </dd>
                                    </dl>
                                <?php endif; ?>
...
<?php if($eveOutForm->comiket_div() == Sgmov_View_Twi_Common::COMIKET_DEV_BUSINESS) : // 法人 ?>
