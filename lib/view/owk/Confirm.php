 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Owk_Confirm extends Sgmov_View_Owk_Common {
...
Sgmov_Component_Log::debug('########################## confirm9999');
Sgmov_Component_Log::debug($inForm);
        ...
        // チケットを発行
        $ticket = $session->publishTicket(self::FEATURE_ID, self::GAMEN_ID_OWK003);
