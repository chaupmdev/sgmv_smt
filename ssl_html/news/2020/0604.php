...
<meta name="description" content="SGムービング イケア・ジャパンと連携してCO2排出量の削減に向けEVトラックを導入">
...
<title>SGムービング イケア・ジャパンと連携してCO2排出量の削減に向けEVトラックを導入｜ニュース｜<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/meta-ttl.php'); ?></title>
<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/common_style.php'); ?>
<link rel="stylesheet" type="text/css" href="/css/topics.css">
<link rel="stylesheet" type="text/css" href="/css/commonpdfbtn.css">
		...
		<div class="mainBox" data-stt-ignore>
			<article id="conts">
				<div class="titleBox fadeInUp">
					...
					<p class="title">SGムービング イケア・ジャパンと連携してCO2排出量の削減に向けEVトラックを導入</p>
				</div>
				<div class="wpBox fadeInUp">
					<p>SGホールディングスグループにおいて引越輸送、設置輸送、特殊輸送やオフィスなどの内装デザインから施工までを請け負うアーキテクト事業などを展開するSGムービング株式会社（本社：東京都江東区、代表取締役社長：別所規至）は、イケア・ジャパン株式会社（本社：千葉県船橋市、代表取締役社長：ヘレン・フォン・ライス）と連携し6月にEVトラックを2台導入しましたのでお知らせいたします。</p>
					<br>
                    <div class="btn"><p><il><a href="/news/news-release/pdf/topic55.pdf" target="_blank" rel="noopener" class="link-list__type--pdf">詳細はこちら<i class="link-list__filesize">[PDF:210KB]</i></a></il></p></div>
				</div>
