                    <div class="payment_method clearfix<?php if (isset($e) && $e->hasErrorForId('payment_method')) { echo ' form_error'; } ?>" id="payment_method">
                        ...
                        <label class="radio-label" for="pay_convenience_store_laterpay" >
                        </label>
<!--                        <label class="radio-label pay_digital_money" for="pay_digital_money" style="display: none">
...
<!--                    <div class="pay_digital_money_attention">
                        ...
                        <strong class="red" style="display: none">※ 電子マネーでのお支払いは、残高不足にご注意ください。なお1万円を超える場合は、お取り扱いできません。</strong>
                        <br>
                    </div>-->
                    <br>
