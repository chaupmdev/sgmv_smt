...
<meta name="description" content="SGムービング 従業員のマスク着用について">
...
<title>SGムービング 従業員のマスク着用について｜ニュース｜<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/meta-ttl.php'); ?></title>
		...
		<div class="mainBox" data-stt-ignore>
			<article id="conts">
				<div class="titleBox fadeInUp">
					<p class="time">2020.02.28<span class="cat-news">お知らせ</span></p>
					<p class="title">SGムービング 従業員のマスク着用について</p>
				</div>
				<div class="wpBox fadeInUp">
					<p>お客さま各位</p>
					<br>
					<p>いつもSGムービングをご利用いただきまして、誠にありがとうございます。</p>
					<br>
					<p>SGムービングでは、新型コロナウイルスやインフルエンザなどの感染症流行をうけ、従業員には集荷・配達、および接客時など就業中のマスク着用を許可しております。</p>
					<br>
					<p>お客さまにおかれましては、ご理解・ご了承のほど、よろしくお願い申し上げます。</p>
				</div>
