...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <div class="section">
                <form action="/<?=$dirDiv?>/complete" id="ev_form" data-feature-id="<?php echo Sgmov_View_Rms_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Rms_Common::GAMEN_ID_RMS001 ?>" method="post">
...
?>
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        ...
                                        &nbsp;
                                        <span><?=@$dispItemInfo['eventsub_selected_data']['collect_timeframe']?></span>
<?php
    ...
    <script>
        $(function() {
            $('input[name="submit"]').on('click', function () {
                ...
                let s_tel="<?php echo $eveOutForm->comiket_detail_inbound_tel();?>";
                $("<input>",{
                    type:"hidden",
