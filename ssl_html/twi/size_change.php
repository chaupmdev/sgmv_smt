...
// 処理を実行
$view = new Sgmov_View_Twi_SizeChange();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/<?=$dirDiv?>/size_change_check_input" data-feature-id="<?php echo Sgmov_View_Twi_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Twi_Common::GAMEN_ID_TWI001 ?>" method="post">
