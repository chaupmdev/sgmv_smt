...
Sgmov_Lib::useView('gmm/Cancel');
/**#@-*/

// 処理を実行
$view = new Sgmov_View_Gmm_Cancel();
$forms = $view->execute();
...
?>
                ...
                <p class="under">
                    ...
                    ?>
                    <br/>TEL: 03-5857-2413(受付時間:平日09時～17時)<?php if ($eve001Out->eventsub_cd_sel() == '4') : ?>※年内は12月28日まで<?php endif; ?>
                </p>
            </div>
...
?>
            <div class="section other">
                <form action="/gmm/cancel_comp" data-feature-id="<?php echo Sgmov_View_Gmm_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Gmm_Common::GAMEN_ID_GMM001 ?>" method="post">
...
//                        var_dump($eve001Out);
                        if ($eve001Out->comiket_detail_type_sel() == '3') { // 往路+復路
                            ///////////////////////////////////////////////
                            // 搬入情報入力エリア
                            ///////////////////////////////////////////////
                            include_once dirname(__FILE__) . '/parts/input_outbound_cancel.php';
                        ...
                        } elseif ($eve001Out->comiket_detail_type_sel() == '1') { // 往路
                            ///////////////////////////////////////////////
                            // 搬入情報入力エリア
                            ///////////////////////////////////////////////
                            include_once dirname(__FILE__) . '/parts/input_outbound_cancel.php';
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/gmm/js/input.js?<?php echo $strSysdate; ?>"></script>
</body>
</html>
