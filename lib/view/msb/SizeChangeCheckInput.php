...
Sgmov_Lib::useView('dsn/CheckInput');
 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Dsn_SizeChangeCheckInput extends Sgmov_View_Dsn_CheckInput {
    ...
    public function _redirectProc($inForm, $errorForm) {
        if ($errorForm->hasError()) {
            Sgmov_Component_Redirect::redirectPublicSsl('/dsn/size_change');
        }
