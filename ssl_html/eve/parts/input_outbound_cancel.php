...
<?php /**********************************************************************************************************************/ ?>
                        <div class="dl_block comiket_block">
                            ...
                            <dl>
                                ...
                                <dd>
<?php
        echo Sgmov_View_Eve_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_pref_cds(), $eve001Out->comiket_detail_outbound_pref_lbls(), $eve001Out->comiket_detail_outbound_pref_cd_sel());
?>
...
<?php echo $eve001Out->comiket_detail_outbound_delivery_date_day_sel(); ?>日
                                        ...
                                        <!--14:00～15:30-->
<?php
//        echo Sgmov_View_Eve_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_delivery_time_cds(), $eve001Out->comiket_detail_outbound_delivery_time_lbls(), $eve001Out->comiket_detail_outbound_delivery_time_sel());
?>
                                        </span>
                                    </div>
                                </dd>
...
<?php echo $eve001Out->comiket_detail_outbound_collect_date_day_sel(); ?>日
    ...
    <?php
            echo Sgmov_View_Eve_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_collect_time_cds(), $eve001Out->comiket_detail_outbound_collect_time_lbls(), $eve001Out->comiket_detail_outbound_collect_time_sel());
    ?>
                                        </span>
                                    </div>
                                </dd>
