...
// Basic認証
require_once dirname(__FILE__) . '/../../lib/component/auth_eve.php';

/**#@+
 * include files
 */
require_once dirname(__FILE__) . '/../../lib/Lib.php';
Sgmov_Lib::useView('eve/Input');
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <p class="sentence" style="margin-bottom: 5px;">
                ...
                <br /><span class="red">※九州・四国・中国・北海道・青森・沖縄エリアの方は搬入申込の締め切り時間が12月22日（日）12時までとなりますのでご注意ください。</span>
                <br />
            ...
            <div style="font-size: 14px;margin-top: 5px;">
                <span style="color: red;font-weight: bolder;">搬出・申込み期間</span>について 「2024年12月13日 ～ 2024年12月30日 <!--の <span style="font-size: 20px;font-weight: bolder;color:red;">22:00</span-->」 までにお申込みお願いします。
            </div>
...
?>
            <div class="section other">
                <form action="/eve/check_input" data-feature-id="<?php echo Sgmov_View_Eve_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Eve_Common::GAMEN_ID_EVE001 ?>" method="post">
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/eve/js/input.js?<?php echo $strSysdate; ?>"></script>
