...
// 処理を実行
$view = new Sgmov_View_Twi_Cancel();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/<?=$dirDiv?>/cancel_comp" data-feature-id="<?php echo Sgmov_View_Twi_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Twi_Common::GAMEN_ID_TWI001 ?>" method="post">
