...
<?php
//  var_dump($dispItemInfo);
//  var_dump($eve001Out);
            // echo Sgmov_View_Evp_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
?>
<?php 
    echo $dispItemInfo['eventname_all'];
?>
                                    &nbsp;&nbsp;
                                    </span>
...
<?php
            echo Sgmov_View_Evp_Input::_createPulldown($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel(), @$eve001Out->Eve_timeover_flg(), @$eve001Out->Eve_timeover_date());
?>
...
<?php
            echo Sgmov_View_Evp_Input::_createPulldown($eve001Out->eventsub_cds(), $eve001Out->eventsub_lbls(), $eve001Out->eventsub_cd_sel());
?>
                                                    </select>
...
<?php
        ...
        //if(strpos($eventName,'デザインフェスタ') !== false){
            echo '<img src="/evp/images/logo.png">';
        //}
?>
<?php
    // キャッシュ対策
...
?>
                                        <div class="sp_dl_area2 paste_tag">
                                            <table class="red eventsub_dl_link paste_tag_link paste_tag" >
                                                <tr>
                                                    <td style="vertical-align: top;padding-top:10px;width: 70%;">
                                                        <div style=";display:none;" class="eventsub_dl_link paste_tag">
                                                            ...
                                                            <a style="color: blue;font-weight: normal;" class="paste_tag_link" href="/evp/pdf/paste_tag/paste_tag_<?php echo $eve001Out->eventsub_cd_sel(); ?>_1.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">【1日目】貼付票（手書用）</a>
                                                            </br>
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;font-weight: normal;" class="paste_tag_link" href="/evp/pdf/paste_tag/paste_tag_<?php echo $eve001Out->eventsub_cd_sel(); ?>_2.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">【2日目】貼付票（手書用）</a>
                                                        </div>
                                                        <br/>
                                                    ...
                                                    <td style="color: #000;">
                                                        <img src="/images/common/hako_haritsuke.png" width="125" height="96" alt="" style="margin-left: 20px;"><br>
                                                        天面と側面1ヶ所以上に貼り付けてください。
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <div class="eventsub_dl_link manual" style="display:none;">
                                                <!--<img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">-->
                                                 <!--<a style="color: blue;font-weight: normal;text-decoration: underline;" class="manual_link" href="/evp/pdf/manual/<?php echo $eventName; ?><?php echo $eventsubName; ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">宅配便WEB申込みのご案内</a>-->
                                                <!--<a style="color: blue;font-weight: normal;text-decoration: underline;" href="https://www.comiket.co.jp/info-c/C101/C101appeal.html" target="_blank">https://www.comiket.co.jp/info-c/C101/C101appeal.html</a>-->
                                            </div>
                            ...
                            <?php /*
                            <dl>
                                <dt id="service_selected">
                                    サービス選択<span>必須</span>
                                </dt>
                                <dd<?php
                                    if (isset($e)
                                       && ($e->hasErrorForId('service_selected'))
                                    ) {
                                        echo ' class="form_error"';
                                    }
                                ?>>
                                    ...
                                    <div class="comiket_service_selected-dd" style="">
                                        <label class="radio-label comiket_service_selected-label2"
                                            for="service_selected1" style="">
                                            <input id="service_selected1" class="service_selected1"
                                                name="comiket_detail_service_selected" type="radio" value="1" <?php if ($eve001Out->comiket_detail_service_selected() == '1') echo ' checked="checked"'; ?>>
                                            配送受付サービス
                                        </label>
                                        &nbsp;<strong class="disp_comiket red">※「会場⇔お客様」へ荷物をお送りする／資材購入する方はこちら。</strong>
                                       <!--  <br>
                                        <label class="radio-label comiket_service_selected-label2"
                                            for="service_selected2" style="">
                                            <input id="service_selected2" class="service_selected2"
                                                name="comiket_detail_service_selected" type="radio" value="2" >
                                            手荷物預かりサービス
                                        </label>
                            ...
                            **/ ?>
                            ...
                            <?php if ($userType === 1) :?>
                                <dl>
                                    ...
                                    <dd>
                                        <?php echo $_SESSION['EVP_LOGIN']['email'] ?>
                                    </dd>
                                </dl>
                            <?php endif; ?>
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_pref')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <select name="comiket_pref_cd_sel">
                                        <option value="">選択してください</option>
<?php
        echo Sgmov_View_Evp_Input::_createPulldown($eve001Out->comiket_pref_cds(), $eve001Out->comiket_pref_lbls(), $eve001Out->comiket_pref_cd_sel());
?>
                                    </select>
                            ...
                            <dl class="class_building_name_sel">
                                <dt id="building_name_sel">
                                    <?php if ($eve001Out->event_cd_sel() == '2') : ?>
                                        ブース番号<span class = "hissu">必須</span>
                                    <?php else: ?>
                                        館名<span>必須</span>
                                    <?php endif; ?>
                                </dt>
                                <dd<?php if (isset($e) && $e->hasErrorForId('building_name_sel')) { echo ' class="form_error"'; } ?>>
                                    <!-- <input type="hidden" name="building_name_sel" value="916" > -->
                                    <select name="building_cd_and_name_sel" class="building_cd_and_name_sel">
                                        <option value="">選択してください</option>
                                        <?php foreach ($eve001Out->raw_building_name_ids as $key => $val) : ?>
                                            <option value="<?= $val; ?>,<?= $eve001Out->raw_building_name_lbls[$key] ?>" 
                                                <?php if($eve001Out->raw_building_cd_and_name_sel == "{$val},{$eve001Out->raw_building_name_lbls[$key]}"){ echo 'selected';} ?>
                                            >
                                                <?= $val; ?><?= $eve001Out->raw_building_name_lbls[$key] ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>&nbsp;ホール
                                    ...
                                    <select name="building_booth_position_sel" class="building_booth_position_sel">
                                        <option value="">選択してください</option>
<?php
                                         echo Sgmov_View_Evp_Input::_createPulldown($eve001Out->building_booth_position_ids(), $eve001Out->building_booth_position_lbls(), $eve001Out->building_booth_position_sel());
?>
                                    </select>&nbsp;ブロック
                                    </div>
                                    ...
                                    <input class="w_30Per" autocapitalize="off" maxlength="2" name="comiket_booth_num" placeholder="例）12(数値2桁)" type="text" value="<?php echo $eve001Out->comiket_booth_num();?>" />
                                    <br/>
                                    <div style="display: block;">
                                    <select name="comiket_booth_addition_num" class="comiket_booth_addition_num">
                                        <option value=""
                                                <?php if($eve001Out->raw_comiket_booth_addition_num == ""){ echo 'selected';} ?>
                                                ></option>
                                        <option value="a" 
                                                <?php if($eve001Out->raw_comiket_booth_addition_num == "a"){ echo 'selected';} ?>
                                                >a</option>
                                        <option value="b"
                                                <?php if($eve001Out->raw_comiket_booth_addition_num == "b"){ echo 'selected';} ?>
                                                >b</option>
                                    </select>&nbsp;机  &nbsp;&nbsp; <strong class="red">※机の範囲を選択してください。（「  」「a」「b」）。</strong>
                                    </div>
                                    <br/>
                                    <br/>
                                    <strong class="red">
                                    <?php if ($eve001Out->event_cd_sel() == '2') : ?>
                                        ※複数のブースを使用する出展者は代表ブース番号を入力してください。<br />
                                        ※出店者及び関係者の方がご利用の場合は、ブース番号を忘れずに入力してください。<br />
                                        ※※イベント来場者の方がご利用の場合は、「--」「-」「00」と入力してください。<br />
                                    <?php else: ?>
                                        ※出展者以外の方がご利用の場合は、「--」「-」「00」と、選択してください。<br />
                                    <?php endif; ?>
                                        <br/>
                                        <div class="eventsub_dl_link kaijoMap">
                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                            <a style="color: blue;" class="paste_kaijoMap" href="<?= $dispItemInfo['dispEvent']['kaijoMap']?>" target="_blank">会場MAP</a>
                                        </div>
                                    </strong>
                                </dd>
                            </dl>
                            ...
                            <dl class="class_comiket_booth_name">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_booth_name')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <br/>
                                    <strong class="red">
                                        ※出店者及び関係者の方がご利用の場合は、サークル名を忘れずに入力してください。<br/>
                                        ※イベント来場者の方がご利用の場合は「なし」と入力してください。
                                    </strong>
                                </dd>
                            </dl>

                            <dl class="class_comiket_staff_seimei">
                            ...
                            <dl class="class_comiket_staff_seimei_furi">
                            ...
                            <dl class="class_comiket_staff_tel">
