...
<?php
        echo Sgmov_View_Tme_Input::_createPulldown($eve001Out->comiket_detail_outbound_pref_cds(), $eve001Out->comiket_detail_outbound_pref_lbls(), $eve001Out->comiket_detail_outbound_pref_cd_sel());
?>
                                    </select>
                                    <br/>
                                    <br/>
...
<?php
        echo Sgmov_View_Tme_Input::_createPulldown($eve001Out->comiket_detail_outbound_collect_date_year_cds(), $eve001Out->comiket_detail_outbound_collect_date_year_lbls(), $eve001Out->comiket_detail_outbound_collect_date_year_sel());
?>
                                            </select>年
                                        </span>
                                        <span class="comiket_detail_outbound_collect_date">
...
<?php
        echo Sgmov_View_Tme_Input::_createPulldown($eve001Out->comiket_detail_outbound_collect_date_month_cds(), $eve001Out->comiket_detail_outbound_collect_date_month_lbls(), $eve001Out->comiket_detail_outbound_collect_date_month_sel());
?>
                                            </select>月
                                        </span>
                                        <span class="comiket_detail_outbound_collect_date">
...
<?php
            echo Sgmov_View_Tme_Input::_createPulldown($eve001Out->comiket_detail_outbound_collect_date_day_cds(), $eve001Out->comiket_detail_outbound_collect_date_day_lbls(), $eve001Out->comiket_detail_outbound_collect_date_day_sel());
?>
                                            </select>日
                                        </span>
                                        &nbsp;
    ...
    <?php
            echo Sgmov_View_Tme_Input::_createPulldown($eve001Out->comiket_detail_outbound_collect_time_cds(), $eve001Out->comiket_detail_outbound_collect_time_lbls(), $eve001Out->comiket_detail_outbound_collect_time_sel());
    ?>
                                            </select>
                                        </span>
                                    </div>
                                    ...
                                    <div class="comiket_detail_outbound_delivery_date_parts">
                                        <span class="comiket_detail_outbound_delivery_date">
                                            <select name="comiket_detail_outbound_delivery_date_year_sel">
                                                <option value="">年を選択</option>
<?php
        echo Sgmov_View_Tme_Input::_createPulldown($eve001Out->comiket_detail_outbound_delivery_date_year_cds(), $eve001Out->comiket_detail_outbound_delivery_date_year_lbls(), $eve001Out->comiket_detail_outbound_delivery_date_year_sel());
?>
                                            </select>年
                                        </span>
                                        <span class="comiket_detail_outbound_delivery_date">
                                            <select name="comiket_detail_outbound_delivery_date_month_sel">
                                                <option value="">月を選択</option>
<?php
        echo Sgmov_View_Tme_Input::_createPulldown($eve001Out->comiket_detail_outbound_delivery_date_month_cds(), $eve001Out->comiket_detail_outbound_delivery_date_month_lbls(), $eve001Out->comiket_detail_outbound_delivery_date_month_sel());
?>
                                            </select>月
                                        </span>
                                        <span class="comiket_detail_outbound_delivery_date">
                                            <select name="comiket_detail_outbound_delivery_date_day_sel">
                                                <option value="">日を選択</option>
<?php
        echo Sgmov_View_Tme_Input::_createPulldown($eve001Out->comiket_detail_outbound_delivery_date_day_cds(), $eve001Out->comiket_detail_outbound_delivery_date_day_lbls(), $eve001Out->comiket_detail_outbound_delivery_date_day_sel());
?>
                                            </select>日
                                        </span>
                                        &nbsp;
                                        <span class="comiket_detail_outbound_delivery_time_sel">
                                            ...
                                            <select name="comiket_detail_outbound_delivery_time_sel">
                                                <option value="">時間帯を選択</option>
    <?php
            echo Sgmov_View_Tme_Input::_createPulldown($eve001Out->comiket_detail_outbound_delivery_time_cds(), $eve001Out->comiket_detail_outbound_delivery_time_lbls(), $eve001Out->comiket_detail_outbound_delivery_time_sel());
    ?>
                                            </select>
                                        </span>
                                    </div>
                            ...
                            <dl class="service-outbound-item" service-id="1">
                                ...
                                <dd <?php if (isset($e) && $e->hasErrorForId('comiket_box_outbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                    <div class="comiket-box-outbound-num comiket-box-outbound-num-dmy"> <!-- 個人・法人 両方 -->
                                        <?php // if($eve001Out->comiket_div() == Sgmov_View_Tme_Common::COMIKET_DEV_BUSINESS) : ?>
                                        <table>
                                            <tr>
                                                <td>
                                                    <table>
                                                ...
                                                <td class="dispSeigyoPC" style='vertical-align: middle;text-align: right;'>
                                                    <?php if($eve001Out->comiket_div() == Sgmov_View_Tme_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
                            ...
                            <dl class="service-outbound-item" service-id="2">
                                ...
                                <dd <?php if (isset($e) && $e->hasErrorForId('comiket_cargo_outbound_num_ary')) { echo ' class="form_error"'; } ?> >
                                    <div class="comiket-cargo-outbound-num" div-id="<?php echo Sgmov_View_Tme_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                    </div>
                                    <div class="comiket-cargo-outbound-num" div-id="<?php echo Sgmov_View_Tme_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                    </div>
                                        <div style="">
...
<?php
                                                echo Sgmov_View_Tme_Input::_createPulldown($eve001Out->comiket_cargo_outbound_num_cds(), $eve001Out->comiket_cargo_outbound_num_lbls(), $eve001Out->comiket_cargo_outbound_num_sel());
?>
                                            </select>-->
                            ...
                            <dl class="service-outbound-item" service-id="3">
                                ...
                                <dd <?php if (isset($e) && $e->hasErrorForId('comiket_charter_outbound_num')) { echo ' class="form_error"'; } ?>>
                                    <div class="comiket-charter-outbound-num" div-id="<?php echo Sgmov_View_Tme_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                    ...
                                    <div class="comiket-charter-outbound-num" div-id="<?php echo Sgmov_View_Tme_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                        <!--<div style="margin-bottom: 10px;">-->
                                            <table>
