...
// 処理を実行
$view = new Sgmov_View_Nss_SizeChange();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/<?=$dirDiv?>/size_change_check_input" data-feature-id="<?php echo Sgmov_View_Nss_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Nss_Common::GAMEN_ID_NSS001 ?>" method="post">
                    ...
                    <input name="screen" type="hidden" value="size_change" />
