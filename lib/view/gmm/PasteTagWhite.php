 ...
 * #@-
 */
class Sgmov_View_Gmm_PasteTag_White {
...
// 		}
		...
		if( $comiket['sid'] == '301' || $comiket['sid'] == '302' ){
			for($page = 1; $page <= $sum_num; $page ++) {
				$comiket ['building_name'] = 'A';
		...
		if( $comiket['sid'] == '303' ){
			for($page = 1; $page <= $sum_num; $page ++) {
				$comiket ['building_name'] = '西1';
				$comiket ['which_day'] = 1;
				$comiket ['delivery_date'] = '2021/04/10';
				$this->eventsub_id = $comiket ['sid'];
				$this->building_name = $comiket ['building_name'];
				$this->addSheet ( $pdf, $comiket, $page );
			}
			for($page = 1; $page <= $sum_num; $page ++) {
				$comiket ['building_name'] = '西2';
				$comiket ['which_day'] = 1;
				$comiket ['delivery_date'] = '2021/04/10';
				$this->eventsub_id = $comiket ['sid'];
				$this->building_name = $comiket ['building_name'];
			...
			for($page = 1; $page <= $sum_num; $page ++) {
				$comiket ['building_name'] = '西1';
				$comiket ['which_day'] = 2;
				$comiket ['delivery_date'] = '2021/04/11';
				$this->eventsub_id = $comiket ['sid'];
				$this->building_name = $comiket ['building_name'];
				$this->addSheet ( $pdf, $comiket, $page );
			}
