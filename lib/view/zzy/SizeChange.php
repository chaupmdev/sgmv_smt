 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Zzy_SizeChange extends Sgmov_View_Zzy_Input {
    ...
    protected function _createOutFormByInForm($inForm, $param=NULL) {
        ...
        if(!empty($param)) {
            ...
            if ($comikeDetailInfo['type'] == '1') { // 往路
                ...
                $inForm["comiket_detail_outbound_service_sel"] = '1'; // みどり会は宅配のみ
            ...
            if ($comikeDetailInfo['type'] == '2') { // 復路
                ...
                $inForm["comiket_detail_inbound_service_sel"] = '1'; // みどり会は宅配のみ
