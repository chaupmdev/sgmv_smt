...
Sgmov_Lib::useView('bpn/Cancel');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Bpn_Cancel();
$forms = $view->execute();
...
<head>
    ...
    <title><?php echo $title; ?>のキャンセルお申込み│ＳＧムービング株式会社＜ＳＧホールディングスグループ＞</title>
<?php
    // キャッシュ対策
...
?>
    <div id="breadcrumb">
        <ul class="wrap">
            ...
            <li class="current"><?php echo $title; ?>のキャンセルお申込み</li>
        </ul>
    </div>
    <div id="main">
        <div class="wrap clearfix">
            <h1 class="page_title"><?php echo $title; ?>のキャンセルお申込み</h1>
            <p class="sentence">
...
?>
            <div class="section other">
                <form action="/bpn/cancel_comp" data-feature-id="<?php echo Sgmov_View_Bpn_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Bpn_Common::GAMEN_ID_BPN001 ?>" method="post">
...
<?php
                        ...
                        //// 商品情報入力エリア
                        /////////////////////////////////////////////////
                        include_once dirname(__FILE__) . '/parts/input_shohin_cancel.php';
?>
                    </div>
