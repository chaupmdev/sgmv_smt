...
// 処理を実行
$view = new Sgmov_View_Twf_Cancel();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/<?=$dirDiv?>/cancel_comp" data-feature-id="<?php echo Sgmov_View_Twf_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Twf_Common::GAMEN_ID_TWF001 ?>" method="post">
