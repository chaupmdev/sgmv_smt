...
// 処理を実行
$view = new Sgmov_View_Twi_Input2();
$forms = $view->execute();
...
<head>
    ...
    <meta name="Description" content="テーブルウェア・フェスティバル開催会場からの宅配便お申込みのご案内です。" />
    <meta name="author" content="SG MOVING Co.,Ltd" />
    <meta name="copyright" content="SG MOVING Co.,Ltd All rights reserved." />
    <title>テーブルウェア・フェスティバル開催会場からの宅配便お申込み｜お問い合わせ│ＳＧムービング株式会社＜ＳＧホールディングスグループ＞</title>
<?php
    // キャッシュ対策
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <p class="sentence" style="margin-bottom: 5px;">
                ...
                <br /><a href="/twi/pdf/manual/宅配発送における注意事項.pdf" target="_blank" style="color: #1774bc; text-decoration: underline;">宅配発送における注意事項</a>
...
?>
                ...
                <p class="under">
                    ...
                    <br />
                    <?php
                            $selectedEventNmae = Sgmov_View_Twi_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
...
?>
            <div class="section other">
                <form action="/<?=$dirDiv?>/check_input2" data-feature-id="<?php echo Sgmov_View_Twi_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Twi_Common::GAMEN_ID_TWI001 ?>" method="post">
                    ...
                    <div class="section">
                        ...
                        <div class="dl_block comiket_block">
                            <dl>
                                ...
                                ?>>
<?php
        $eventName = Sgmov_View_Twi_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
        echo $eventName;
...
<?php
        $eventsubName = Sgmov_View_Twi_Input::_getLabelSelectPulldownData($eve001Out->eventsub_cds(), $eve001Out->eventsub_lbls(), $eve001Out->eventsub_cd_sel());
        echo $eventsubName;
?>
</span>
...
<?php endif; ?>
                            ...
                            <?php if ($eve001Out->comiket_div() == Sgmov_View_Twi_Common::COMIKET_DEV_BUSINESS) : // 法人?>
                                <dl>
...
?>
                    ...
                    <?php if ($eve001Out->comiket_div() == Sgmov_View_Twi_Common::COMIKET_DEV_INDIVIDUA) : ?>
...
?>
    ...
    data-G_DEV_INDIVIDUAL="<?php echo Sgmov_View_Twi_Common::COMIKET_DEV_INDIVIDUA; ?>"
    data-G_DEV_BUSINESS="<?php echo Sgmov_View_Twi_Common::COMIKET_DEV_BUSINESS; ?>"
    ></script>
