...
Sgmov_Lib::useView('tme/CreditCard');
/**#@-*/
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <form action="/tme/check_credit_card" method="post">
...
?>
                    ...
                    <div class="btn_area">
                        ...
                        if(empty($comiketId)): ?>
                            <a class="back" href="/tme/input/?clr=1">修正する</a>
                        <?php else: ?>
                            <a class="back" href="/tme/input2/?clr=1">修正する</a>
                        <?php endif; ?>
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/tme/js/credit_card.js"></script>
    <script>
        $(function() {
