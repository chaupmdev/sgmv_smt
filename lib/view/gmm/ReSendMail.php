 ...
 * #@-
 */
class Sgmov_View_Gmm_ReSendMail extends Sgmov_View_Gmm_Common {
    ...
    public function executeInner() {
        ...
        $comiketData['sgf_res_shopOrderId'] = $comiketData['kounyuten_no'];
        $comiketData['sgf_res_transactionId'] = $comiketData['transaction_id'];
