...
abstract class Sgmov_View_Dsn_Common extends Sgmov_View_Public {
     ...
     * イベントサブID
     */
    const EVENT_SUB_ID = '1805';

    /**
     * DSN001の画面ID
     */
    const GAMEN_ID_DSN001 = 'HMJ001';

    /**
     * DSN002の画面ID
     */
    const GAMEN_ID_DSN002 = 'HMJ002';

    /**
     * DSN003の画面ID
     */
    const GAMEN_ID_DSN003 = 'HMJ003';
...
///////////////////////////////////////////////////////////////////////////////////
    ...
    protected function createOutFormByInForm($inForm, $outForm = array()) {
        ...
        // 地区＆ホール
        //GiapLN comment remove item building_cd_and_name_sel
...
//        $outForm->raw_building_name = $inForm["building_cd_and_name_sel"];
        //End GiapLN comment remove item building_cd_and_name_sel
        // 都道府県名
        ...
        // ブース位置
        $buildingListByEventsubId = $this->_BuildingService->fetchBuildingDataByEventsubId2($db, $inForm["eventsub_sel"]);
    ...
    public function setDispEvent(&$dispItemInfo){
        ...
        foreach($dispItemInfo['event_alllist'] as $k=>$v){
            if(isset($dispItemInfo['eventsub_selected_data']['event_id']) && $v['id']==$dispItemInfo['eventsub_selected_data']['event_id']){
                    ...
                    $dispItemInfo['dispEvent']['kaijoMap']  ='/'.$this->_DirDiv.'/pdf/manual/kaijoMap_'.$this->_DirDiv.'.pdf'.$cacheStr;
        ...
        try {
            ...
            if ($eventsubData['booth_display'] !== '0') {
                ...
                if ($eventData['id'] === '10') {  // 国内クルーズ
                    ...
                    $data['comiket_booth_name'] = PHP_EOL . '【クリエイター名】' . $comiket['booth_name'];
                }
            }
