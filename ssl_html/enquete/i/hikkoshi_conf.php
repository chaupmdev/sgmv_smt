<?php 
    ...
    $array_pro = array('約束通り'=>'1', '早かった（連絡有り）'=>'2', '遅れた（連絡有り）'=>'3', '早かった（連絡なし）'=>'4', '遅れた（連絡なし）'=>'5');
    $array_cus = array('お客様と一緒に確認'=>'1', 'お客様が確認'=>'2', '配送員が確認'=>'3', '行っていない'=>'4', 'わからない'=>'5');
    ...
    if($err == true){
        ...
        $_SESSION['q1'] = $array_pro[$q1];
        
        $_SESSION['q2'] = $array_quality[$q2];
        $_SESSION['q4'] = $array_quality[$q4];
        $_SESSION['q5'] = $array_quality[$q5];
        $_SESSION['q6'] = $array_quality[$q6];
        $_SESSION['q7'] = $array_quality[$q7];
        $_SESSION['q8'] = $array_quality[$q8];
        
        $_SESSION['q3'] = $array_cus[$q3];
        ...
        header("Location: hikkoshi.php?param=".$param);
        exit;
    }
...
<div id="contents">
        ...
        <strong>お約束の作業開始時間は守られましたか。</strong>
        </div>    
        <p>
            <?php echo $q1; ?>
        </p>
        ...
        <br />
        <div style="border:3px solid #78EAFE; background:#D3F8FF; padding: 5px;">
        <strong>引越スタッフの服装・態度・挨拶・言葉使いの印象はいかがでしたか。</strong>
        </div>
        <p>
            <?php echo $q2; ?>
        </p>
        ...
        <br />
        <div style="border:3px solid #78EAFE; background:#D3F8FF; padding: 5px;">
        <strong>作業前にどのように家屋・家財のキズ確認を行いましたか。</strong>
        </div>
        <p>
            <?php echo $q3; ?>
        </p>
        ...
        <div style="border:3px solid #78EAFE; background:#D3F8FF; padding: 5px;">
        <strong>作業時に家屋へキズをつけないための配慮はありましたか。</strong>
        </div>
        <p>
            <?php echo $q4; ?>
        </p>
        ...
        <br />
        <div style="border:3px solid #78EAFE; background:#D3F8FF; padding: 5px;">
        <strong>作業時に家財・引越荷物へキズをつけないための配慮はありましたか。</strong>
        </div>
        <p>
            <?php echo $q5; ?>
        </p>
        ...
        <br />
        <div style="border:3px solid #78EAFE; background:#D3F8FF; padding: 5px;">
        <strong>作業効率・段取り・作業時間はいかがでしたか。</strong>
        </div>
        <p>
            <?php echo $q6; ?>
        </p>
        ...
        <br />
        <div style="border:3px solid #78EAFE; background:#D3F8FF; padding: 5px;">
        <strong>お客様の指示通りのレイアウトに搬入を行いましたか。</strong>
        </div>
        <p>
            <?php echo $q7; ?>
        </p>
        ...
        <br />
        <div style="border:3px solid #78EAFE; background:#D3F8FF; padding: 5px;">
        <strong>作業終了時に資材・作業道具・梱包廃材等を残さず持ち帰りましたか。</strong>
        </div>
        <p>
            <?php echo $q8; ?>
        </p>
        ...
        <br />
        <div style="border:3px solid #78EAFE; background:#D3F8FF; padding: 5px;">
        <strong>作業後にどのように家屋・家財のキズ確認を行いましたか。</strong>
        </div>
        <p>
            <?php echo $q9; ?>
        </p>
        ...
        <br />
        <div style="border:3px solid #78EAFE; background:#D3F8FF; padding: 5px;">
        <strong>ＳＧムービングの引越をまた利用したいと思いますか？</strong>
        </div>
        <p>
            <?php echo $q10; ?>
        </p>
        ...
        <p>
            <?php echo nl2br (htmlspecialchars($q11, ENT_QUOTES, 'sjis-win')); ?>
        </p>
        ...
        <p>
            ...
            名前:<?php echo nl2br (htmlspecialchars($q12b, ENT_QUOTES, 'sjis-win')); ?></div>
            電話:<?php echo nl2br (htmlspecialchars($q12c, ENT_QUOTES, 'sjis-win')); ?></div><br />
            住所:<?php echo nl2br (htmlspecialchars($q12d, ENT_QUOTES, 'sjis-win')); ?></div>
            <?php } ?>
        </p>
        
        
    <form action="./hikkoshi.php" method="post">
        
        <input type="hidden" name="q1" value="<?php echo $array_pro[$q1]; ?>">
        <input type="hidden" name="q2" value="<?php echo $array_quality[$q2]; ?>">
        <input type="hidden" name="q3" value="<?php echo $array_cus[$q3]; ?>">
        <input type="hidden" name="q4" value="<?php echo $array_quality[$q4]; ?>">
        <input type="hidden" name="q5" value="<?php echo $array_quality[$q5]; ?>">
        <input type="hidden" name="q6" value="<?php echo $array_quality[$q6]; ?>">
        <input type="hidden" name="q7" value="<?php echo $array_quality[$q7]; ?>">
        <input type="hidden" name="q8" value="<?php echo $array_quality[$q8]; ?>">
        ...
        <input type="hidden" name="kbn" value="<?php echo 1; ?>">
