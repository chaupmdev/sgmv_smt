...
class Sgmov_Form_Eve001Out {
     ...
     * @var string
     */
    public $raw_comiket_booth_cd_sel = '';

    /**
     * 都道府県コードリスト
     * @var array
     */
    public $raw_comiket_booth_cds = array();

    /**
     * 都道府県コードラベルリスト
     * @var array
     */
    public $raw_comiket_booth_lbls = array();
...
//    public $raw_building_booth_lbls = array();
     ...
     * @var string
     */
    public $raw_comiket_booth_addition_num = '';
...
//    public $raw_comiket_cargo_outbound_num_ary = array();
    ...
    public $raw_comiket_detail_caremark_flg = '';
    public $raw_comiket_detail_caremark_flg_enable = '';
    /**
     * 搬入-備考-2行目
     * @var string
     */
...
//    public $raw_comiket_cargo_inbound_num_ary = array();
    public $raw_comiket_detail_caremark_flg_inbound = '';
    public $raw_comiket_detail_caremark_flg_enable_inbound = '';
    /**
     * 復路-貸切台数
     * @var string
     */
...
////////////////////////////////////////////////////////////////////////////////
     ...
     * @var string
     */
    public $raw_travel_departure_nm = '';
     ...
     * @var string
     */
    public $raw_delivery_collection_date_year_cd_sel = '';

    /**
     * 集荷希望年コードリスト
     * @var array
     */
    public $raw_delivery_collection_date_year_cds = array();

    /**
     * 集荷希望年コードラベルリスト
     * @var array
     */
    public $raw_delivery_collection_date_year_lbls = array();
    
    /**
     * 集荷希望月コード選択値
     * @var string
     */
    public $raw_delivery_collection_date_month_cd_sel = '';

    /**
     * 集荷希望月コードリスト
     * @var array
     */
    public $raw_delivery_collection_date_month_cds = array();

    /**
     * 集荷希望月コードラベルリスト
     * @var array
     */
    public $raw_delivery_collection_date_month_lbls = array();
    
    /**
     * 集荷希望日コード選択値
     * @var string
     */
    public $raw_delivery_collection_date_day_cd_sel = '';

    /**
     * 集荷希望日コードリスト
     * @var array
     */
    public $raw_delivery_collection_date_day_cds = array();

    /**
     * 集荷希望日コードラベルリスト
     * @var array
     */
    public $raw_delivery_collection_date_day_lbls = array();
     ...
     * @return string エンティティ化された都道府県コード選択値
     */
    public function comiket_booth_cd_sel() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_booth_cd_sel);
    }
     ...
     * @return array エンティティ化された都道府県コードリスト
     */
    public function comiket_booth_cds() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_booth_cds);
    }
     ...
     * @return array エンティティ化された都道府県コードラベルリスト
     */
    public function comiket_booth_lbls() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_booth_lbls);
    }
...
//    }
     ...
     * @return string エンティティ化されたブース番号
     */
    public function comiket_booth_addition_num() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_booth_addition_num);
    }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     * @return string エンティティ化された往路-宅配数量
     */
    public function comiket_box_num() {
        return Sgmov_Component_String::htmlspecialchars(@$this->raw_comiket_box_num);
    }
//
//    /**
//     * 往路-カーゴ選択
...
//    }
     ...
     * @return string エンティティ化された往路-備考
     */
    public function comiket_detail_caremark_flg() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_caremark_flg);
    }
     ...
     * @return string エンティティ化された往路-備考
     */
    public function comiket_detail_caremark_flg_enable() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_caremark_flg_enable);
    }
    /**
...
//    }
     ...
     * @return string エンティティ化された往路-備考
     */
    public function comiket_detail_caremark_flg_inbound() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_caremark_flg_inbound);
    }
     ...
     * @return string エンティティ化された往路-備考
     */
    public function comiket_detail_caremark_flg_enable_inbound() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_caremark_flg_enable_inbound);
    }
...
////////////////////////////////////////////////////////////////////////////////
     ...
     * @return string エンティティ化された出発地コードラベルリスト
     */
    public function travel_departure_nm() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_travel_departure_nm);
    }
    /**
     ...
     * @return string エンティティ化された集荷希望年コード選択値
     */
    public function delivery_collection_date_year_cd_sel() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_delivery_collection_date_year_cd_sel);
    }
     ...
     * @return array エンティティ化された集荷希望年コードリスト
     */
    public function delivery_collection_date_year_cds() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_delivery_collection_date_year_cds);
    }
     ...
     * @return array エンティティ化された集荷希望年ラベルリスト
     */
    public function delivery_collection_date_year_lbls() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_delivery_collection_date_year_lbls);
    }
     ...
     * @return string エンティティ化された集荷希望月コード選択値
     */
    public function delivery_collection_date_month_cd_sel() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_delivery_collection_date_month_cd_sel);
    }
     ...
     * @return array エンティティ化された集荷希望月コードリスト
     */
    public function delivery_collection_date_month_cds() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_delivery_collection_date_month_cds);
    }
     ...
     * @return array エンティティ化された集荷希望月ラベルリスト
     */
    public function delivery_collection_date_month_lbls() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_delivery_collection_date_month_lbls);
    }
     ...
     * @return string エンティティ化された集荷希望日コード選択値
     */
    public function delivery_collection_date_day_cd_sel() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_delivery_collection_date_day_cd_sel);
    }
     ...
     * @return array エンティティ化された集荷希望日コードリスト
     */
    public function delivery_collection_date_day_cds() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_delivery_collection_date_day_cds);
    }
     ...
     * @return array エンティティ化された集荷希望日ラベルリスト
     */
    public function delivery_collection_date_day_lbls() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_delivery_collection_date_day_lbls);
    }

    public $raw_addressee_type_sel = '';

    /**
     * 搬入-お届け日時-時間帯 リスト
     * @var array
     */
    public $raw_addressee_type_cds = array();

    /**
     * 搬入-お届け日時-時間帯 ラベルリスト
     * @var array
     */
    public $raw_addressee_type_lbls = array();
    
    public function addressee_type_sel() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_addressee_type_sel);
    }
     ...
     * @return string エンティティ化された往路-お届け日時-時間帯 リスト
     */
    public function addressee_type_cds() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_addressee_type_cds);
    }
     ...
     * @return string エンティティ化された往路-お届け日時-時間帯 ラベルリスト
     */
    public function addressee_type_lbls() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_addressee_type_lbls);
    }
    
    public $raw_sevice_center_sel = '';
    public $raw_sevice_center_cds = array();
    public $raw_sevice_center_lbls = array();
    
    public function sevice_center_sel() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_sevice_center_sel);
    }
    public function sevice_center_cds() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_sevice_center_cds);
    }
    public function sevice_center_lbls() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_sevice_center_lbls);
    }
    
    public $raw_hotel_sel = '';
    public $raw_hotel_cds = array();
    public $raw_hotel_lbls = array();
    
    public function hotel_sel() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_hotel_sel);
    }
    public function hotel_cds() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_hotel_cds);
    }
    public function hotel_lbls() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_hotel_lbls);
    }
    
    public $raw_airport_sel = '';
    public $raw_airport_cds = array();
    public $raw_airport_lbls = array();
    
    public function airport_sel() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_airport_sel);
    }
    public function airport_cds() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_airport_cds);
    }
    public function airport_lbls() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_airport_lbls);
    }
    
    public $raw_comiket_detail_delivery_date_min = '';
    public function comiket_detail_delivery_date_min() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_delivery_date_min);
    }
    
    public $raw_comiket_detail_delivery_date_hour = '';
    public function comiket_detail_delivery_date_hour() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_delivery_date_hour);
    }
    
    public $raw_comiket_detail_delivery_date = '';
    public function comiket_detail_delivery_date() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_delivery_date);
    }
