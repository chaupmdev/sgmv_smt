...
?>
            <div class="section other">
                <form action="/<?=$dirDiv?>/check_input" data-feature-id="<?php echo Sgmov_View_Yid_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Yid_Common::GAMEN_ID_TWF001 ?>" method="post">
