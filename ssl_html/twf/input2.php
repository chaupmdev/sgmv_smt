...
// 処理を実行
$view = new Sgmov_View_Twf_Input2();
$forms = $view->execute();
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <p class="sentence" style="margin-bottom: 5px;">
                <span class="red">お申込から当日までの流れにつきましては、配布をしております出展ガイド・出品ガイドの搬入出ページをご確認ください。</span>
                <!--<a style="color: #1774bc;" href="<?=$dispItemInfo['dispEvent']['manual']?>" target="_blank">こちら</a><br />-->
                <br />
                ...
                <br /><a href="/twf/pdf/manual/宅配発送における注意事項.pdf" target="_blank" style="color: #1774bc; text-decoration: underline;">宅配発送における注意事項</a>
...
?>
                ...
                <p class="under">
                    ...
                    <br />
                    <?php
                            $selectedEventNmae = Sgmov_View_Twf_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
...
?>
            <div class="section other">
                <form action="/<?=$dirDiv?>/check_input2" data-feature-id="<?php echo Sgmov_View_Twf_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Twf_Common::GAMEN_ID_TWF001 ?>" method="post">
                    ...
                    <div class="section">
                        ...
                        <div class="dl_block comiket_block">
                            <dl>
                                ...
                                ?>>
<?php
        $eventName = Sgmov_View_Twf_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
        echo $eventName;
...
<?php
        $eventsubName = Sgmov_View_Twf_Input::_getLabelSelectPulldownData($eve001Out->eventsub_cds(), $eve001Out->eventsub_lbls(), $eve001Out->eventsub_cd_sel());
        echo $eventsubName;
?>
</span>
...
<?php endif; ?>
                            ...
                            <?php if ($eve001Out->comiket_div() == Sgmov_View_Twf_Common::COMIKET_DEV_BUSINESS) : // 法人?>
                                <dl>
                                ...
                                <dl>
                                    <dt id="building_booth_id_sel">
                                        <?php if($eve001Out->event_cd_sel() == '2') :  // コミケ?>
                                            ブース番号<span>必須</span>
                                        <?php else : ?>
                                            エリア名、ブース番号、<br/>エントリーNo<span>必須</span>
                                        <?php endif; ?>
                                    </dt>
...
?>
                    ...
                    <?php if ($eve001Out->comiket_div() == Sgmov_View_Twf_Common::COMIKET_DEV_INDIVIDUA) : ?>
...
?>
    ...
    data-G_DEV_INDIVIDUAL="<?php echo Sgmov_View_Twf_Common::COMIKET_DEV_INDIVIDUA; ?>"
    data-G_DEV_BUSINESS="<?php echo Sgmov_View_Twf_Common::COMIKET_DEV_BUSINESS; ?>"
    ></script>
