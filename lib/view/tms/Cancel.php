 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Tms_Cancel extends Sgmov_View_Tms_Input {
...
Sgmov_Component_Log::debug($collectDate);
            ...
            if ($eventTermEndDate <= $toDate) {
                ...
                $message = "既に {$eventTermEndDate2} を過ぎているため搬出のキャンセルのお申し込みができませんでした。(イベント終了日までキャンセル可能)";
                Sgmov_Component_Redirect::redirectPublicSsl("/tms/error?t={$title}&m={$message}");
            }
        }
