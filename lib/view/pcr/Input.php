...
Sgmov_Lib::useForms(array('Error', 'PcrSession', 'Pcr001Out'));
/**#@-*/
 ...
 * @copyright  2009-2010 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Pcr_Input extends Sgmov_View_Pcr_Common {
    ...
    private function _createOutFormByInForm($inForm) {
        ...
        if (@empty($travelAgency['ids'])) {
            ...
            Sgmov_Component_Redirect::redirectPublicSsl("/error_pcr.html");
        }
