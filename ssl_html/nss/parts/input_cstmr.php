...
<?php
            echo Sgmov_View_Nss_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
?>
                                    &nbsp;&nbsp;
                                    </span>
...
<?php
            echo Sgmov_View_Nss_Input::_createPulldown($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel(), $eve001Out->eve_timeover_flg(), $eve001Out->eve_timeover_date());
?>
                                        </select>
...
<?php
            echo Sgmov_View_Nss_Input::_createPulldown($eve001Out->eventsub_cds(), $eve001Out->eventsub_lbls(), $eve001Out->eventsub_cd_sel());
?>
                                        </select>
                                            <br/>
<?php
        $eventName = Sgmov_View_Nss_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
        $eventsubName = Sgmov_View_Nss_Input::_getLabelSelectPulldownData($eve001Out->eventsub_cds(), $eve001Out->eventsub_lbls(), $eve001Out->eventsub_cd_sel());
        if(strpos($eventName,'にじそうさく') !== false){
        echo '<img src="/nss/images/logo.png">';
        }
?>
<?php
    // キャッシュ対策
...
?>
                                                    <div class="sp_dl_area2 paste_tag">
                                                        <div style=";display:none;" class="eventsub_dl_link paste_tag">
                                                            ...
                                                            <a style="color: blue;" class="paste_tag_link" href="<?=$dispItemInfo['dispEvent']['pasteTag']?>" target="_blank">配達カード（例）</a>
                                                        </div>
                                                        <br/>
                                                        <strong class="red eventsub_dl_link paste_tag_link paste_tag" style="display:none;">
                                                            ※出荷の際、こちらを荷物に貼り付けて出荷をお願いします。<br/><br/>
                                                            ※お申し込み完了画面でブース名が記載された配達カードを出力できます。
                                                        </strong>
<?php if ($eve001Out->input_mode() != '002') {  // 入力モードが"002"(コミケ)なら説明書のリンクは表示しない ?>
                                                        ...
                                                        <br/>
                                                        <div>
                                                        <strong style="color:#C00;">※北海道、青森・中国・四国・九州・沖縄エリアにご在住の方は申込受付期間が7月2日(火)12：00までになります。</strong>
                                                        </div>
<?php } ?>
                                                    </div>
                                                    <!-- <br/> -->
                            ...
                            <?php if ($userType === 1) :?>
                                <dl>
                                    ...
                                    <dd>
                                        <?php echo $_SESSION['NSS_LOGIN']['email'] ?>
                                    </dd>
                                </dl>
                            <?php endif; ?>
                            <!-- END -->
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_pref')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <select name="comiket_pref_cd_sel">
                                        <option value="">選択してください</option>
<?php
        echo Sgmov_View_Nss_Input::_createPulldown($eve001Out->comiket_pref_cds(), $eve001Out->comiket_pref_lbls(), $eve001Out->comiket_pref_cd_sel());
?>
                                    </select>
                                </dd>
                            </dl>
                                ...
                                <input class="" style="width:80%;" maxlength="16" autocapitalize="off" name="comiket_booth_name" data-pattern="" placeholder="" type="text" value="<?php echo $eve001Out->comiket_booth_name() ?>" />
                                    ...
                                    <br/>
                                     <strong class="red lhn">
                                        ※出店者及び関係者の方がご利用の場合は、ブース名を忘れずに入力してください。<br />
                            ...
                            <dl class="class_building_name_sel">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('building_name_sel')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    東 <select name="building_booth_position_sel">
                                        <option value="">選択してください</option>
<?php
                                         echo Sgmov_View_Nss_Input::_createPulldown($eve001Out->building_booth_position_ids(), $eve001Out->building_booth_position_lbls(), $eve001Out->building_booth_position_sel());
?>
                                    </select>
