...
<?php
        echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->comiket_detail_outbound_pref_cds(), $eve001Out->comiket_detail_outbound_pref_lbls(), $eve001Out->comiket_detail_outbound_pref_cd_sel());
?>
                                    </select>
                                    <br/>
                                    <br/>
...
<?php
        echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->comiket_detail_outbound_collect_date_year_cds(), $eve001Out->comiket_detail_outbound_collect_date_year_lbls(), $eve001Out->comiket_detail_outbound_collect_date_year_sel());
?>
                                            </select>年
                                        </span>
                                        <span class="comiket_detail_outbound_collect_date">
...
<?php
        echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->comiket_detail_outbound_collect_date_month_cds(), $eve001Out->comiket_detail_outbound_collect_date_month_lbls(), $eve001Out->comiket_detail_outbound_collect_date_month_sel());
?>
                                            </select>月
                                        </span>
                                        <span class="comiket_detail_outbound_collect_date">
...
<?php
            echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->comiket_detail_outbound_collect_date_day_cds(), $eve001Out->comiket_detail_outbound_collect_date_day_lbls(), $eve001Out->comiket_detail_outbound_collect_date_day_sel());
?>
                                            </select>日
                                        </span>
                                        &nbsp;
    ...
    <?php
            echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->comiket_detail_outbound_collect_time_cds(), $eve001Out->comiket_detail_outbound_collect_time_lbls(), $eve001Out->comiket_detail_outbound_collect_time_sel());
    ?>
                                            </select>
                                        </span>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <br>
                                        <strong class="red">※ 午後１６時３０分以降は、翌日を集荷日にできません。</strong>
                                    </div>
                                    ...
                                    <div class="comiket_detail_outbound_delivery_date_parts">
                                        <span class="comiket_detail_outbound_delivery_date">
                                            <select name="comiket_detail_outbound_delivery_date_year_sel">
                                                <option value="">年を選択</option>
<?php
        echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->comiket_detail_outbound_delivery_date_year_cds(), $eve001Out->comiket_detail_outbound_delivery_date_year_lbls(), $eve001Out->comiket_detail_outbound_delivery_date_year_sel());
?>
                                            </select>年
                                        </span>
                                        <span class="comiket_detail_outbound_delivery_date">
                                            <select name="comiket_detail_outbound_delivery_date_month_sel">
                                                <option value="">月を選択</option>
<?php
        echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->comiket_detail_outbound_delivery_date_month_cds(), $eve001Out->comiket_detail_outbound_delivery_date_month_lbls(), $eve001Out->comiket_detail_outbound_delivery_date_month_sel());
?>
                                            </select>月
                                        </span>
                                        <span class="comiket_detail_outbound_delivery_date">
                                            <select name="comiket_detail_outbound_delivery_date_day_sel">
                                                <option value="">日を選択</option>
<?php
        echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->comiket_detail_outbound_delivery_date_day_cds(), $eve001Out->comiket_detail_outbound_delivery_date_day_lbls(), $eve001Out->comiket_detail_outbound_delivery_date_day_sel());
?>
                                            </select>日
                                        </span>
                                        &nbsp;
                                        <span class="comiket_detail_outbound_delivery_time_sel">
                                            ...
                                            <select name="comiket_detail_outbound_delivery_time_sel">
                                                <option value="">時間帯を選択</option>
    <?php
            echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->comiket_detail_outbound_delivery_time_cds(), $eve001Out->comiket_detail_outbound_delivery_time_lbls(), $eve001Out->comiket_detail_outbound_delivery_time_sel());
    ?>
                                            </select>
                                        </span>
                                    </div>
...
<?php
                                                echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->comiket_cargo_outbound_num_cds(), $eve001Out->comiket_cargo_outbound_num_lbls(), $eve001Out->comiket_cargo_outbound_num_sel());
?>
                                            </select>-->
