...
Sgmov_Lib::useView('dsn/Complete');
            ...
            <div style="clear: both;">
                ...
                <?php if(($eveOutForm->comiket_detail_type_sel() == "1" || $eveOutForm->comiket_detail_type_sel() == "3") // 搬入、もしくは往復
                    ...
                    <div style="font-size:20px;">
                        <a href="/dsn/paste_tag/<?php echo sprintf('%010d', $eveOutForm->qr_code_string()) . Sgmov_View_Dsn_Common::getChkD2($eveOutForm->qr_code_string()); ?>/" target="_blank" style="color:blue;" download>
                ...
                <?php if ($eventsubData['manual_display'] == '1') { ?>
                    ...
                    <div style="font-size:20px;">
                        <a class="button_link2" href="/dsn/pdf/manual/<?php echo $eventData['name']; ?><?php echo $eventsubData['name']; ?>.pdf" target="_blank" style="color:blue;">
                ...
                <?php if(!empty($existsComiketId)):?>
                    <b>引き続き搬出申込する方はこちら<a href="/dsn/input/<?php echo $existsComiketId; ?>" target="_self" style="color:blue;font-weight: bold;text-decoration: underline;">こちら</a></b>
                <?php else:?>
                    <b>引き継き宅配をご利用される方は<a href="/dsn/input" target="_self" style="color:blue;font-weight: bold;text-decoration: underline;">こちら</a></b>
                <?php endif;?>
            </div>
            <br/><br>
