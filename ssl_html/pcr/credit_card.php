...
Sgmov_Lib::useView('pcr/CreditCard');
/**#@-*/

// 処理を実行
$view = new Sgmov_View_Pcr_CreditCard();
$forms = $view->execute();
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <form action="/pcr/check_credit_card" method="post">
...
<?php
        echo Sgmov_View_Pcr_CreditCard::_createPulldown($pcr002Out->card_expire_month_cds(), $pcr002Out->card_expire_month_lbls(), $pcr002Out->card_expire_month_cd_sel());
?>
                                </select>
                                月
                            </label>
...
<?php
        echo Sgmov_View_Pcr_CreditCard::_createPulldown($pcr002Out->card_expire_year_cds(), $pcr002Out->card_expire_year_lbls(), $pcr002Out->card_expire_year_cd_sel());
?>
                                    </select>
                                    年
                                </label>
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/pcr/js/credit_card.js"></script>
</body>
</html>