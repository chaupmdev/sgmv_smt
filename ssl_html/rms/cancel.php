...
Sgmov_Lib::useView('rms/Cancel');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Rms_Cancel();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/rms/cancel_comp" data-feature-id="<?php echo Sgmov_View_Rms_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Rms_Common::GAMEN_ID_RMS001 ?>" method="post">
