...
Sgmov_Lib::useView('rec/Complete');
// /**#@-*/

// // 処理を実行
$view = new Sgmov_View_Rec_Complete();
$forms = $view->execute();
 ...
 *
 */
$moushiKomiID = $forms['moushiKomiID'];
?>
<!DOCTYPE html>
...
<head>
    ...
    <meta property="og:url" content="https://www.sagawa-mov.co.jp/rec/complete/">
    ...
    <title>中途採用エントリーの完了｜<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/meta-ttl.php'); ?></title>
...
<body>
    ...
    <div id="main">
        <div class="pageTitle style01">
            <div class="comBox">
                <h1 class="topLead">中途採用エントリーの完了<em>Complete</em></h1>
                <ul id="pagePath">
...
<!--            <h1 class="page_title" id="pcm_ttl_03">中途採用エントリー完了</h1>-->
            <div class="section" style="font-size: 20px;font-weight: bold;">
                <p class="sentence btm30">
                    この度は、弊社の求人にエントリーいただきまして誠にありがとうございます。
                </p>
                <p class="sentence btm30">
                    ２～３営業日以内に担当者よりご連絡致します。
                </p>
                <p class="sentence btm30">
                    ご不明点な点は採用担当(<a href="mailto:sgmoving_saiyou@sagawa-exp.co.jp" style="color: blue;text-decoration: underline;">sgmoving_saiyou@sagawa-exp.co.jp</a>)までお問い合わせをお願いいたします。
                </p>
                <div class="btn_area">
