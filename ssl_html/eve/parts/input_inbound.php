                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_detail_inbound_collect_date')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <?php if(isset($dispItemInfo["eventsub_selected_data"]["is_eq_inbound_collect"]) && $dispItemInfo["eventsub_selected_data"]["is_eq_inbound_collect"]) : ?>
                                        ...
                                        <!-- GiapLN fix bug validate 2022.07.24 -->
...
<!--                                        <input type='hidden' name="comiket_detail_inbound_collect_date_year_sel" value="<?php echo @$eve001Out->comiket_detail_inbound_collect_date_year_sel(); ?>"/>
                                        <input type='hidden' name="comiket_detail_inbound_collect_date_month_sel" value="<?php echo @$eve001Out->comiket_detail_inbound_collect_date_month_sel(); ?>"/>
                                        <input type='hidden' name="comiket_detail_inbound_collect_date_day_sel" value="<?php echo @$eve001Out->comiket_detail_inbound_collect_date_day_sel(); ?>"/>
                                        <input type='hidden' name="comiket_detail_inbound_collect_time_sel" value="<?php echo @$eve001Out->comiket_detail_inbound_collect_time_sel(); ?>"/>-->
                            ...
                            <dl class="service-inbound-item" service-id="1">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_box_inbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="dispSeigyoPC" style='vertical-align: middle;text-align: right;'>
                                                        <?php if($eve001Out->comiket_div() == Sgmov_View_Eve_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
                                                            <img src='/eve/images/about_boxsize.png' width='100%'/>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <div class="dispSeigyoSP" style="margin-top: 1em;">
                                        <img src='/eve/images/about_boxsize.png' width='250px' style='margin-top: 1em;' />
                                    </div>
                                    <?php else: ?>
                                    <!--<img src='/eve/images/about_boxsize.png' width='100%'/>-->
                                    <?php endif; ?>
                                    ...
                                    <div class="outbound_example_boxsize example_boxsize">
                                        ...
                                        <strong class="red">※ １申込み４０個を超える場合は、ＳＧムービング/コミックマーケット105係 03-5857-2462 へお問い合わせください。</strong><br/><br/>
                                        <a href="/eve/pdf/example/example_box_size.pdf" target="_blank" style="color:blue;">目安表</a>
                                    </div>
                                </dd>
                            </dl>
...
?>
                            ...
                            <dl>
                                ...
                                >
                                    <div>
                                        <a style="margin-left: 5px;color:blue;text-decoration: underline; font-size: 19px" href="/eve/pdf/manual/packing_guideline.pdf" target="_blank" class="comiket_detail_caremark_flg_link" >梱包ガイドラインについて(PDF)</a>
                                    </div>
                                    ...
                                    <br/>
                                    <!-- <input id="comiket_detail_caremark_flg_enable" name="comiket_detail_caremark_flg_enable" type="hidden" value="1" />-->
                                </dd>
                            </dl>
