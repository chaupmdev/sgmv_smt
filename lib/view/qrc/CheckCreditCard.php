 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Qrc_CheckCreditCard extends Sgmov_View_Qrc_Common
{
    ...
    public function executeInner()
    {
        ...
        // チケットの確認と破棄
        $session->checkTicket(self::FEATURE_ID, self::GAMEN_ID_QRC002, $this->_getTicket());
     ...
     * @param Sgmov_Form_Qrc001In $inputForm 入力フォーム
     * @return Sgmov_Form_Qrc002In クレジット入力フォーム
     */
    ...
    /**
     * 入力値の妥当性検査を行います。
     * @param Sgmov_Form_Qrc002In $inForm 入力フォーム
