...
// 処理を実行
$view = new Sgmov_View_Qrc_CancelComp();
$forms = $view->execute();
				...
				<form action="/" method="post">
					<div class="section">
						...
						<div class="btn_area">
							...
							<input id="submit_button" type="button" name="button" value="キャンセル対応画面に戻る" onclick="location.href='./sgmv_dashboard.php';" />
						</div>
					</div>
				</form>
			</div>
