...
?>
            <div class="section other">
                <form action="/sso/check_input" data-feature-id="<?php echo Sgmov_View_Sso_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Sso_Common::GAMEN_ID_EVE001 ?>" method="post">
