 ...
 */
class Sgmov_View_Twi_Complete extends Sgmov_View_Twi_Common {
    ...
    public function __construct() {
        ...
        $this->_BcmView             = new Sgmov_View_Twi_Bcm();
    ...
    public function executeInner($argBackInputPaht="") {
        ...
        //チケットの確認と破棄 TODO
        $session->checkTicket(self::FEATURE_ID, self::GAMEN_ID_TWI003, $this->_getTicket());
    ...
    protected function registerComiket($db, $inForm, $comiketId, $argBackInputPath){
        ...
        try {
            ...
            $db->rollback();
            $_SESSION["Sgmov_View_Twi.inputErrorInfo"] = array("db_insert_error" => "・データベースの登録・更新に失敗しました。");
...
Sgmov_Component_Log::debug($pay_limit_convenience_store);
     ...
     * @param Sgmov_Form_Twi003In $inForm 入力フォーム
