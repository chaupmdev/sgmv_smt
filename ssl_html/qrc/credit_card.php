...
// 処理を実行
$view = new Sgmov_View_Qrc_CreditCard();
$forms = $view->execute();
...
/**
 * フォーム
 * @var Sgmov_Form_qrc002Out
 */
$qrcOutForm = $forms['outForm'];
...
// 開催期間開始日
$termFr = explode('-', $qrcOutForm->raw_term_fr);
// クレジットカード有効期限年のカウント
$inputCreditcardCnt = $qrcOutForm->input_creditcard_cnt;
            ...
            <form action="/<?= $dirDiv ?>/check_credit_card" method="post">
                ...
                <div class="section">
                    ...
                    <div class="result02" style="font-size:134%;text-align: center;">
                        ...
                        <span style="white-space: nowrap;"><?= $qrcOutForm->toiban(); ?></span>
                        <input name="toiawase_number" type="hidden" value="<?= $qrcOutForm->toiawase_no(); ?>" />
                    </div>
                    <div class="result02" style="font-size:134%;text-align: center;">
                        <span style="white-space: nowrap;">合計金額：</span>
                        &nbsp;<span style="white-space: nowrap;"><?php echo number_format((int)$qrcOutForm->uriage_kingaku()); ?>円（税込）</span>
                        <input name="uriage_kingaku" type="hidden" value="<?= $qrcOutForm->uriage_kingaku(); ?>" />
                    </div>
                    ...
                    <div class="dl_block">
                            ...
                            <dd<?php if (isset($e) && ($e->hasErrorForId('top_card_expire_year_cd_sel') || $e->hasErrorForId('top_card_expire_month_cd_sel') || $e->hasErrorForId('top_card_expire'))) {
                                ...
                                <label for="card_expire_month">
                                    <select id="card_expire_month" name="card_expire_month_cd_sel">
                                        ...
                                        <?php
                                        echo Sgmov_View_Qrc_CreditCard::_createPulldown($qrcOutForm->card_expire_month_cds(), $qrcOutForm->card_expire_month_lbls(), $qrcOutForm->card_expire_month_cd_sel());
                                        ?>
                                    </select>
                                    月
                                </label>
                                <label for="card_expire_year">
                                    <select id="card_expire_year" name="card_expire_year_cd_sel">
                                        ...
                                        <?php
                                        echo Sgmov_View_Qrc_CreditCard::_createPulldown($qrcOutForm->card_expire_year_cds(), $qrcOutForm->card_expire_year_lbls(), $qrcOutForm->card_expire_year_cd_sel());
                                        ?>
                                    </select>
                                    年
                                </label>
                        ...
                        <dl>
                            ...
                            <dd<?php if (isset($e) && $e->hasErrorForId('top_card_number')) {
                                ...
                                <input autocapitalize="off" class="w_280" id="card_number" inputmode="numeric" maxlength="16" name="card_number" data-pattern="^\d+$" placeholder="例）9999999999999999" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $qrcOutForm->card_number(); ?>" />
                                </dd>
                        </dl>
                        <dl>
                            <dt class="condition">
                            ...
                            <dd<?php if (isset($e) && $e->hasErrorForId('top_security_cd')) {
                                ...
                                <input autocapitalize="off" class="w_70" id="security_cd" inputmode="numeric" maxlength="4" name="security_cd" data-pattern="^\d+$" placeholder="例）9999" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $qrcOutForm->security_cd(); ?>" />
