...
Sgmov_Lib::useView('gmm/Input2');

// 処理を実行
$view = new Sgmov_View_Gmm_Input2();
$forms = $view->execute();
...
$userType = isset($_SESSION['GMM_LOGIN']['user_type']) ? $_SESSION['GMM_LOGIN']['user_type'] : -1;
...
?>
    ...
    <link href="/gmm/css/eve.css?<?php echo $strSysdate; ?>" rel="stylesheet" type="text/css" />
    <!--[if lt IE 9]>
        ...
        <div class="wrap clearfix">
            ...
            <p class="sentence disp_gooutcamp" style="display: none;">
                <span class="red">
                    ...
                    SG ムービング株式会社<br/>
                    ＧｏＯｕｔ係 <br/>
                    TEL: 03-5857-2413(受付時間:平日09時～17時)
                </span>
            </p>
...
?>
                ...
                <p class="under">
                    ...
                    <br />
                    <?php
                            $selectedEventNmae = Sgmov_View_Gmm_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
                            if(!empty($selectedEventNmae)) {
                                $selectedEventNmae .= '係';
                            }
                            echo $selectedEventNmae;
                    ?>
                    <br />TEL: 03-5857-2413(受付時間:平日09時～17時)
                </p>
            </div>
...
?>
            <div class="section other">
                <form action="/gmm/check_input2" data-feature-id="<?php echo Sgmov_View_Gmm_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Gmm_Common::GAMEN_ID_GMM001 ?>" method="post">
...
<?php
        ...
        echo '<br><br><img src="/gmm/images/logo.gif">';
        }
?>
...
<div class="sp_dl_area2">
    <div class="eventsub_dl_link manual" >
        <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt=""><a style="color: blue;" class="manual_link" href="/gmm/pdf/manual/<?php echo str_replace(array(" ", "　"), "", $eventName); ?>搬出.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">説明書</a>
    </div>
</div>
<?php endif; ?>
                            ...
                            <?php if ($eve001Out->comiket_div() == Sgmov_View_Gmm_Common::COMIKET_DEV_BUSINESS) : // 法人?>
                                <dl>
...
?>
                    ...
                    <?php if ($eve001Out->comiket_div() == Sgmov_View_Gmm_Common::COMIKET_DEV_INDIVIDUA) : ?>
...
?>
    <script charset="UTF-8" type="text/javascript" src="/gmm/js/define.js" id="definejs-arg"
    data-G_DEV_INDIVIDUAL="<?php echo Sgmov_View_Gmm_Common::COMIKET_DEV_INDIVIDUA; ?>"
    data-G_DEV_BUSINESS="<?php echo Sgmov_View_Gmm_Common::COMIKET_DEV_BUSINESS; ?>"
    ></script>
    <script charset="UTF-8" type="text/javascript" src="/gmm/js/input2.js?<?php echo $strSysdate; ?>"></script>
