...
<head>
    ...
    <title>宿泊ホテルより国内配送受付サービスのお申し込みフォームの完了│ＳＧムービング株式会社＜ＳＧホールディングスグループ＞</title>
...
<div id="breadcrumb">
    <ul class="wrap">
        ...
        <li class="current">宿泊ホテルより国内配送受付サービスのお申し込みフォームの完了</li>
    </ul>
</div>

<div id="main">
    <div class="wrap clearfix">
        <h1 class="page_title">宿泊ホテルより国内配送受付サービスのお申し込みフォームの完了</h1>
        <div class="section">
