...
<!--                                        <table>
                                            <tr>
                                                <td class="event_eventsub_td_name" style="">-->
                                                    ...
                                                    <span class="<?php if(empty($inputMode)) :?>comiket_diplay_none2<?php endif; ?>" >
                                                        シーフードショー大阪・アグリフードＥＸＰＯ大阪
<?php
//            echo Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
?>
                                        &nbsp;&nbsp;
                                                    </span>
                                                    <select name="event_sel" class="comiket_diplay_none <?php if(!empty($inputMode)) :?>comiket_diplay_none2<?php endif; ?>">
                                                        <option value="" timeoverflg="0">選択してください</option>
<!--                                                        
                                                        <?php foreach (Sgmov_View_Sso_Input::$eventInfo as $key => $val) : ?>
                                                            <option value="<?= $val ?>"></option>
                                                        <?php endforeach; ?>
                                                            -->
<?php
            echo Sgmov_View_Sso_Input::_createPulldown($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel(), $eve001Out->eve_timeover_flg(), $eve001Out->eve_timeover_date());
?>
                                                    </select>
...
<?php
            echo Sgmov_View_Sso_Input::_createPulldown($eve001Out->eventsub_cds(), $eve001Out->eventsub_lbls(), $eve001Out->eventsub_cd_sel());
?>
                                                    </select>
                                                    <!--<div class="paste_tag">-->
                                                        <br/>
                                                    <!--</div>-->
<?php
        $eventName = Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
        $eventsubName = Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->eventsub_cds(), $eve001Out->eventsub_lbls(), $eve001Out->eventsub_cd_sel());
        if(strpos($eventName,'デザインフェスタ') !== false){
        echo '<img src="/sso/images/logo.gif">';
        }
?>
<?php
    // キャッシュ対策
...
?>
                                                    <!--<img src="/sso/images/logo_furusato.jpg" height="120px">-->
                                                    <br />
                                                        <img src="/sso/images/seafood-show.png" height="40px">
                                                    <br/><br/>
                                                        <img src="/sso/images/agri-foodexpo.png" height="35px">
                                                    <br />
                                                    <br />
                                                    <input type="hidden" name="comiket_customer_kbn_sel" value="1" />
                                                    <div>
                                                        <label class="radio-label-comiket_eventsub_sel_rd" for="comiket_eventsub_sel_rd1" style="height: 10px; white-space: normal;">
                                                            <input id="comiket_eventsub_sel_rd1" class="comiket_eventsub_sel_rd" name="eventsub_sel_rd" type="radio" value="<?= Sgmov_View_Sso_Input::$eventsubInfo[0] ?>" style="vertical-align: middle;"
                                                                   <?php if ($eve001Out->eventsub_cd_sel() == Sgmov_View_Sso_Input::$eventsubInfo[0] ) : ?>checked="checked"<?php endif; ?>
                                                                   cstm_event_id="<?= Sgmov_View_Sso_Input::$eventInfo[0] ?>">シーフードショー（水産養殖技術・スマートフィッシュテクノロジー） </label>
                                                        <br/>
                                                        <label class="radio-label-comiket_eventsub_sel_rd" for="comiket_eventsub_sel_rd2" style="height: 10px;white-space: nowrap;">
                                                            <input id="comiket_eventsub_sel_rd2" class="comiket_eventsub_sel_rd" name="eventsub_sel_rd" type="radio" value="<?= Sgmov_View_Sso_Input::$eventsubInfo[1] ?>" style="vertical-align: middle;"
                                                                   <?php if ($eve001Out->eventsub_cd_sel() == Sgmov_View_Sso_Input::$eventsubInfo[1]) : ?>checked="checked"<?php endif; ?>
                                                                   cstm_event_id="<?= Sgmov_View_Sso_Input::$eventInfo[1] ?>">
                                                            アグリフードEXPO</label>
                                                    </div>
                                                    <div class="sp_dl_area2">
                                                        <div style="display:none;" class="eventsub_dl_link paste_tag">
                                                            ...
                                                            <a style="color: blue;font-weight: bold;text-decoration: underline;" class="paste_tag_link" href="/sso/pdf/paste_tag/paste_tag_<?php echo $eve001Out->eventsub_cd_sel(); ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">貼付票（例）</a>
                                                        </div>

                                                        <div class="eventsub_dl_link manual" style="display:none;">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;font-weight: bold;text-decoration: underline;" 
                                                               class="manual_link" href="/sso/pdf/manual/<?php echo $eventName; ?><?php echo $eventsubName; ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">宅配便WEB申込みのご案内</a>
                                                        </div>
                                                    </div>
<!--                                                    <div class="eventsub_dl_link manual" style="display:none;">
                                                        <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
...
<!--                                                    <div class="pc_dl_area2">
                                                        <div style="margin-bottom:3px;display:none;" class="eventsub_dl_link pasete_tag">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;" class="paste_tag_link" href="/sso/pdf/paste_tag/paste_tag_<?php echo $eve001Out->eventsub_cd_sel(); ?>.pdf" target="_blank">貼付票</a>
                                                        </div>
                                                        <br/>
                                                        <div class="eventsub_dl_link manual" style="display:none;">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                        ...
                                        <div style="display: none;" class="event_data">
                                                <?php  foreach($dispItemInfo["eventsub_list"] as $key => $val): ?>
                                                    <div class="eventsub-info-list"
                                                        ...
                                                        eventsub-venue="<?php echo @$val["venue"]; ?>"
                                                    ></div>
                                                <?php endforeach; ?>
                                        </div>
                                </dd>
...
//Sgmov_Component_Log::debug('##################### 222222');
//Sgmov_Component_Log::debug(@$dispItemInfo);
                                        echo @$selectedEventData["venue"];
                                    ?>
                                    <?php /*
                                    <?php $eventSubZip = $eve001Out->eventsub_zip(); ?>
                                    <?php if(!empty($eventSubZip)) : ?>〒<?php endif; ?>
                                    <?php echo substr($eventSubZip, 0, 3) . "-" . substr($eventSubZip, 3); ?>&nbsp;<?php echo $eve001Out->eventsub_address(); ?>
                                     *
                                     */ ?>
                                </span>
                                <!--
                                <input class="" style="width:80%;" autocapitalize="off" inputmode="eventsub_address" name="eventsub_address" data-pattern="" placeholder="" type="hidden" value="<?php echo $eve001Out->eventsub_address(); ?>" />
                                -->
                            ...
                            <?php if ($userType === 1) :?>
                                <dl>
                                    ...
                                    <dd>
                                        <?php echo $_SESSION['SSO_LOGIN']['email'] ?>
                                    </dd>
                                </dl>
                            <?php endif; ?>
                            <!-- END -->
                            ...
                            <dl class="comiket_customer_cd"  style="display:none;">
                                ...
                                <table style="border: #000 solid 0px;">
                                    <tr>
                                         <td style="border: #000 solid 0px;width:120px;white-space: nowrap;">
                                            <label class="radio-label comiket_customer_cd_sel1" for="comiket_customer_cd_sel1">
                                                <input<?php if ($eve001Out->comiket_customer_cd_sel() == '1') echo ' checked="checked"'; ?> id="comiket_customer_cd_sel1" name="comiket_customer_cd_sel" type="radio" value="1" />
                                                使用する
                                            </label>
                                         </td>
                                         <td style="padding-left:0px;white-space: nowrap;">
                                            <input class="" style="width:70%;" maxlength="12" autocapitalize="off" inputmode="comiket_customer_cd" name="comiket_customer_cd" data-pattern="^\d+$" placeholder="" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $eve001Out->comiket_customer_cd() ?>" />
                                            <input class="m110" style="width:60px;" name="customer_search_btn" type="button" value="詳細" />
                                         </td>
                                    </tr>
                                    <tr>
                                         <td colspan="2">
                                            <label class="radio-label comiket_customer_cd_sel2" for="comiket_customer_cd_sel2">
                                                <input<?php if ($eve001Out->comiket_customer_cd_sel() == '2') echo ' checked="checked"'; ?> id="comiket_customer_cd_sel2" name="comiket_customer_cd_sel" type="radio" value="2" />
                                                しない
                                            </label>
                                         </td>
                                    </tr>
                            ...
                            <dl class="comiket-personal-name-seimei" style="display: none;">
                                ...
                                姓<input class="" style="width:30%;" maxlength="7" autocapitalize="off" inputmode="comiket_personal_name_sei" name="comiket_personal_name_sei" data-pattern="" placeholder="例）佐川" type="text" value="<?php echo $eve001Out->comiket_personal_name_sei() ?>" />
                            ...
                            <dl style="display:none;">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_zip')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <span style="font-size:12px;" class="forget-address-discription">
                            ...
                            <dl style="display:none;">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_pref')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <!--<input autocapitalize="off" class="w_70" inputmode="numeric" name="comiket_pref_nm" type="text" value="<?php echo $eve001Out->comiket_pref_nm();?>" />-->
                                    <select name="comiket_pref_cd_sel">
                                        <option value="">選択してください</option>
<?php
        echo Sgmov_View_Sso_Input::_createPulldown($eve001Out->comiket_pref_cds(), $eve001Out->comiket_pref_lbls(), $eve001Out->comiket_pref_cd_sel());
?>
                                    </select>
                                </dd>
                            </dl>
                            ...
                            <?php endif; ?>
                            <dl class="class_comiket_booth_name booth_name_no">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_booth_name')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <br/>
                                    <strong class="red">
                                    ※出展者以外の方がご利用の場合は「なし」と入力してください
                                    </strong>
                                </dd>
                            </dl>
                            <dl class="class_building_name_sel booth_name_no">
                                <dt id="building_name_sel">
                                    ブースNO<span>必須</span>
                                </dt>
                                <dd<?php if (isset($e) && $e->hasErrorForId('building_name_sel')) { echo ' class="form_error"'; } ?>>
<!--                                    <select name="building_name_sel">
                                        <option value="">選択してください</option>
<?php
//                                        echo Sgmov_View_Sso_Input::_createPulldown($eve001Out->building_name_ids(), $eve001Out->building_name_lbls(), $eve001Out->building_name_sel());
?>
                                    </select>-->
                                    <input type="hidden" name="building_name_sel" value="SSO" >
                                    <div style="margin-bottom: 2px;">
                                        <span style="font-size: 0.5em;">　　　　　　</span>
                                        <span class="building_booth_position_sel" style="font-size: 0.5em;margin-left: 100px;">ブース番号</span>
                                    </div>
                                    <select name="building_booth_position_sel" style="">
                                        <option value="">選択してください</option>
<?php
                                         echo Sgmov_View_Sso_Input::_createPulldown($eve001Out->building_booth_position_ids(), $eve001Out->building_booth_position_lbls(), $eve001Out->building_booth_position_sel());
?>
                                    </select>
                                    

                                    <input class="w_30Per" autocapitalize="off" maxlength="4" name="comiket_booth_num" placeholder="例）1234(数値4桁)" type="text" value="<?php echo $eve001Out->comiket_booth_num();?>" />
                                    <br/>
                                    <strong class="red">※出展者以外の方がご利用の場合は「その他」と選択してください。ブース番号は「0000」と入力してください。</strong>
                                </dd>
                            </dl>
                                    ...
                                    <div class="comiket_detail_type_sel-dd">
                                        <?php foreach($dispItemInfo['comiket_detail_type_lbls'] as $key => $val) : ?>
                                            <label class="radio-label comiket_detail_type_sel-label<?php echo $key; ?>" for="comiket_detail_type_sel<?php echo $key; ?>">
                                                <input<?php if ($eve001Out->comiket_detail_type_sel() == $key) echo ' checked="checked"'; ?> id="comiket_detail_type_sel<?php echo $key; ?>" class="comiket_detail_type_sel" name="comiket_detail_type_sel" type="radio" value="<?php echo $key; ?>" />
                                                <?php echo $val; ?>
                                            </label>
                                            <br />
                                        <?php endforeach; ?>
...
<!--                                    <script>
                                        $(function() {
                                            $('input.comiket_detail_type_sel').trigger('change');
                                        });
                                    </script>-->
                                </dd>
                            </dl>
