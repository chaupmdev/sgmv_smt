...
Sgmov_Lib::useView('owk/CreditCard');
/**#@-*/

// 処理を実行
$view = new Sgmov_View_Owk_CreditCard();
$forms = $view->execute();
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <form action="/owk/check_credit_card" method="post">
...
<?php
        echo Sgmov_View_Owk_CreditCard::_createPulldown($eveOutForm->card_expire_month_cds(), $eveOutForm->card_expire_month_lbls(), $eveOutForm->card_expire_month_cd_sel());
?>
                                </select>
                                月
                            </label>
...
<?php
        echo Sgmov_View_Owk_CreditCard::_createPulldown($eveOutForm->card_expire_year_cds(), $eveOutForm->card_expire_year_lbls(), $eveOutForm->card_expire_year_cd_sel());
?>
                                    </select>
                                    年
                                </label>
                    ...
                    <div class="btn_area">
                        ...
                        if(empty($comiketId)): ?>
                            <a class="back" href="/owk/input/?clr=1">修正する</a>
                        <?php else: ?>
                            <a class="back" href="/owk/input2/?clr=1">修正する</a>
                        <?php endif; ?>
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/owk/js/credit_card.js"></script>
    <script>
        $(function() {
