...
?>
            <div class="section other">
                <form action="/<?=$dirDiv?>/size_change_check_input" data-feature-id="<?php echo Sgmov_View_Dsn_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Dsn_Common::GAMEN_ID_HOT001 ?>" method="post">
