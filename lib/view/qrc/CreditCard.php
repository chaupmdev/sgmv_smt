...
Sgmov_Lib::useForms(array('Error', 'QrcSession', 'Qrc002Out'));
/**#@-*/
/**
 ...
 */
class Sgmov_View_Qrc_CreditCard extends Sgmov_View_Qrc_Common
{
    ...
    public function executeInner()
    {
        ...
        // チケットを発行
        $ticket = $session->publishTicket(self::FEATURE_ID, self::GAMEN_ID_QRC002);
     ...
     * @param Sgmov_Form_Qrc002In $sessionForm 入力フォーム
     * @return Sgmov_Form_Qrc002Out 出力フォーム
     */
    public function _createOutFormByInForm($inForm)
    {

        $outForm = new Sgmov_Form_Qrc002Out();
