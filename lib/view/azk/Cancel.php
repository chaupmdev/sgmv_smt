 ...
 */
class Sgmov_View_Azk_Cancel extends Sgmov_View_Azk_Input {
...
Sgmov_Component_Log::debug ( 'CD不一致' );
    ...
    protected function _createOutFormByInForm($inForm, $param=NULL) {
        ...
        if(!empty($param)) {
            ...
            $inForm["comiket_detail_type_sel"] = $comikeDetailInfo['type']; // 手荷物預かり
            ...
            // $inForm['comiket_detail_note1'] = $comikeDetailInfo['note'];
