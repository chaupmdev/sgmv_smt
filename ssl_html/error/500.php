...
<meta name="description" content="500エラー サーバー内部エラー">
...
<title>500エラー サーバー内部エラー｜<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/meta-ttl.php'); ?></title>
...
<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/header.php'); ?>
    <main id="main" role="main">
		<div class="pageTitle style01">
			<div class="comBox">
				<h1 class="topLead">サーバーの内部エラーです。<em>500エラー</em></h1>
				<ul id="pagePath">
		...
		<div class="topBox comBox">
			<p class="text fadeInUp">サーバーの内部エラーです。</p>
