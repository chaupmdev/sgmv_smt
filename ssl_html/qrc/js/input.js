...
//                return;
    ...
    // TODO VASI 
    // rooms41
    var serviceSel = $('input[name="comiket_detail_type_sel"]:checked').val();
    var suuryoVal = $('.comiket_box_item_value_input').val();
    var ref = document.referrer;
    if(ref == "" && (serviceSel != undefined && serviceSel != "" && (suuryoVal == "" || suuryoVal == undefined))){
        getBoxData();
    }
...
//                    htmlCode += "<img src='/"+dirDiv+"/images/about_boxsize.png' width='100%' style='visibility:hidden;'/>";
                ...
                htmlCode2 += "</td>";
                if($('input[name="comiket_div"]:checked').val() ==  G_DEV_INDIVIDUAL) {
                  //  htmlCode2 += "<img class='dispSeigyoPC' src='/"+dirDiv+"/images/about_boxsize.png' width='100%'/>";
                }
                htmlCode2 += "</tr></table>";
