 ...
 */
class Sgmov_View_Azk_Input2 extends Sgmov_View_Azk_Input {
    ...
    protected function _createOutFormByInForm($inForm, $param=NULL) {
        if(!empty($param)) {
            ...
            $comiketId = intval(substr($param, 0, 10));
            ...
            $inForm["shikibetsushi"] = $comiketInfo["event_key"];
        }
