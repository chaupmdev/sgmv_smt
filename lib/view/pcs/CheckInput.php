...
Sgmov_Lib::useForms(array('Error', 'PcsSession', 'Pcs001In'));
/**#@-*/
 ...
 * @copyright  2009-2010 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Pcs_CheckInput extends Sgmov_View_Pcs_Common
{
    /**
     * 処理を実行します。
     * <ol><li>
    ...
    public function executeInner()
    {
        ...
        // チケットの確認と破棄
        $session->checkTicket(self::FEATURE_ID, self::GAMEN_ID_PCS001, $this->_getTicket());
        ...
        // 情報をセッションに保存
        $sessionForm = new Sgmov_Form_PcsSession();
        ...
        // リダイレクト
        if ($errorForm->hasError()) {
            Sgmov_Component_Redirect::redirectPublicSsl('/pcs/input/');
        } else {
            Sgmov_Component_Redirect::redirectPublicSsl('/pcs/confirm/');
        }
    }
     ...
     * @return Sgmov_Form_Pcs001In 入力フォーム
     */
    public function _createInFormFromPost($post)
    {
        $inForm = new Sgmov_Form_Pcs001In();
