 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
abstract class Sgmov_View_Evp_CommonToiawase extends Sgmov_View_Public {
    /**
     * 機能ID
     */
    ...
    public function sendCompleteMail($comiket, $sendTo2 = '', $sendCc = '', $type = '', $tmplateType = '') {
        ...
        try {
            ...
            if ($comiket['div'] == self::COMIKET_DEV_BUSINESS) {
                ...
                //個人用メールテンプレート
                $mailTemplate[] = "/evp/evp_complete_individual_re_toiawase{$tmplateType}.txt";
...
//                    && $eventData['id'] !== '4')  {
                ...
                $data['paste_tag_url'] = "【貼付票URL】" . PHP_EOL . $urlPublicSsl . "/evp/paste_tag/{$pasteTagId}/";
            }
