...
Sgmov_Lib::useView('ata/Delete');
/**#@-*/

// 処理を実行
$view = new Sgmov_View_Ata_Delete();
$forms = $view->execute();
...
/**
 * フォーム
 * @var Sgmov_Form_Ata012Out
 */
$ata012Out = $forms['outForm'];
            ...
            <dl id="globalNav">
                ...
                <dd>
                    <ul>
                        ...
                        <li class="nav02">
<?php if($ata012Out->honsha_user_flag() === '1'){ ?>
...
<?php } ?>
    ...
    <div id="topWrap">
        ...
        <h3 class="register_ttl">ツアー会社情報の削除</h3>
...
<?php } ?>
                <ul class="register_item" id="travel_agency_item">
                    <li id="travel_agency_item_01" class="clearfix">
                        <fieldset>
                            ...
                            <?php echo $ata012Out->travel_agency_cd() . PHP_EOL; ?>
                        </fieldset>
                    </li>
                    <li id="travel_agency_item_02">
                        <fieldset>
                            <legend>船名</legend>
                            <?php echo $ata012Out->travel_agency_name() . PHP_EOL; ?>
                        </fieldset>
                    </li>
                </ul>
                <input id="travel_agency_id" name="travel_agency_id" type="hidden" value="<?php echo $ata012Out->travel_agency_id(); ?>" />
    ...
    <!--<![endif]-->
    <script charset="UTF-8" type="text/javascript" src="/common/js/ataDelete.js"></script>
</body>
</html>