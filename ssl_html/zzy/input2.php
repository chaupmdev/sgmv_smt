...
Sgmov_Lib::useView('zzy/Input2');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Zzy_Input2();
$forms = $view->execute();
    ...
    <div id="main">
        <div class="wrap clearfix">
           ...
           <!--  <p class="sentence" style="margin-bottom: 5px;">
                ...
                <br />
                <span class="red fwb" style="font-size: 1.5em;font-weight: bolder;">
                ...
                <br />梱包方法ガイドライン
                <br /><a href="http://www.sagawa-exp.co.jp/send/howto-packing/" target="_blank">http://www.sagawa-exp.co.jp/send/howto-packing/</a>
                <br />「商標についてーリンクガイドライン」の一読と確認をお願いいたします。
                <br /><a href="https://www.sagawa-exp.co.jp/company/public/" target="_blank">一般宅配便（陸便）の運送約款はこちら</a>
                ...
                <br /><a href="/pdf/kokubin_goriyoujyono_tyui.pdf" target="_blank">航空便ご利用上の注意はこちら</a>
                <br /><a href="/pdf/kokutakuhaibinnado_unso_yakkan.pdf" target="_blank">航空宅配便等個建運送約款はこちら</a>
            </p> -->
...
?>
                ...
                <p class="under">
                    ...
                    <br />
                    <?php
                            $selectedEventNmae = Sgmov_View_Zzy_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
...
?>
            <div class="section other">
                <form action="/zzy/check_input2" data-feature-id="<?php echo Sgmov_View_Zzy_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Zzy_Common::GAMEN_ID_ZZY001 ?>" method="post">
                    ...
                    <div class="section">
                        ...
                        <div class="dl_block comiket_block">
                            <dl>
                                ...
                                <dd<?php if (isset($e) && ($e->hasErrorForId('event_sel'))) { echo ' class="form_error"'; }?>>
                                    <?php
                                            $eventName = Sgmov_View_Zzy_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
                                            echo $eventName;
                                            //echo '<br><br><img src="/zzy/images/logo.png" style="max-width:60%;">';
                                    ?>
                                    <span class='eventsub_sel'>
                                        <?php
                                                $eventsubName = Sgmov_View_Zzy_Input::_getLabelSelectPulldownData($eve001Out->eventsub_cds(), $eve001Out->eventsub_lbls(), $eve001Out->eventsub_cd_sel());
                                                echo $eventsubName;
                                        ?>
                                    </span>
                                    <?php if($eventsubInfo["is_manual_display"]) : ?>
                                       ...
                                       <!--  <div class="sp_dl_area2">
                                            <div class="eventsub_dl_link manual" >
                                                ...
                                                <a style="color: blue;" class="manual_link" href="/zzy/pdf/manual/<?php //echo $eventName; ?>.pdf<?php //echo '?' . $strSysdate; ?>" target="_blank">説明書</a>
                                            </div>
                                        </div> -->
                                    <?php endif; ?>
                                </dd>
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e)&& ($e->hasErrorForId('eventsub_address'))) { echo ' class="form_error"'; }?>>
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && ($e->hasErrorForId('eventsub_term_fr') || $e->hasErrorForId('eventsub_term_to'))) { echo ' class="form_error"'; }?>>
                            ...
                            <dl style="display: none;">
                                ...
                                <dd<?php if (isset($e) && ($e->hasErrorForId('comiket_div'))) { echo ' class="form_error"'; }?>>
                            ...
                            <?php if ($eve001Out->comiket_div() == Sgmov_View_Zzy_Common::COMIKET_DEV_BUSINESS) : // 法人?>
                                <dl>
                                    <dt id="comiket_customer_cd">
                                        顧客コード<span>必須</span>
                                    </dt>
                                    <dd<?php if (isset($e) && ($e->hasErrorForId('comiket_customer_cd'))) { echo ' class="form_error"'; }?>>
                                ...
                                <dl>
                                    ...
                                    <dd<?php if (isset($e) && ($e->hasErrorForId('office_name'))) { echo ' class="form_error"'; }?>>
                            ...
                            <?php else : // 個人 ?>
                                <dl>
                                    ...
                                    <dd<?php if (isset($e)&& ($e->hasErrorForId('comiket_personal_name'))) { echo ' class="form_error"'; }?>>
...
?>
                    ...
                    <?php if ($eve001Out->comiket_div() == Sgmov_View_Zzy_Common::COMIKET_DEV_INDIVIDUA) : ?>
...
?>
    <script charset="UTF-8" type="text/javascript" src="/zzy/js/define.js" id="definejs-arg"
    data-G_DEV_INDIVIDUAL="<?php echo Sgmov_View_Zzy_Common::COMIKET_DEV_INDIVIDUA; ?>"
    data-G_DEV_BUSINESS="<?php echo Sgmov_View_Zzy_Common::COMIKET_DEV_BUSINESS; ?>"
    ></script>
    <script charset="UTF-8" type="text/javascript" src="/zzy/js/input2.js?<?php echo $strSysdate; ?>"></script>
