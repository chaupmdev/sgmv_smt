...
Sgmov_Lib::useView('rec/Input');

// /**#@-*/

// // 処理を実行
$view = new Sgmov_View_Rec_Input();
...
<head>
    ...
    <meta property="og:url" content="https://www.sagawa-mov.co.jp/rec/input/">
    ...
    <title>中途採用エントリーフォーム｜お問い合わせ｜<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/meta-ttl.php'); ?></title>
...
<body>
    ...
    <div id="main">
        <div class="pageTitle style01">
            <div class="comBox">
                <h1 class="topLead">中途採用エントリーフォーム<em>Entry</em></h1>
                <ul id="pagePath">
...
<!--            <h1 class="page_title">中途採用エントリーフォーム</h1>-->
            ...
            <div class="section other">
                <form action="/rec/check_input" data-feature-id="<?php echo Sgmov_View_Rec_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Rec_Common::GAMEN_ID_REC001 ?>"  method="post">
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/rec/js/input.js?<?php echo $strSysdate; ?>"></script>
