...
<?php
        echo Sgmov_View_Gmm_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_inbound_pref_cds(), $eve001Out->comiket_detail_inbound_pref_lbls(), $eve001Out->comiket_detail_inbound_pref_cd_sel());
?>
                                </dd>
                            </dl>
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_detail_inbound_collect_date')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <?php endif; ?>
                                        <div class="comiket_detail_inbound_collect_date_parts" style="display:<?php echo $displaySetting; ?>">
                                            <?php echo $eve001Out->comiket_detail_inbound_collect_date_year_sel();?>年<?php echo $eve001Out->comiket_detail_inbound_collect_date_month_sel();?>月<?php echo $eve001Out->comiket_detail_inbound_collect_date_day_sel();?>日（<?php echo Sgmov_View_Gmm_Input::_getWeek($eve001Out->comiket_detail_inbound_collect_date_year_sel(), $eve001Out->comiket_detail_inbound_collect_date_month_sel(), $eve001Out->comiket_detail_inbound_collect_date_day_sel()); ?>）
                                        &nbsp;
<?php
                echo Sgmov_View_Gmm_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_inbound_collect_time_cds(), $eve001Out->comiket_detail_inbound_collect_time_lbls(), $eve001Out->comiket_detail_inbound_collect_time_sel());
?>
                            ...
                            <dl class="comiket_detail_inbound_delivery_date">
                                ...
                                <dd>
                                    ...
                                    <div class="comiket_detail_inbound_delivery_date_parts">
                                        <?php echo $eve001Out->comiket_detail_inbound_delivery_date_year_sel();?>年<?php echo $eve001Out->comiket_detail_inbound_delivery_date_month_sel();?>月<?php echo $eve001Out->comiket_detail_inbound_delivery_date_day_sel();?>日（<?php echo Sgmov_View_Gmm_Input::_getWeek($eve001Out->comiket_detail_inbound_delivery_date_year_sel(), $eve001Out->comiket_detail_inbound_delivery_date_month_sel(), $eve001Out->comiket_detail_inbound_delivery_date_day_sel()); ?>）
                                        &nbsp;
                                        <span class="comiket_detail_inbound_delivery_time_sel" >

<?php
            echo Sgmov_View_Gmm_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_inbound_delivery_time_cds(), $eve001Out->comiket_detail_inbound_delivery_time_lbls(), $eve001Out->comiket_detail_inbound_delivery_time_sel());
?>
                                        </span>
                                    </div>
                                </dd>
                            ...
                            <dl class="service-inbound-item" service-id="1">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_box_inbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                    <div class="comiket-box-inbound-num comiket-box-inbound-num-dmy"> <!-- 個人・法人 どちらでも -->
                                        <?php // if($eve001Out->comiket_div() == Sgmov_View_Gmm_Input::COMIKET_DEV_BUSINESS) : ?>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <table>
                                                    ...
                                                    <td class="dispSeigyoPC" style='vertical-align: middle;text-align: right;'>
                                                        <?php if($eve001Out->comiket_div() == Sgmov_View_Gmm_Input::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
