...
// Basic認証
require_once dirname(__FILE__) . '/../../lib/component/auth_evp.php';
...
$userType = isset($_SESSION['EVP_LOGIN']['user_type']) ? $_SESSION['EVP_LOGIN']['user_type'] : -1;
...
?>
    ...
    <link href="/evp/css/eve.css?<?php echo $strSysdate; ?>" rel="stylesheet" type="text/css" />
    <link href="/eve/css/style.css?<?php echo $strSysdate; ?>" rel="stylesheet" type="text/css" />
    <!--[if lt IE 9]>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <p class="sentence" style="margin-bottom: 5px;">
                <!--<a href="https://www.sagawa-exp.co.jp/" target="_blank" style="color: red; text-decoration: underline;font-weight: bold;font-size: 16px">天候不良における配送状況について</a>-->
                <!--<span style="font-size: 16px">（佐川急便のホームページに移動します）</span>-->
                以下のフォームにもれなくご入力をお願いいたします。
                <br />
                <span class="red">※1日目(12月29日)の搬入申込の締切時間は以下となりますので、ご注意ください。
                    <br/>
                    　関西・中部・北陸・東北・関東エリア　　　　　：12月22日(日)12時まで
                    <br/>
                    　九州・四国・中国・北海道・青森・沖縄エリア　：12月21日(土)12時まで
                </span>
                <br/>
                <br/>
                <span class="red">※2日目(12月30日)の搬入申込の締切時間は以下となりますので、ご注意ください。
                    <br/>
                    　関西・中部・北陸・東北・関東エリア　　　　　：12月23日(月)12時まで
                    <br/>
                    　九州・四国・中国・北海道・青森・沖縄エリア　：12月22日(日)12時まで
                </span>
                <br />
            ...
            <!-- <div style="font-size: 14px;">
                スマートコンテナご利用希望のお客様は、「コミックマーケット99スマートコンテナ御見積依頼書」を使用してメールでお申し込みください。
                <table style="margin-top: 5px;">
                    <tr>
                        <td style="width:45%;line-height: 20px;">
                            <a href="/evp/pdf/manual/SGMVスマートコンテナ輸送のご案内【2021冬コミケ99版】.pdf" target="_blank" style="margin-top:15px;color: #1774bc; text-decoration: underline;">
                                SGMVスマートコンテナ輸送のご案内 はこちら
                            </a><br/>
                            <a href="/evp/excel/estimate/コミックマーケット99スマートコンテナ御見積依頼書.xlsx" target="_blank" style="color: #1774bc; text-decoration: underline;">
                                コミックマーケット99スマートコンテナ御見積依頼書 はこちら
                            </a>
                        </td>
            ...
            <!-- <div style="font-size: 14px;margin-top: 5px;">
                <span style="color: red;font-weight: bolder;">搬出・申込み期間</span>について <br/>
                「1日目(13日)お預かりご希望の方：2022年08月13日～12月30日の <span style="font-size: 20px;font-weight: bolder;color:red;">16:00</span>まで」<br/>
                「2日目(14日)お預かりご希望の方：2022年08月14日～12月31日の <span style="font-size: 20px;font-weight: bolder;color:red;">16:00</span>まで」<br/>
                にお申込みお願いします。
            </div>-->
...
?>
                ...
                <p class="under">
                    ...
                    ?>
                    <br/>TEL: 03-5857-2462(受付時間:平日10時～17時)<?php if ($eve001Out->eventsub_cd_sel() == '4') : ?>※年内は12月28日まで<?php endif; ?>
                </p>
            </div>
...
?>
            <div class="section other">
                <form action="/evp/check_input" data-feature-id="<?php echo Sgmov_View_Evp_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Evp_Common::GAMEN_ID_EVE001 ?>" method="post">
...
<?php
                        ...
                        // 荷物預入取出エリア
                        ///////////////////////////////////////////////
                        // include_once dirname(__FILE__) . '/parts/input_azukari.php';
?>
                    </div>
...
?>
                    ...
                    <br/>
                    お問い合わせ先<br/>
                    SGムービング コミックマーケット105係　03-5857-2462(10:00～17:00)<br/>
...
?>
    <script charset="UTF-8" type="text/javascript" src="/evp/js/define.js" id="definejs-arg"
    ...
    <script charset="UTF-8" type="text/javascript" src="/evp/js/input.js?<?php echo $strSysdate; ?>"></script>
