...
//header("Location: /eve/error_toiawase");
//exit;
...
Sgmov_Lib::useView('eve/Input2');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Eve_Input2();
$forms = $view->execute();
...
// 2022-03-25 ToanDD3 implement SMT6-106
$userType = isset($_SESSION['EVE_LOGIN']['user_type']) ? $_SESSION['EVE_LOGIN']['user_type'] : -1;
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <div style="font-size: 13.5px;">
                スマートコンテナご利用希望のお客様は、「コミックマーケット103スマートコンテナ御見積依頼書」を使用してメールでお申し込みください。
                <table style="margin-top: 5px;">
                    <tr>
                        <td>
                            <a href="/eve/excel/estimate/コミックマーケット 御見積依頼書.xlsx" target="_blank" style="color: #1774bc; text-decoration: underline;">
                                コミックマーケット103スマートコンテナ御見積依頼書 はこちら
                            </a>
                        </td>
...
?>
                ...
                <p class="under">
                    ...
                    <br />
                    <?php
                            $selectedEventNmae = Sgmov_View_Eve_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
...
?>
            <div class="section other">
                <form action="/eve/check_input2" data-feature-id="<?php echo Sgmov_View_Eve_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Eve_Common::GAMEN_ID_EVE001 ?>" method="post">
...
<?php
        ...
        //if(strpos($eventName,'デザインフェスタ') !== false){
            echo '<br><br><img src="/eve/images/logo.png">';
        //}
?>
...
<!--    <div class="eventsub_dl_link manual" >
        ...
        <a style="color: blue;" class="manual_link" href="/eve/pdf/manual/<?php echo $eventName; ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">説明書</a>
    </div>-->
</div>
<?php endif; ?>
                            ...
                            <?php if ($eve001Out->comiket_div() == Sgmov_View_Eve_Common::COMIKET_DEV_BUSINESS) : // 法人?>
                                <dl>
...
?>
                    ...
                    <?php if ($eve001Out->comiket_div() == Sgmov_View_Eve_Common::COMIKET_DEV_INDIVIDUA) : ?>
...
?>
    <script charset="UTF-8" type="text/javascript" src="/eve/js/define.js" id="definejs-arg"
    ...
    ></script>
    <script charset="UTF-8" type="text/javascript" src="/eve/js/input2.js?<?php echo $strSysdate; ?>"></script>
