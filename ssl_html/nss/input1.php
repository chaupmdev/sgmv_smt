    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <span>
                ...
                <br /><a href="/<?=$dirDiv?>/pdf/example/logistics_information_packing_guide_0111.pdf" target="_blank" style="color: #1774bc; text-decoration: underline;">#にじそうさく　物流に関するご案内</a>
...
?>
            <div class="section other">
                <form action="/<?=$dirDiv?>/check_input" data-feature-id="<?php echo Sgmov_View_Nss_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Nss_Common::GAMEN_ID_NSS001 ?>" method="post">
