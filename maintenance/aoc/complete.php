...
Sgmov_Lib::useView('aoc/Complete');
/**#@-*/

// 処理を実行
$view = new Sgmov_View_Aoc_Complete();
$forms = $view->execute();
...
<?php if($aoc004Out->honsha_user_flag() === '1'){ ?>
	...
	<tr>
		...
		<td>
			<table class="inner" width="880">
				<tr>
					<td>他社連携キャンペーンの登録が完了いたしました。</td>
				</tr>
				<tr>
					<td><img src="/common/img/spacer.gif" width="1" height="50" alt=""></td>
				</tr>
				<tr>
					<td align="center"><a href="/aoc/list/">← 一覧に戻る</a></td>
				</tr>
			</table>
		</td>
		<td><img src="/common/img/spacer.gif" width="10" height="1" alt=""></td>
