...
// 処理を実行
$view = new Sgmov_View_Dsn_CancelComp();
$forms = $view->execute();
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>宿泊ホテルより国内配送受付サービスのキャンセルお申し込み│ＳＧムービング株式会社＜ＳＧホールディングスグループ＞</title>
	...
	<body>
		...
		<div id="main">
                    <div class="wrap clearfix">
                        <h1 class="page_title">宿泊ホテルより国内配送受付サービスのキャンセル処理完了しました。</h1>
