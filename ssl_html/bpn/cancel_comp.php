...
Sgmov_Lib::useView('bpn/CancelComp');


// 処理を実行
$view = new Sgmov_View_Bpn_CancelComp();
$forms = $view->execute();
...
$shohinPatterm = $forms['shohin_patterm'];
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div id="breadcrumb">
			<ul class="wrap">
				<li><a href="/">ホーム</a></li>
                <li class="current"><?php echo $title; ?>のキャンセル処理完了</li>
			</ul>
		</div>
		<div id="main">
                    <div class="wrap clearfix">
                        <h1 class="page_title"><?php echo $title; ?>のキャンセル処理完了しました。</h1>
                        <div class="section">
