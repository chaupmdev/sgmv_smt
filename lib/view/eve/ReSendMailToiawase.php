...
Sgmov_Lib::useView('eve/CommonToiawase', 'CommonConst');
 ...
 * #@-
 */
class Sgmov_View_Eve_ReSendMailToiawase extends Sgmov_View_Eve_CommonToiawase {
...
//        }
        ...
        if ($result) {
            echo $comiket_id . '：再送信の処理を行いました。eve1<br/>';
        } else {
            echo $comiket_id . '：再送信の処理を行いました。eve2<br/>';
        }
