        ...
        <dl class="service-azukari-item" service-id="1" style="">
            ...
            <dd>
                ...
                <div class="azukari_example_boxsize example_boxsize" style="">
                    ...
                    <a href="https://sagawa-mov-test03.media-tec.jp/<?=$dirDiv?>/pdf/example/example_box_size.pdf" target="_blank" style="color:blue;">目安表</a>
                </div>
            </dd>
        </dl>
        -->
    ...
    <dl class="service-azukari-item" service-id="1" style="">
        ...
        <dd>
            ...
            <!-- <div class="dispSeigyoSP" style="margin-top: 1em;">
                <img 
                src="./テーブルウェア・フェスティバル開催会場からの宅配便お申込み｜お問い合わせ│ＳＧムービング株式会社＜ＳＧホールディングスグループ＞_files/about_boxsize.png"
            ...
            <div class="azukari_example_boxsize example_boxsize" style="">
                ...
                <?=$dispItemInfo['dispEvent']['sgName']?>/<?=$dispItemInfo['dispEvent']['customName']?>
                 <?=$dispItemInfo['dispEvent']['tel1']?>　もしくはカウンタースタッフへお問い合わせください。</strong><br><br>
