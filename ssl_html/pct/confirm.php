...
Sgmov_Lib::useView('pct/Confirm');
/**#@-*/

// 処理を実行
$view = new Sgmov_View_Pct_Confirm();
$forms = $view->execute();
...
?>
    <div id="breadcrumb">
        <ul class="wrap">
            <li><a href="/">ホーム</a></li>
            <li><a href="/pct/input/">お問い合わせ</a></li>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <div class="section">
                <form action="/pct/complete/" method="post">
                    <div class="section">
...
?>
                    ...
                    <div class="btn_area">
                        <a class="back" href="/pct/input/">修正する</a>
...
?>
                    ...
                    <div class="dl_block">
                        <dl>
                            <dt>確定送料</dt>
                            <dd>
                                <?php echo $pcr003Out->delivery_charge().PHP_EOL; ?>
<?php
    if (intval($pcr003Out->repeater_discount()) > 0) {
?>
                                <span class="f80">※リピータ割引（<?php echo number_format($pcr003Out->repeater_discount()); ?>円）が適用されました</span>
<?php
    }
?>
                            </dd>
                        ...
                        <dl>
                            <dt>有効期限</dt>
                            <dd>
                                <?php echo $pcr003Out->card_expire().PHP_EOL; ?>
                            </dd>
                        </dl>
                        <dl>
                            <dt>カード番号</dt>
                            <dd>
                                <?php echo $pcr003Out->card_number().PHP_EOL; ?>
                                <span class="f80">※下4桁のみの表示となります</span>
                            </dd>
                        </dl>
                        <dl>
                            <dt>セキュリティコード</dt>
                            <dd><?php echo $pcr003Out->security_cd(); ?></dd>
                        </dl>
                        <dl>
                            <dt>お支払い方法</dt>
                            <dd>1回</dd>
                    ...
                    <div class="btn_area">
                        <a class="back" href="/pct/credit_card/">修正する</a>
                        <input id="submit_button" type="submit" name="submit" value="入力内容を送信する" />
                    </div>
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/pct/js/confirm.js"></script>
</body>
</html>