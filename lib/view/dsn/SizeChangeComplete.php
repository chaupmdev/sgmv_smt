 ...
 */
class Sgmov_View_Dsn_SizeChangeComplete extends Sgmov_View_Dsn_Complete {
...
Sgmov_Component_Log::debug($inForm);
        ...
        if (@empty($boxNumTotal)) {
            ...
            // 先に親処理の実行(セッションはなくなる)
            // Sgmov_View_Dsn_Completeを実行ここでサイズ変更のデータが作成される
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////
        $renkeiFlg = false; 
        // この処理ではコンビニ前払い以外を業務連携させているが
        // バッチでは業務連携済み(支払い済み)のコンビニ前払いは業務連携されている
