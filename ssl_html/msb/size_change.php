...
Sgmov_Lib::useView('dsn/SizeChange');
...
?>
            <div class="section other">
                <form action="/dsn/size_change_check_input" data-feature-id="<?php echo Sgmov_View_Dsn_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Dsn_Common::GAMEN_ID_DSN001 ?>" method="post">
