...
<?php
        echo Sgmov_View_Eve_Input::_createPulldown($eve001Out->comiket_detail_inbound_pref_cds(), $eve001Out->comiket_detail_inbound_pref_lbls(), $eve001Out->comiket_detail_inbound_pref_cd_sel());
?>
                                    </select>
                                    <br/>
                                    <br/>
...
<?php
                echo Sgmov_View_Eve_Input::_createPulldown($eve001Out->comiket_detail_inbound_collect_date_year_cds(), $eve001Out->comiket_detail_inbound_collect_date_year_lbls(), $eve001Out->comiket_detail_inbound_collect_date_year_sel());
?>
                                            </select>年
                                            <select name="comiket_detail_inbound_collect_date_month_sel">
                                                <option value="">月を選択</option>
<?php
                echo Sgmov_View_Eve_Input::_createPulldown($eve001Out->comiket_detail_inbound_collect_date_month_cds(), $eve001Out->comiket_detail_inbound_collect_date_month_lbls(), $eve001Out->comiket_detail_inbound_collect_date_month_sel());
?>
                                            </select>月
                                            <select name="comiket_detail_inbound_collect_date_day_sel">
                                                <option value="">日を選択</option>
<?php
                echo Sgmov_View_Eve_Input::_createPulldown($eve001Out->comiket_detail_inbound_collect_date_day_cds(), $eve001Out->comiket_detail_inbound_collect_date_day_lbls(), $eve001Out->comiket_detail_inbound_collect_date_day_sel());
?>
                                            </select>日
                                            &nbsp;
...
<?php
                echo Sgmov_View_Eve_Input::_createPulldown($eve001Out->comiket_detail_inbound_collect_time_cds(), $eve001Out->comiket_detail_inbound_collect_time_lbls(), $eve001Out->comiket_detail_inbound_collect_time_sel());
?>
                                                </select>
                                            </span>
                                        </div>
                                        <!--<strong class="red">※14時以降の受付となります</strong>-->
                                        <strong class="red">（13:00 〜 22:00 受付カウンター）</strong>
                                ...
                                <dd <?php if (isset($e) && $e->hasErrorForId('comiket_detail_inbound_delivery_date')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <div class="comiket_detail_inbound_delivery_date_parts">
                                        <select name="comiket_detail_inbound_delivery_date_year_sel">
                                            <option value="">年を選択</option>
<?php
            echo Sgmov_View_Eve_Input::_createPulldown($eve001Out->comiket_detail_inbound_delivery_date_year_cds(), $eve001Out->comiket_detail_inbound_delivery_date_year_lbls(), $eve001Out->comiket_detail_inbound_delivery_date_year_sel());
?>
                                        </select>年
                                        <select name="comiket_detail_inbound_delivery_date_month_sel">
                                            <option value="">月を選択</option>
<?php
            echo Sgmov_View_Eve_Input::_createPulldown($eve001Out->comiket_detail_inbound_delivery_date_month_cds(), $eve001Out->comiket_detail_inbound_delivery_date_month_lbls(), $eve001Out->comiket_detail_inbound_delivery_date_month_sel());
?>
                                        </select>月
                                        <select name="comiket_detail_inbound_delivery_date_day_sel">
                                            <option value="">日を選択</option>
<?php
            echo Sgmov_View_Eve_Input::_createPulldown($eve001Out->comiket_detail_inbound_delivery_date_day_cds(), $eve001Out->comiket_detail_inbound_delivery_date_day_lbls(), $eve001Out->comiket_detail_inbound_delivery_date_day_sel());
?>
                                        </select>日
                                        &nbsp;
                                        ...
                                        時間帯
                                            <select name="comiket_detail_inbound_delivery_time_sel">
                                                <option value="">時間帯を選択</option>
<?php
            echo Sgmov_View_Eve_Input::_createPulldown($eve001Out->comiket_detail_inbound_delivery_time_cds(), $eve001Out->comiket_detail_inbound_delivery_time_lbls(), $eve001Out->comiket_detail_inbound_delivery_time_sel());
?>
                                            </select>
                                        </span>
                                        <br/>
...
<!--                                        <strong class="red">※ 天災、交通状況の影響により、希望に添えない可能性があります。</strong>-->
                            ...
                            <dl class="service-inbound-item" service-id="1">
                                ...
                                <dd <?php if (isset($e) && $e->hasErrorForId('comiket_box_inbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <?php foreach($dispItemInfo['inbound_box_lbls'] as $key => $val) : ?>
                                                            ...
                                                            <!--<div style="margin-bottom: 10px;">-->
                                                                ...
                                                                <td class='comiket_box_item_value' nowrap>
                                                                    <input autocapitalize="off" class="number-only comiket_box_item_value_input" maxlength="2" inputmode="numeric" name="comiket_box_inbound_num_ary[<?php echo $val["id"]; ?>]" data-pattern="^\d+$" placeholder="例）1" type="<?php echo $inputTypeNumber; ?>" style="width: 50px;" value="<?php echo $eve001Out->comiket_box_inbound_num_ary($val["id"]);?>" /> 個
                                                                </td>
                                                            <!--</div>-->
                                                            </tr>
                                                        <?php endforeach; ?>
                                                    ...
                                                    <td class="dispSeigyoPC" style='vertical-align: middle;text-align: right;'>
                                                        <?php // if($eve001Out->comiket_div() == Sgmov_View_Eve_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
                                                            <img src='/tme/images/about_boxsize.png' width='95%'/>
                                                        <?php // endif; ?>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <div class="outbound_example_boxsize example_boxsize">
                                        ...
                                        <strong class="red">※ 30個口を取り扱い上限とし、31個口以上でご利用の場合はチャーター便をご利用ください</strong><br/><br/>
                            ...
                            <dl class="service-inbound-item" service-id="2">
                                ...
                                <dd <?php if (isset($e) && $e->hasErrorForId('comiket_cargo_inbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <div class="comiket-cargo-inbound-num" div-id="<?php echo Sgmov_View_Eve_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                    </div>
                                    <div class="comiket-cargo-inbound-num" div-id="<?php echo Sgmov_View_Eve_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                    </div>
                                    <div class="">
...
<?php
                                        echo Sgmov_View_Eve_Input::_createPulldown($eve001Out->comiket_cargo_inbound_num_cds(), $eve001Out->comiket_cargo_inbound_num_lbls(), $eve001Out->comiket_cargo_inbound_num_sel());
?>
                                            </select>台-->
                                    </div>
                                </dd>
                            ...
                            <dl class="service-inbound-item" service-id="3">
                                ...
                                <dd <?php if (isset($e) && $e->hasErrorForId('comiket_charter_inbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <div class="comiket-charter-inbound-num" div-id="<?php echo Sgmov_View_Eve_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                    ...
                                    <div class="comiket-charter-inbound-num" div-id="<?php echo Sgmov_View_Eve_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                        <table>
