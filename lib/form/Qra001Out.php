...
class Sgmov_Form_Qra001Out
{
     ...
     * @var string
     */
    public $raw_qr_uketsuke_no = '';

    /**
     * QR-問合せ番号
     * @var string
     */
    public $raw_qr_toiawase_no = '';

    /**
     * QR-問合せ番号 4桁区切り
     * @var string
     */
    public $raw_qr_toiban = '';

    /**
     * QR-ARK受付番号
     * @var string
     */
    public $raw_qr_ark_uketsuke_no = '';

    /**
     * QR-決済明細ID
     * @var string
     */
    public $raw_qr_kessai_meisai_id = '';

    /**
     * QR-売上金額
     * @var string
     */
    public $raw_qr_uriage_kingaku = '';

    /**
     * QR-システム区分
     * @var string
     */
    public $raw_qr_system_kbn = '';
    ...
    /**
     * エンティティ化されたQRコードパラメータを返します。
     * @return string エンティティ化された受渡場所
     */
    public function qr_uketsuke_no()
    {
        return Sgmov_Component_String::htmlspecialchars($this->qr_uketsuke_no);
    }
    public function qr_toiawase_no()
    {
        return Sgmov_Component_String::htmlspecialchars($this->qr_toiawase_no);
    }
    public function qr_toiban()
    {
        return Sgmov_Component_String::htmlspecialchars($this->qr_toiban);
    }
    public function qr_ark_uketsuke_no()
    {
        return Sgmov_Component_String::htmlspecialchars($this->qr_ark_uketsuke_no);
    }
    public function qr_kessai_meisai_id()
    {
        return Sgmov_Component_String::htmlspecialchars($this->qr_kessai_meisai_id);
    }
    public function qr_uriage_kingaku()
    {
        return Sgmov_Component_String::htmlspecialchars($this->qr_uriage_kingaku);
    }
    public function qr_system_kbn()
    {
        return Sgmov_Component_String::htmlspecialchars($this->qr_system_kbn);
    }
    public function qr_cd()
    {
        return Sgmov_Component_String::htmlspecialchars($this->qr_cd);
    }
}
