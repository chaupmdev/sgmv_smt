 ...
 */
//Sgmov_Component_Log::debug('##################### comp 2001-0');
/**#@+
 * include files
 */
require_once dirname(__FILE__) . '/../../lib/Lib.php';
Sgmov_Lib::useView('tms/Complete');
Sgmov_Lib::useForms(array('Error', 'EveSession'));
/**#@-*/
Sgmov_Component_Log::debug('##################### comp 2001-1');
$exceptionFlg = FALSE;
// 処理を実行
$view = new Sgmov_View_Tms_Complete();
Sgmov_Component_Log::debug('##################### comp 2001-2');
$eveOutForm = array();
$eventData = array();
$eventsubData = array();
Sgmov_Component_Log::debug('##################### comp 2001-3');
try {
Sgmov_Component_Log::debug('##################### comp 2001-4');
    $forms = $view->execute();
Sgmov_Component_Log::debug('##################### comp 2001-5');
...
Sgmov_Component_Log::debug('##################### comp 2001-6');
...
?>
                ...
                <table class="default_tbl">
                    <tr>
                        ...
                        <td><?php echo $eveOutForm->receipt_cd(); ?></td>
                    </tr>
...
<!--                    <li><a href="/cvs/pc/lawson.html" target="_blank">ローソン</a></li>
                    <li><a href="/cvs/pc/seicomart.html" target="_blank">セイコーマート</a></li>
                    <li><a href="/cvs/pc/famima2.html" target="_blank">ファミリーマート</a></li>
                    <li><a href="/cvs/pc/ministop_loppi.html" target="_blank">ミニストップ</a></li>-->
                </ul>
<?php
                    break;
...
<?php
    if ($entryType === '1') {
?>
                    <br /><span style="color: red;">※お支払いはお預かり日時の<?php echo $collectDate;?>の前日17時までに入金していただきますようお願いいたします。</span><br /><br />
<?php
    }
?>
...
//                                ($eveOutForm->comiket_detail_inbound_service_sel() == "1" || $eveOutForm->comiket_detail_inbound_service_sel() == "2") // 宅配、またはカーゴ
                    ...
                    <div style="font-size:20px;">
                        <a href="/tms/paste_tag/<?php echo sprintf('%010d', $eveOutForm->qr_code_string()) . Sgmov_View_Tms_Common::getChkD2($eveOutForm->qr_code_string()); ?>/" target="_blank" style="color:blue;" download>
...
<?php if ($eventsubData['manual_display'] == '1') { ?>
                ...
                <div style="font-size:20px;">
                    <!--<a class="button_link2" href="/tms/pdf/manual/manual_<?php echo $eveOutForm->eventsub_cd_sel(); ?>.pdf" target="_blank" style="color:blue;">-->
                    <a class="button_link2" href="/tms/pdf/manual/<?php echo $eventData['name']; ?><?php echo $eventsubData['name']; ?>.pdf" target="_blank" style="color:blue;">
...
//                                ||
                    ...
                    搬出お申し込みのお客様は、宅配カウンターでこのＱＲコードをご提示頂きます。<br/><br/>
                    スクリーンショットを保存しておくと便利です。<br/><br/>
...
<!--                <p class="sentence br">
                    お申し込み内容の登録が完了いたしましたら、ご記入いただいたメールアドレス[<?php echo $eveOutForm->mail(); ?>]宛に自動でメールを送らせていただいています。
