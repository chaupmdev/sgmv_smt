...
$e = $forms['errorForm'];
    ...
    //タイトル
    if ($binshu == '906') {
        $title = '単品輸送サービスのお申し込み';
        $komoku = '単品輸送品目';
        $readonlyText = 'readonly';
    } else {
        $title = '単身カーゴ引越しサービスのお申し込み';
        $komoku = 'カーゴ台数';
        $readonlyText = '';
    }
    ...
    if (isset($e)
       && ($e->hasErrorForId('top_surname') || $e->hasErrorForId('top_forename'))
        ...
        echo ' class="form_error"';
                                ...
                                ?>>
                        <input autocapitalize="off" class="w_100" maxlength="32" name="surname" id="surname" placeholder="例）佐川" type="text" value="<?php echo $ptu001Out->surname();?>" />
                        <input autocapitalize="off" class="w_100" maxlength="32" name="forename" id="forename" placeholder="例）花子" type="text" value="<?php echo $ptu001Out->forename();?>" />
                    </dd>
                </dl>
                <dl>
                    ...
                    <dd<?php
    if (isset($e)
       && ($e->hasErrorForId('top_tel'))
    ) {
        echo ' class="form_error"';
    }
                                ?>>
                        <input autocapitalize="off" class="w_70" inputmode="" maxlength="4" name="tel1" id="tel1" data-pattern="^[!-~]+$" placeholder="例）075" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $ptu001Out->tel1();?>" />
                        -
                        <input autocapitalize="off" class="w_70" inputmode="" maxlength="4" name="tel2" id="tel2" data-pattern="^[!-~]+$" placeholder="例）1234" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $ptu001Out->tel2();?>" />
                        -
                        <input autocapitalize="off" class="w_70" inputmode="" maxlength="4" name="tel3" id="tel3" data-pattern="^[!-~]+$" placeholder="例）5678" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $ptu001Out->tel3();?>" />
                    </dd>
                </dl>
                <dl>
                    <dt id="tel">FAX番号</dt>
                    <dd >
                        <input autocapitalize="off" class="w_70" inputmode="numeric" maxlength="4" name="fax1" data-pattern="^[!-~]+$" placeholder="例）123" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $ptu001Out->fax1();?>" />
                        -
                        <input autocapitalize="off" class="w_70" inputmode="numeric" maxlength="4" name="fax2" data-pattern="^[!-~]+$" placeholder="例）1234" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $ptu001Out->fax2();?>" />
                        -
                        <input autocapitalize="off" class="w_70" inputmode="numeric" maxlength="4" name="fax3" data-pattern="^[!-~]+$" placeholder="例）1234" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $ptu001Out->fax3();?>" />
                    </dd>
                </dl>
                <dl>
                    <dt class="condition_02 even" id="mail">メールアドレス</dt>
                    <dd class="width_change even<?php
    if (isset($e)
       && ($e->hasErrorForId('top_mail'))
    ) {
        echo ' form_error';
    }
                                ?>" id="mail_address">
                        <input class="w_220" autocapitalize="off" inputmode="email" name="mail" data-pattern="^[!-~]+$" placeholder="例）ringo@sagawa.com" type="<?php echo $inputTypeEmail; ?>" value="<?php echo $ptu001Out->mail();?>" />
                ...
                <dl>
                    ...
                    <dd class="width_change<?php
    if (isset($e)
       && ($e->hasErrorForId('top_retype_mail'))
    ) {
        echo ' form_error';
    }
                                ?>">
                        <input class="w_220" autocapitalize="off" inputmode="email" name="retype_mail" data-pattern="^[!-~]+$" placeholder="例）ringo@sagawa.com" type="<?php echo $inputTypeEmail; ?>" value="<?php echo $ptu001Out->retype_mail();?>" />
                    </dd>
                </dl>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="dl_block">
                <dl class="form_list clearfix">
                    ...
                    <dd<?php
    if (isset($e)
       && ($e->hasErrorForId('top_zip'))
    ) {
        echo ' class="form_error"';
    }
                                ?>>
                        <input autocapitalize="off" class="w_70" maxlength="3" inputmode="numeric" name="zip1" data-pattern="^[!-~]+$" placeholder="例）136" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $ptu001Out->zip1();?>" />
                        -
                        <input autocapitalize="off" class="w_70" maxlength="4" inputmode="numeric" name="zip2" data-pattern="^[!-~]+$" placeholder="例）0082" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $ptu001Out->zip2();?>" />
                        <input class="m110" name="adrs_search_btn" type="button" value="住所検索" />
                        <span style="font-size:12px;">　※郵便番号が不明な方は<a style="text-decoration: underline" href = "http://www.post.japanpost.jp/zipcode/" TARGET="_blank">こちら...</a></span>
                    </dd>
                </dl>
                <dl>
                    <dt id="pref">都道府県</dt>
                    <dd<?php
    if (isset($e)
       && ($e->hasErrorForId('top_pref_cd_sel'))
    ) {
        echo ' class="form_error"';
    }
                                ?>>
                        <select id="pref_cd_sel" name="pref_cd_sel" class="ken todofuken">
                ...
                <dl>
                    ...
                    <dd class="even width_change<?php
    if (isset($e)
       && ($e->hasErrorForId('top_address') || $e->hasErrorForId('top_addressbuild'))
    ) {
        echo ' form_error';
    }
                                ?>">
                        <input class="w_220" autocapitalize="off" maxlength="28" name="address" placeholder="例）江東区新砂" type="text" value="<?php echo $ptu001Out->address();?>" value=""/>
                    </dd>
                </dl>
                <dl>
                    <dt id="building">番地・建物名</dt>
                    <dd class="width_change w_220<?php
    if (isset($e)
       && ($e->hasErrorForId('top_building') || $e->hasErrorForId('top_addressbuild'))
    ) {
        echo ' form_error';
    }
                                ?>"><input autocapitalize="off" maxlength="28" name="building" placeholder="例）1-8-2" type="text" value="<?php echo $ptu001Out->building();?>" /></dd>
                </dl>
            </div>
        </div>
        <!--▲現在のお住まいについて　ここまで-->
        ...
        <div class="section">
            ...
            <div class="dl_block">
                <dl class="form_list">
                    ...
                    <dd<?php
    if (isset($e)
       && ($e->hasErrorForId('top_surname_hksaki') || $e->hasErrorForId('top_forename_hksaki'))
    ) {
        echo ' class="form_error"';
    }
                                ?>>
                        <input id="surname_hksaki" name="surname_hksaki" class="w_100" type="text" maxlength="32" placeholder="例）佐川" value="<?php echo $ptu001Out->surname_hksaki();?>" autocapitalize="off" />
                        <input id="forename_hksaki" name="forename_hksaki" class="w_100" type="text" maxlength="32" placeholder="例）花子" value="<?php echo $ptu001Out->forename_hksaki();?>" autocapitalize="off" />
                        <input class="m110" id="name_copy_btn" name="name_copy_btn" type="button" value="既入力情報をコピー" />
                    </dd>
                </dl>
                <dl>
                    ...
                    <dd<?php
    if (isset($e)
       && ($e->hasErrorForId('top_zip_hksaki'))
    ) {
        echo ' class="form_error"';
    }
                                ?>>
                        <input name="zip1_hksaki" class="w_70" maxlength="3" placeholder="例）136" value="<?php echo $ptu001Out->zip1_hksaki();?>" data-pattern="^[!-~]+$" type="<?php echo $inputTypeNumber; ?>" autocapitalize="off" inputmode="numeric" />
                        -
                        <input name="zip2_hksaki" class="w_70" maxlength="4" placeholder="例）0082" value="<?php echo $ptu001Out->zip2_hksaki();?>" data-pattern="^[!-~]+$" type="<?php echo $inputTypeNumber; ?>" autocapitalize="off" inputmode="numeric" />
                ...
                <dl>
                    ...
                    <dd<?php
    if (isset($e)
       && ($e->hasErrorForId('top_pref_cd_sel_hksaki'))
    ) {
        echo ' class="form_error"';
    }
                                ?>>
                        <select id="pref_cd_sel_hksaki" name="pref_cd_sel_hksaki" class="ken todofuken">
                            <option value="">県を選択</option>
                ...
                <dl>
                    ...
                    <dd class="width_change even<?php
    if (isset($e)
       && ($e->hasErrorForId('top_address_hksaki') || $e->hasErrorForId('top_addressbuild_hksaki'))
    ) {
        echo ' form_error';
    }
                                ?>">
                        <input class="w_220" name="address_hksaki" type="text" maxlength="44" placeholder="例）江東区新砂" value="<?php echo $ptu001Out->address_hksaki();?>" autocapitalize="off" value=""/>
                    </dd>
                </dl>
                <dl>
                    ...
                    <dd class="width_change<?php
    if (isset($e)
       && ($e->hasErrorForId('top_building_hksaki') || $e->hasErrorForId('top_addressbuild_hksaki'))
    ) {
        echo ' form_error';
    }
                                ?>">
                        <input class="w_220" name="building_hksaki" type="text" maxlength="44" placeholder="例）1-8-2" value="<?php echo $ptu001Out->building_hksaki();?>" autocapitalize="off" />
                    </dd>
                </dl>
                <dl>
                    ...
                    <dd<?php
    if (isset($e)
       && ($e->hasErrorForId('top_tel_hksaki'))
    ) {
        echo ' class="form_error"';
    }
                                ?>>
                        <input name="tel1_hksaki" id="tel1_hksaki" class="w_70" type="<?php echo $inputTypeNumber; ?>" maxlength="4" placeholder="例）075" value="<?php echo $ptu001Out->tel1_hksaki();?>" data-pattern="^[!-~]+$" autocapitalize="off" inputmode="numeric" />
                        -
                        <input name="tel2_hksaki" id="tel2_hksaki" class="w_70" type="<?php echo $inputTypeNumber; ?>" maxlength="4" placeholder="例）1234" value="<?php echo $ptu001Out->tel2_hksaki();?>" data-pattern="^[!-~]+$" autocapitalize="off" inputmode="numeric" />
                        -
                        <input name="tel3_hksaki" id="tel3_hksaki" class="w_70" type="<?php echo $inputTypeNumber; ?>" maxlength="4" placeholder="例）5678" value="<?php echo $ptu001Out->tel3_hksaki();?>" data-pattern="^[!-~]+$" autocapitalize="off" inputmode="numeric" />
                ...
                <dl>
                    ...
                    <dd>
                        <input name="tel1_fuzai_hksaki" class="w_70" type="<?php echo $inputTypeNumber; ?>" maxlength="4" placeholder="例）075" value="<?php echo $ptu001Out->tel1_fuzai_hksaki();?>" data-pattern="^[!-~]+$" autocapitalize="off" inputmode="numeric" />
                        -
                        <input name="tel2_fuzai_hksaki" class="w_70" type="<?php echo $inputTypeNumber; ?>" maxlength="4" placeholder="例）1234" value="<?php echo $ptu001Out->tel2_fuzai_hksaki();?>" data-pattern="^[!-~]+$" autocapitalize="off" inputmode="numeric" />
                        -
                        <input name="tel3_fuzai_hksaki" class="w_70" type="<?php echo $inputTypeNumber; ?>" maxlength="4" placeholder="例）5678" value="<?php echo $ptu001Out->tel3_fuzai_hksaki();?>" data-pattern="^[!-~]+$" autocapitalize="off" inputmode="numeric" />
                    </dd>
                </dl>
                <dl>
                    <dt id="hikitori_yotehiji" class="condition_02 even">お引取り予定日時</dt>
                    <dd id="hikitori_yotehiji_date" <?php
    if (isset($e)
       && ($e->hasErrorForId('top_hikitori_yotehiji_date') || $e->hasErrorForId('top_hikoshi_yotehiji_time'))
    ) {
        echo ' class="form_error"';
    }
                                ?>>
                        ...
                        <div class="ymdwidth">
                            <select id="hikitori_yotehiji_date_year_cd_sel" name="hikitori_yotehiji_date_year_cd_sel" class="hiduke todofuken optChg ">
                            ...
                            年
                            <select id="hikitori_yotehiji_date_month_cd_sel" name="hikitori_yotehiji_date_month_cd_sel" class="hiduke todofuken optChg ">
                            ...
                            月
                            <select id="hikitori_yotehiji_date_day_cd_sel" name="hikitori_yotehiji_date_day_cd_sel" class="hiduke todofuken optChg ">
                        ...
                        <select id="hikitori_yotehiji_time_cd_sel" name="hikitori_yotehiji_time_cd_sel" class="hiduke ">
                        ...
                        <select id="hikitori_yotehiji_justime_cd_sel" name="hikitori_yotehiji_justime_cd_sel" class="hiduke ">
                ...
                <dl>
                    ...
                    <dd id="hikoshi_yotehiji_date" <?php
    if (isset($e)
       && ($e->hasErrorForId('top_hikoshi_yotehiji_date') || $e->hasErrorForId('top_hikoshi_yotehiji_time'))
    ) {
        echo ' class="form_error"';
    }
                                ?>>
                        ...
                        <div class="ymdwidth">
                            <select id="hikoshi_yotehiji_date_year_cd_sel" name="hikoshi_yotehiji_date_year_cd_sel" class="hiduke ">
                                <option value="">年を選択</option>
                            ...
                            年
                            <select id="hikoshi_yotehiji_date_month_cd_sel" name="hikoshi_yotehiji_date_month_cd_sel" class="hiduke ">
                                <option value="">月を選択</option>
                            ...
                            月
                            <select id="hikoshi_yotehiji_date_day_cd_sel" name="hikoshi_yotehiji_date_day_cd_sel" class="hiduke ">
                                <option value="">日を選択</option>
                        ...
                        <select id="hikoshi_yotehiji_time_cd_sel" name="hikoshi_yotehiji_time_cd_sel" class="hiduke ">
                        ...
                        <select id="hikoshi_yotehiji_justime_cd_sel" name="hikoshi_yotehiji_justime_cd_sel" class="hiduke ">
                ...
                <dl>
                    ...
                    <dd<?php
    if (isset($e)
       && ($e->hasErrorForId('top_cago_daisu'))
    ) {
        echo ' class="form_error"';
    }
                                ?>>
                        <input id="cago_daisu" name="cago_daisu" class="w_70 cagoChange " type="<?php echo $inputTypeNumber; ?>" maxlength="3" data-pattern="^[!-~]+$" value="<?php echo $ptu001Out->cago_daisu();?>" />台
                    </dd>
                </dl>
                <dl>
                    <dt class="">基本料金（税抜）</dt>
                ...
                <?php } else if ($binshu == '906') { ?>
                </div>
                <!-- ▼20160308追加分-->
                <div class="ul_block">
                    <div class="btn_area">
                        <input class="add addRow" name="addTanpin" type="button" value="＋　行追加" />
                    </div>
                    <ul id="tanpinyuso" class="option_ul">
                        <li class="ttl_cell pcH">単品輸送品目</li>
                        <li class="item_cell">
                            <span class="tan_titl ttl_cell">単品輸送品目</span>
                            <span class="tan_fees">基本料金</span>
                            <span class="tan_delt">&nbsp;</span>
                        </li>
                        <?php
                            $tanhin_sels = $ptu001Out->tanhin_cd_sel();
                            $tanNms = $ptu001Out->tanNmFree();
                            $cnt = count($tanhin_sels);
                            for ($i = 0; $i < $cnt; $i++) {
                        ?>
                        <li <?php
    if (isset($e)
       && ($e->hasErrorForId('top_tanhin_cd_sel'))
    ) {
        echo ' class="form_error"';
    }
                                ?>>
                            <span class="tan_slct">
                                <select id="tanhin_cd_sel" name="tanhin_cd_sel[]" class="tanhinChange <?php if (isset($e) && $e->hasErrorForId('top_tanhin_cd_sel')) { echo ' form_error'; } ?>" >
                                    ...
                                    <?php echo Sgmov_View_Ptu_Input::_createPulldown($ptu001Out->tanhin_cds(), $ptu001Out->tanhin_lbls(), $tanhin_sels[$i]);?>
                                </select>
                            </span>
                            <span class="tan_name">
                                <input id="tanNmFree" name="tanNmFree[]" type="text" class="w80p tanName" value="<?php echo $tanNms[$i];?>" disabled="disabled"  />
                            </span>
                            <span class="tanka tan_fees money"></span>
                            <span class="tan_delt">
                                <?php if ($i > 0) { ?>
                                <input name="del" type="button" value="削除" class="delRow"/>
                                <?php } ?>
                                <input type="hidden" value="" name="hidden_size" id="hidden_size" />
                            </span>
                        </li>
                        <?php } ?>
                        <li class="clone_tanhin" style="display: none">
                            <span class="tan_slct">
                                <select id="tanhin_cd_sel" name="tanhin_cd_sel[]" class="tanhinChange <?php if (isset($e) && $e->hasErrorForId('top_tanhin_cd_sel')) { echo ' form_error'; } ?>" >
                                    <option value="">品目を選択</option>
                                    <?php echo Sgmov_View_Ptu_Input::_createPulldown($ptu001Out->tanhin_cds(), $ptu001Out->tanhin_lbls(), '');?>
                                </select>
                            </span>
                            <span class="tan_name">
                                <input id="tanNmFree" name="tanNmFree[]" type="text" class="w80p tanName" value="" disabled="disabled"/>
                            </span>
                            <span class="tanka tan_fees money"></span>
                            <span class="tan_delt">
                                <input name="del" type="button" value="削除" class="delRow"/>
                ...
                <div class="dl_block" id="tanpin_dl">
                    <dl>
                        <dt>合計サイズ</dt>
                        <dd id="sizeTot"><span class="money" id="sizeGokei"> </span></dd>
                        <dt>合計基本料金</dt>
                        <dd id="kinTot"><span class="money" id="kihonKin"> </span></dd>
                    </dl>
                    <input type="hidden" value="" name="hidden_kihonKin" id="hidden_kihonKin" />
                    <input type="hidden" value="" name="hidden_sizeGokei" id="hidden_sizeGokei" />
                </div>
                <!-- ▲20160308追加分-->
                <?php } ?>
...
//              }
//              echo '<span class="slct"><input '.$readonlyText.' class="outOpt textHst w_40'.$chkOptText.'" name="textHanshutsu[]" type="'.$inputTypeNumber.'" id="textHanshutsu_'.$cd.'" size="3" maxlength="3" value="'.$val.'"></span>';
//              $y++;
//             } else {
                $checked = '';
                ...
                echo '<span class="slct"><label><input '.$disableChk.' class="outOpt '.$chkHst.' '.$chkShow.'" type="checkbox" name="checkboxHanshutsu[]" value="'.$cd.'" '.$checked.' id="checkboxHanshutsu_'.$cd.'"></label></span>';
//             }
            ...
            if ($kbn === '2') {
                ...
                echo '<span class="cmmt"><input '.$readonlyText.' class="outOpt textHst w_40'.$chkOptText.'" name="textHanshutsu[]" type="'.$inputTypeNumber.'" id="textHanshutsu_'.$cd.'" size="3" maxlength="3" value="'.$val.'">'.$biko.'</span>';
                $y++;
            } else {
...
//                  $val = $text_hannyu[$y];
//              }
//              echo '<span class="slct"><input '.$readonlyText.' class="inOpt textHyu w_40'.$chkText.'" name="textHannyu[]" type="'.$inputTypeNumber.'" id="textHannyu_'.$cd.'" size="3" maxlength="3" value="'.$val.'"></span>';
//              $y++;
//             } else {
                $checked1 = '';
                ...
                echo '<span class="slct"><label><input '.$disableChk.' class="inOpt '.$chkHyu.' '.$chkShowHanyu.'" type="checkbox" name="checkboxHannyu[]" value="'.$cd.'" '.$checked1.' id="CheckboxHannyu_'.$cd.'"></label></span>';
//             }
            ...
            if ($kbn === '2') {
                ...
                echo '<span class="cmmt"><input '.$readonlyText.' class="inOpt textHyu w_40'.$chkText.'" name="textHannyu[]" type="'.$inputTypeNumber.'" id="textHannyu_'.$cd.'" size="3" maxlength="3" value="'.$val.'">'.$biko.'</span>';
                $y++;
            } else {
                echo '<span class="cmmt">'.$biko.'</span>';
            }
