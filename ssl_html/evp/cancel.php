...
Sgmov_Lib::useView('evp/Cancel');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Evp_Cancel();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/evp/cancel_comp" data-feature-id="<?php echo Sgmov_View_Evp_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Evp_Common::GAMEN_ID_EVE001 ?>" method="post">
