...
Sgmov_Lib::useForms(array('Error', 'QraSession', 'Qra003Out'));
 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Qra_Confirm extends Sgmov_View_Qra_Common
{
    ...
    public function executeInner()
    {
        ...
        // チケットを発行
        $ticket = $session->publishTicket(self::FEATURE_ID, self::GAMEN_ID_QRA003);
     ...
     * @param Sgmov_Form_Qra001In $inForm 入力フォーム
     * @return Sgmov_Form_Qra003Out 出力フォーム
     */
    public function _createOutFormByInForm($inForm, $db)
    {
        ...
        return $this->createOutFormByInForm($inForm, new Sgmov_Form_Qra003Out());
    }
}
