...
Sgmov_Lib::useForms(array('Error', 'MsbSession', 'Msb003Out'));
/**#@-*/
 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Msb_Confirm extends Sgmov_View_Msb_Common {
    ...
    public function executeInner() {
        ...
        // チケットを発行
        $ticket = $session->publishTicket(self::FEATURE_ID, self::GAMEN_ID_MSB003);
    ...
    public function _createOutFormByInForm($inForm, $db) {
        return $this->createOutFormByInForm($inForm, new Sgmov_Form_Msb003Out());
    }
}