...
?>
            <div class="section other">
                <form action="/<?=$dirDiv?>/size_change_check_input" data-feature-id="<?php echo Sgmov_View_Evp_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Evp_Common::GAMEN_ID_EVE001; ?>" method="post">
