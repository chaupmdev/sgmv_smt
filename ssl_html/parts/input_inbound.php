...
<!-- 
                                    ...
                                    <?php endif; ?>
                                        ...
                                        <strong class="red">会場内宅配カウンター開設日時：2021年10月23日（土）<span style="white-space: nowrap;">16:00～21:00</span> </strong>
                                        <input type = "hidden" name = "comiket_detail_inbound_collect_date_year_sel" value = "2021">
                                        <input type = "hidden" name = "comiket_detail_inbound_collect_date_month_sel" value = "10">
                                        <input type = "hidden" name = "comiket_detail_inbound_collect_date_day_sel" value = "23">
                            ...
                            <dl class="service-inbound-item" service-id="1">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_box_inbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <div class="outbound_example_boxsize example_boxsize">
                                        ...
                                        <strong class="red">※ １申込み４０個を超える場合は、ＳＧムービング/<?=$dispItemInfo['eventsub_selected_data']['name']?>係 ０３－５８５７－２４６２　もしくはカウンタースタッフへお問い合わせください。</strong><br/>
