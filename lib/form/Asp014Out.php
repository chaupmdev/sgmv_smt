...
/**#@-*/
 ...
 /**
 * カレンダー用特価詳細画面の出力フォームです。
 *
 * @package    Form
 * @author     自動生成
 * @copyright  2009-2010 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_Form_Asp014Out
{
    /**
     * 特価種別
     * @var string
    ...
    /**
     * エンティティ化された特価対象日カレンダーURLを返します。
     * @return string エンティティ化された特価対象日カレンダーURL
     */
    public function sp_priod_cal_url()
    {
        return Sgmov_Component_String::htmlspecialchars($this->raw_sp_priod_cal_url);
    }
