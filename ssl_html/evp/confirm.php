...
<head>
    ...
    <link href="/evp/css/eve.css" rel="stylesheet" type="text/css" />
    <!--[if lt IE 9]>
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <div class="section">
                <form action="/evp/complete" data-feature-id="<?php echo Sgmov_View_Evp_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Evp_Common::GAMEN_ID_EVE001 ?>" method="post">
                                                ...
                                                <table style="width:100%;">
                                                        <tr>
                                                                <td style="padding-right: 20px;">
                                                                    ...
                                                                    &nbsp;<?php echo @sprintf('%02s', $eveOutForm->comiket_booth_num()).@$eveOutForm->comiket_booth_addition_num();?>
                                            ...
                                            <tr>
                                                ...
                                                <td style='padding-top:5px;'>
                                                    <?php if($eveOutForm->comiket_div() == Sgmov_View_Evp_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
                                                        <!--<img src='/evp/images/about_boxsize.png' width='80%'/>-->
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                        </table>
...
<?php
// var_dump($eveOutForm);
        $inboundDeliverydateYear = Sgmov_View_Evp_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_detail_inbound_delivery_date_year_cds(), $eveOutForm->comiket_detail_inbound_delivery_date_year_lbls(), $eveOutForm->comiket_detail_inbound_delivery_date_year_sel());
        echo $inboundDeliverydateYear;
?>
                                        年
<?php
        $inbounddeliverydateMonth = Sgmov_View_Evp_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_detail_inbound_delivery_date_month_cds(), $eveOutForm->comiket_detail_inbound_delivery_date_month_lbls(), $eveOutForm->comiket_detail_inbound_delivery_date_month_sel());
        echo $inbounddeliverydateMonth;
?>
                                        月
<?php
        $inboundDeliveryDateDay = Sgmov_View_Evp_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_detail_inbound_delivery_date_day_cds(), $eveOutForm->comiket_detail_inbound_delivery_date_day_lbls(), $eveOutForm->comiket_detail_inbound_delivery_date_day_sel());
        echo $inboundDeliveryDateDay;
?>
                                        日
                                        （<?php echo Sgmov_View_Evp_Confirm::_getWeek($inboundDeliverydateYear, $inbounddeliverydateMonth, $inboundDeliveryDateDay); ?>）
                                        &nbsp;
<?php
        if ( $view->checkColAndDelTime("inbound", $eveOutForm->comiket_div(), $eveOutForm->comiket_detail_inbound_service_sel(), $dispItemInfo["eventsub_selected_data"]) ) :
            echo Sgmov_View_Evp_Confirm::_getTimeFormatSelectPulldownDataForInBound($eveOutForm->comiket_detail_inbound_delivery_time_cds(), $eveOutForm->comiket_detail_inbound_delivery_time_lbls(), $eveOutForm->comiket_detail_inbound_delivery_time_sel());
        endif;
?>
                                        <br/>
                                        <br/>
...
<?php if($eveOutForm->comiket_div() == Sgmov_View_Evp_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
    ...
    <?php if ($eveOutForm->comiket_payment_method_cd_sel() === '1') : ?>
                        ...
                        <div class="btn_area">
                            <a class="back" href="/evp/<?php echo $dispItemInfo['back_input_path']; ?>/">修正する</a>
    ...
    <?php if ($eveOutForm->comiket_payment_method_cd_sel() == '2') : // クレジット ?>
                        ...
                        <div class="btn_area">
                            <a class="back" href="/evp/credit_card/">修正する</a>
                            <input id="submit_button" type="submit" name="submit" value="入力内容を送信する" />
                        </div>
...
?>
    <!--<script charset="UTF-8" type="text/javascript" src="/evp/js/input.js"></script>-->
    <script>
        $(function() {
