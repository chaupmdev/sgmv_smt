...
$userType = isset($_SESSION['DSN_LOGIN']['user_type']) ? $_SESSION['DSN_LOGIN']['user_type'] : -1;
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <span>
                ...
                <br/>
                　復路チャーター便を申込の場合は、イベント当日にカウンターへお荷物をお持ち込みください。
                <br/>
...
?>
            <div class="section other">
                <form action="/<?=$dirDiv?>/check_input2" data-feature-id="<?php echo Sgmov_View_Dsn_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Dsn_Common::GAMEN_ID_DSN001 ?>" method="post">
