...
$userType = isset($_SESSION['TME_LOGIN']['user_type']) ? $_SESSION['TME_LOGIN']['user_type'] : -1;
...
<head>
    ...
    <meta name="Description" content="東京マラソンEXPO 宅配サービスのお申し込みのご案内です。" />
...
?>
            <div class="section other">
                <form action="/<?=$dirDiv?>/check_input" data-feature-id="<?php echo Sgmov_View_Rms_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Rms_Common::GAMEN_ID_RMS001 ?>" method="post">
