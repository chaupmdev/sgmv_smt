...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <p class="sentence" style="margin-bottom: 0px;">
...
?>
            <div class="section other">
                <form action="/tms/check_input" data-feature-id="<?php echo Sgmov_View_Tms_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Tms_Common::GAMEN_ID_EVE001 ?>" method="post">
