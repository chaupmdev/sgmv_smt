<!doctype html>
<html lang="ja" data-stt-ignore>
<head>
<meta charset="utf-8">
<meta name="format-detection" content="telephone=no">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="SGムービング ニューステンプレート">
...
<title>ニューステンプレート｜ニュース｜<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/meta-ttl.php'); ?></title>
		...
		<div class="mainBox">
			<article id="conts">
				<div class="titleBox fadeInUp">
					<p class="time">2019.12.04<span class="cat-news">お知らせ</span></p>
					<p class="title">SGムービング 「第8回 SGムービング品質選手権」を開催</p>
				</div>
				<div class="wpBox fadeInUp">
					<p>SGホールディングスグループにおいて引越輸送や設置輸送、特殊輸送などを展開するSGムービング株式会社（本社:東京都江東区、代表取締役社長：別所規至）は、11月20日（水）に「第8回 SGムービング品質選手権」を開催しました。</p>
					<div class="list-wrap">
           				 <ul class="link-list" data-col-pc="1" data-col-sp="1">
          				    <li><a href="/news/news-release/pdf/topic50.pdf" target="_blank" rel="noopener" class="link-list__type--pdf">詳細はこちら<i class="link-list__filesize">[PDF:550KB]</i></a></li>
           				 </ul>
         			 </div>	
				</div>
				<div class="comBtn02 fadeInUp"><a href="/news/"><span>ニューストップへ戻る</span></a></div>
			</article>
