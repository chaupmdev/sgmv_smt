 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
abstract class Sgmov_View_Dsn_Common extends Sgmov_View_Public {
    /**
     * 機能ID
     */
    const FEATURE_ID = 'DSN';
    // 2022-03-10 ToanDD3 implement SMT6-69
    const LOGIN_ID = 'DSN_LOGIN';
...
///////////////////////////////////////////////////////////////////////////////////
     ...
     * @param type $inForm
     * @param Sgmov_Form_Dsn001Out $outForm
     * @return type
     */
    protected function createOutFormByInForm($inForm, $outForm = array()) {
        ...
        foreach($buildingListByEventsubId as $key => $val) {
            ...
            if ($val['id'] == $inForm["building_booth_position_sel"]) {
                $outForm->raw_building_booth_position = $val['booth_position'];
            }
        }
    ...
    public function setDispEvent(&$dispItemInfo){
        ...
        foreach($dispItemInfo['event_alllist'] as $k=>$v){
            if(isset($dispItemInfo['eventsub_selected_data']['event_id']) && $v['id']==$dispItemInfo['eventsub_selected_data']['event_id']){
                    ...
                    // ロゴ画像ファイル名：例)logo.dsn.gif logo_[イベント識別子].gif
            ...
            foreach ($procList as $keyTree => $valTree) {
                ...
                foreach($valTree["comiket_detail_list"] as $keyDet => $valDet) {
                    ...
                    if(isset($valDet["comiket_box_list"])){
                        ...
                        /////////////////////////////////////////////////////////
                        $valTree["comiket_detail_list"][$keyDet]['fare'] = ceil((string)($fareTotal / Sgmov_View_Dsn_Common::CURRENT_TAX));

                        $valTree["comiket_detail_list"][$keyDet]['fare_tax'] = $fareTotal;

                        $valTree["comiket_detail_list"][$keyDet]['cost'] = ceil((string)($costTotal / Sgmov_View_Dsn_Common::CURRENT_TAX));
                        // // 税込
        ...
        try {
            ...
            if ($eventsubData['building_display'] !== '0') {
                ...
                if($comiket['building_name'] == "その他"){
                    $building = $comiket['building_name']; //GiapLN fix bug send mail item 【ブースNO】 2024.07.09
                }
            ...
            // 2022-03-11 ToanDD3 implement SMT6-59
            // if ($comiket['div'] == self::COMIKET_DEV_BUSINESS) { // 法人
            //     $mailTemplate[] = "/dsn_parts{$footerTmpName}_footer_type_1.txt";

            //     // 2018.09.10 tahira add 申込者と営業所で使用するメールテンプレートをわけ別々に送信する
            //     $mailTemplateSgmv[] = "/dsn_parts{$footerTmpName}_footer_type_1.txt";
            // } else { // 個人
            //     $mailTemplate[] = "/dsn_parts{$footerTmpName}_footer_type_2.txt";

            //     // 2018.09.10 tahira add 申込者と営業所で使用するメールテンプレートをわけ別々に送信する
            //     $mailTemplateSgmv[] = "/dsn_parts{$footerTmpName}_footer_type_2.txt";
            // }
            ...
            // $data['edit_url'] = $urlPublicSsl . "/dsn/input/" . sprintf('%010d', $comiket["id"]) . $comiketIdCheckD;
...
";
            ...
            ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            // 2022-03-24 ToanDD3 implement SMT6-84
            // $data['cancel_url'] = $urlPublicSsl . "/dsn/cancel/" . sprintf('%010d', $comiket["id"]) . $comiketIdCheckD;
            // $data['size_change_url'] = $urlPublicSsl . "/dsn/size_change/" . sprintf('%010d', $comiket["id"]) . $comiketIdCheckD;
            if (!$isSecurity) {
