 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Dsn_BuildingBoothPosition extends Sgmov_View_Dsn_Common {
    ...
    public function executeInner() {
        ...
        $buildingCdAndName    = filter_input(INPUT_POST, 'building_cd_and_name_sel'); // 集荷元JIS5（集荷元都道府県の選択）
        ...
        Sgmov_Component_Log::debug('############################ ZZZZZZZZZZZZZZZZZZZ');
        Sgmov_Component_Log::debug($boothPositionList);
