...
<?php
        echo Sgmov_View_Mdr_Input::_createPulldown($eve001Out->comiket_detail_inbound_pref_cds(), $eve001Out->comiket_detail_inbound_pref_lbls(), $eve001Out->comiket_detail_inbound_pref_cd_sel());
?>
                                    </select>
                                    <br/>
                                    <br/>
...
<?php
            echo Sgmov_View_Mdr_Input::_createPulldown($eve001Out->comiket_detail_inbound_collect_time_cds(), $eve001Out->comiket_detail_inbound_collect_time_lbls(), $eve001Out->comiket_detail_inbound_collect_time_sel());
?>
                                            </select>
                                        </span>
                                    </div>
                                    ...
                                    <!-- <div class = "dsp-inbl vat lhn">
                                        <img src="/images/common/img_icon_pdf.gif" class = "vat" width="18" height="21" alt="">
                                            <a class = "clr-blue fwn" href="/mdr/pdf/manual/会場内宅配受付カウンター場所.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">会場内宅配受付カウンター場所</a>
                                    </div>-->
                                </dd>
                            </dl>
                                    ...
                                    <div class="comiket_detail_inbound_delivery_date_parts">
                                        ...
                                        時間帯
                                            <select name="comiket_detail_inbound_delivery_time_sel">
                                                <option value="">時間帯を選択</option>
<?php
            echo Sgmov_View_Mdr_Input::_createPulldown($eve001Out->comiket_detail_inbound_delivery_time_cds(), $eve001Out->comiket_detail_inbound_delivery_time_lbls(), $eve001Out->comiket_detail_inbound_delivery_time_sel());
?>
                                            </select>
                                        </span>
                                        <br/>
                            ...
                            <dl class="service-inbound-item" service-id="1">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_box_inbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    <td class="dispSeigyoPC vam tar">
                                                        <?php if($eve001Out->comiket_div() == Sgmov_View_Mdr_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
                                                            <img src='/mdr/images/about_boxsize.png' width='100%'/>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <div class="dispSeigyoSP mt1em">
                                        <img src='/mdr/images/about_boxsize.png' class ="mt1em" width='250px' />
                                    </div>
                                    <?php else: ?>
                                    <?php endif; ?>
                                    <br/>
                                    <div class="outbound_example_boxsize example_boxsize">
                                        ...
                                        <strong class="red">※ １申込み４０個を超える場合は、ＳＧムービング/みどり会 2022年年末販売優待会係 03-5857-2462 もしくはカウンタースタッフへお問い合わせください。</strong><br/>
                                        <a href="/mdr/pdf/example/example_box_size.pdf" target="_blank" class = "clr-blue">目安表</a>
                                    </div>
                                </dd>
                            </dl>
                            <dl class="service-inbound-item" service-id="2">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_cargo_inbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <div class="comiket-cargo-inbound-num" div-id="<?php echo Sgmov_View_Mdr_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                    </div>
                                    <div class="comiket-cargo-inbound-num" div-id="<?php echo Sgmov_View_Mdr_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                    </div>
                                    <div class="">
                            ...
                            <dl class="service-inbound-item" service-id="3">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_charter_inbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <div class="comiket-charter-inbound-num" div-id="<?php echo Sgmov_View_Mdr_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                    ...
                                    <div class="comiket-charter-inbound-num" div-id="<?php echo Sgmov_View_Mdr_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                        <table>
