...
// Basic Authen
require_once dirname(__FILE__) . '/../../lib/component/auth_pct.php';

require_once dirname(__FILE__) . '/../../lib/Lib.php';
Sgmov_Lib::useView('pct/Input');
/**#@-*/

// 処理を実行
$view = new Sgmov_View_Pct_Input();
$forms = $view->execute();
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <p class="sentence">
<!--            <p style="color: red;font-size: 20px"><strong>那覇港発クルーズツアーに伴う手荷物配送のご依頼はこちら</strong></p>
            <p style="margin-top: 5px">リンク先：<a href="http://localhost/pcr/input/" target="blank" style="color: #0563C1">http://localhost/pcr/input/</a></p>
            <br>-->
                受付申込みは、<span style="color: red; font-weight: bold">乗船19日前から申し込み可能</span>となります。対象日より項目が表示されます。
                <br/>
                対応客船：ダイヤモンド・プリンセス（全日程）<br/>
                　　　　　クイーン・エリザベス（全日程）<br/>
                　　　　　MSCベリッシマ（一部日程）<br/>
                　　　　　ウエステルダム（一部日程）<br/>
                　　　　　セレブリティ・ミレニアム（一部日程）<br/>
                　　　　　コスタセレーナ（一部日程）<br/>
                　　　　　ノールダム（一部日程）<br/>
                　　　　　三井オーシャンフジ（一部日程）<br/>
                　　　　　バイキングエデン（一部日程）
            ...
            <p class="sentence">
                ...
                <br />入力に関する不明点、その他お問い合わせについては、下記電話番号までお願いいたします。
                <br />
                <?php
                    if ($isSmartPhone) {
                ?>
                    <a href="tel:03-6850-7828" style="color: #1774bc;text-decoration: underline">03-6850-7828</a>
                <?php
                    } else {
                ?>
                    <span style="font-weight: bold">　・03-6850-7828</span>
                <?php
                    } 
                ?>
                <br /><br />※前日23時までにお支払の確認ができたお客様につきましては、翌日より集荷が可能となります。
                <br />
                <span class="red">
...
?>
            <div class="section other">
                <form action="/pct/check_input" data-feature-id="<?php echo $featureId; ?>" data-id="<?php echo Sgmov_View_Pct_Common::GAMEN_ID_PCR001 ?>" method="post">
                    <input name="ticket" type="hidden" value="<?php echo $ticket ?>" />
                    <input name="req_flg" type="hidden" value="2" />
                    <input name="site_flg" type="hidden" value="1" /><!--通常版-->
                    <div class="section">
        ...
        echo ' class="form_error"';
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('top_tel')) { echo ' class="form_error"'; } ?>>
                                    <input autocapitalize="off" class="w_70" inputmode="numeric" maxlength="18" name="tel1" data-pattern="^\d+$" placeholder="例）075" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $pcr001Out->tel1();?>" />
                                    -
...
<?php
        echo Sgmov_View_Pct_Input::_createPulldown($pcr001Out->pref_cds(), $pcr001Out->pref_lbls(), $pcr001Out->pref_cd_sel());
?>
                                    </select>
                                    <!-- 190617_0900 -->
                                    <div class="">
                                        <br>
                                        ※<span class="red">北海道にお住まいのお客様へ</span>※　<br>
                                        <!--<span class="red">博多港乗船</span>の場合、<span class="red">最終集荷日からマイナス2日前</span>・<span class="red">その他の乗船港</span>に関しましても(苫小牧港は除く)、-->
                                        <span style="font-weight: bold">最終集荷日から<span class="red">マイナス1日前</span>を集荷日選択お願いします。</span>
                                        <br>
                                        <br>
                                        ※<span class="red">沖縄県にお住まいのお客様へ</span>※<br>
                                        <span style="font-weight: bold">最終集荷日から<span class="red">マイナス３日以上前</span>を集荷日選択お願いします。</span>
                                        <br/>
                                        <br/>
                                        <span>受付後であっても、集荷日から乗船日に間に合わない場合は、</span>
                                        <br>
                                        <span>集荷日のご相談を差し上げますのでご承知おきください。</span>
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('top_address')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <div class="">
                                        <br/>
                                        <span>※配送料金の他に別途中継料金がかかる集荷地域の場合がございます。</span><br/>
                                        <span>該当地域のお客様へは、</span><span class="red">決済前または決済後に配送料金とは別途、</span><br/>
                                        <span class="red">中継料金追加の案内</span>をする場合もございます。ご承知おきください。
                                    </div>
                                </dd>
                            </dl>
                            <dl>
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('top_travel_agency_cd_sel')) { echo ' class="form_error"'; } ?>>
                                    <select name="travel_agency_cd_sel">
                                        <option value="">選択してください</option>
<?php
        echo Sgmov_View_Pct_Input::_createPulldown($pcr001Out->travel_agency_cds(), $pcr001Out->travel_agency_lbls(), $pcr001Out->travel_agency_cd_sel());
?>
                                    </select>
                                </dd>
                            </dl>
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('top_travel_cd_sel')) { echo ' class="form_error"'; } ?>>
                                    <select name="travel_cd_sel">
                                        <option value="">選択してください</option>
<?php
        echo Sgmov_View_Pct_Input::_createPulldown($pcr001Out->travel_cds(), $pcr001Out->travel_lbls(), $pcr001Out->travel_cd_sel());
?>
                                    </select>
                                </dd>
                            </dl>
                            <dl>
                                ...
                                <dd <?php if (isset($e) && $e->hasErrorForId('top_room_number')) { echo ' class="form_error"'; } ?> style="display: flex; align-items: center;">
                                    ...
                                    <span style="font-size:12px; white-space: nowrap; line-height: 1.8;">
                                       &#12288;※お部屋番号が決まっていない場合は、確定後に申し込みをお願いいたします。
                            ...
                            <dl>
                                ...
                                <dd class="departure<?php if (isset($e) && $e->hasErrorForId('top_travel_departure_cd_sel')) { echo ' form_error'; } ?>">
                                    <select name="travel_departure_cd_sel">
                                        <option value="">選択してください</option>
<?php
    echo Sgmov_View_Pct_Input::_createPulldownAddDate($pcr001Out->travel_departure_cds(), $pcr001Out->travel_departure_lbls(), $pcr001Out->travel_departure_cd_sel(), $pcr001Out->travel_departure_dates());
?>
                                    </select>
                                </dd>
                            </dl>
...
<?php
        echo Sgmov_View_Pct_Input::_createPulldown($pcr001Out->cargo_collection_date_year_cds(), $pcr001Out->cargo_collection_date_year_lbls(), $pcr001Out->cargo_collection_date_year_cd_sel());
?>
                                    </select>
                                    年
...
<?php
        echo Sgmov_View_Pct_Input::_createPulldown($pcr001Out->cargo_collection_date_month_cds(), $pcr001Out->cargo_collection_date_month_lbls(), $pcr001Out->cargo_collection_date_month_cd_sel());
?>
                                    </select>
                                    月
...
<?php
        echo Sgmov_View_Pct_Input::_createPulldown($pcr001Out->cargo_collection_date_day_cds(), $pcr001Out->cargo_collection_date_day_lbls(), $pcr001Out->cargo_collection_date_day_cd_sel());
?>
                                    </select>
                                    日
...
<?php
        echo Sgmov_View_Pct_Input::_createPulldown($pcr001Out->cargo_collection_st_time_cds(), $pcr001Out->cargo_collection_st_time_lbls(), $pcr001Out->cargo_collection_st_time_cd_sel());
?>
                                    </select>
                            ...
                            <dl>
                                ...
                                <dd class="arrival<?php if (isset($e) && $e->hasErrorForId('top_travel_arrival_cd_sel')) { echo ' form_error'; } ?>">
                                    <select name="travel_arrival_cd_sel">
                                        <option value="">選択してください</option>
<?php
        echo Sgmov_View_Pct_Input::_createPulldown($pcr001Out->travel_arrival_cds(), $pcr001Out->travel_arrival_lbls(), $pcr001Out->travel_arrival_cd_sel());
?>
                                    </select>
                                </dd>
                            </dl>
                            ...
                            <div id="transactions_contents" class="ac_content">
                                ...
                                <dl>
                                    ...
                                    <dd>
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <p>
                                                        ...
                                                        <br />コンビニ払いの場合：ご乗船日の7日前
                                                        <br />コンビニ払いの場合のお支払い期限：ご乗船日の7日前
                                                    </p>
                                                </li>
                                                <li>
                                                    <strong>手荷物集荷</strong>
                                        ...
                                        <!--▲※スマホ版　有効期限一覧表-->
                                        <!--<p class="pc_only">※船の入出港スケジュールや国内行事などによる交通規制により、受付期間を設定変更する場合がございます。</p>-->
                                ...
                                <dl>
                                    <dt>お荷物の破損について：</dt>
                                    <dd>
                                        <p>当社に故意又は重大な過失がある場合を除き、 以下の損傷に関しては補償対象外となりますので、あらかじめご了承ください。</p>
                                        <ul style="text-indent: -15px;margin-left: 15px">
                                            <li>・経年劣化によるハンドルやキャスター破損、 タイヤの摩耗</li>
                                            <li>・スーツケースの機能として問題のない切り傷、擦り傷、汚れ、凹み等</li>
                                            <li>・過重量、 過容量による破損</p></li>
                                            <li>・手荷物のカバー、 着脱式キャスター、 ストラップ、 フック 、 名札、 ベルトなど突起した付属品の欠損</li>
                                            <li>・お荷物の中に入っている 楽器、 陶磁器、 ガラス製品、 酒類等の壊れやすいもので、固有の欠陥、または性質から生じた破損</li>
                                            <li>・耐用年数を超過したスーツケースの損傷全般</li>
                                            <li>　※耐用年数は 5年とさせていただきます。</li>
                                        </ul>
                                        <p>
                                            <br />
                                            お帰り後、ご自宅でお荷物の破損（上記補償対象外の損傷は除く ） などを確認した場合は、
                                            <br />
                                                <?php if ($isSmartPhone) { ?>
                                                <a href="tel:03-6850-7828" style="color: #1774bc;text-decoration: underline">03-6850-7828</a>
                                                <?php } else { ?>
                                ...
                                <dl>
                                    <dt>キャンセル：</dt>
                                    <dd>
                                        旅客手荷物受付サービスをキャンセルされたい場合は、下船日の当日までに、お手数ですがお客様ご自身でSGムービングにご連絡いただき、キャンセルをお申し出ください。
                                        <br />
                                        <br />■ご連絡先：
                                        <br />
                                        <table class="pc_only spTabH">
                                            <tr>
                                                <td style="width: 18%">お電話</td>
                                                <td style="text-align: left">03-6850-7828(受付時間:9時～18時)</td>
                                            </tr>
                                            <tr>
                                                <td>メールアドレス</td>
                                                <td>
                                                    solution-sgmv@sagawa-exp.co.jp
                                                    <br />※メールでのキャンセルのご連絡の場合、氏名・お電話番号・船名・下船日を必ずご記載いただきますようお願いいたします。
                                                </td>
                                            </tr>
                                        </table>
                                        <div class="sp_only pcH">
                                            <p>お電話：</p><p><a href="tel:03-6850-7828" style="color: #1774bc;text-decoration: underline">03-6850-7828</a>(受付時間:9時～18時) </p>
                                            <br/>
                                            <p>メールアドレス：</p><p>solution-sgmv@sagawa-exp.co.jp</p>
                                            <p>※メールでのキャンセルのご連絡の場合、氏名・お電話番号・船名・下船日を必ずご記載いただきますようお願いいたします。</p>
                                        </div>
                                        <br />(往復でお申し込みされているお客様が、お預かり後キャンセルされた場合は、復路代金で返送する為、全額ご返金はございません）
                                        <br />(往路しかお申し込みされていないお客様が、お預かり後キャンセルされた場合は、返送代金をご請求させて頂きます)
                                        <br />
                                        <br />なお、下船日当日中にお荷物の預け入れがなかった場合、復路便をキャンセルされたものとみなします。
                                        <br />当社へ申し出ることなく復路便をキャンセルされた場合、その理由に関わらず、復路便にかかる料金のご返金は致しかねますので、あらかじめご了承ください。
                                    </dd>
                                </dl>
                                    <p style="text-align: right">改定日：2023年7月26日</p>
                            </div>
                        </div>
                        <!--▲特定商取引法に基づく表記ここまで-->
                    </div>
                    ...
                    <div style='width: 100%;text-align: center;font-size: 20px;'>
                        <input type="checkbox" id="checkbox_agreement" name="chb_agreement" value="<?php echo $pcr001Out->chb_agreement() ?>" <?php if ($pcr001Out->chb_agreement() == '1') echo ' checked="checked"'; ?> />
                        <label for="checkbox_agreement" style="font-weight: bold;color:red;">上記内容を理解し、同意します。</label>
                    </div>
                    <br/>
                    <p class="text_center">
...
?>
    <script charset="UTF-8" type="text/javascript" src="/pct/js/input.js?v=<?php echo date('YmdHis'); ?>"></script>
    <script> 
