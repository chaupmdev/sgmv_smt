...
<div id="contents">
    <form action="./setti_conf.php" method="post">
        ...
        <p>
            ...
            <input type="radio" name="q1" value="有った" <?php if ($q1 === '1') { ?>checked="cheked"<?php } ?> >有った<br />
            <input type="radio" name="q1" value="無かった" <?php if ($q1 === '2') { ?>checked="cheked"<?php } ?> >無かった<br />
        </p>
        ...
        <p>
            ...
            <input type="radio" name="q2" value="適切だった" <?php if ($q2 === '1') { ?>checked="cheked"<?php } ?>>適切だった <br />
            <input type="radio" name="q2" value="適切では無かった" <?php if ($q2 === '2') { ?>checked="cheked"<?php } ?>>適切では無かった<br />
            <input type="radio" name="q2" value="連絡が無かった" <?php if ($q2 === '3') { ?>checked="cheked"<?php } ?>>連絡が無かった<br />
        </p>
        
        <br />
        
        <div style="border:3px solid #78EAFE; background:#D3F8FF; padding: 5px;">
        <strong>Q3 お約束の作業開始時間は守られましたか。</strong>
        </div>
        <p>
            <?php if ($err3 === 'エラー') {?><div style="color: #F00; margin-bottom: 10px;">いずれかを選択してください。</div><br /><?php } ?>
            <input type="radio" name="q3" value="約束通り" <?php if ($q3 === '1') { ?>checked="cheked"<?php } ?> >約束通り <br />
            <input type="radio" name="q3" value="早かった（連絡有り）" <?php if ($q3 === '2') { ?>checked="cheked"<?php } ?> >早かった（連絡有り）<br />
            <input type="radio" name="q3" value="遅れた（連絡有り）" <?php if ($q3 === '3') { ?>checked="cheked"<?php } ?> >遅れた（連絡有り）<br />
            <input type="radio" name="q3" value="早かった（連絡なし）" <?php if ($q3 === '4') { ?>checked="cheked"<?php } ?> >早かった（連絡なし）<br />
            <input type="radio" name="q3" value="遅れた（連絡なし）" <?php if ($q3 === '5') { ?>checked="cheked"<?php } ?> >遅れた（連絡なし）
        </p>
        ...
        <p>
            ...
            <input type="radio" name="q5" value="お客様と一緒に確認" <?php if ($q5 === '1') { ?>checked="cheked"<?php } ?>>お客様と一緒に確認 <br />
            <input type="radio" name="q5" value="お客様だけで確認" <?php if ($q5 === '2') { ?>checked="cheked"<?php } ?>>お客様だけで確認<br />
            <input type="radio" name="q5" value="配送員だけで確認" <?php if ($q5 === '3') { ?>checked="cheked"<?php } ?>>配送員だけで確認<br />
            <input type="radio" name="q5" value="行っていない" <?php if ($q5 === '4') { ?>checked="cheked"<?php } ?>>行っていない<br />
            <input type="radio" name="q5" value="わからない" <?php if ($q5 === '5') { ?>checked="cheked"<?php } ?>>わからない
        </p>
        ...
        <p>
            ...
            <input type="radio" name="q8" value="お客様と一緒に確認" <?php if ($q8 === '1') { ?>checked="cheked"<?php } ?>>お客様と一緒に確認 <br />
            <input type="radio" name="q8" value="お客様だけで確認" <?php if ($q8 === '2') { ?>checked="cheked"<?php } ?>>お客様だけで確認<br />
            <input type="radio" name="q8" value="配送員だけで確認" <?php if ($q8 === '3') { ?>checked="cheked"<?php } ?>>配送員だけで確認<br />
            <input type="radio" name="q8" value="行っていない" <?php if ($q8 === '4') { ?>checked="cheked"<?php } ?>>行っていない<br />
            <input type="radio" name="q8" value="わからない" <?php if ($q8 === '5') { ?>checked="cheked"<?php } ?>>わからない
        </p>
        ...
        <p>
            ...
            <input type="radio" name="q9" value="お客様だけで確認" <?php if ($q9 === '2') { ?>checked="cheked"<?php } ?>>お客様だけで確認<br />
            <input type="radio" name="q9" value="配送員だけで確認" <?php if ($q9 === '3') { ?>checked="cheked"<?php } ?>>配送員だけで確認<br />
        ...
        <p>
            ...
            <?php if ($err12b === 'エラー3') {?><div style="color: #F00; ">半角カナ、もしくは特殊文字が含まれています。</div><?php } ?>
            ...
            <?php if ($err12c === 'エラー3') {?><div style="color: #F00; ">半角カナ、もしくは特殊文字が含まれています。</div><?php } ?>
            ...
            <?php if ($err12d === 'エラー3') {?><div style="color: #F00; ">半角カナ、もしくは特殊文字が含まれています。</div><?php } ?>
