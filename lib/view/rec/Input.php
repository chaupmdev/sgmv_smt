...
Sgmov_Lib::useForms(array('Error', 'RecSession', 'Rec001In', 'Rec001Out'));
/**#@-*/
 ...
 * @copyright  2020-2020 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Rec_Input extends Sgmov_View_Rec_Common {
    ...
    public function executeInner() {
        ...
        // チケット発行
        $ticket = $session->publishTicket(self::FEATURE_ID, self::GAMEN_ID_REC001);
        return array(
            'ticket'    => $ticket,
            'outForm'   => $outForm,
     ...
     * @param Sgmov_Form_Rec001In $inForm 入力フォーム
     * @return Sgmov_Form_Rec001Out 出力フォーム
     */
