 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Zzy_Input extends Sgmov_View_Zzy_Common {
...
//     protected $_BuildingService;
    ...
    public function executeInner() {
        ...
        if(@empty($_SERVER["HTTP_REFERER"]) || strpos($_SERVER["HTTP_REFERER"], "/zzy/") == false) {
            // セッション情報を破棄
...
///////////////////////////////////////////////////////////////////////////////////////////////////
        if(strlen($param) == 10) {
            Sgmov_Component_Redirect::redirectPublicSsl("/zzy/input2_dialog/{$param}");
        }
        ...
        if($input2DialogFlg == "1") {
            ...
            if(!is_numeric($input2DialogComiketId)){
                Sgmov_Component_Redirect::redirectPublicSsl("/zzy/temp_error");
                exit;
            }
            ...
            if($comiketData['tel'] == $input2DialogData1Tel
                ...
                Sgmov_Component_Redirect::redirectPublicSsl("/zzy/input/{$param}");
            } else {
                Sgmov_Component_Redirect::redirectPublicSsl("/zzy/temp_error/{$comiketData['event_id']}");
            }
        }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if(@!empty($_SERVER["REQUEST_URI"]) && strpos($_SERVER["REQUEST_URI"], "/zzy/input2") !== false && empty($param)) {
        ...
        // チケット発行
        $ticket = $session->publishTicket(self::FEATURE_ID, self::GAMEN_ID_ZZY001);
