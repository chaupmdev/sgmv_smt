...
<?php
        echo Sgmov_View_Nss_Input::_getLabelSelectPulldownData($eve001Out->comiket_pref_cds(), $eve001Out->comiket_pref_lbls(), $eve001Out->comiket_pref_cd_sel());
?>
                                </dd>
                            </dl>
                            <dl>
                            ...
                            <dl class="class_building_name_sel">
                                ...
                                <dd>
                                    <?php if($eve001Out->building_name() != "その他"): ?>
                                        <?php echo $eve001Out->building_name(); ?>
                                        <span style="font-size: 0.5em;">ホール</span>&nbsp;
                                    <?php endif; ?>
                                    <?php echo $eve001Out->building_booth_position(); ?>&nbsp;<?php echo $eve001Out->comiket_booth_num(); ?>
                                </dd>
                            </dl>
                            <dl>
                            ...
                            <dl style=" border-bottom: solid 1px #ccc !important;">
                                    ...
                                    <div class="comiket_detail_type_sel-dd">
                                        <?php foreach($dispItemInfo['comiket_detail_type_lbls'] as $key => $val) : ?>
                                            <?php if ($eve001Out->comiket_detail_type_sel() == $key) : ?>
                                                <label class="comiket_detail_type_sel-label<?php echo $key; ?>" for="comiket_detail_type_sel<?php echo $key; ?>">
