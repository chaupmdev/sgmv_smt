...
?>
                        ...
                        <div id="transactions" class="accordion">
                            ...
                            <div id="transactions_contents" class="ac_content">
                                ...
                                <dl>
                                    <dt>お荷物の持ち込み先：</dt>
                                    <dd>会場内に開設されている宅配カウンターへお持込みください。<br>
                                        申し込み完了時にサイトで表示される「受付完了画面」もしくは完了後に配信される「申込み完了メール」のいずれかをご提示下さい。</dd>
                                </dl>
                                <dl>
                                    <dt>お荷物の破損について：</dt>
                                    <dd>
                                        <p>
                                            お帰り後、ご自宅で荷物の破損などを確認した場合は、佐川急便株式会社<br/>
<!--
                                            <span style="color:#F00;"><strong>03-5857-2462
                                            （SGムービング<?=$dispItemInfo['eventsub_selected_data']['name']?>係）
                                            （受付時間:平日10時～17時）</strong></span>へご連絡ください。
                                            佐川急便株式会社
                                            <br />
-->
                                            <!-- <span style="color:#F00;"><strong>渋谷営業所 0570-01-0213 (受付時間 8:00～19:00)</strong></span>にご連絡下さい。 -->
                                            <span style="color:#F00;"><strong>千代田営業所 0570-01-0279 (受付時間 8:00～19:00)</strong></span>にご連絡下さい。
                                        </p>
                                    </dd>
                                </dl>
                                <dl>
                                    ...
                                    <dd>
                                        ...
                                        <br />(お預かり後キャンセルされた場合は、搬出代金で返送する為、全額ご返金はございません)
                                    </dd>
                                </dl>
                            </div>
                        </div>
