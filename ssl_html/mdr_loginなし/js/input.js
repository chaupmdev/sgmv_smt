...
//                $('.paste_tag_link').attr("href", "/mdr/pdf/paste_tag/paste_tag_" + eventsubSel + ".pdf");
//                $('.manual_link').attr("href", "/mdr/pdf/manual/manual_" + eventsubSel + ".pdf");

                $('.manual').show(g_fifoVal);
                eventSelText = eventSelText.replace(/\s+/g, "");
                $('.manual_link').attr("href", "/mdr/pdf/manual/" + eventSelText +  ".pdf" + '?' + strCurrentDate);
            } else {
                $('.manual').hide(g_fifoVal);
            }
            if(g_eventsubList[eventsubSel]['is_paste_display']){
                $('.paste_tag').show(g_fifoVal);
                $('.paste_tag_link').attr("href", "/mdr/pdf/paste_tag/paste_tag_" + eventsubSel + ".pdf" + '?' + strCurrentDate);
            } else {
...
//                    htmlCode += "<img class='dispSeigyoPC' src='/mdr/images/about_boxsize.png' width='100%'/>";
//                } else {
////                    htmlCode += "<img src='/mdr/images/about_boxsize.png' width='100%' style='visibility:hidden;'/>";
//                }
//                htmlCode += "</td></tr></table>";
//
//                if($('input[name="comiket_div"]:checked').val() ==  G_DEV_INDIVIDUAL && $('.dispSeigyoSP').length === 0) {
//                    htmlCode += "<div class='dispSeigyoSP'><img src='/mdr/images/about_boxsize.png' width='250px' style='margin-top: 1em;' /></div>";
//                }
//
...
//            }
           if($('input[name="comiket_detail_type_sel"]:checked').val() == "2") { // 搬出
                ...
                if($('input[name="comiket_div"]:checked').val() ==  G_DEV_INDIVIDUAL) {
                    htmlCode += "<img src='/mdr/images/about_boxsize.png' width='100%'/>";
                }
                htmlCode += "</td></tr></table>";
...
//                htmlCode2 += "</td>";
//                if($('input[name="comiket_div"]:checked').val() ==  G_DEV_INDIVIDUAL) {
//                  //  htmlCode2 += "<img class='dispSeigyoPC' src='/mdr/images/about_boxsize.png' width='100%'/>";
//                }
//                htmlCode2 += "</tr></table>";
//
//                // 搬入div
