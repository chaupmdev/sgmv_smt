...
Sgmov_Lib::useForms(array('Error', 'PcrSession', 'Pcr002Out'));
/**#@-*/
/**
 ...
 * @copyright  2009-2010 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Pcr_ConvenienceStore extends Sgmov_View_Pcr_Common {
    /**
     * コンストラクタでサービスを初期化します。
     */
    ...
    public function executeInner() {
        ...
        // チケットを発行
        $ticket = $session->publishTicket(self::FEATURE_ID, self::GAMEN_ID_PCR002);
     ...
     * @param Sgmov_Form_Pcr001In $sessionForm 入力フォーム
     * @return Sgmov_Form_Pcr002Out 出力フォーム
     */
    public function _createOutFormByInForm() {

        $outForm = new Sgmov_Form_Pcr002Out();
