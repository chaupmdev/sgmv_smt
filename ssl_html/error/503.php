...
<meta name="description" content="503エラー Service Unavailable">
...
<title>503エラー Service Unavailable｜<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/meta-ttl.php'); ?></title>
...
<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/header.php'); ?>
    <main id="main" role="main">
		<div class="pageTitle style01">
			<div class="comBox">
				<h1 class="topLead">Service Unavailable<em>503エラー</em></h1>
				<ul id="pagePath">
		...
		<div class="topBox comBox">
			<p class="text fadeInUp">サーバーが大変込み合っております。<br>しばらくしてから再度アクセスしてください。</p>
