...
// 処理を実行
$view = new Sgmov_View_Unf_Complete();
$eveOutForm = array();
$eventData = array();
$eventsubData = array();
...
<head>
    ...
    <title>手荷物配送サービスのお申し込みフォームの完了│ＳＧムービング株式会社＜ＳＧホールディングスグループ＞</title>
...
<div id="breadcrumb">
    <ul class="wrap">
        ...
        <li class="current">手荷物配送サービスのお申し込みフォームの完了</li>
    </ul>
</div>

<div id="main">
    <div class="wrap clearfix">
        <h1 class="page_title">手荷物配送サービスのお申し込みフォームの完了</h1>
        <div class="section">
