    ...
    <dl>
        ...
        <dd>
            ...
            <div class="comiket_detail_inbound_collect_date_parts" style="display:<?php echo $displaySetting; ?>">
                <?php echo $qrc001Out->comiket_detail_inbound_collect_date_year_sel(); ?>年
                <?php echo $qrc001Out->comiket_detail_inbound_collect_date_month_sel(); ?>月
                <?php echo $qrc001Out->comiket_detail_inbound_collect_date_day_sel(); ?>日
                <?php
    ...
    <dl class="comiket_detail_inbound_delivery_date">
        ...
        <dd>
            ...
            <div class="comiket_detail_inbound_delivery_date_parts">
                <?php echo $qrc001Out->comiket_detail_inbound_delivery_date_year_sel(); ?>年
                <?php echo $qrc001Out->comiket_detail_inbound_delivery_date_month_sel(); ?>月
                <?php echo $qrc001Out->comiket_detail_inbound_delivery_date_day_sel(); ?>日
                &nbsp;
                    ...
                    <td class='box_table_td' style='vertical-align: middle;width:40%;'>
                        <table>
                            <?php foreach ($dispItemInfo['inbound_box_lbls'] as $key => $val) : ?>
                                <?php $boxNum = $qrc001Out->comiket_box_inbound_num_ary($val["id"]); ?>
                                <?php if (!empty($boxNum)) : ?>
                                    <tr>
