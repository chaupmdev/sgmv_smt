...
Sgmov_Lib::useView('pin/Complete');
/**#@-*/

// 処理を実行
$view = new Sgmov_View_Pin_Complete();
$forms = $view->execute();

/**
 * フォーム
 * @var Sgmov_Form_Pin003Out
 */
$pin003Out = $forms['outForm'];
?>
<!DOCTYPE html>
...
<head>
    ...
    <meta property="og:url" content="https://www.sagawa-mov.co.jp/pin/complete/">
    ...
    <title>一般的なお問い合わせの送信完了｜<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/meta-ttl.php'); ?></title>
...
<!-- ヘッダEnd ************************************************ -->
    ...
    <div id="main">
		<div class="pageTitle style01">
			<div class="comBox">
				<h1 class="topLead">一般的なお問い合わせの送信完了<em>Confirm</em></h1>
				<ul id="pagePath">
        ...
        <div class="wrap clearfix">
            ...
            <h1 class="page_title">お問い合わせの完了</h1>
            <div class="section">
