...
<meta name="description" content="504エラー Gateway Timeout">
...
<title>504エラー Gateway Timeout｜<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/meta-ttl.php'); ?></title>
...
<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/header.php'); ?>
    <main id="main" role="main">
		<div class="pageTitle style01">
			<div class="comBox">
				<h1 class="topLead">Gateway Timeout<em>504エラー</em></h1>
				<ul id="pagePath">
					<li><a href="/"><img class="home" src="/img/common/icon54.jpg" alt=""></a></li>
					<li>サーバーが大変込み合っております。</li>
				</ul>
			</div>
		</div>
		<div class="topBox comBox">
			<p class="text fadeInUp">制限時間内にリクエストを処理出来ませんでした。<br>サーバーが大変込み合っている可能性があります。<br>しばらくしてから再度アクセスしてください。</p>
