...
Sgmov_Lib::useView('tms/CreditCard');
/**#@-*/

// 処理を実行
$view = new Sgmov_View_Tms_CreditCard();
$forms = $view->execute();
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <form action="/tms/check_credit_card" method="post">
...
<?php } ?>
                    ...
                    <div class="result02" style="font-size:134%;text-align: center;">
                        <span style="white-space: nowrap;">確定送料(仕分け特別料金含む)：</span>
                        &nbsp;<span style="white-space: nowrap;"><?php echo number_format($eveOutForm->delivery_charge_free()); ?>円（税込）</span>
                    </div>
...
<?php
        echo Sgmov_View_Tms_CreditCard::_createPulldown($eveOutForm->card_expire_month_cds(), $eveOutForm->card_expire_month_lbls(), $eveOutForm->card_expire_month_cd_sel());
?>
                                </select>
                                月
                            </label>
...
<?php
        echo Sgmov_View_Tms_CreditCard::_createPulldown($eveOutForm->card_expire_year_cds(), $eveOutForm->card_expire_year_lbls(), $eveOutForm->card_expire_year_cd_sel());
?>
                                    </select>
                                    年
                                </label>
                    ...
                    <div class="btn_area">
                        ...
                        if(empty($comiketId)): ?>
                            <a class="back" href="/tms/input/?clr=1">修正する</a>
                        <?php else: ?>
                            <a class="back" href="/tms/input2/?clr=1">修正する</a>
                        <?php endif; ?>
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/tms/js/credit_card.js"></script>
    <script>
        $(function() {
