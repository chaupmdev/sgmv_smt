...
<?php
        echo Sgmov_View_Sso_Input::_createPulldown($eve001Out->comiket_detail_outbound_pref_cds(), $eve001Out->comiket_detail_outbound_pref_lbls(), $eve001Out->comiket_detail_outbound_pref_cd_sel());
?>
                                    </select>
                                    <br/>
                                    <br/>
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_detail_outbound_building')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <br/>
                                    <strong class="red">※集合住宅にお住まいの方は建物名や部屋番号も漏れなくご記入ください。<br>　記載漏れがあると集荷に伺えない場合があります。</strong>
                                </dd>
                            </dl>
                            <dl>
...
<!--                                    <p class="comiket-detail-outbound-collect-date-fr-to">
                                    ...
                                    <p>
                                        ...
                                        <a href="/sso/images/term_col_outboud.png" target="_blank" style="color: #1774bc; text-decoration: underline;">
                                            こちら
                                        </a>
                                    </p>
                                        
                                    <!--<strong class="red">※ 北海道・九州・四国の方は2019年12月23日（月）まで選択できます。</strong>-->
...
<?php
        echo Sgmov_View_Sso_Input::_createPulldown($eve001Out->comiket_detail_outbound_collect_date_year_cds(), $eve001Out->comiket_detail_outbound_collect_date_year_lbls(), $eve001Out->comiket_detail_outbound_collect_date_year_sel());
?>
                                            </select>年
                                        </span>
                                        <span class="comiket_detail_outbound_collect_date">
...
<?php
        echo Sgmov_View_Sso_Input::_createPulldown($eve001Out->comiket_detail_outbound_collect_date_month_cds(), $eve001Out->comiket_detail_outbound_collect_date_month_lbls(), $eve001Out->comiket_detail_outbound_collect_date_month_sel());
?>
                                            </select>月
                                        </span>
                                        <span class="comiket_detail_outbound_collect_date">
...
<?php
            echo Sgmov_View_Sso_Input::_createPulldown($eve001Out->comiket_detail_outbound_collect_date_day_cds(), $eve001Out->comiket_detail_outbound_collect_date_day_lbls(), $eve001Out->comiket_detail_outbound_collect_date_day_sel());
?>
                                            </select>日
                                        </span>
                                        &nbsp;
    ...
    <?php
            echo Sgmov_View_Sso_Input::_createPulldown($eve001Out->comiket_detail_outbound_collect_time_cds(), $eve001Out->comiket_detail_outbound_collect_time_lbls(), $eve001Out->comiket_detail_outbound_collect_time_sel());
    ?>
                                            </select>
                                        </span>
                                    </div>
                                    ...
                                    <br>
                                    <div>
                                        <strong class="red">※ お預かり日の前日１７時までにお支払いが完了されない場合、<br>　 お預かり日時に伺うことができません。</strong>
                                        <br>
                                        <strong class="red">※ 午後１２時００以降は、翌日を集荷日にできません。</strong>
                                    </div>
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_detail_outbound_delivery_date')) { echo ' class="form_error"'; } ?>>
                                    <p class="comiket-detail-outbound-delivery-date-fr-to" style="float: left;padding: 0px;">
                                    ...
                                    <div class="comiket_detail_outbound_delivery_date_parts">
                                        <span class="comiket_detail_outbound_delivery_date">
                                            <select name="comiket_detail_outbound_delivery_date_year_sel">
                                                <option value="">年を選択</option>
<?php
        echo Sgmov_View_Sso_Input::_createPulldown($eve001Out->comiket_detail_outbound_delivery_date_year_cds(), $eve001Out->comiket_detail_outbound_delivery_date_year_lbls(), $eve001Out->comiket_detail_outbound_delivery_date_year_sel());
?>
                                            </select>年
                                        </span>
                                        <span class="comiket_detail_outbound_delivery_date">
                                            <select name="comiket_detail_outbound_delivery_date_month_sel">
                                                <option value="">月を選択</option>
<?php
        echo Sgmov_View_Sso_Input::_createPulldown($eve001Out->comiket_detail_outbound_delivery_date_month_cds(), $eve001Out->comiket_detail_outbound_delivery_date_month_lbls(), $eve001Out->comiket_detail_outbound_delivery_date_month_sel());
?>
                                            </select>月
                                        </span>
                                        <span class="comiket_detail_outbound_delivery_date">
                                            <select name="comiket_detail_outbound_delivery_date_day_sel">
                                                <option value="">日を選択</option>
<?php
        echo Sgmov_View_Sso_Input::_createPulldown($eve001Out->comiket_detail_outbound_delivery_date_day_cds(), $eve001Out->comiket_detail_outbound_delivery_date_day_lbls(), $eve001Out->comiket_detail_outbound_delivery_date_day_sel());
?>
                                            </select>日
                                        </span>
                                        &nbsp;
                                        <span class="comiket_detail_outbound_delivery_time_sel">
                                            ...
                                            <select name="comiket_detail_outbound_delivery_time_sel">
                                                <option value="">時間帯を選択</option>
    <?php
            echo Sgmov_View_Sso_Input::_createPulldown($eve001Out->comiket_detail_outbound_delivery_time_cds(), $eve001Out->comiket_detail_outbound_delivery_time_lbls(), $eve001Out->comiket_detail_outbound_delivery_time_sel());
    ?>
                                            </select>
                                        </span>
                                    </div>
                            ...
                            <dl class="comiket_detail_outbound_binshu_kbn_sel">
                                <dt id="comiket_detail_outbound_binshu_kbn_sel">
                                    便種選択<span>必須</span>
                                </dt>
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_detail_outbound_binshu_kbn_sel')) { echo ' class="form_error"'; } ?>>
                                    <label class="radio-label-binshu" for="comiket_detail_outbound_binshu_kbn_sel1" style="height: 10px;white-space: nowrap;">
                                        <input id="comiket_detail_outbound_binshu_kbn_sel1" name="comiket_detail_outbound_binshu_kbn_sel" type="radio" value="0" style="vertical-align: middle;"
                                               <?php if ($eve001Out->comiket_detail_outbound_binshu_kbn_sel() == '0') : ?>checked="checked"<?php endif; ?>>
                                        飛脚宅配便 </label>

                                    <label class="radio-label-binshu" for="comiket_detail_outbound_binshu_kbn_sel2" style="white-space: nowrap;vertical-align: middle;">
                                        <input id="comiket_detail_outbound_binshu_kbn_sel2" name="comiket_detail_outbound_binshu_kbn_sel" type="radio" value="1" style="vertical-align: middle;"
                                               <?php if ($eve001Out->comiket_detail_outbound_binshu_kbn_sel() == '1') : ?>checked="checked"<?php endif; ?>>
                                        飛脚クール便（冷蔵）</label>

                                    <label class="radio-label-binshu" for="comiket_detail_outbound_binshu_kbn_sel3" style="white-space: nowrap;vertical-align: middle;">
                                        <input id="comiket_detail_outbound_binshu_kbn_sel3" name="comiket_detail_outbound_binshu_kbn_sel" type="radio" value="2" style="vertical-align: middle;"
                                               <?php if ($eve001Out->comiket_detail_outbound_binshu_kbn_sel() == '2') : ?>checked="checked"<?php endif; ?>>
                                        飛脚クール便（冷凍）</label>
                                    <br>
                                    <strong class="red">
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    ...
                                                    <?php if ($eve001Out->comiket_detail_outbound_binshu_kbn_sel() != '' 
                                                            && $eve001Out->comiket_detail_outbound_binshu_kbn_sel() != null) : ?>
                                                        <table>
...
<!--                                        <strong class="red msg-hikyaku_coolbin">※ 飛脚クール便を発送される方は、必ずご利用予定日の15時までに宅配カウンターへお荷物をお持ち込みください。15時を過ぎますと、お引受けができなくなります。</strong>
                            ...
                            <dl class="service-outbound-item" service-id="2">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_cargo_outbound_num_ary')) { echo ' class="form_error"'; } ?> >
                                    <div class="comiket-cargo-outbound-num" div-id="<?php echo Sgmov_View_Sso_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                    </div>
                                    <div class="comiket-cargo-outbound-num" div-id="<?php echo Sgmov_View_Sso_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                    </div>
                                        <div style="">
...
<?php
                                                echo Sgmov_View_Sso_Input::_createPulldown($eve001Out->comiket_cargo_outbound_num_cds(), $eve001Out->comiket_cargo_outbound_num_lbls(), $eve001Out->comiket_cargo_outbound_num_sel());
?>
                                            </select>-->
                            ...
                            <dl class="service-outbound-item" service-id="3">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_charter_outbound_num')) { echo ' class="form_error"'; } ?>>
                                    <div class="comiket-charter-outbound-num" div-id="<?php echo Sgmov_View_Sso_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
