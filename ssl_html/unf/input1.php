...
// Basic認証
require_once dirname(__FILE__) . '/../../lib/component/auth_unf.php';
...
?>
            <div class="section other">
                <form action="/<?=$dirDiv?>/check_input" data-feature-id="<?php echo Sgmov_View_Unf_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Unf_Common::GAMEN_ID_UNF001 ?>" method="post">
...
?>
    ...
    data-G_DEV_INDIVIDUAL="<?php echo Sgmov_View_Unf_Common::COMIKET_DEV_INDIVIDUA; ?>"
    data-G_DEV_BUSINESS="<?php echo Sgmov_View_Unf_Common::COMIKET_DEV_BUSINESS; ?>"
    data-ADD_DELIVERY_DAYS="<?php echo Sgmov_View_Unf_Common::ADD_DELIVERY_DAYS_END; ?>">
    </script>
    ...
    <script charset="UTF-8" type="text/javascript" src="/<?=$dirDiv?>/js/unf.js?<?php echo $strSysdate; ?>"></script>
</body>
</html>