...
<meta name="description" content="408エラー リクエスト時間切れ">
...
<title>408エラー リクエスト時間切れ｜<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/meta-ttl.php'); ?></title>
...
<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/header.php'); ?>
    <main id="main" role="main">
		<div class="pageTitle style01">
			<div class="comBox">
				<h1 class="topLead">ページのリクエストが時間切れとなりました。<em>408エラー</em></h1>
				<ul id="pagePath">
					<li><a href="/"><img class="home" src="/img/common/icon54.jpg" alt=""></a></li>
					<li>ページのリクエストが時間切れとなりました。</li>
				</ul>
			</div>
		</div>
		<div class="topBox comBox">
			<p class="text fadeInUp">ページのリクエストが時間切れとなりました。</p>
