 ...
 * #@-
 */
class Sgmov_View_Eve_ChangeDeliveryDate {
	...
	public function execute() {
		...
		if($addr != '172.16.1.5'){
			Sgmov_Component_Log::debug ( '非SMT社内Serverにて稼働' );
			if($referer != 'https://sgmvweb.sagawa-mov.co.jp/sgmv/cm0601/search' && $referer != 'http://10.57.224.32/sgmv/cm0601/search' && $referer != 'http://10.57.224.33/sgmv/cm0601/search' && $referer != 'http://10.57.56.17/sgmv/cm0601/search' && $referer != 'http://10.57.56.18/sgmv/cm0601/search' && $referer != 'https://sgmvweb-test.sagawa-mov.co.jp/sgmv/cm0601/search' && $referer != 'http://10.57.50.43/sgmv/cm0601/search'){
				Sgmov_Component_Log::debug ( '非本番Serverからのリクエスト' );
				exit;
			}
		}
