<?php
/**
 * 法人オフィス移転訪問見積もり申し込みを登録し、完了画面を表示します。
 * @package    ssl_html
 * @subpackage PCV
 * @author     M.Kokawa(SCS)
...
Sgmov_Lib::useView('pcv/Complete');
Sgmov_Lib::useForms(array('Error', 'PcvSession'));
/**#@-*/

// 処理を実行
$view = new Sgmov_View_Pcv_Complete();
$forms = $view->execute();

/**
 * フォーム
 * @var Sgmov_Form_Pcv003Out
 */
$pcv003Out = $forms['outForm'];
?>
<!DOCTYPE html>
...
<head>
    ...
    <meta property="og:url" content="https://www.sagawa-mov.co.jp/pcv/complete/">
    ...
    <title>オフィス移転訪問お見積りフォームの送信完了｜<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/meta-ttl.php'); ?></title>
...
<body>
    ...
    <div id="main">
        <div class="pageTitle style01">
            <div class="comBox">
                <h1 class="topLead">オフィス移転訪問お見積りフォームの送信完了<em>Complete</em></h1>
                <ul id="pagePath">
