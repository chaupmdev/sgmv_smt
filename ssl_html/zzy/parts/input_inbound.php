...
<?php /**********************************************************************************************************************/ ?>
                        <div class="dl_block input-inbound comiket_block">
                            ...
                            <dl>
                                ...
                                ?>>
                                <input class="w_80Per" autocapitalize="off" inputmode="comiket_detail_inbound_name" name="comiket_detail_inbound_name" data-pattern="" placeholder="" type="text" value="<?php echo $eve001Out->comiket_detail_inbound_name() ?>" />
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_detail_inbound_zip')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <span class = "fs12px" style="display: inline-block !important;" class="forget-address-discription">
                                        &#12288;※郵便番号が不明な方は<a class = "txt-underline" target="_blank" href="http://www.post.japanpost.jp/zipcode/">こちら...</a>
                                    </span>
                                </dd>
                            </dl>
                            <dl>
...
<?php
        echo Sgmov_View_Zzy_Input::_createPulldown($eve001Out->comiket_detail_inbound_pref_cds(), $eve001Out->comiket_detail_inbound_pref_lbls(), $eve001Out->comiket_detail_inbound_pref_cd_sel());
?>
                                    </select>
                                    <br/>
                                    <br/>
                                   <!--  <strong class="red">
                                        ...
                                        <br /><a href="/pdf/kokubin_goriyoujyono_tyui.pdf" target="_blank" class = "clr-link txt-underline">航空便ご利用上の注意はこちら</a>
                                        <br /><a href="/pdf/kokutakuhaibinnado_unso_yakkan.pdf" target="_blank" class = "clr-link txt-underline">航空宅配便等個建運送約款はこちら</a>
                                    </strong> -->
                                </dd>
                            </dl>
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_detail_inbound_address')) { echo ' class="form_error"'; } ?>>
                                    <input class="w_80Per" maxlength="14" autocapitalize="off" name="comiket_detail_inbound_address" placeholder="例）江東区新砂" type="text" value="<?php echo $eve001Out->comiket_detail_inbound_address();?>" />
                                </dd>
                            </dl>
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_detail_inbound_building')) { echo ' class="form_error"'; } ?>>
                                    <input class="w_80Per" maxlength="30" autocapitalize="off" name="comiket_detail_inbound_building" placeholder="例）1-8-2" type="text" value="<?php echo $eve001Out->comiket_detail_inbound_building();?>" />
                                </dd>
                            </dl>
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_detail_inbound_tel')) { echo ' class="form_error"'; } ?>>
                                    <input autocapitalize="off" class="number-p-only w_50Per" maxlength="15" name="comiket_detail_inbound_tel" data-pattern="^[0-9-]+$" placeholder="例）075-1234-5678" type="text" value="<?php echo $eve001Out->comiket_detail_inbound_tel();?>" />
                                </dd>
                            </dl>
                            <dl>
                                <dt id="comiket_detail_inbound_collect_date">
                                    お預かり日・場所<span>必須</span>
                                </dt>
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_detail_inbound_collect_date')) { echo ' class="form_error"'; } ?>>
                                    <?php 
                                        $displaySetting = "block";
                                        if(isset($dispItemInfo["eventsub_selected_data"]["is_eq_inbound_collect"]) && $dispItemInfo["eventsub_selected_data"]["is_eq_inbound_collect"]) :
                                            echo @$dispItemInfo["eventsub_selected_data"]["inbound_collect_fr"];
                                            $displaySetting = "none";
                                        else: 
                                    ?>
...
<?php
            echo Sgmov_View_Zzy_Input::_createPulldown($eve001Out->comiket_detail_inbound_collect_time_cds(), $eve001Out->comiket_detail_inbound_collect_time_lbls(), $eve001Out->comiket_detail_inbound_collect_time_sel());
?>
                                            </select>
                                        </span>
                                    </div>
                                    <br>
                                   <!--  <strong class="red lhn">会場内宅配カウンター開設日時　2020年11月28日（土）、2020年11月29日（日）10:00～17:30 です。 </strong>
                                    <br>
                                    <div class = "dsp-inbl vat lhn">
                                        <img src="/images/common/img_icon_pdf.gif" class = "vat" width="18" height="21" alt="">
                                            <a class = "clr-blue fwn" href="/zzy/pdf/manual/会場内宅配受付カウンター場所.pdf<?php //echo '?' . $strSysdate; ?>" target="_blank">会場内宅配受付カウンター場所</a>
                                    </div> -->
                                </dd>
                            </dl>
                                    ...
                                    <div class="comiket_detail_inbound_delivery_date_parts">
                                        ...
                                        時間帯
                                            <select name="comiket_detail_inbound_delivery_time_sel">
                                                <option value="">時間帯を選択</option>
<?php
            echo Sgmov_View_Zzy_Input::_createPulldown($eve001Out->comiket_detail_inbound_delivery_time_cds(), $eve001Out->comiket_detail_inbound_delivery_time_lbls(), $eve001Out->comiket_detail_inbound_delivery_time_sel());
?>
                                            </select>
                                        </span>
                                        <br/>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_box_inbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <div class="comiket-box-inbound-num comiket-box-inbound-num-dmy"> <!-- 個人・法人 どちらでも -->
                                            <table>
                                                <tr>
                                                            ...
                                                            <?php foreach($dispItemInfo['inbound_box_lbls'] as $key => $val) : ?>
                                                                <tr class ="box_<?php echo $val['size_display'];?>">
                                                                    ...
                                                                    <td class='comiket_box_item_value'>
                                                                        <input autocapitalize="off" style ="min-width: 100px;" class="number-only comiket_box_item_value_input"maxlength="2" inputmode="numeric" name="comiket_box_inbound_num_ary[<?php echo $val["id"]; ?>]" data-pattern="^\d+$" placeholder="例）1" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $eve001Out->comiket_box_inbound_num_ary($val["id"]);?>" />個
                                                                        &nbsp;
                                                                    </td>
                                                                </tr>
                                                            <?php endforeach; ?>
                                                    ...
                                                    <td class="dispSeigyoPC vam tar">
                                                        <?php if($eve001Out->comiket_div() == Sgmov_View_Zzy_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
                                                            <img src='/zzy/images/about_boxsize.png' width='100%'/>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <?php if($eve001Out->comiket_div() == Sgmov_View_Zzy_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
                                    <div class="dispSeigyoSP mt1em">
                                        <img src='/zzy/images/about_boxsize.png' class ="mt1em" width='250px' />
                                    </div>
                                    <?php else: ?>
                                    <?php endif; ?>
                                    <br/>
                                   <!--  <div class="outbound_example_boxsize example_boxsize">
                                        ...
                                        <strong class="red">※ １申込み４０個を超える場合は、ＳＧムービング/ベイクルーズグループ　ファミリーセール 2020年末優待販売会係り 03-5857-2462 もしくはカウンタースタッフへお問い合わせください。</strong><br/>
                                        <a href="/zzy/pdf/example/example_box_size.pdf" target="_blank" class = "clr-blue">目安表</a>
                                    </div> -->
                                </dd>
                            </dl>
                            <dl class="service-inbound-item" service-id="2">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_cargo_inbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <div class="comiket-cargo-inbound-num" div-id="<?php echo Sgmov_View_Zzy_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                    </div>
                                    <div class="comiket-cargo-inbound-num" div-id="<?php echo Sgmov_View_Zzy_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                    </div>
                                    <div class="">
                            ...
                            <dl class="service-inbound-item" service-id="3">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_charter_inbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <div class="comiket-charter-inbound-num" div-id="<?php echo Sgmov_View_Zzy_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                        <input autocapitalize="off" class="w_10Per" maxlength="3" inputmode="numeric" name="comiket_charter_inbound_num_ary[0]" data-pattern="^\d+$" placeholder="例）7" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $eve001Out->comiket_charter_inbound_num_ary("0");?>" />台
                                    </div>
                                    <div class="comiket-charter-inbound-num" div-id="<?php echo Sgmov_View_Zzy_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                        <table>
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_detail_inbound_note')) { echo ' class="form_error"'; } ?>>
                                    <input autocapitalize="off" class="w_50Per" maxlength="16" inputmode="text" name="comiket_detail_inbound_note1" placeholder="" type="text" value="<?php echo $eve001Out->comiket_detail_inbound_note1();?>" /><br/>
                                </dd>
                            </dl>
                        </div>