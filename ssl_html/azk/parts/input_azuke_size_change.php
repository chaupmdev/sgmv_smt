...
?>
                            ...
                            <dl class="comiket_detail_service_sel" style="display: none;">
                                <dt id="comiket_detail_service_sel">
                                    サービス選択
                                </dt>
                                <dd<?php
                                    if (isset($e)
                                       && ($e->hasErrorForId('comiket_detail_service_sel'))
                                    ) {
                                        echo ' class="form_error"';
                                    }
                                ?>>
                                    ...
                                    <?php foreach($dispItemInfo['comiket_detail_service_lbls'] as $key => $val) : ?>
                                        <label class="radio-label" for="comiket_detail_service_sel<?php echo $key; ?>">
                                            <input<?php if ($eve001Out->comiket_detail_service_sel() == $key) echo ' checked="checked"'; ?> id="comiket_detail_service_sel<?php echo $key; ?>" name="comiket_detail_service_sel" type="radio" value="<?php echo $key; ?>" />
                                            <?php echo $val; ?>
                                        </label>
                                    <?php endforeach; ?>
                                    <div class='comiket_detail_service_sel2'>
                            ...
                            <dl class="service-inbound-item" service-id="1">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_box_num')) { echo ' class="form_error"'; } ?>>
                                    <div class="comiket-box-num comiket-box-inbound-num-dmy"> <!-- 個人・法人 どちらでも -->
                                        <table>
                                            <tr>
                                                <td>
                                                    <table>
                                                    <?php foreach($dispItemInfo['comiket_box_lbls'] as $key => $val) : ?>
                                                        <tr>
                                                            ...
                                                            <td class='comiket_box_item_value'>
                                                                <input autocapitalize="off" class="number-only comiket_box_item_value_input" style="" maxlength="2" inputmode="numeric" name="comiket_box_num_ary[<?php echo $val["id"]; ?>]" data-pattern="^\d+$" placeholder="例）1" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $eve001Out->comiket_box_num_ary($val["id"]);?>" />個
                                                                &nbsp;
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                               ...
                                               <!--  <td class="dispSeigyoPC" style='vertical-align: middle;text-align: right;'>
                                                    <img src='/azk/images/about_boxsize.png' width='100%'/>
                                                </td> -->
                                            </tr>
                                        </table>
                                    </div>
                                   <!--  <div class="dispSeigyoSP" style="margin-top: 1em;">
                                        <img src='/azk/images/about_boxsize.png' width='250px' style='margin-top: 1em;' />
                                    </div> -->
                                </dd>
                            </dl>
                        </div>