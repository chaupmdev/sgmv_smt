...
class Sgmov_Form_Bpn001Out {
     ...
     * @var string
     */
    public $raw_comiket_box_buppan_num_ary = array();

    /**
     * 在庫商品コード
     * @var string
     */
    public $raw_comiket_box_buppan_ziko_shohin_cd_ary = array();
...
////////////////////////////////////////////////////////////////////////////////
     ...
     * @var string
     */
    public $raw_collect_year_cd_sel = '';

    /**
     * 商品引き渡し日-年 リスト
     * @var array
     */
    public $raw_collect_year_cds = array();

    /**
     * 商品引き渡し日-年 ラベルリスト
     * @var array
     */
    public $raw_collect_year_lbls = array();

    /**
     * 商品引き渡し日-月 選択値
     * @var string
     */
    public $raw_collect_month_cd_sel = '';

    /**
     * 商品引き渡し日-月 リスト
     * @var array
     */
    public $raw_collect_month_cds = array();

    /**
     * 商品引き渡し日-月 ラベルリスト
     * @var array
     */
    public $raw_collect_month_lbls = array();

    /**
     * 商品引き渡し日-日 選択値
     * @var string
     */
    public $raw_collect_day_cd_sel = '';

    /**
     * 品引き渡し日-日 リスト
     * @var array
     */
    public $raw_collect_day_cds = array();

    /**
     * 商品引き渡し日-日 ラベルリスト
     * @var array
     */
    public $raw_collect_day_lbls = array();

    /**
     * 数量
     * @var string
     */
    public $raw_comiket_box_buppan_num_sel = array();

    /**
     * 数量-idリスト
     * @var string
     */
    public $raw_comiket_box_buppan_num_ids = array();

    /**
     * 数量-nameリスト
     * @var string
     */
    public $raw_comiket_box_buppan_num_lbls = array();
    ...
    /**
     * エンティティ化された物販数量返します。
     * @return string エンティティ化された物販数量
     */
    public function comiket_box_buppan_num_ary($key="cmp") {
        if(!isset($this->raw_comiket_box_buppan_num_ary[$key])) {
            return "";
        }
        return Sgmov_Component_String::htmlspecialchars(@$this->raw_comiket_box_buppan_num_ary[$key]);
    }
     ...
     * @return string エンティティ化された物販数量
     */
    public function comiket_box_buppan_ziko_shohin_cd_ary($key="cmp") {
        if(!isset($this->raw_comiket_box_buppan_ziko_shohin_cd_ary[$key])) {
            return "";
        }
        return Sgmov_Component_String::htmlspecialchars(@$this->raw_comiket_box_buppan_ziko_shohin_cd_ary[$key]);
    }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    /**
     * エンティティ化された物販タイプを返します。
     * @return string エンティティ化された受渡場所
     */
    public function bpn_type() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_bpn_type);
    }

    /**
     * エンティティ化された商品パターンプを返します。
     * @return string エンティティ化された受渡場所
     */
    public function shohin_pattern() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_shohin_pattern);
    }

     /**
     * エンティティ化された商品引き渡し日-年 選択値を返します。
     * @return string エンティティ化された都道府県コード選択値
     */
    public function collect_year_cd_sel() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_collect_year_cd_sel);
    }

    /**
     * エンティティ化された商品引き渡し日-年 リストを返します。
     * @return array エンティティ化された商品引き渡し日-年 リスト
     */
    public function collect_year_cds() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_collect_year_cds);
    }

    /**
     * エンティティ化された商品引き渡し日-年 ラベルリストを返します。
     * @return array エンティティ化された商品引き渡し日-年 ラベルリスト
     */
    public function collect_year_lbls() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_collect_year_lbls);
    }

     /**
     * エンティティ化された商品引き渡し日-月 選択値を返します。
     * @return string エンティティ化された商品引き渡し日-月 選択値
     */
    public function collect_month_cd_sel() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_collect_month_cd_sel);
    }

    /**
     * エンティティ化された商品引き渡し日-月 リストを返します。
     * @return array エンティティ化された商品引き渡し日-月 リスト
     */
    public function collect_month_cds() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_collect_month_cds);
    }

    /**
     * エンティティ化された商品引き渡し日-月 ラベルリストを返します。
     * @return array エンティティ化された品引き渡し日-月 ラベルリスト
     */
    public function collect_month_lbls() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_collect_month_lbls);
    }

    /**
     * エンティティ化された商品引き渡し日-日 選択値を返します。
     * @return string エンティティ化された商品引き渡し日-日 選択値
     */
    public function collect_day_cd_sel() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_collect_day_cd_sel);
    }

    /**
     * エンティティ化された商品引き渡し日-日 リストを返します。
     * @return array エンティティ化された商品引き渡し日-日 リスト
     */
    public function collect_day_cds() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_collect_day_cds);
    }

    /**
     * エンティティ化された商品引き渡し日-日 ラベルリストを返します。
     * @return array エンティティ化された商品引き渡し日-日 ラベルリスト
     */
    public function collect_day_lbls() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_collect_day_lbls);
    }

    /**
     * エンティティ化された数量を返します。
     * @return string エンティティ化された数量
     */
    public function comiket_box_buppan_num_sel($key="cmp") {
        if(!isset($this->raw_comiket_box_buppan_num_sel[$key])) {
            return "";
        }
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_box_buppan_num_sel[$key]);
    }

    /**
     * エンティティ化された数量-idリストを返します。
     * @return string エンティティ化された数量-idリスト
     */
    public function comiket_box_buppan_num_ids() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_box_buppan_num_ids);
    }
     ...
     * @return string エンティティ化されたブース位置-ラベルリスト
     */
    public function comiket_box_buppan_num_lbls() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_box_buppan_num_lbls);
    }
