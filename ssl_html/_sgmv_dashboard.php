...
//****************************************
    ...
    //$DASHOBOARD_SVR = $_SERVER['REMOTE_ADDR'];
    //$DASHOBOARD_SVR = 'Release';
    $DASHOBOARD_SVR = 'Develop';
switch($DASHOBOARD_SVR)
{
    case 'Develop':
    case '172.16.1.5':
        ...
        <table class="table_page">
            <tr>
                ...
                イベント <select name='event' id="event" >
                 ...
                 <select name='eventsub' id="eventsub"></select></div>
        ...
        ?>
                ...
                <?php }?>
                    ...
                    <?php if($result[$key]['キャンセル']!='キャンセル'){ ?>
                        <td style="display: none;"><p class="text_center"><input type="button" class="btn btn--blue" name="mofifi" onclick="change_num('<?= $result[$key]['申込番号10桁'] ?>')" value="変更"></p></td>
