 ...
 * @copyright  2009-2010 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
abstract class Sgmov_View_Pcr_Common extends Sgmov_View_Public {
    /**
     * 機能ID
     */
    const FEATURE_ID = 'PCR';
    
    const FEATURE_ID_IVR = 'PCR_IVR';

    /**
     * PCR001の画面ID
     */
    const GAMEN_ID_PCR001 = 'PCR001';

    /**
     * PCR002の画面ID
     */
    const GAMEN_ID_PCR002 = 'PCR002';

    /**
     * PCR003の画面ID
     */
    const GAMEN_ID_PCR003 = 'PCR003';
    
    const PCR_IVR_REQUEST = 1;

    const PCR_WEB_REQUEST = 2;
    
    const COLLECT_DATE_END = '-4 day'; //５日前から８日前に変更したのものから4日前に変更
    const COLLECT_DATE_START = '-8 day'; //１１日前から１５日前に変更したものから8日前に変更
    const SITE_FLAG = '2';//那覇版
    /**
     * 集荷の往復コード選択値
     * @var array
     */
