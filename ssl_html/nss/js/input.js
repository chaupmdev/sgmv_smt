...
//    getEventsubData();
    // 搬入・搬出のラジオボタンが選択された場合、それぞれの入力項目を表示する
    $('input#comiket_detail_type_sel1').attr("checked", true);
...
//        dispComiketDetailInboundDeliveryTimeByDivAndType();
    ...
    $('input[name="comiket_detail_type_sel"]').on('change', dispOutBoundInBound);
...
//                    htmlCode += "<img src='/"+dirDiv+"/images/about_boxsize.png' width='100%' style='visibility:hidden;'/>";
                ...
                htmlCode += "</td>";
                if($('input[name="comiket_div"]:checked').val() ==  G_DEV_INDIVIDUAL) {
                   // htmlCode += "<img class='dispSeigyoPC' src='/nss/images/about_boxsize.png' width='100%'/>";
                }
                htmlCode += "</tr></table>";
                // 搬入
                $('.comiket-box-outbound-num').append(htmlCode);
                ...
                htmlCode2 += "</td>";
                if($('input[name="comiket_div"]:checked').val() ==  G_DEV_INDIVIDUAL) {
                  //  htmlCode2 += "<img class='dispSeigyoPC' src='/nss/images/about_boxsize.png' width='100%'/>";
                }
                htmlCode2 += "</tr></table>";
