...
<?php
        echo Sgmov_View_Nss_Input::_createPulldown($eve001Out->comiket_detail_outbound_pref_cds(), $eve001Out->comiket_detail_outbound_pref_lbls(), $eve001Out->comiket_detail_outbound_pref_cd_sel());
?>
                                    </select>
                                    <br/>
                                    <br/>
    ...
    <?php
            echo Sgmov_View_Nss_Input::_createPulldown($eve001Out->comiket_detail_outbound_collect_time_cds(), $eve001Out->comiket_detail_outbound_collect_time_lbls(), $eve001Out->comiket_detail_outbound_collect_time_sel());
    ?>
                                            </select>
                                        </span>
                                    </div>
                                    ...
                                    <div class="comiket_detail_outbound_delivery_date_parts">
                                        ...
                                        <span class="comiket_detail_outbound_delivery_time_sel">
                                            ...
                                            <select name="comiket_detail_outbound_delivery_time_sel">
                                                <option value="">時間帯を選択</option>
    <?php
            echo Sgmov_View_Nss_Input::_createPulldown($eve001Out->comiket_detail_outbound_delivery_time_cds(), $eve001Out->comiket_detail_outbound_delivery_time_lbls(), $eve001Out->comiket_detail_outbound_delivery_time_sel());
    ?>
                                            </select>
                                        </span>
                                    </div>
                                    <div class="eventsub_dl_link">
                                        ...
                                        <a style="color: blue;" href="<?=$dispItemInfo['dispEvent']['takuhai']?>" target="_blank">引き渡し場所</a>
                                    </div>
                                </dd>
                            </dl>
                            ...
                            <dl class="service-outbound-item" service-id="2">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_cargo_outbound_num_ary')) { echo ' class="form_error"'; } ?> >
                                    <div class="comiket-cargo-outbound-num" div-id="<?php echo Sgmov_View_Nss_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                    </div>
                                    <div class="comiket-cargo-outbound-num" div-id="<?php echo Sgmov_View_Nss_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                    </div>
                                        <div style="">
                            ...
                            <dl class="service-outbound-item" service-id="3">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_charter_outbound_num')) { echo ' class="form_error"'; } ?>>
                                    <div class="comiket-charter-outbound-num" div-id="<?php echo Sgmov_View_Nss_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                            ...
                            <dl>
                                ...
                                <dd<?php
                                    if (isset($e)
                                       && ($e->hasErrorForId('comiket_detail_caremark_flg'))
                                    ) {
                                        echo ' class="form_error"';
                                    }
                                ?>
                                >
                                    ...
                                    <div style="margin-top:7px; margin-bottom: 7px;">
                                        <a style="margin-left: 5px;color:blue;text-decoration: underline; font-size: 19px" onclick="EnableCaremarkFlg();" href="https://www.sagawa-exp.co.jp/send/howto-packing/" target="_blank" class="comiket_detail_caremark_flg_link" >梱包ガイドラインについて(動画)</a>
                                    </div>
                                    <div>
                                        <a style="margin-left: 5px;color:blue;text-decoration: underline;font-size: 19px" onclick="EnableCaremarkFlg();" href="https://www.sagawa-exp.co.jp/send/howto-packing/heavy.html" target="_blank" class="comiket_detail_caremark_flg_link" >重量物の梱包について(動画)</a>
                                    </div>
                                    <div style="margin-top: 5px;">
                                        <input id="comiket_detail_caremark_flg" <?php if (@$eve001Out->comiket_detail_caremark_flg_enable() != '1') { ?> disabled="disabled" <?php } ?> class="class_comiket_detail_caremark_flg" <?php if ($eve001Out->comiket_detail_caremark_flg() == '1') { ?> checked="checked" <?php } ?> name="comiket_detail_caremark_flg" type="checkbox"/>
                                        <label for="comiket_detail_caremark_flg">梱包ガイドラインに従って発送致します</label>
                                        <br/><strong class="red" style = "font-size: 18px;">※ 外装異常が発生した際に、中身の確認をさせて頂きます。</strong>
                                    </div>
                                    <br/>
                                    <input id="comiket_detail_caremark_flg_enable" name="comiket_detail_caremark_flg_enable" type="hidden" value="<?php echo $eve001Out->comiket_detail_caremark_flg_enable(); ?>" />
                                </dd>
                            </dl>
                            <!-- GiapLN add  梱包ガイドライン2022.07.13 END --> 
                        </div>