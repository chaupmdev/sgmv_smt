...
// 処理を実行
$view = new Sgmov_View_Nss_SizeChangeConfirm();
$forms = $view->execute();
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <div class="section">
                <form action="/<?=$dirDiv?>/size_change_complete" data-feature-id="<?php echo Sgmov_View_Nss_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Nss_Common::GAMEN_ID_NSS001 ?>" method="post">
