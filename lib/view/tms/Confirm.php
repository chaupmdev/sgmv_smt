 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Tms_Confirm extends Sgmov_View_Tms_Common {
...
//        $this->_TravelDeliveryChargeAreasService = new Sgmov_Service_TravelDeliveryChargeAreas();
    ...
    public function executeInner() {
        ...
        // 無料boxId
        $boxInfo = $this->getFreeBoxInfoInInForm($inForm);

        if (@!empty($boxInfo)) {
            $dispItemInfo['box_id_free'] = $boxInfo['boxId'];
            $dispItemInfo['free_num'] = $boxInfo['freeNum'];
        }
