...
<meta name="description" content="石川県の大雨に伴う配送への影響について（2024年9月25日15時現在）">
...
<title>石川県の大雨に伴う配送への影響について（2024年9月25日15時現在）｜お知らせ｜<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/meta-ttl.php'); ?></title>
		...
		<div class="mainBox" data-stt-ignore>
			<article id="conts">
				<div class="titleBox fadeInUp">
					<p class="time">2024.09.25<span class="cat-news">お知らせ</span></p>
					<p class="title">石川県の大雨に伴う配送への影響について（2024年9月25日15時現在）</p></div>
				<div class="wpBox fadeInUp">
                    <p  style="font-weight: bold; color:#3B4A9F;">重要なお知らせ</p>
                    <br>
                    <p>2024.09.25</p>
                    <br>
                    <p>お客さま各位</p>
...
<td>石川県</td><td>輪島市、珠洲市、鳳珠郡能登町</td>
                    ...
                    <br>
                    <p style="font-weight: bold; color:#ff0000;">※全国から上記地域向けへのお荷物は<span style="text-decoration: underline;" >遅延了承のうえお預かり（荷受け）しております。</span></p>  
                    <br>
