...
<?php /**********************************************************************************************************************/ ?>
                        <div class="dl_block input-inbound comiket_block">
                            ...
                            <dl>
                                ...
                                <dd>
<?php
        echo Sgmov_View_Rms_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_inbound_pref_cds(), $eve001Out->comiket_detail_inbound_pref_lbls(), $eve001Out->comiket_detail_inbound_pref_cd_sel());
?>
                                </dd>
                            </dl>
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <?php endif; ?>
                                        <div class="comiket_detail_inbound_collect_date_parts" style="display:<?php echo $displaySetting; ?>">
                                            <?php echo $eve001Out->comiket_detail_inbound_collect_date_year_sel();?>年<?php echo $eve001Out->comiket_detail_inbound_collect_date_month_sel();?>月<?php echo $eve001Out->comiket_detail_inbound_collect_date_day_sel(); ?>日
                                              &nbsp;
<?php
                //echo Sgmov_View_Rms_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_inbound_collect_time_cds(), $eve001Out->comiket_detail_inbound_collect_time_lbls(), $eve001Out->comiket_detail_inbound_collect_time_sel());
?>  
                            ...
                            <dl class="comiket_detail_inbound_delivery_date">
                                ...
                                <dd>
                                    ...
                                    <div class="comiket_detail_inbound_delivery_date_parts">
                                        <?php echo $eve001Out->comiket_detail_inbound_delivery_date_year_sel();?>年<?php echo $eve001Out->comiket_detail_inbound_delivery_date_month_sel();?>月<?php echo $eve001Out->comiket_detail_inbound_delivery_date_day_sel(); ?>日
                                        &nbsp;
                                        <span class="comiket_detail_inbound_delivery_time_sel" >

<?php
            echo Sgmov_View_Rms_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_inbound_delivery_time_cds(), $eve001Out->comiket_detail_inbound_delivery_time_lbls(), $eve001Out->comiket_detail_inbound_delivery_time_sel());
?>
                                        </span>
<!--                                        <strong class="red">※ 天災、交通状況の影響により、希望に添えない可能性があります。</strong>-->
                            ...
                            <dl class="service-inbound-item" service-id="1">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_box_inbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                    <div class="comiket-box-inbound-num1 comiket-box-inbound-num-dmy"> <!-- 個人・法人 どちらでも -->
                                        <?php // if($eve001Out->comiket_div() == Sgmov_View_Rms_Common::COMIKET_DEV_BUSINESS) : ?>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <table>
                                                    ...
                                                    <td class="dispSeigyoPC" style='vertical-align: middle;text-align: right;'>
                                                        <?php if($eve001Out->comiket_div() == Sgmov_View_Rms_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
                                                            <img src='/rms/images/about_boxsize.png' width='100%'/>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <div class="dispSeigyoSP" style="margin-top: 1em;">
                                        <img src='/rms/images/about_boxsize.png' width='250px' style='margin-top: 1em;' />
                                    </div>
                                    <?php else: ?>
                                    <!--<img src='/rms/images/about_boxsize.png' width='100%'/>-->
                                    <?php endif; ?>
                                    ...
                                    <div class="outbound_example_boxsize example_boxsize">
                                        ...
                                        <a href="/rms/pdf/example/example_box_size.pdf" target="_blank" style="color:blue;">目安表</a>
                                    </div>
                                </dd>
                            </dl>
                            ...
                            <dl class="service-inbound-item" service-id="2">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_cargo_inbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <div class="comiket-cargo-inbound-num" div-id="<?php echo Sgmov_View_Rms_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                    </div>
                                    <div class="comiket-cargo-inbound-num" div-id="<?php echo Sgmov_View_Rms_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                    </div>
                                    <div class="">
...
<?php
                                        echo Sgmov_View_Rms_Input::_createPulldown($eve001Out->comiket_cargo_inbound_num_cds(), $eve001Out->comiket_cargo_inbound_num_lbls(), $eve001Out->comiket_cargo_inbound_num_sel());
?>
                                            </select>台-->
                                    </div>
                                </dd>
                            ...
                            <dl class="service-inbound-item" service-id="3">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_charter_inbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <div class="comiket-charter-inbound-num" div-id="<?php echo Sgmov_View_Rms_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                    ...
                                    <div class="comiket-charter-inbound-num" div-id="<?php echo Sgmov_View_Rms_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                        <table>
