 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Owk_CheckInput extends Sgmov_View_Owk_Common {
    ...
    public function executeInner() {
        ...
        // チケットの確認と破棄
        $session->checkTicket(self::FEATURE_ID, self::GAMEN_ID_OWK001, $this->_getTicket());
    ...
    public function _redirectProc($inForm, $errorForm) {
        if ($errorForm->hasError()) {
            Sgmov_Component_Redirect::redirectPublicSsl('/owk/input');
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if($inForm->comiket_detail_type_sel == "2" || $inForm->comiket_detail_type_sel == "3") { // 搬出の場合
            ...
            if (!$v->isValid()) {
                ...
                // $prefName = @isset($prefectures["names"][$prefectures["ids"][$inForm->comiket_detail_inbound_pref_cd_sel]]) ? 
                //     $prefectures["names"][$prefectures["ids"][$inForm->comiket_detail_inbound_pref_cd_sel]] : NULL;
