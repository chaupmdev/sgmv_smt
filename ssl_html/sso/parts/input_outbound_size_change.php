...
<?php /**********************************************************************************************************************/ ?>
                        <div class="dl_block input-outbound comiket_block">
                            ...
                            <dl>
                                ...
                                <dd>
<?php
        echo Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_pref_cds(), $eve001Out->comiket_detail_outbound_pref_lbls(), $eve001Out->comiket_detail_outbound_pref_cd_sel());
?>
...
<?php
        echo Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_collect_date_year_cds(), $eve001Out->comiket_detail_outbound_collect_date_year_lbls(), $eve001Out->comiket_detail_outbound_collect_date_year_sel());
?>年
                                        </span>
                                        <span class="comiket_detail_outbound_collect_date">
<?php
        echo Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_collect_date_month_cds(), $eve001Out->comiket_detail_outbound_collect_date_month_lbls(), $eve001Out->comiket_detail_outbound_collect_date_month_sel());
?>月
                                        </span>
                                        <span class="comiket_detail_outbound_collect_date">
<?php
            echo Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_collect_date_day_cds(), $eve001Out->comiket_detail_outbound_collect_date_day_lbls(), $eve001Out->comiket_detail_outbound_collect_date_day_sel());
?>日
                                        </span>
                                        &nbsp;
                                        <span class="comiket_detail_outbound_collect_time_sel">
    <?php
            echo Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_collect_time_cds(), $eve001Out->comiket_detail_outbound_collect_time_lbls(), $eve001Out->comiket_detail_outbound_collect_time_sel());
    ?>
                                        </span>
                                    </div>
                                </dd>
...
<?php
        echo Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_delivery_date_year_cds(), $eve001Out->comiket_detail_outbound_delivery_date_year_lbls(), $eve001Out->comiket_detail_outbound_delivery_date_year_sel());
?>年
                                        </span>
                                        <span class="comiket_detail_outbound_delivery_date">
<?php
        echo Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_delivery_date_month_cds(), $eve001Out->comiket_detail_outbound_delivery_date_month_lbls(), $eve001Out->comiket_detail_outbound_delivery_date_month_sel());
?>月
                                        </span>
                                        <span class="comiket_detail_outbound_delivery_date">
<?php
        echo Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_delivery_date_day_cds(), $eve001Out->comiket_detail_outbound_delivery_date_day_lbls(), $eve001Out->comiket_detail_outbound_delivery_date_day_sel());
?>日
                                        </span>
                                        &nbsp;
                                        <span class="comiket_detail_outbound_delivery_time_sel2">
                                            13:00～19:00
<?php
//        echo Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_delivery_time_cds(), $eve001Out->comiket_detail_outbound_delivery_time_lbls(), $eve001Out->comiket_detail_outbound_delivery_time_sel());
?>
                                        </span>
                                    </div>
                                </dd>
                            ...
                            <dl class="comiket_detail_outbound_binshu_kbn_sel">
                                ...
                                <dd>
                                    <label class="radio-label-binshu" for="comiket_detail_outbound_binshu_kbn_sel1" style="height: 10px;white-space: nowrap;">
                                        <input id="comiket_detail_outbound_binshu_kbn_sel1" name="comiket_detail_outbound_binshu_kbn_sel" type="radio" value="0" checked="checked" style="vertical-align: middle;"
