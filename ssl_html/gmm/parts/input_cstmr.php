...
<?php
            echo Sgmov_View_Gmm_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
?>
                                        &nbsp;&nbsp;
                                                    </span>
...
<?php
            echo Sgmov_View_Gmm_Input::_createPulldown($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel(), $eve001Out->eve_timeover_flg(), $eve001Out->eve_timeover_date());
?>
                                                    </select>
...
<?php
            echo Sgmov_View_Gmm_Input::_createPulldown($eve001Out->eventsub_cds(), $eve001Out->eventsub_lbls(), $eve001Out->eventsub_cd_sel());
?>
                                                    </select>
                                                        <br/>
<?php
        $eventName = Sgmov_View_Gmm_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
        $eventsubName = Sgmov_View_Gmm_Input::_getLabelSelectPulldownData($eve001Out->eventsub_cds(), $eve001Out->eventsub_lbls(), $eve001Out->eventsub_cd_sel());
        if(strpos($eventName,'ゲームマーケット') !== false){
        echo '<img src="/gmm/images/GM_rogo3.gif" width="40%">';
        }
?>
<?php
    // キャッシュ対策
                                                            ...
                                                            <tr>
                                                                <td style="vertical-align: top;padding-top:20px;width: 70%;">
                                                                    <div style=";display:none;" class="eventsub_dl_link paste_tag">
                                                                        ...
                                                                        <a style="color: blue;font-weight: normal;" class="paste_tag_link" href="/gmm/pdf/paste_tag/paste_tag_<?php echo $eve001Out->eventsub_cd_sel(); ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">貼付票（例）</a>
                                                                    </div>
                                                                    <br/>
...
<?php if ($eve001Out->input_mode() != '002') {  // 入力モードが"002"(コミケ)なら説明書のリンクは表示しない ?>
                                                        ...
                                                        <div class="eventsub_dl_link manual " style="display:none;">
                                                            ...
                                                            ※出展者手引きより、宅配便に関する内容を抜粋して掲示しています。<br><br>
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt=""><a style="color: blue;text-decoration: underline;font-weight: normal;" class="manual_link" href="/gmm/pdf/manual/<?php echo $eventName; ?><?php echo $eventsubName; ?>搬入.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">宅配便WEB申込みのご案内（出展社マニュアルより抜粋）</a>
                                                            からご確認ください。
                                                            </strong>
                                                        </div>
<?php } ?>
                            ...
                            <?php if ($userType === 1) :?>
                                <dl>
                                    ...
                                    <dd>
                                        <?php echo $_SESSION['GMM_LOGIN']['email'] ?>
                                    </dd>
                                </dl>
                            <?php endif; ?>
                            <!-- END -->
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_pref')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <select name="comiket_pref_cd_sel">
                                        <option value="">選択してください</option>
<?php
        echo Sgmov_View_Gmm_Input::_createPulldown($eve001Out->comiket_pref_cds(), $eve001Out->comiket_pref_lbls(), $eve001Out->comiket_pref_cd_sel());
?>
                                    </select>
                                </dd>
                            </dl>
                            ...
                            <dl class="class_building_name_sel">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('building_name_sel')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <select name="building_booth_position_sel">
                                        <option value="">選択してください</option>
<?php
                                         echo Sgmov_View_Gmm_Input::_createPulldown($eve001Out->building_booth_position_ids(), $eve001Out->building_booth_position_lbls(), $eve001Out->building_booth_position_sel());
?>
                                    </select>
