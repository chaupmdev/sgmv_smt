...
<?php
            echo Sgmov_View_Fmt_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
?>
                                        &nbsp;&nbsp;
                                                    </span>
...
<?php
            echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel(), $eve001Out->eve_timeover_flg(), $eve001Out->eve_timeover_date());
?>
                                                    </select>
...
<?php
            echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->eventsub_cds(), $eve001Out->eventsub_lbls(), $eve001Out->eventsub_cd_sel());
?>
                                                    </select>
                                                    <!--<div class="paste_tag">-->
                                                        <br/>
                                                    <!--</div>-->
<?php
        $eventName = Sgmov_View_Fmt_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
        $eventsubName = Sgmov_View_Fmt_Input::_getLabelSelectPulldownData($eve001Out->eventsub_cds(), $eve001Out->eventsub_lbls(), $eve001Out->eventsub_cd_sel());
        if(strpos($eventName,'デザインフェスタ') !== false){
        echo '<img src="/fmt/images/logo.gif">';
        }
?>
<?php
    // キャッシュ対策
...
?>
                                                    <img src="/fmt/images/logo_furusato.jpg" height="120px">
                                                    <div>
                                                        <label class="radio-label-comiket_customer_kbn" for="comiket_customer_kbn_sel1" style="height: 10px; white-space: normal;">
                                                            <input id="comiket_customer_kbn_sel1" class="comiket_customer_kbn" name="comiket_customer_kbn_sel" type="radio" value="1" checked="checked" style="vertical-align: middle;"
                                                                   <?php if ($eve001Out->comiket_customer_kbn_sel() == '1') : ?>checked="checked"<?php endif; ?>>出展者様 </label>
                                                        &nbsp;
                                                        <label class="radio-label-comiket_customer_kbn" for="comiket_customer_kbn_sel2" style="height: 10px;white-space: nowrap;">
                                                            <input id="comiket_customer_kbn_sel2" class="comiket_customer_kbn" name="comiket_customer_kbn_sel" type="radio" value="2" style="vertical-align: middle;"
                                                                   <?php if ($eve001Out->comiket_customer_kbn_sel() == '2') : ?>checked="checked"<?php endif; ?>>
                                                            一般のご利用者様（来場者様）</label>
                                                    </div>
...
<!--                                                        <div style="display:none;" class="eventsub_dl_link paste_tag">
                                                            ...
                                                            <a style="color: blue;" class="paste_tag_link" href="/fmt/pdf/paste_tag/paste_tag_<?php echo $eve001Out->eventsub_cd_sel(); ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">貼付票（例）</a>
                                                        </div>-->

                                                        <div class="eventsub_dl_link manual" style="display:none;">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;font-weight: bold;text-decoration: underline;" 
                                                               class="manual_link" href="/fmt/pdf/manual/<?php echo $eventName; ?><?php echo $eventsubName; ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">宅配便WEB申込みのご案内</a>
                                                        </div>
...
<!--                                                    <div class="pc_dl_area2">
                                                        <div style="margin-bottom:3px;display:none;" class="eventsub_dl_link pasete_tag">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;" class="paste_tag_link" href="/fmt/pdf/paste_tag/paste_tag_<?php echo $eve001Out->eventsub_cd_sel(); ?>.pdf" target="_blank">貼付票</a>
                                                        </div>
                                                        <br/>
                                                        <div class="eventsub_dl_link manual" style="display:none;">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
...
Sgmov_Component_Log::debug(@$dispItemInfo);
                            ...
                            <?php if ($userType === 1) :?>
                                <dl>
                                    ...
                                    <dd>
                                        <?php echo $_SESSION['FMT_LOGIN']['email'] ?>
                                    </dd>
                                </dl>
                            <?php endif; ?>
                            <!-- END -->
                            ...
                            <dl style="display:none;">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_pref')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <select name="comiket_pref_cd_sel">
                                        <option value="">選択してください</option>
<?php
        echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->comiket_pref_cds(), $eve001Out->comiket_pref_lbls(), $eve001Out->comiket_pref_cd_sel());
?>
                                    </select>
                                </dd>
                            </dl>
...
<!--                                    <select name="building_name_sel">
                                        <option value="">選択してください</option>
<?php
//                                        echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->building_name_ids(), $eve001Out->building_name_lbls(), $eve001Out->building_name_sel());
?>
                                    </select>-->
                                    <input type="hidden" name="building_name_sel" value="" >
                                    ...
                                    <select name="building_booth_position_sel" style="">
                                        <option value="">選択してください</option>
<?php
                                         echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->building_booth_position_ids(), $eve001Out->building_booth_position_lbls(), $eve001Out->building_booth_position_sel());
?>
                                    </select>
