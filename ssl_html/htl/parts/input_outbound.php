                        ...
                        <div class="dl_block input-outbound comiket_block">
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_detail_outbound_zip')) { echo ' class="form_error"'; } ?>>
                                    <?php
                                        $outboundZip1 = $eve001Out->comiket_detail_outbound_zip1();
                                        if (@empty($outboundZip1)) {
                                            $outboundZip1 = '100';
                                        }
                                        $outboundZip2 = $eve001Out->comiket_detail_outbound_zip2();
                                        if (@empty($outboundZip2)) {
                                            $outboundZip2 = '0001';
                                        }
                                    ?>
                                    〒<input autocapitalize="off" class="w_70 number-only" maxlength="3" inputmode="numeric" name="comiket_detail_outbound_zip1" data-pattern="^\d+$" placeholder="例）136" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $outboundZip1;?>" />
                                    -
                                    <input autocapitalize="off" class="w_70 number-only" maxlength="4" inputmode="numeric" name="comiket_detail_outbound_zip2" data-pattern="^\d+$" placeholder="例）0082" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $outboundZip2;?>" />
                            ...
                            <dl class="">
                                ...
                                <dd>
                                    <select name="comiket_detail_outbound_collect_date_day_sel">
                                        ...
                                        <option value="20">20時～21時</option>
                                        <option value="21">21時～22時</option>
                                        <option value="22">22時～23時</option>
                                    </select>
                                </dd>
                            </dl>
                            <dl class="class_comiket_detail_outbound_collect_date_dmy" style="display: none;">
                                <dt id="comiket_detail_outbound_collect_date">
                                    お預かり日時<span>必須</span>
                                </dt>
...
?>
    ...
    ?>
                            ...
                            <dl class="service-outbound-item_dmy" service-id="1" style="display: none;">
