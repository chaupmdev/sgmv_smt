...
Sgmov_Lib::useView('gmm/CreditCard');
/**#@-*/

// 処理を実行
$view = new Sgmov_View_Gmm_CreditCard();
$forms = $view->execute();
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <form action="/gmm/check_credit_card" method="post">
                <input name="ticket" type="hidden" value="<?php echo $ticket ?>" />
                <div class="section">
                    <p class="sentence br">
                        お支払い総額をご確認の上、クレジットカード情報をご入力ください。
...
<?php } ?>
                    ...
                    <div class="result02" style="font-size:134%;text-align: center;">
                        <span style="white-space: nowrap;">お支払い総額：</span>
                        &nbsp;<span style="white-space: nowrap;"><?php echo number_format((int)$eveOutForm->delivery_charge()); ?>円（税込）</span>
                    </div>
...
<?php
        echo Sgmov_View_Gmm_CreditCard::_createPulldown($eveOutForm->card_expire_month_cds(), $eveOutForm->card_expire_month_lbls(), $eveOutForm->card_expire_month_cd_sel());
?>
                                </select>
                                月
                            </label>
...
<?php
        echo Sgmov_View_Gmm_CreditCard::_createPulldown($eveOutForm->card_expire_year_cds(), $eveOutForm->card_expire_year_lbls(), $eveOutForm->card_expire_year_cd_sel());
?>
                                    </select>
                                    年
                                </label>
                    ...
                    <div class="btn_area">
                        ...
                        if(empty($comiketId)): ?>
                            <a class="back" href="/gmm/input/?clr=1">修正する</a>
                        <?php else: ?>
                            <a class="back" href="/gmm/input2/?clr=1">修正する</a>
                        <?php endif; ?>
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/gmm/js/credit_card.js?<?php echo $strSysdate; ?>"></script>
    <script>
        $(function() {
