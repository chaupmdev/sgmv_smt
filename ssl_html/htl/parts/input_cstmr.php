...
<?php
            echo Sgmov_View_Eve_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
?>
                                        &nbsp;&nbsp;
                                                    </span>
...
?>
                                                    ...
                                                    <!--</div>-->
<?php
        $eventName = Sgmov_View_Eve_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
        $eventsubName = Sgmov_View_Eve_Input::_getLabelSelectPulldownData($eve001Out->eventsub_cds(), $eve001Out->eventsub_lbls(), $eve001Out->eventsub_cd_sel());
        if(strpos($eventName,'デザインフェスタ') !== false){
        echo '<img src="/htl/images/logo.gif">';
        }
?>
<?php
    // キャッシュ対策
...
?>
                                                    <div class="sp_dl_area2 paste_tag">
                                                        <div style=";display:none;" class="eventsub_dl_link paste_tag">
                                                            ...
                                                            <a style="color: blue;" class="paste_tag_link" href="/htl/pdf/paste_tag/paste_tag_<?php echo $eve001Out->eventsub_cd_sel(); ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">貼付票（例）</a>
                                                        </div>
                                                        <br/>
...
<?php if ($eve001Out->input_mode() != '002') {  // 入力モードが"002"(コミケ)なら説明書のリンクは表示しない ?>
                                                        ...
                                                        <div class="eventsub_dl_link manual" style="display:none;">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;" class="manual_link" href="/htl/pdf/manual/<?php echo $eventName; ?><?php echo $eventsubName; ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">説明書</a>
                                                        </div>
<?php } ?>
                                                    </div>
                                                    <br/>
...
<!--                                                    <div class="pc_dl_area2">
                                                        <div style="margin-bottom:3px;display:none;" class="eventsub_dl_link pasete_tag">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;" class="paste_tag_link" href="/htl/pdf/paste_tag/paste_tag_<?php echo $eve001Out->eventsub_cd_sel(); ?>.pdf" target="_blank">貼付票</a>
                                                        </div>
                                                        <br/>
                                                        <div class="eventsub_dl_link manual" style="display:none;">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;" class="manual_link" href="/htl/pdf/manual/<?php echo $eventName; ?><?php echo $eventsubName; ?>.pdf" target="_blank">説明書</a>
                                                        </div>
                                                    </div>-->
<!--                                                </td>
                                            </tr>
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_pref')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <select name="comiket_pref_cd_sel">
                                        <option value="">選択してください</option>
<?php
        echo Sgmov_View_Eve_Input::_createPulldown($eve001Out->comiket_pref_cds(), $eve001Out->comiket_pref_lbls(), $eve001Out->comiket_pref_cd_sel());
?>
                                    </select>
                                </dd>
                            </dl>
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_mail_retype')) { echo ' class="form_error"'; } ?>>
                                    <input class="w_220" maxlength="100" autocapitalize="off" inputmode="email" name="comiket_mail_retype" data-pattern="^[!-~]+$" placeholder="例）ringo@sagawa.com" type="<?php echo $inputTypeEmail; ?>" value="<?php echo $eve001Out->comiket_mail_retype();?>" />
                                    <br/>
                                    <br/>
                                    <strong class="red">
                                        ※確認のため、再入力をお願いいたします。
                            ...
                            <dl class="class_building_name_sel">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('building_name_sel')) { echo ' class="form_error"'; } ?>>
                                    <select name="building_name_sel">
                                        <option value="">選択してください</option>
<?php
                                        echo Sgmov_View_Eve_Input::_createPulldown($eve001Out->building_name_ids(), $eve001Out->building_name_lbls(), $eve001Out->building_name_sel());
?>
                                    </select>
                                    ...
                                    <select name="building_booth_position_sel">
                                        <option value="">選択してください</option>
<?php
                                         echo Sgmov_View_Eve_Input::_createPulldown($eve001Out->building_booth_position_ids(), $eve001Out->building_booth_position_lbls(), $eve001Out->building_booth_position_sel());
?>
                                    </select>
