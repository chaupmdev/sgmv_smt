...
class Sgmov_Form_Asp007Out
{
    ...
    /**
     * エンティティ化された金額設定区分を返します。
     * @return string エンティティ化された金額設定区分
     */
    public function priceset_kbn()
    {
        return Sgmov_Component_String::htmlspecialchars($this->raw_priceset_kbn);
    }
