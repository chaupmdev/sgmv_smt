...
<?php
        echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->comiket_detail_inbound_pref_cds(), $eve001Out->comiket_detail_inbound_pref_lbls(), $eve001Out->comiket_detail_inbound_pref_cd_sel());
?>
                                    </select>
                                    <br/>
                                    <br/>
...
<?php                                           
                echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->comiket_detail_inbound_collect_date_year_cds(), $eve001Out->comiket_detail_inbound_collect_date_year_lbls(), $eve001Out->comiket_detail_inbound_collect_date_year_sel());
?>
                                            </select>年
                                            <select name="comiket_detail_inbound_collect_date_month_sel">
                                                <!--<option value="">月を選択</option>-->
<?php
                echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->comiket_detail_inbound_collect_date_month_cds(), $eve001Out->comiket_detail_inbound_collect_date_month_lbls(), $eve001Out->comiket_detail_inbound_collect_date_month_sel());
?>
                                            </select>月
                                            <select name="comiket_detail_inbound_collect_date_day_sel">
                                                <option value="">日を選択</option>
<?php
                echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->comiket_detail_inbound_collect_date_day_cds(), $eve001Out->comiket_detail_inbound_collect_date_day_lbls(), $eve001Out->comiket_detail_inbound_collect_date_day_sel());
?>
                                            </select>日
                                            &nbsp;
...
<?php
                echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->comiket_detail_inbound_collect_time_cds(), $eve001Out->comiket_detail_inbound_collect_time_lbls(), $eve001Out->comiket_detail_inbound_collect_time_sel());
?>
                                                </select>
                                            </span>
                                        </div>
...
<?php
            ...
            echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->comiket_detail_inbound_delivery_date_year_cds(), $eve001Out->comiket_detail_inbound_delivery_date_year_lbls(), $eve001Out->comiket_detail_inbound_delivery_date_year_sel());
?>
                                        </select>年
                                        <select name="comiket_detail_inbound_delivery_date_month_sel">
                                            <!--<option value="">月を選択</option>-->
<?php
            echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->comiket_detail_inbound_delivery_date_month_cds(), $eve001Out->comiket_detail_inbound_delivery_date_month_lbls(), $eve001Out->comiket_detail_inbound_delivery_date_month_sel());
?>
                                        </select>月
                                        <select name="comiket_detail_inbound_delivery_date_day_sel">
                                            <option value="">日を選択</option>
<?php
            echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->comiket_detail_inbound_delivery_date_day_cds(), $eve001Out->comiket_detail_inbound_delivery_date_day_lbls(), $eve001Out->comiket_detail_inbound_delivery_date_day_sel());
?>
                                        </select>日
                                        &nbsp;
                                        ...
                                        時間帯
                                            <select name="comiket_detail_inbound_delivery_time_sel">
                                                <option value="">時間帯を選択</option>
<?php
            echo Sgmov_View_Fmt_Input::_createPulldown($eve001Out->comiket_detail_inbound_delivery_time_cds(), $eve001Out->comiket_detail_inbound_delivery_time_lbls(), $eve001Out->comiket_detail_inbound_delivery_time_sel());
?>
                                            </select>
                                        </span>
                                        <br/>
...
<!--                                        <strong class="red">※ 天災、交通状況の影響により、希望に添えない可能性があります。</strong>-->
                                    ...
                                    <div>
                                        <strong class="red">※お預かり日の翌々日～お預かり日の7日目まで指定可能（北海道、中国、九州、四国は3日後から）<br>　範囲外を指定した場合、申込エラーとなり申込完了できません。</strong>
                                    </div>
                                </dd>
                            </dl>
