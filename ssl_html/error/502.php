...
<meta name="description" content="502エラー Bad Gateway">
...
<title>502エラー Bad Gateway｜<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/meta-ttl.php'); ?></title>
...
<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/header.php'); ?>
    <main id="main" role="main">
		<div class="pageTitle style01">
			<div class="comBox">
				<h1 class="topLead">Bad Gateway<em>502エラー</em></h1>
				<ul id="pagePath">
					<li><a href="/"><img class="home" src="/img/common/icon54.jpg" alt=""></a></li>
					<li>サーバー管理者が現在確認中です。</li>
				</ul>
			</div>
		</div>
		<div class="topBox comBox">
			<p class="text fadeInUp">サーバー管理者が現在確認中です。</p>
