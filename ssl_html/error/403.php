...
<meta name="description" content="403エラー アクセス権限がありません">
...
<title>403エラー アクセス権限がありません｜<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/meta-ttl.php'); ?></title>
...
<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/header.php'); ?>
    <main id="main" role="main">
		<div class="pageTitle style01">
			<div class="comBox">
				<h1 class="topLead">ページへのアクセス権限がありません<em>403エラー</em></h1>
				<ul id="pagePath">
					<li><a href="/"><img class="home" src="/img/common/icon54.jpg" alt=""></a></li>
					<li>ページへのアクセス権限がありません</li>
				</ul>
			</div>
		</div>
		<div class="topBox comBox">
			<p class="text fadeInUp">ページへのアクセス権限がありません。</p>
