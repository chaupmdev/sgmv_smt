...
<body>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <form action="/<?= $dirDiv ?>/size_change_check_credit_card" method="post">
                ...
                <div class="section">
                            ...
                            <dd<?php if (isset($e) && ($e->hasErrorForId('top_card_expire_year_cd_sel') || $e->hasErrorForId('top_card_expire_month_cd_sel') || $e->hasErrorForId('top_card_expire'))) {
                                ...
                                <label for="card_expire_month">
                                    <select id="card_expire_month" name="card_expire_month_cd_sel">
                                        ...
                                        <?php
                                        echo Sgmov_View_Qrc_CreditCard::_createPulldown($eveOutForm->card_expire_month_cds(), $eveOutForm->card_expire_month_lbls(), $eveOutForm->card_expire_month_cd_sel());
                                        ?>
                                    </select>
                                    月
                                </label>
                                <label for="card_expire_year">
                                    <select id="card_expire_year" name="card_expire_year_cd_sel">
                                        ...
                                        <?php
                                        echo Sgmov_View_Qrc_CreditCard::_createPulldown($eveOutForm->card_expire_year_cds(), $eveOutForm->card_expire_year_lbls(), $eveOutForm->card_expire_year_cd_sel());
                                        ?>
                                    </select>
                                    年
                                </label>
                    ...
                    <div class="btn_area">
                        <a class="back" href="/<?= $dirDiv ?>/size_change/?clr=1">修正する</a>
