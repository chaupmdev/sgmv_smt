...
// 処理を実行
$view = new Sgmov_View_Twi_Complete();
$eveOutForm = array();
$eventData = array();
$eventsubData = array();
...
<head>
    ...
    <title>テーブルウェア・フェスティバル開催会場からの宅配便お申込みフォームの完了│ＳＧムービング株式会社＜ＳＧホールディングスグループ＞</title>
...
<div id="breadcrumb">
    <ul class="wrap">
        ...
        <li class="current">テーブルウェア・フェスティバル開催会場からの宅配便お申込みフォームの完了</li>
    </ul>
</div>

<div id="main">
    <div class="wrap clearfix">
        <h1 class="page_title">テーブルウェア・フェスティバル開催会場からの宅配便お申込みフォームの完了</h1>
        <div class="section">
            ...
            <div style="clear: both;">
                ...
                <?php if(($eveOutForm->comiket_detail_type_sel() == "1" || $eveOutForm->comiket_detail_type_sel() == "3") // 搬入、もしくは往復
                    ...
                    <div style="font-size:20px;">
                        <a href="/<?=$dirDiv?>/paste_tag/<?php echo sprintf('%010d', $eveOutForm->qr_code_string()) . Sgmov_View_Twi_Common::getChkD2($eveOutForm->qr_code_string()); ?>/" target="_blank" style="color:blue;" download>
                ...
                <?php if ($eventsubData['manual_display'] == '1') { ?>
                    ...
                    <div style="font-size:20px;">
                        <a class="button_link2" href="<?=$dispItemInfo['dispEvent']['manual']?>" target="_blank" style="color:blue;">
