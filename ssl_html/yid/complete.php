...
// 処理を実行
$view = new Sgmov_View_Yid_Complete();
$eveOutForm = array();
$eventData = array();
$eventsubData = array();
            ...
            <div style="clear: both;">
                ...
                <?php if(($eveOutForm->comiket_detail_type_sel() == "1" || $eveOutForm->comiket_detail_type_sel() == "3") // 搬入、もしくは往復
                    ...
                    <div style="font-size:20px;">
                        <a href="/<?=$dirDiv?>/paste_tag/<?php echo sprintf('%010d', $eveOutForm->qr_code_string()) . Sgmov_View_Yid_Common::getChkD2($eveOutForm->qr_code_string()); ?>/" target="_blank" style="color:blue;" download>
                ...
                <?php if ($eventsubData['manual_display'] == '1') { ?>
                    <br/><br/>ご不明な点はメールに添付されている出展ガイド、もしくは下記のボタンから出展ガイドをダウンロードして、ご確認ください。<br/><br/>
                    <div style="font-size:20px;">
