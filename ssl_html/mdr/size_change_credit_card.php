...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <form action="/mdr/size_change_check_credit_card" method="post">
...
<?php } ?>
                    ...
                    <div class="result02 tac fs134per">
                        ...
                        &nbsp;<span class = "wsp-nowrap"><?php echo number_format($eveOutForm->delivery_charge()); ?>円（税込）</span>
                    </div>
...
?>
                        ...
                        <dl>
                            ...
                            <dd<?php if (isset($e) && $e->hasErrorForId('top_security_cd')) { echo ' class="form_error"'; } ?>>
                                <input autocapitalize="off" class="w_80" id="security_cd" inputmode="numeric" maxlength="4" name="security_cd" data-pattern="^\d+$" placeholder="例）9999" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $eveOutForm->security_cd(); ?>" />
                    ...
                    <div class="btn_area">
                        <a class="back" href="/mdr/size_change/?clr=1">修正する</a>
