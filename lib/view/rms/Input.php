...
class Sgmov_View_Rms_Input extends Sgmov_View_Rms_Common {
    ...
    public function executeInner() {
        ...
        if (!isset($_SESSION[self::LOGIN_ID]['user_type'])) {
            ...
            Sgmov_Component_Redirect::redirectPublicSsl('/event/userSelect?event_nm=rms');
        }
        
        if(@empty($_SERVER["HTTP_REFERER"]) || strpos($_SERVER["HTTP_REFERER"], "/rms/") == false) {
            // セッション情報を破棄
...
///////////////////////////////////////////////////////////////////////////////////////////////////
        if(strlen($param) == 10) {
            Sgmov_Component_Redirect::redirectPublicSsl("/rms/input2_dialog/{$param}");
        }
        ...
        if($input2DialogFlg == "1") {
            ...
            if(!is_numeric($input2DialogComiketId)){
                Sgmov_Component_Redirect::redirectPublicSsl("/rms/temp_error");
                exit;
            }
            ...
            if($comiketData['tel'] == $input2DialogData1Tel
                ...
                Sgmov_Component_Redirect::redirectPublicSsl("/rms/input/{$param}");
            } else {
                Sgmov_Component_Redirect::redirectPublicSsl("/rms/temp_error/{$comiketData['event_id']}");
            }
        }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if(@!empty($_SERVER["REQUEST_URI"]) && strpos($_SERVER["REQUEST_URI"], "/rms/input2") !== false && empty($param)) {
