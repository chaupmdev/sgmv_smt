    ...
    function dispDocLinkEachEventsub() {
        ...
        if(eventsubSel && eventsubSel != "") {
            ...
            if(g_eventsubList[eventsubSel]['is_paste_display']){
                ...
                $('.paste_tag_link').attr("href", "/"+dirDiv+"/pdf/paste_tag/paste_tag_" + eventSel + ".pdf" + '?' + strCurrentDate);
            } else {
            ...
            if(g_eventsubList[eventsubSel]['is_manual_display']) {
                ...
                $('.manual_link').attr("href", "/"+dirDiv+"/pdf/manual/manual_" + eventSel + ".pdf" + '?' + strCurrentDate);
            } else {
    ...
    function getOutBoundCollectCal() {
        sgwns.api('/common/php/getOutBoundCollectCal.php', getFormData(), (function (data) {
            ...
            if (errorMsg && (errorMsg != undefined || errorMsg != '')) {
                ...
                if(nowD<=18 || (nowD==18 && nowH<12)){
//                if(nowD<=6 || (nowD==7 && nowH<17)){
                    changeMessage= '2022年06月20日（月）から2022年06月22日（水）まで選択できます。'
                    var frDt = '2022-06-20';
                    var toDt = '2022-06-22';
