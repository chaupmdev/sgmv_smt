...
<?php
            echo Sgmov_View_Twf_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
?>
                                    &nbsp;&nbsp;
                                    </span>
...
<?php
            echo Sgmov_View_Twf_Input::_createPulldown($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel(), $eve001Out->eve_timeover_flg(), $eve001Out->eve_timeover_date());
?>
                                        </select>
...
<?php
            echo Sgmov_View_Twf_Input::_createPulldown($eve001Out->eventsub_cds(), $eve001Out->eventsub_lbls(), $eve001Out->eventsub_cd_sel());
?>
                                        </select>
                                            <br/>
                                            <img src="<?=$dispItemInfo['dispEvent']['logoImg']?>" style="margin:10px 0;width:40%;">
                                            <div class="sp_dl_area2 paste_tag"><strong class="red eventsub_dl_link paste_tag_link paste_tag">
                                                       【一般出展者・協賛社】の方は以下ご確認ください。<br/>
                                                       申込完了画面で出展者名が記載された配達カードを出力できます。<br/>
                                                        ※追加搬入の際、こちらをダウンロードし、荷物に貼付下さい。<br/><br/>        
                                                        </strong></div>
                                                        <div class="eventsub_dl_link paste_tag">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;" class="paste_tag_link" href="<?=$dispItemInfo['dispEvent']['pasteTag3']?>" target="_blank">配達カード(協賛社・一般出展者用)</a>
                                                        </div>
                                                        <br/>
                                                        <strong class="red eventsub_dl_link paste_tag_link paste_tag">
                                                            【主催者展示･コンテスト】の方は以下ご確認ください。
                                                        </strong>
                                                        <br/>
                                                        <strong class="red eventsub_dl_link paste_tag_link paste_tag">
                                                            ※コンテスト及び主催者展示をご利用される方は、コンテスト用・主催者展示用の配達カードPDFを出力し、記載必須項目をご自身で記入の上、箱横面に必ず貼付をお願いします。
                                                        </strong>
                                                        <br/>
                                                        <br/>
                                                        <div class="eventsub_dl_link paste_tag">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;" class="paste_tag_link" href="<?=$dispItemInfo['dispEvent']['pasteTag1']?>" target="_blank">配達カード(主催者展示)</a>
                                                        </div>
                                                        <div class="eventsub_dl_link paste_tag">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;" class="paste_tag_link" href="<?=$dispItemInfo['dispEvent']['pasteTag2']?>" target="_blank">配達カード(コンテスト)</a>
                                                        </div>
                                                        <br/>
                                                        <strong class="red eventsub_dl_link paste_tag_link paste_tag">
                                                            ※出荷の際、こちらを荷物に貼り付けて出荷をお願いします。<br/>
                                                        </strong>

<?php
// 注意：jsで動的に貼付票、マニュアルのリンクを取得していた(dispDocLinkEachEventsubメソッド 2022/06/01 修正)
 if ($eve001Out->input_mode() != '002') {  // 入力モードが"002"(コミケ)なら説明書のリンクは表示しない 
?>
                                                        <div class="paste_tag">
                                                            <!-- <br/> -->
                                                            <br/>
<!--                                                        </div>
                                                        <div style="display: none" class="eventsub_dl_link manual">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;" class="manual_link2" href="<?=$dispItemInfo['dispEvent']['manual2']?>" target="_blank">出展ガイド</a>
                                                        </div>
                                                        <br/>-->
                                                        <div>
                                                        <strong style="color:#C00;"><会場一括搬入受付期間></strong>
                                                        <br/>
                                                        <strong style="color:#C00;">※関東圏エリアにご在住の⽅は申込受付期間が11月12日(火)0:00～11月19日(火)11:59まで。</strong>
                                                        <br>
                                                        <br>
                                                        <strong style="color:#C00;">※その他エリアにご在住の⽅は申込受付期間が11月12日(火)0:00～11月18日(月)23:59まで。</strong>
                                                        <br>
                                                        <br>
                                                        <strong style="color:#C00;">※11/26(火)の夜に、プリズムホール内の各ブースへお届けいたします。</strong>
                                                        <br/>
                                                        <br/>
                                                        <strong style="color:#C00;"><会場搬出受付期間><br>※12月4日(水)　20:00まで</strong>
                                                        </div>
<?php } ?>
                                                    </div>
                                                    <!-- <br/> -->
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_pref')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <select name="comiket_pref_cd_sel">
                                        <option value="">選択してください</option>
<?php
        echo Sgmov_View_Twf_Input::_createPulldown($eve001Out->comiket_pref_cds(), $eve001Out->comiket_pref_lbls(), $eve001Out->comiket_pref_cd_sel());
?>
                                    </select>
                                </dd>
                            </dl>
...
<?php // ホール コンボボックス ?>
                                    <select name="building_cd_and_name_sel" class="building_cd_and_name_sel">
                                        ...
                                        <?php foreach ($eve001Out->raw_building_name_ids as $key => $val) : ?>
                                            ...
                                            >
                                                <?= $eve001Out->raw_building_name_lbls[$key] ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>&nbsp;
...
<?php
                                    // ブースNo コンボボックス 出力
                                         echo Sgmov_View_Twf_Input::_createPulldown($eve001Out->building_booth_position_ids()
                                                                                  , $eve001Out->building_booth_position_lbls()
                                                                                  , $eve001Out->building_booth_position_sel());
?>
                                    </select>


<?php // ブース番号テキストボックス ?>
                                    <input class="w_30Per" autocapitalize="off" maxlength="4"
                                     name="comiket_booth_num" placeholder="例）1234(数値4桁)" type="text"
                                     value="<?php echo $eve001Out->comiket_booth_num();?>"
                                     style="display:none;"  />


                                    <br/>
                                    <br/>
                                     <strong class="red lhn" style="display: none">
                                    <?php if ($eve001Out->event_cd_sel() == '2') : ?>
                                        ※出展者以外の方がご利用の場合は、「0000」と、入力してください。<br />
                                        また、複数のブースを使用する出展者は代表ブース番号を入力してください。
                                    <?php else: ?>
                                        ※出展者以外の方がご利用の場合は、「その他」「0000」と、選択してください。
                                    <?php endif; ?>
                                    </strong>
                                </dd>
                            </dl>
