 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Dsn_SizeChange extends Sgmov_View_Dsn_Input {
...
Sgmov_Component_Log::debug ( 'リクエストパラメータなし + セッションにデータなし' );
            ...
            if(strlen($param) == 10) {
                Sgmov_Component_Redirect::redirectPublicSsl("/dsn/input2_dialog/{$param}");
            }
