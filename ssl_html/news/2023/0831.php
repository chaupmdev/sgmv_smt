...
<meta name="description" content="これまでに発生した自然災害による当社現業務への影響について（2023.09.04　9時現在）">
...
<title>台風11号の接近に伴う配送への影響について（2023年9月4日10時現在）｜ニュース｜<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/meta-ttl.php'); ?></title>
		...
		<div class="mainBox" data-stt-ignore>
			<article id="conts">
				<div class="titleBox fadeInUp">
					<p class="time">2023.09.04<span class="cat-news">お知らせ</span></p>
					<p class="title">台風11号の接近に伴う配送への影響について（2023年9月4日10時現在）</p>
				</div>
				<div class="wpBox fadeInUp">
                    ...
                    <br>
                    <p>台風11号の影響により、欠航していたフェリーが再開し以下の地域への積載量が増加したことで、お荷物のお届けに遅れが生じます。</p>
                    <br>
                    <h2 class="heading2__title">【お荷物のお届けに遅れが生じる地域】</h2>
                    <br>		
                    <dt>（沖縄県）全域</dt>               
                    <br>
			  <p>今後の天候状況により対象地域に変更が生じる可能性があります。</p>
