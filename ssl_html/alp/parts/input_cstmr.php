                        ...
                        <?php echo('<img src="/'.$dirDiv.'/images/logo.jpg" style="width:50%;">');?>
                        </div>
...
<?php
    // イベント名とバナーロゴ画像表示
    echo('<div style="padding-bottom:10px;">'.$dispItemInfo['eventname_all'].'</div>');
    echo('<img src="/'.$dirDiv.'/images/logo.jpg" style="width:50%;">');
...
<!--
                                            <table class="red eventsub_dl_link paste_tag_link paste_tag" >
                                                <tr>
                                                    <td style="vertical-align: top;padding-top:20px;width: 70%;">
                                                        <div style=";display:none;" class="eventsub_dl_link paste_tag">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;font-weight: normal;" class="paste_tag_link" href="/<?=$dirDiv?>/pdf/paste_tag/paste_tag_<?php echo $eve001Out->eventsub_cd_sel(); ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">貼付票（例）</a>
                                                        </div>
                                                        <br/>
                                            ...
                                            <div class="eventsub_dl_link manual" style="display:none;">
                                                <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                <a style="color: blue;font-weight: normal;text-decoration: underline;" class="manual_link" href="/<?=$dirDiv?>/pdf/manual/<?php echo $eventName; ?><?php echo $eventsubName; ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">宅配便WEB申込みのご案内</a>
                                            </div>
-->
...
?>
                            ...
                            <dl class="class_building_name_sel" style="background:red;display:none;">
...
<!--
                                    <span style="padding-right:18px;">エリア</span>
-->
                                    ...
                                    <div style="margin-bottom: 2px;display: none;">
                                      <span style="font-size: 0.5em;">お店No.</span>
                                      <span style="font-size: 0.5em;margin-left: 100px;">ブース番号</span>
                                    </div>

                                    <input type="hidden" name="building_booth_position_sel" class="building_booth_position_sel" value='1250'>
                                    <input class="" name="comiket_booth_name" type="hidden" value="shop_name" />
                                    <input  name="comiket_booth_num" type="hidden" value="1234">
<!--
                                    <div style="display: block;">
                                      <span style="padding-right:10px;">お店No.</span>
                                        <select>
                                          <option value="">選択してください</option>
<?php
...
?>
                                    ...
                                    <div style="display: block;padding: 18px 0;">
                                      <span style="padding-right:24px;">お店名</span>
                                      <span class='shop_name'><?php echo $eve001Out->comiket_booth_name() ?></span>
                                      <input class=""  name="comiket_booth_name"
                                        data-pattern="" placeholder="" type="hidden" value="<?php echo $eve001Out->comiket_booth_name() ?>" />
                                    </div>
-->
<!--
<?php // イベント固有実装：ブース番号のチェックなし ?>
...
-->
                                    ...
                                    <br/>
                                    <br/>
                                        ※ブース番号の後ろに借りている机の範囲、A、B、ABを付けてご入力ください。<br />
                                        ※出展者以外の方がご利用の場合は、「--」「-」「0000」と、入力してください。<br />
                                        また、複数のブースを使用する出展者は代表ブース番号を入力してください。
                                    <?php endif; ?>
                                    </strong>
                                </dd>
                            </dl>
...
<!--
                                    <input class="" style="width:80%;" maxlength="16" autocapitalize="off" name="comiket_booth_name"
                                     data-pattern="" placeholder="" type="text" value="<?php echo $eve001Out->comiket_booth_name() ?>" />
-->
                                    <br/>
                                    <br/>
                                    <strong class="red">
