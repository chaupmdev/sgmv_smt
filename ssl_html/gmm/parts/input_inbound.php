...
<?php
        echo Sgmov_View_Gmm_Input::_createPulldown($eve001Out->comiket_detail_inbound_pref_cds(), $eve001Out->comiket_detail_inbound_pref_lbls(), $eve001Out->comiket_detail_inbound_pref_cd_sel());
?>
                                    </select>
                                    <br/>
                                    <br/>
...
<?php
                echo Sgmov_View_Gmm_Input::_createPulldown($eve001Out->comiket_detail_inbound_collect_time_cds(), $eve001Out->comiket_detail_inbound_collect_time_lbls(), $eve001Out->comiket_detail_inbound_collect_time_sel());
?>
                                                </select>
                                            </span>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <a style="color: blue;line-height: normal"  href="/gmm/pdf/manual/<?php echo str_replace(array(" ", "　"), "", $eventName); ?>搬出.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">宅配便WEB申込みのご案内<div style="display: inline-block;">（出展社マニュアルより抜粋）</div></a>
                                        </div>
                                        <br>
                                        <div class = "dsp-inblck vat fwb red lhn">
                                            お預かり日時・場所 : &nbsp;<img src="/images/common/img_icon_pdf.gif" class = "vat" width="18" height="21" alt="">
                                                <a style="color: blue;font-weight: normal;"  href="/gmm/pdf/manual/会場内宅配受付カウンター.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">会場内宅配受付カウンター</a>
                                        </div>
                                        <br>
                                         <div class = "dsp-inblck vat fwb red lhn out_bnd-clt-dt" style="padding-left: 15px;">
                                            4/10(土)、4/11（日) 西1、西2 共に 11:00～18:00
                                        </div>
                                </dd>
                            </dl>
<!--                            <dl>
                            ...
                            <dl class="comiket_detail_inbound_delivery_date">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_detail_inbound_delivery_date')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <div class="comiket_detail_inbound_delivery_date_parts">
                                        ...
                                        <?php
                                        // ****************************************************************************************
                                        // 191026 sawada デザインフェスタvol50のみの対応
                                        // ****************************************************************************************
                                        ?>
                                        ...
                                        時間帯
                                            <select name="comiket_detail_inbound_delivery_time_sel">
                                                <option value="">時間帯を選択</option>
<?php
            echo Sgmov_View_Gmm_Input::_createPulldown($eve001Out->comiket_detail_inbound_delivery_time_cds(), $eve001Out->comiket_detail_inbound_delivery_time_lbls(), $eve001Out->comiket_detail_inbound_delivery_time_sel());
?>
                                            </select>
                                        </span>
                                        <br/>
...
<!--                                        <strong class="red">※ 天災、交通状況の影響により、希望に添えない可能性があります。</strong>-->
                            ...
                            <dl class="service-inbound-item" service-id="1">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_box_inbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                    <div class="comiket-box-inbound-num comiket-box-inbound-num-dmy"> <!-- 個人・法人 どちらでも -->
                                        <?php // if($eve001Out->comiket_div() == Sgmov_View_Gmm_Common::COMIKET_DEV_BUSINESS) : ?>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <table>
                                                    ...
                                                    <td class="dispSeigyoPC" style='vertical-align: middle;text-align: right;'>
                                                        <?php if($eve001Out->comiket_div() == Sgmov_View_Gmm_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
                                                            <img src='/gmm/images/about_boxsize.png' width='100%'/>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <div class="dispSeigyoSP" style="margin-top: 1em;">
                                        <img src='/gmm/images/about_boxsize.png' width='250px' style='margin-top: 1em;' />
                                    </div>
                                    <?php else: ?>
                                    <!--<img src='/gmm/images/about_boxsize.png' width='100%'/>-->
                                    <?php endif; ?>
                                    ...
                                    <div class="outbound_example_boxsize example_boxsize">
                                        ...
                                        <strong class="red">※ １申込み４０個を超える場合は、ＳＧムービング/ゲームマーケット係り 03-5857-2462 へお問い合わせください。</strong><br/><br/>
                                        <a href="/gmm/pdf/example/example_box_size.pdf" target="_blank" style="color:blue;">サイズの目安はこちらをご確認ください</a>
                                    </div>
                                </dd>
                            </dl>
                            <dl class="service-inbound-item" service-id="2">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_cargo_inbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <div class="comiket-cargo-inbound-num" div-id="<?php echo Sgmov_View_Gmm_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                    </div>
                                    <div class="comiket-cargo-inbound-num" div-id="<?php echo Sgmov_View_Gmm_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                    </div>
                                    <div class="">
...
<?php
                                        echo Sgmov_View_Gmm_Input::_createPulldown($eve001Out->comiket_cargo_inbound_num_cds(), $eve001Out->comiket_cargo_inbound_num_lbls(), $eve001Out->comiket_cargo_inbound_num_sel());
?>
                                            </select>台-->
                                    </div>
                                </dd>
                            ...
                            <dl class="service-inbound-item" service-id="3">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_charter_inbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <div class="comiket-charter-inbound-num" div-id="<?php echo Sgmov_View_Gmm_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                    ...
                                    <div class="comiket-charter-inbound-num" div-id="<?php echo Sgmov_View_Gmm_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                        <table>
