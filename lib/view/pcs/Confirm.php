...
Sgmov_Lib::useForms(array('Error', 'PcsSession', 'Pcs002Out'));
/**#@-*/
 ...
 * @copyright  2009-2010 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Pcs_Confirm extends Sgmov_View_Pcs_Common
{
    /**
     * 処理を実行します。
     * <ol><li>
    ...
    public function executeInner()
    {
        ...
        // チケットを発行
        $ticket = $session->publishTicket(self::FEATURE_ID, self::GAMEN_ID_PCS002);
     ...
     * @return Sgmov_Form_Pcs002Out 出力フォーム
     */
    public function _createOutFormFromInForm($inForm)
    {
        ...
        $outForm = new Sgmov_Form_Pcs002Out();
