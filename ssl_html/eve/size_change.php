...
Sgmov_Lib::useView('eve/SizeChange');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Eve_SizeChange();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/eve/size_change_check_input" data-feature-id="<?php echo Sgmov_View_Eve_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Eve_Common::GAMEN_ID_EVE001; ?>" method="post">
