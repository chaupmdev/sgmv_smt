 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Unf_Input extends Sgmov_View_Unf_Common {
    ...
    public function executeInner() {
        ...
        //BOXデフォルトを設定する
        $inForm->comiket_detail_type_sel = "2";
        ...
        // チケット発行
        $ticket = $session->publishTicket(self::FEATURE_ID, self::GAMEN_ID_UNF001);
