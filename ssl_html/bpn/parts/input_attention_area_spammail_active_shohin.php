                        ...
                        <div id="bounce_mail" class="accordion">
                            <h3 class="accordion_button" data-id = "act1">ご連絡メールが届かない場合</h3>
                            <div id="bounce_mail_contents" class="ac_content act">
                                <p class="sentence">
                                    お申込み受付後、ご登録いただいたメールアドレスに「sgmoving_system@sagawa-mov.co.jp」より、自動で「<?php echo $title;?>受付のご連絡」のメールをお送りしております。
                                ...
                                <p class="sentence">
                                    スマートフォンや携帯電話のメール設定でドメイン指定受信をされているお客さまは、受信できない場合がございますので、必ず「sagawa-mov.co.jp」からのメールを受信する設定にしてください。
