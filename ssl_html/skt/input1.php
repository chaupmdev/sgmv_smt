...
?>
    ...
    <link href="/<?=$dirDiv?>/css/style.css?<?php echo $strSysdate; ?>" rel="stylesheet" type="text/css" />
    <!--[if lt IE 9]>
...
<?php
/*
                <br /><span class="red">※北海道・青森・中国・四国・九州・沖縄の方は搬入申込の締め切り時間が12月24日（金）12時までとなりますのでご注意ください。</span>
*/
?>
                <br />
            ...
            <p class="sentence" style="margin-bottom: 5px;color:#f00;">
            ※お申込期間について<br>
            <table style="margin-bottom: 5px;color:#f00;">
                <tr style="display:none"><td style="width:23em;padding-bottom:10px;">沖縄エリアの方</td>
                    <td nowrap>4/16(土)0時00分～4/21(木)12時00分00秒　まで</td>
                </tr>
                <tr><td style="width:23em;padding-bottom:10px;">東北・関東・北陸・中部・関西・沖縄エリアの方</td>
                    <td nowrap>12/10(火)0時00分～12/23(月)12時00分00秒　まで</td>
                </tr>
                <tr><td style="width:23em;padding-bottom:10px;">北海道・青森県・中国・四国・九州エリアの方</td>
                    <td nowrap>12/10(火)0時00分～12/22(日)12時00分00秒　まで</td>
                </tr>
            </table>
            </p>
                ...
                <table style="margin-top: 5px;">
                    <tr>
                        <td style="width:45%;line-height: 20px;">
                            <a href="/<?=$dirDiv?>/pdf/manual/SGMVスマートコンテナ輸送のご案内【2021冬コミケ99版】.pdf" target="_blank" style="margin-top:15px;color: #1774bc; text-decoration: underline;">
                                SGMVスマートコンテナ輸送のご案内 はこちら
                            </a><br/>
                            <a href="/<?=$dirDiv?>/excel/estimate/コミックマーケット99スマートコンテナ御見積依頼書.xlsx" target="_blank" style="color: #1774bc; text-decoration: underline;">
...
/*
            ...
            <div style="font-size: 14px;margin-top: 5px;">
                ...
                「1日目(30日)お預かりご希望の方：2021年12月17日～12月30日の <span style="font-size: 20px;font-weight: bolder;color:red;">16:00</span>まで」<br/>
                「2日目(31日)お預かりご希望の方：2021年12月17日～12月31日の <span style="font-size: 20px;font-weight: bolder;color:red;">16:00</span>まで」<br/>
                にお申込みお願いします。
            </div>
*/
?>
...
?>
            <div class="section other">
                <form action="/<?=$dirDiv?>/check_input" data-feature-id="<?php echo Sgmov_View_Evp_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Evp_Common::GAMEN_ID_EVE001 ?>" method="post">
...
?>
                    ...
                    <br/>
                    お問い合わせ先<br/>
                    SGムービング <?=$dispItemInfo['eventname_all']?>係　03-5857-2462(10:00～17:00)<br/>
