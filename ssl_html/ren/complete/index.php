...
Sgmov_Lib::useView('ren/Complete');
// /**#@-*/

// // 処理を実行
$view = new Sgmov_View_Ren_Complete();
$forms = $view->execute();
...
<head>
    ...
    <meta property="og:url" content="https://www.sagawa-mov.co.jp/ren/complete/">
    ...
    <title>新卒採用エントリーの完了｜<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/meta-ttl.php'); ?></title>
...
<body>
    ...
    <div id="main">
        <div class="pageTitle style01">
            <div class="comBox">
                <h1 class="topLead">新卒採用エントリーの完了<em>Complete</em></h1>
                <ul id="pagePath">
