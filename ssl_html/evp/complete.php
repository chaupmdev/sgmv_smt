...
Sgmov_Lib::useView('evp/Complete');
Sgmov_Lib::useForms(array('Error', 'EveSession'));
/**#@-*/

// 処理を実行
$view = new Sgmov_View_Evp_Complete();
$eveOutForm = array();
$eventData = array();
$eventsubData = array();
...
.mt10px{ margin-left: 10px !important; }
        ...
        <div class="section">
            ...
            <div style="clear: both;">
                ...
                <?php if(($eveOutForm->comiket_detail_type_sel() == "1" || $eveOutForm->comiket_detail_type_sel() == "3") // 搬入、もしくは往復
                    ...
                    <br/>以下の方法で送り状を用意できます。<br/>
                    荷物を送る際に必要になるので用意してください<br/>
                    ・ 画面下の「貼付票のDL」からPDFをダウンロードし、貼付票を印刷後、荷物に貼り付けて、発送ください。<br/><br/>
                    <div style="font-size:20px;">
                        <a href="/evp/paste_tag/<?php echo sprintf('%010d', $eveOutForm->qr_code_string()) . Sgmov_View_Evp_Common::getChkD2($eveOutForm->qr_code_string()); ?>/" target="_blank" style="color:blue;" download>
                ...
                <?php if ($eventsubData['manual_display'] == '1') { ?>
                    ...
                    <div style="font-size:20px;">
                        <a class="button_link2" href="https://www.comiket.co.jp/info-c/C101/C101appeal.html" target="_blank" style="color:blue;">
                        https://www.comiket.co.jp/info-c/C101/C101appeal.html
                        </a>
<!--                        <a class="button_link2" href="/evp/pdf/manual/<?php echo $eventData['name']; ?><?php echo $eventsubData['name']; ?>.pdf" target="_blank" style="color:blue;">
                ...
                <?php endif; ?>
                <br/>
                ・ イベント開催当日は、宅配カウンターが大変混み合います。お荷物のサイズ、個数がお決まりになられましたら、お早めにお申込みをお済ませ下さい。

                <br/><br/>
                <!-- GiapLN implement SMT6-129 2022/04/12 --> 
                <?php if(!empty($existsComiketId)):?>
                    <b>引き続き搬出申込する方はこちら<a href="/evp/input/<?php echo $existsComiketId; ?>" target="_self" style="color:blue;font-weight: bold;text-decoration: underline;">こちら</a></b>
                <?php else:?>
                    <b>引き継き宅配をご利用される方は<a href="/evp/input" target="_self" style="color:blue;font-weight: bold;text-decoration: underline;">こちら</a></b>
                <?php endif;?>
                <!-- <b>引き続き宅配をご利用される方は<a href="/evp/input" target="_self" style="color:blue;font-weight: bold;text-decoration: underline;">こちら</a></b>-->
            </div>
             <br/><br/>
                                    ...
                                    <?php if($paymentMethodCd == 1) : // コンビニ前払い?>
                                        ...
                                        <table class="default_tbl" style="width:100%;table-layout: fixed;">
                                            <tbody>
                                                ...
                                                <?php /* if (@!empty($eveOutForm->payment_url())) : ?>
                                                    <tr>
            ...
            <div style="clear: both;">
                ...
                <div class="btn_area">
                    ...
                    <a class="next" href="<?php echo $redirect['urlBackTop'];?>"><?php echo $redirect['valBackTop'];?></a>
                </div>
            </div>
