...
<?php
        echo Sgmov_View_Unf_Input::_createPulldown($eve001Out->comiket_detail_outbound_pref_cds(), $eve001Out->comiket_detail_outbound_pref_lbls(), $eve001Out->comiket_detail_outbound_pref_cd_sel());
?>
                                    </select>
                                    <br/>
                                    <br/>
                            ...
                            <dl class="class_building_name_sel">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('building_name_sel')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <select name="building_booth_position_sel">
                                        <option value="">選択してください</option>
<?php
                                         echo Sgmov_View_Unf_Input::_createPulldown($eve001Out->building_booth_position_ids(), $eve001Out->building_booth_position_lbls(), $eve001Out->building_booth_position_sel());
?>
                                    </select>
    ...
    <?php
            echo Sgmov_View_Unf_Input::_createPulldown($eve001Out->comiket_detail_outbound_delivery_time_cds(), $eve001Out->comiket_detail_outbound_delivery_time_lbls(), $eve001Out->comiket_detail_outbound_delivery_time_sel());
    ?>
                                            </select>
                                        </span>
                                    </div>
                            ...
                            <dl class="class_comiket_detail_outbound_collect_date" style="display:none">
                                    ...
                                    <div class="comiket_detail_outbound_collect_date_parts">
                                        ...
                                        時間帯
                                            <select name="comiket_detail_outbound_collect_time_sel">
                                                <option value="">時間帯を選択</option>
    <?php
            echo Sgmov_View_Unf_Input::_createPulldown($eve001Out->comiket_detail_outbound_collect_time_cds(), $eve001Out->comiket_detail_outbound_collect_time_lbls(), $eve001Out->comiket_detail_outbound_collect_time_sel());
    ?>
                                            </select>
                                        </span>
                                    </div>
                            ...
                            <dl class="arrival">
                                <dt  id="top_comiket_detail_collect_date">
                                    &nbsp;チェックアウト日<br>（お預かり希望日）<span>必須</span>
                                </dt>
                                <dd class="<?php if (isset($e) && $e->hasErrorForId('top_comiket_detail_collect_date')) { echo ' form_error'; } ?>">
                                    <select name="comiket_detail_collect_date_sel">
                                        <option value="">選択してください</option>
                                        <?php
                                        echo Sgmov_View_Unf_Input::_createPulldown($eve001Out->raw_comiket_detail_collect_date_cds, $eve001Out->raw_comiket_detail_collect_date_lbls, $eve001Out->raw_comiket_detail_collect_date_sel);
                                        ?>
                                    </select>
                                </dd>
                            </dl>
                            <dl class="service-outbound-item" service-id="2" style="display: none">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_cargo_outbound_num_ary')) { echo ' class="form_error"'; } ?> >
                                    <div class="comiket-cargo-outbound-num" div-id="<?php echo Sgmov_View_Unf_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                    </div>
                                    <div class="comiket-cargo-outbound-num" div-id="<?php echo Sgmov_View_Unf_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                    </div>
                                        <div style="">
                            ...
                            <dl class="service-outbound-item" service-id="3"  style="display: none">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_charter_outbound_num')) { echo ' class="form_error"'; } ?>>
                                    <div class="comiket-charter-outbound-num" div-id="<?php echo Sgmov_View_Unf_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                    ...
                                    <div class="comiket-charter-outbound-num" div-id="<?php echo Sgmov_View_Unf_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                            <table>
