...
// 処理を実行
$view = new Sgmov_View_Qrc_Input2();
$forms = $view->execute();
...
<body>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            ?>
                <div class="err_msg">
                    ...
                    <p class="under">
                        ...
                        <br />
                        <?php
                        $selectedEventNmae = Sgmov_View_Qrc_Input::_getLabelSelectPulldownData($qrc001Out->event_cds(), $qrc001Out->event_lbls(), $qrc001Out->event_cd_sel());
            ...
            <div class="section other">
                <form action="/<?= $dirDiv ?>/check_input2" data-feature-id="<?php echo Sgmov_View_Qrc_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Qrc_Common::GAMEN_ID_QRA001 ?>" method="post">
                    <input name="ticket" type="hidden" value="<?php echo $ticket ?>" />
                    <input name="comiket_id" type="hidden" value="<?php echo $qrc001Out->comiket_id(); ?>" />
                        ...
                        <div class="dl_block comiket_block">
                            <dl>
                                ...
                                <dd<?php
                                    ...
                                    echo $eventName;
                                    echo '<br><br><img src="/<?=$dirDiv?>/images/logo.png">';
                                    ?>
                                    ...
                                    <?php if ($eventsubInfo["is_manual_display"]) : ?>
                                        ...
                                        <div class="sp_dl_area2">
                                            ...
                                            <div class="eventsub_dl_link manual">
                                                ...
                                                <a style="color: blue;" class="manual_link" href="/<?= $dirDiv ?>/pdf/manual/<?php echo $eventName; ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">宅配便WEB申込みのご案内</a>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                            ...
                            <?php if ($qrc001Out->comiket_div() == Sgmov_View_Qrc_Common::COMIKET_DEV_BUSINESS) : // 法人
                            ?>
                                <dl>
                                    ...
                                    <dd<?php
                                        ...
                                        ?>>
                                        <?php echo $qrc001Out->comiket_customer_cd() ?>
                                        </dd>
                                </dl>
                            ...
                            <dl>
                                ...
                                <dd>
                                    〒<span class="comiket_zip1-lbl"><?php echo $qrc001Out->comiket_zip1(); ?></span>
                    ...
                    <?php if ($qrc001Out->comiket_div() == Sgmov_View_Qrc_Common::COMIKET_DEV_INDIVIDUA) : ?>
    ...
    ?>
    <script charset="UTF-8" type="text/javascript" src="/<?= $dirDiv ?>/js/define.js" id="definejs-arg" data-G_DEV_INDIVIDUAL="<?php echo Sgmov_View_Qrc_Common::COMIKET_DEV_INDIVIDUA; ?>" data-G_DEV_BUSINESS="<?php echo Sgmov_View_Qrc_Common::COMIKET_DEV_BUSINESS; ?>"></script>
