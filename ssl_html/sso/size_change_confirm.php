...
Sgmov_Lib::useView('sso/SizeChangeConfirm');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Sso_SizeChangeConfirm();
$forms = $view->execute();
...
<head>
    ...
    <link href="/sso/css/eve.css" rel="stylesheet" type="text/css" />
    <!--[if lt IE 9]>
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <div class="section">
                <form action="/sso/size_change_complete" data-feature-id="<?php echo Sgmov_View_Sso_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Sso_Common::GAMEN_ID_EVE001 ?>" method="post">
...
<?php
        $eventName = Sgmov_View_Sso_Confirm::_getLabelSelectPulldownData($eveOutForm->event_cds(), $eveOutForm->event_lbls(), $eveOutForm->event_cd_sel());
        echo $eventName;
?>
                                    &nbsp;
...
<?php
        $eventsubName = Sgmov_View_Sso_Confirm::_getLabelSelectPulldownData($eveOutForm->eventsub_cds(), $eveOutForm->eventsub_lbls(), $eveOutForm->eventsub_cd_sel());
        echo $eventsubName;
?>
                                    </span>
                                    <!--</div>-->
<!--                                                    <br/>
                                                    <div class="sp_dl_area">
                                                        <span class="eventsub_dl_link pasete_tag">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;" class="paste_tag_link" href="/sso/pdf/paste_tag/paste_tag_<?php echo $eveOutForm->eventsub_cd_sel(); ?>.pdf" target="_blank">貼付票</a>
                                                        </span>
                                                        &nbsp;&nbsp;
                                                        <span class="eventsub_dl_link manual">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;" class="manual_link" href="/sso/pdf/manual/<?php echo $eventName; ?><?php echo $eventsubName; ?>.pdf" target="_blank">説明書</a>
                                                        </span>
                                                    </div>-->
                                                </td>
...
<!--                                                    <div class="pc_dl_area">
                                    ...
                                    <?php foreach($dispItemInfo['comiket_div_lbls'] as $key => $val) : ?>
                                        <?php if ($eveOutForm->comiket_div() == $key) : ?>
                                            <?php if($eveOutForm->event_cd_sel() == '2') :  // コミケの場合?>
                                                ...
                                                <?php if($eveOutForm->comiket_div() == Sgmov_View_Sso_Common::COMIKET_DEV_BUSINESS) : ?>
                                                <?php $val = '請求書にて請求'; ?>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                            <?php echo $val; ?>
                            ...
                            <?php if ($eveOutForm->comiket_div() == Sgmov_View_Sso_Common::COMIKET_DEV_BUSINESS) : // 法人 and 顧客コードを使用する ?>
                                <dl>
...
<!--                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_mail_retype')) { echo ' class="form_error"'; } ?>>
                                        <?php echo $eveOutForm->comiket_mail_retype();?>
                                </dd>
                            </dl>-->
                            <?php // if($eveOutForm->event_cd_sel() != '4') : ?>
                            <?php if($eveOutForm->comiket_customer_kbn_sel() == '1') : ?>
                                                        ...
                                                        <tr>
                                                                <td style="padding-right: 20px;">
                                                                    ...
                                                                    <?php if(empty($comiketId)) : ?>
                                                                        <?php
//                                                                            echo Sgmov_View_Sso_Confirm::_getLabelSelectPulldownData($eveOutForm->building_name_ids(), $eveOutForm->building_name_lbls(), $eveOutForm->building_name_sel());
                                                                        ?>
                                                                        <?php /*
                                                                         ...
                                                                         */ ?>
                                                                        <?php
                                                                            echo Sgmov_View_Sso_Confirm::_getLabelSelectPulldownData($eveOutForm->building_booth_position_ids(), $eveOutForm->building_booth_position_lbls(), $eveOutForm->building_booth_position_sel());
                                                                        ?>
                                                                    <?php else: ?>
                                                                            <?php
                                                                            ...
                                                                            <?php endif; ?>
                                                                            <?php /*
                                                                            <?php echo $eveOutForm->building_name(); ?><span style="font-size: 0.5em;">ホール</span>&nbsp;&nbsp;
                                                                             * 
                                                                             */ ?>
                                                                            
                                                                            <?php echo $eveOutForm->building_booth_position(); ?>
                                                                            <?php if ($eveOutForm->comiket_booth_num() != '0000') : ?>
...
<!--                                    <br/>
                                    <br/>
                                    <strong class="red">※ イベント当日に、現地で連絡がとれる番号</strong>-->
                                </dd>
                            </dl>
                            <dl style="display: none;">
...
<?php /**********************************************************************************************************************/ ?>
                            <div class="dl_block input-outbound comiket_block">
                                ...
                                <dl>
                                    ...
                                    <dd>
<?php
        echo Sgmov_View_Sso_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_detail_outbound_pref_cds(), $eveOutForm->comiket_detail_outbound_pref_lbls(), $eveOutForm->comiket_detail_outbound_pref_cd_sel());
?>
                                            <?php // echo $eveOutForm->comiket_detail_outbound_pref_cd_sel_num();?>
<!--                                        <br/>
                                        <br/>
                                        <strong class="red">※沖縄県はご利用いただけません</strong>-->
                                    </dd>
                                </dl>
                                <dl>
...
<?php
        $outboundCollectDateYear = Sgmov_View_Sso_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_detail_outbound_collect_date_year_cds(), $eveOutForm->comiket_detail_outbound_collect_date_year_lbls(), $eveOutForm->comiket_detail_outbound_collect_date_year_sel());
        echo $outboundCollectDateYear;
?>
                                        年
<?php
        $outboundCollectDateMonth = Sgmov_View_Sso_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_detail_outbound_collect_date_month_cds(), $eveOutForm->comiket_detail_outbound_collect_date_month_lbls(), $eveOutForm->comiket_detail_outbound_collect_date_month_sel());
        echo $outboundCollectDateMonth;
?>
                                        月

<?php
        $outboundCollectDateDay = Sgmov_View_Sso_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_detail_outbound_collect_date_day_cds(), $eveOutForm->comiket_detail_outbound_collect_date_day_lbls(), $eveOutForm->comiket_detail_outbound_collect_date_day_sel());
        echo $outboundCollectDateDay;
?>
                                        日
                                        （<?php echo Sgmov_View_Sso_Confirm::_getWeek($outboundCollectDateYear, $outboundCollectDateMonth, $outboundCollectDateDay); ?>）
                                        &nbsp;
...
<?php
        if ( $view->checkColAndDelTime("outbound", $eveOutForm->comiket_div(), $eveOutForm->comiket_detail_outbound_service_sel(), $dispItemInfo["eventsub_selected_data"]) ) {
            echo Sgmov_View_Sso_Confirm::_getTimeFormatSelectPulldownData($eveOutForm->comiket_detail_outbound_collect_time_cds(), $eveOutForm->comiket_detail_outbound_collect_time_lbls(), $eveOutForm->comiket_detail_outbound_collect_time_sel());
        }
?>
                                    </dd>
                                </dl>
                                ...
                                <dl>
                                    ...
                                    <dd>
<?php
        $outboundDeliveryDateYear = Sgmov_View_Sso_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_detail_outbound_delivery_date_year_cds(), $eveOutForm->comiket_detail_outbound_delivery_date_year_lbls(), $eveOutForm->comiket_detail_outbound_delivery_date_year_sel());
        echo $outboundDeliveryDateYear;
?>
                                        年
<?php
        $outboundDeliveryDateMonth = Sgmov_View_Sso_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_detail_outbound_delivery_date_month_cds(), $eveOutForm->comiket_detail_outbound_delivery_date_month_lbls(), $eveOutForm->comiket_detail_outbound_delivery_date_month_sel());
        echo $outboundDeliveryDateMonth;
?>
                                        月
<?php
        $outboundDeliveryDateDay = Sgmov_View_Sso_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_detail_outbound_delivery_date_day_cds(), $eveOutForm->comiket_detail_outbound_delivery_date_day_lbls(), $eveOutForm->comiket_detail_outbound_delivery_date_day_sel());
        echo $outboundDeliveryDateDay;
?>
                                        日
                                        （<?php echo Sgmov_View_Sso_Confirm::_getWeek($outboundDeliveryDateYear, $outboundDeliveryDateMonth, $outboundDeliveryDateDay); ?>）
                                        &nbsp;
                                        <!--<p style="float: left;padding: 0px;">-->
                                        14:00～16:00
                                        <!--</p>-->
<?php
//        echo Sgmov_View_Sso_Confirm::_getTimeFormatSelectPulldownData($eveOutForm->comiket_detail_outbound_delivery_time_cds(), $eveOutForm->comiket_detail_outbound_delivery_time_lbls(), $eveOutForm->comiket_detail_outbound_delivery_time_sel());
?>
                                    </dd>
                                </dl>
                                ...
                                <dl>
                                    <dt id="comiket_detail_outbound_binshu">
                                        便種
                                    </dt>
                                    <dd>
                                        <?php if ($eveOutForm->comiket_detail_outbound_binshu_kbn_sel() == '0') : ?>
                                            飛脚宅配便
                                        <?php elseif ($eveOutForm->comiket_detail_outbound_binshu_kbn_sel() == '1') : ?>
                                            飛脚クール便（冷蔵）
                                        <?php else: ?>
                                            飛脚クール便（冷凍）
                                        <?php endif; ?>
                                        ...
                                        <table>
                                            <tr>
                                                <td class='box_table_td' style='vertical-align: middle;width:40%;'>
                                                    <table>
                                                        <?php // if($eveOutForm->comiket_div() == Sgmov_View_Sso_Common::COMIKET_DEV_INDIVIDUA) : ?>
                                                            <table>
                                                ...
                                                <td style='padding-top:5px;'>
                                                    <?php if($eveOutForm->comiket_div() == Sgmov_View_Sso_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
                                                        <!--<img src='/sso/images/about_boxsize.png' width='80%'/>-->
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                        </table>
...
<!--                                                    <br/>
                                                    <strong class="red">※ 4種類までしか入力できません</strong>
                                                    <br/>
                                                    <br/>
                                                    <strong class="red">※ 5種類以上の申込がある場合は、再度、新規申込をお願いします</strong><br/><br/>
                                ...
                                <?php if ($eveOutForm->comiket_detail_outbound_service_sel() == "2") : // カーゴ ?>
                                    <dl class="service-outbound-item" service-id="2">
                                        ...
                                        <dd>
<?php
                                                echo Sgmov_View_Sso_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_cargo_outbound_num_cds(), $eveOutForm->comiket_cargo_outbound_num_lbls(), $eveOutForm->comiket_cargo_outbound_num_sel());
?>台
                                ...
                                <?php if ($eveOutForm->comiket_detail_outbound_service_sel() == "3") : // 貸切 ?>
                                    <dl class="service-outbound-item" service-id="3">
                                        ...
                                        <dd<?php if (isset($e) && $e->hasErrorForId('comiket_charter_outbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                            ...
                                            <?php elseif($eveOutForm->comiket_div() == Sgmov_View_Sso_Common::COMIKET_DEV_BUSINESS) : // 法人  ?>
                                                <div class="comiket-charter-outbound-num" div-id="<?php echo Sgmov_View_Sso_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                                    <table>
...
<!--                                    <dl>
                            搬出
                                ...
                                <dl>
                                    ...
                                    <dd>
<?php
        echo Sgmov_View_Sso_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_detail_inbound_pref_cds(), $eveOutForm->comiket_detail_inbound_pref_lbls(), $eveOutForm->comiket_detail_inbound_pref_cd_sel());
?>
<!--                                        <br/>
                                        <br/>
                                        <strong class="red">※沖縄県はご利用いただけません</strong>-->
                                ...
                                <dl>
                                    <dt id="comiket_detail_inbound_binshu">
                                        便種選択<span>必須</span>
                                    </dt>
                                    <dd>
                                        <?php if ($eveOutForm->comiket_detail_inbound_binshu_kbn_sel() == '0') : ?>
                                            飛脚宅配便
                                        <?php elseif ($eveOutForm->comiket_detail_inbound_binshu_kbn_sel() == '1') : ?>
                                            飛脚クール便（冷蔵）
                                        <?php else: ?>
                                            飛脚クール便（冷凍）
                                        <?php endif; ?>
...
<?php
        $inboundCollectDateYear = Sgmov_View_Sso_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_detail_inbound_collect_date_year_cds(), $eveOutForm->comiket_detail_inbound_collect_date_year_lbls(), $eveOutForm->comiket_detail_inbound_collect_date_year_sel());
        echo $inboundCollectDateYear;
?>
                                        年
<?php
        $inboundCollectDateMonth = Sgmov_View_Sso_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_detail_inbound_collect_date_month_cds(), $eveOutForm->comiket_detail_inbound_collect_date_month_lbls(), $eveOutForm->comiket_detail_inbound_collect_date_month_sel());
        echo $inboundCollectDateMonth;
?>
                                        月
<?php
        $inboundCollectDateday = Sgmov_View_Sso_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_detail_inbound_collect_date_day_cds(), $eveOutForm->comiket_detail_inbound_collect_date_day_lbls(), $eveOutForm->comiket_detail_inbound_collect_date_day_sel());
        echo $inboundCollectDateday;
?>
                                        日
                                        （<?php echo Sgmov_View_Sso_Confirm::_getWeek($inboundCollectDateYear, $inboundCollectDateMonth, $inboundCollectDateday); ?>）
                                        &nbsp;14:00～20:00
<?php
//        echo Sgmov_View_Sso_Confirm::_getTimeFormatSelectPulldownData($eveOutForm->comiket_detail_inbound_collect_time_cds(), $eveOutForm->comiket_detail_inbound_collect_time_lbls(), $eveOutForm->comiket_detail_inbound_collect_time_sel());
?>
                                    </dd>
                                </dl>
                                <dl style="display: none;">
...
//                                        ($eveOutForm->comiket_div() == Sgmov_View_Sso_Common::COMIKET_DEV_INDIVIDUA && !($eveOutForm->comiket_detail_type_sel() == "2" && $eveOutForm->comiket_detail_inbound_service_sel() == "2" ) )
//                                        || ($eveOutForm->comiket_div() == Sgmov_View_Sso_Common::COMIKET_DEV_BUSINESS && $eveOutForm->comiket_detail_inbound_service_sel() == "1")) :
                                ...
                                <dl>
                                    ...
                                    <dd>
<?php
        $inboundDeliverydateYear = Sgmov_View_Sso_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_detail_inbound_delivery_date_year_cds(), $eveOutForm->comiket_detail_inbound_delivery_date_year_lbls(), $eveOutForm->comiket_detail_inbound_delivery_date_year_sel());
        echo $inboundDeliverydateYear;
?>
                                        年
<?php
        $inbounddeliverydateMonth = Sgmov_View_Sso_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_detail_inbound_delivery_date_month_cds(), $eveOutForm->comiket_detail_inbound_delivery_date_month_lbls(), $eveOutForm->comiket_detail_inbound_delivery_date_month_sel());
        echo $inbounddeliverydateMonth;
?>
                                        月
<?php
        $inboundDeliveryDateDay = Sgmov_View_Sso_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_detail_inbound_delivery_date_day_cds(), $eveOutForm->comiket_detail_inbound_delivery_date_day_lbls(), $eveOutForm->comiket_detail_inbound_delivery_date_day_sel());
        echo $inboundDeliveryDateDay;
?>
                                        日
                                        （<?php echo Sgmov_View_Sso_Confirm::_getWeek($inboundDeliverydateYear, $inbounddeliverydateMonth, $inboundDeliveryDateDay); ?>）
                                        &nbsp;
<?php
        if ( $view->checkColAndDelTime("inbound", $eveOutForm->comiket_div(), $eveOutForm->comiket_detail_inbound_service_sel(), $dispItemInfo["eventsub_selected_data"]) ) :
            echo Sgmov_View_Sso_Confirm::_getTimeFormatSelectPulldownDataForInBound($eveOutForm->comiket_detail_inbound_delivery_time_cds(), $eveOutForm->comiket_detail_inbound_delivery_time_lbls(), $eveOutForm->comiket_detail_inbound_delivery_time_sel());
        endif;
?>
                                        <br/>
                                        <br/>
...
<!--                                                <br/>
                                                ...
                                                <br/>
                                                <br/>
                                                <a href="/sso/pdf/example/example_box_size.pdf" target="_blank" style="color:blue;">サイズの目安</a>-->
                                            <?php endif; ?>
                                        </dd>
                                    </dl>
                                <?php endif; ?>
                                <?php if ($eveOutForm->comiket_detail_inbound_service_sel() == "2") : // カーゴ ?>
                                    <dl class="service-outbound-item" service-id="2">
                                        ...
                                        <dd>
<?php
                                                echo Sgmov_View_Sso_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_cargo_inbound_num_cds(), $eveOutForm->comiket_cargo_inbound_num_lbls(), $eveOutForm->comiket_cargo_inbound_num_sel());
?>台
                                        </dd>
                                    </dl>
                                <?php endif; ?>
...
<?php if($eveOutForm->comiket_div() == Sgmov_View_Sso_Common::COMIKET_DEV_BUSINESS) : // 法人 ?>
...
<?php if($eveOutForm->comiket_div() == Sgmov_View_Sso_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
    ...
    <?php if ($eveOutForm->comiket_payment_method_cd_sel() === '1') : ?>
                        ...
                        <div class="btn_area">
                            <a class="back" href="/sso/<?php echo $dispItemInfo['back_input_path']; ?>/">修正する</a>
                            <?php if (@empty($dispItemInfo['is_cancel'])) : ?>
    ...
    <?php if ($eveOutForm->comiket_payment_method_cd_sel() == '2') : // クレジット ?>
                        ...
                        <div class="dl_block">
                            ...
                            <?php $cardYearCdSel = @$eveOutForm->card_expire_year_cd_sel(); ?>
                            <?php if (@!empty($cardYearCdSel)) : // サイズが何も入力しなかったら直接本画面に遷移して、以下の値が入っていないため非表示にする?>
                                <dl>
                                    <dt>有効期限</dt>
                                    <dd>
                        ...
                        <div class="btn_area">
                            ...
                            <?php if (@empty($dispItemInfo['is_cancel'])) : ?>
                                <a class="back" href="/sso/size_change_credit_card/">修正する</a>
                                <input id="submit_button" type="submit" name="submit" value="入力内容を送信する" />
                            <?php else: ?>
                                <input id="submit_button" type="submit" name="submit" value="キャンセル送信する" />
                            <?php endif; ?>
    ...
    <?php if ($eveOutForm->comiket_payment_method_cd_sel() == '3') : // 電子マネー ?>
       ...
       <strong class="red">※電子マネーでのお支払いは、￥10,000を超える場合はお取り扱い出来ません。</strong>
        <div class="btn_area">
            <a class="back" href="/sso/size_change/">修正する</a>
            <?php if (@empty($dispItemInfo['is_cancel'])) : ?>
                <input id="submit_button" type="submit" name="submit" value="入力内容を送信する" />
            <?php else: ?>
                <input id="submit_button" type="submit" name="submit" value="キャンセル送信する" />
...
?>
    <!--<script charset="UTF-8" type="text/javascript" src="/sso/js/input.js"></script>-->
    <script>
        $(function() {
