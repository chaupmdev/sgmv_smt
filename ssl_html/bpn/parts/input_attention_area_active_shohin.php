...
<?php
                        ...
                        // 迷惑メールエリア
                        ///////////////////////////////////////////////
                        include_once dirname(__FILE__) . '/input_attention_area_spammail_active_shohin.php';
?>
                        <!--▲ご連絡メールが届かない場合ここまで-->
                        <!--▼個人情報の取り扱いここから-->
<!--                         <div id="privacy_policy" class="accordion">
                            <h3 class="accordion_button" data-id = "act2">個人情報の取り扱い</h3>
                            <div id="privacy_contents" class="ac_content act">
                                <p class="sentence">
                       ...
                       <!--  <div id="transactions" class="accordion">
                            <h3 class="accordion_button" data-id = "act3">特定商取引法に基づく表記</h3>
                            <div id="transactions_contents" class="ac_content act">
                                <dl>
                                    <dt>販売業者：</dt>
                                    <dd>SGムービング株式会社</dd>
                                </dl>
                                ...
                                <dl>
                                    <dt>お支払方法：</dt>
                                    <dd>
                                        <?php //$payType = "クレジットカード支払い（一括支払いのみ）";
                                        //if($bpn001Out->bpn_type() == "2"){
                                          //  $payType = "電子マネー";
                                       // }
                                       // if(@!empty($bpn001Out) && $bpn001Out->eventsub_cd_sel() == "302" && $bpn001Out->shohin_pattern() == "2"){
                                          //  $payType = "電子マネーのみ";
                                       // }?>
                                        &#9312;<?php //echo $payType;?>
                                    </dd>
                                ...
                                <?php //if(@!empty($bpn001Out) && $bpn001Out->eventsub_cd_sel() !== "302" && $bpn001Out->bpn_type() !== "2" && $bpn001Out->shohin_pattern() !== "2"):?>
                                <dl>
                                    <dt>キャンセル：</dt>
                                    <dd>
                                        申し込みをキャンセルされたい場合は、お手数ですがお客様ご自身でSGムービングにご連絡頂き、キャンセルをお申し出ください。
                                    </dd>
                                </dl>
                                 <?php // endif;?>
                            </div>
