        ...
        <div class="wrap clearfix">
            ...
            <div style="font-size: 14px; display: none">
                ...
                <table style="margin-top: 5px;">
                    <tr>
                        <td>
                            <a href="/evp/excel/estimate/コミックマーケット96スマートコンテナ御見積依頼書.xlsx" target="_blank" style="color: #1774bc; text-decoration: underline;">
...
?>
            <div class="section other">
                <form action="/evp/check_input2" data-feature-id="<?php echo Sgmov_View_Evp_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Evp_Common::GAMEN_ID_EVE001 ?>" method="post">
...
<?php
        ...
        //if(strpos($eventName,'デザインフェスタ') !== false){
            echo '<br><br><img src="/evp/images/logo.png">';
        //}
?>
...
<!--    <div class="eventsub_dl_link manual" >
        ...
        <a style="color: blue;" class="manual_link" href="/evp/pdf/manual/<?php echo $eventName; ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">説明書</a>
    </div>-->
</div>
<?php endif; ?>
                            ...
                            <!-- 2022-03-22 ToanDD3 impelement SMT6-84 -->
                            <?php if ($userType === 0) : ?>
                                <dl>
                                    <dt id="comiket_mail">
                                        メールアドレス
...
<?php
                                                echo @$eve001Out->building_cd_and_name_sel();
?>
                                                                <span style="font-size: 0.5em;">ホール</span>
                                                                <input type="hidden" name="building_name" value="<?php echo $eve001Out->building_name(); ?>" />
                                                                <input type="hidden" name="building_cd_and_name_sel"  value="<?php echo $eve001Out->building_name(); ?>" />
                                                                &nbsp;
<?php
...
?>
    ...
    ></script>
    <script charset="UTF-8" type="text/javascript" src="/evp/js/input2.js?<?php echo $strSysdate; ?>"></script>
