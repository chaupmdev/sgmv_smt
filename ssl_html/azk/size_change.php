...
Sgmov_Lib::useView('azk/SizeChange');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Azk_SizeChange();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/azk/size_change_check_input" data-feature-id="<?php echo Sgmov_View_Azk_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Azk_Common::GAMEN_ID_AZK001 ?>" method="post">
...
<?php
                        ...
                        // 預かり入力エリア
                        ///////////////////////////////////////////////
                        include_once dirname(__FILE__) . '/parts/input_azuke_size_change.php';
...
?>
                    ...
                    <p id="contact" class="sentence">
                        お問い合わせ先 
                        <br />
                        SGムービング 手荷物預かり係　03-5857-2462(10:00～17:00) 
                        <br />
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/dsn/js/input.js?<?php echo $strSysdate; ?>"></script>
</body>
</html>
