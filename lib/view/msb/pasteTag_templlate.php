...
class Sgmov_View_Dsn_PasteTag {
	...
	private function publish($comiket) {
		...
		$sum_num = 4;
		 $comiket = array('event_id' => '25',
                'eventsub_id' => '26',
                'which_day' => '1',
                'event_name' => 'デザインフェスタ',
                'eventsub_name' => 'vol.53',
                'building_display' => '1',
                'delivery_date' => '2021/05/28',
                'service' => '1',
                'sum_num' => $sum_num,
                'building_name' => 'B',
                'booth_position' => 'C',
