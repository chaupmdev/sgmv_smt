                                ...
                                <tr <?php if ($value["soldOutCnt"] != 9999 && isset($e) && 
                                    ...
                                    echo ' class="form_error"';
                                        ...
                                        <td class ="vat" <?php if(!$termFlg):?> colspan="2" <?php endif;?> <?php echo $bgClr; ?>>
                                            ...
                                            <div class = "suuryo-div lbl tac" style="width:60% !important;display: inline-block;">
                                                <?php if($value["soldOutCnt"] == 9999 ): ?>
                                                    <span class="fwb clr-rd soldout-span">SOLD OUT</span>
                                                <?php else: ?>数量&emsp;
                                                    <?php if($value["suryo_flg"] == 0): ?>
                                                        <span class="fwb" style="font-size: 13px;">1</span>
                                                        <input autocapitalize="off" maxlength="2" name="comiket_box_buppan_num_ary[<?php echo $value['id']?>]" class="suuryo_<?php echo $value['id']; ?> suuryo-input" type="hidden" 
                                                                value="1" />
                                                    <?php else: ?>
                                                        <select name="comiket_box_buppan_num_ary[<?php echo $value['id']?>]" class = "suuryo-select">
                                                            <?php
                                                                echo Sgmov_View_Bpn_Common::_createPulldown($bpn001Out->comiket_box_buppan_num_ids(), $bpn001Out->comiket_box_buppan_num_lbls(), $bpn001Out->comiket_box_buppan_num_sel($value['id']));
                                                            ?>
                                                        </select>
