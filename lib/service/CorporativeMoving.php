 ...
 * @copyright  2009-2010 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_Service_CorporativeMoving
{
    ...
    public function insert($db, $data)
    {
        ...
        $query = 'INSERT INTO corp_movings(';
        ...
        $db->begin();
        Sgmov_Component_Log::debug("####### START INSERT corp_movings #####");
        $db->executeUpdate($query, $params);
        Sgmov_Component_Log::debug("####### END INSERT corp_movings #####");
        $db->commit();
    }
}
?>
