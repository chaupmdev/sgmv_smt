...
Sgmov_Lib::useView('pcm/Complete');
/**#@-*/

// 処理を実行
$view = new Sgmov_View_Pcm_Complete();
$forms = $view->execute();

/**
 * フォーム
 * @var Sgmov_Form_Pcm003Out
 */
$pcm003Out = $forms['outForm'];
?>
<!DOCTYPE html>
...
<head>
    ...
    <meta property="og:url" content="https://www.sagawa-mov.co.jp/pcm/complete/">
    ...
    <title>引越輸送のお問い合わせの完了｜<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/meta-ttl.php'); ?></title>
...
<body>
    ...
    <div id="main">
        <div class="pageTitle style01">
            <div class="comBox">
                <h1 class="topLead">送信完了<em>Complete</em></h1>
                <ul id="pagePath">
                    <li><a href="/"><img class="home" src="/img/common/icon54.jpg" alt=""></a></li>
                    <li><a href="/contact/">お問い合わせ</a></li>
                    <li><a href="/pin/input/">引越輸送のお問い合わせ</a></li>
