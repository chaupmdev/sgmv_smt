...
class UpopRefundResponseDto extends MdkBaseDto
{
     ...
     * @return トランザクションID(取引毎につけるID)<br>
     */
     ...
     * @param custTxn トランザクションID(取引毎につけるID)<br>
     */
    ...
    /**
     * 決済時刻（日本時間）を設定する<br>
     * @param txnDatetimeJp 決済時刻（日本時間）<br>
     */
    ...
    /**
     * 決済時刻（中国時間）を設定する<br>
     * @param txnDatetimeCn 決済時刻（中国時間）<br>
     */
    ...
    /**
     * 返品後の金額を設定する<br>
     * @param remainingAmount 返品後の金額<br>
     */
    ...
    /**
     * 清算通貨種類を設定する<br>
     * @param settleCurrency 清算通貨種類<br>
     */
     ...
     * @param upopOrderId 決済センターとの取引ID<br>
     */
