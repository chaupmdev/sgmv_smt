...
Sgmov_Lib::useServices(array(
    'Comiket', 'ComiketDetail', 'ComiketBox', 'Shohin', 'CenterMail', 'SgFinancial', 'HttpsZipCodeDll', 'CargoFare', 'Charter'
));
 ...
 * #@-
 */
class Sgmov_View_Qrc_ReSendMail extends Sgmov_View_Qrc_Common
{
