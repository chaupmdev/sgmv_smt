...
//        dispComiketDetailOutboundCollectTimeByDivAndType();
        ...
        // 搬入：時間帯初期設定
        if($('input[name="comiket_detail_type_sel"]:checked').val() == "1" ) {
            $('select[name=comiket_detail_outbound_delivery_time_sel]').val("00");
        }

        // 搬出：時間帯初期設定
        if($('input[name="comiket_detail_type_sel"]:checked').val() == "2" ) {
...
//        dispZipMark();
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // 搬出選択時「※ご利用可能な電子マネーはこちら」の文言を表示する
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
//                $('.paste_tag_link').attr("href", "/"+dirDiv+"/pdf/paste_tag/paste_tag_" + eventsubSel + ".pdf");
//                $('.manual_link').attr("href", "/"+dirDiv+"/pdf/manual/manual_" + eventsubSel + ".pdf");

                $('.manual').show(g_fifoVal);
//                eventSelText = eventSelText.replace(/\s+/g, "");
//                $('.manual_link').attr("href", "/"+dirDiv+"/pdf/manual/" + eventSelText +  ".pdf" + '?' + strCurrentDate);
            } else {
                $('.manual').hide(g_fifoVal);
            }
            if(g_eventsubList[eventsubSel]['is_paste_display']){
                $('.paste_tag').show(g_fifoVal);
                $('.paste_tag_link').attr("href", "/"+dirDiv+"/pdf/paste_tag/paste_tag_" + eventsubSel + ".pdf" + '?' + strCurrentDate);
            } else {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // 搬入・搬出のラジオボタンが選択された場合、それぞれの入力項目を表示する
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // サービスの種類(宅配便・カーゴ・貸切(チャーター)...)を決定する
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
//        }
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // [法人、搬入の場合]サービスの種類を選択して宅配数量の項目を表示する
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
//            }
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // [個人、搬入の場合]サービスの種類を選択して宅配数量の項目を表示する
    ////////////////////////////////////////////////////////////////////////////////////////////////
    function selectComiketDetailOutboundServiceIndividual() {
        // サービスの種類(宅配便・カーゴ・貸切...)を選択する
        dispOutboundServiceItem();
...
//    }
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // 搬入選択時、サービスの種類を選択して宅配数量の項目を表示する
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
//        var serviceSel = $('input[name="comiket_detail_outbound_service_sel"]:checked').val();
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // [法人、搬出の場合]サービスの種類を選択して宅配数量の項目を表示する
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
//        }
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // [個人、搬出の場合]サービスの種類を選択して宅配数量の項目を表示する
    ////////////////////////////////////////////////////////////////////////////////////////////////
...
//    }
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // 搬出選択時、サービスの種類を選択して宅配数量の項目を表示する
    ////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        sgwns.api('/common/php/SearchBox.php', getFormData(), (function(data) {
            ...
            if($('input[name="comiket_detail_type_sel"]:checked').val() == "1" ) { // 搬入
                ...
                for(var i = 0; i < data.outbound.length; i++) {
                    ...
                    htmlCode += "<tr class = 'box_"+data.outbound[i].size_display+"'><td class='comiket_box_item_name' style = 'vertical-align:top;'>" + boxName + "&nbsp;</td><td class='comiket_box_item_value'><input autocapitalize='off' class='number-only comiket_box_item_value_input' maxlength='2' inputmode='numeric' name='comiket_box_outbound_num_ary[" + data.outbound[i].id  + "]' data-pattern='^\d+$' placeholder='例）1' type='" + inputTypeNumber + "' style='min-width:100px;' value='' />個</td></tr>";
                }
                htmlCode += "</table>";

                htmlCode += "</td><td style='vertical-align: middle;text-align: right;'>";
                if($('input[name="comiket_div"]:checked').val() ==  G_DEV_INDIVIDUAL) {
                    htmlCode += "<img class='dispSeigyoPC' src='/"+dirDiv+"/images/about_boxsize.png' width='100%'/>";
                } else {
//                    htmlCode += "<img src='/"+dirDiv+"/images/about_boxsize.png' width='100%' style='visibility:hidden;'/>";
                }
                htmlCode += "</td></tr></table>";

                if($('input[name="comiket_div"]:checked').val() ==  G_DEV_INDIVIDUAL && $('.dispSeigyoSP').length === 0) {
                    htmlCode += "<div class='dispSeigyoSP'><img src='/"+dirDiv+"/images/about_boxsize.png' width='250px' style='margin-top: 1em;' /></div>";
                }
                ...
                for(var i = 0; i < data.inbound.length; i++) {
                    ...
                    htmlCode += "<tr class = 'box_"+data.inbound[i].size_display+"'><td class='comiket_box_item_name' style = 'vertical-align:top;'>" + boxName + "&nbsp;</td><td class='comiket_box_item_value'><input autocapitalize='off' class='number-only comiket_box_item_value_input' maxlength='2' inputmode='numeric' name='comiket_box_inbound_num_ary[" + data.inbound[i].id  + "]' data-pattern='^\d+$' placeholder='例）1' type='" + inputTypeNumber + "'  style='min-width:100px;' value='' />個</td></tr>";
                }
                htmlCode += "</table>";

                htmlCode += "</td><td class='dispSeigyoPC' style='vertical-align: middle;text-align: right;'>";
                if($('input[name="comiket_div"]:checked').val() ==  G_DEV_INDIVIDUAL) {
                    htmlCode += "<img src='/"+dirDiv+"/images/about_boxsize.png' width='100%'/>";
                }
                htmlCode += "</td></tr></table>";
                ...
                var htmlCode = "";
                if($('input[name="comiket_div"]:checked').val() ==  G_DEV_INDIVIDUAL) {
                    htmlCode += "<table><tr><td style='width: 50%;>";
                }
                ...
                for(var i = 0; i < data.outbound.length; i++) {
                    ...
                    htmlCode += "<tr class = 'box_"+data.outbound[i].size_display+"'><td class='comiket_box_item_name'>" + boxName + "&nbsp;</td><td class='comiket_box_item_value'><input autocapitalize='off' class='number-only comiket_box_item_value_input' maxlength='2' inputmode='numeric' name='comiket_box_outbound_num_ary[" + data.outbound[i].id  + "]' data-pattern='^\d+$' placeholder='例）1' type='" + inputTypeNumber + "' value='' /></td></tr>";
                }
                htmlCode += "</table>";
                htmlCode += "</td>";
                if($('input[name="comiket_div"]:checked').val() ==  G_DEV_INDIVIDUAL) {
                   // htmlCode += "<img class='dispSeigyoPC' src='/jtb/images/about_boxsize.png' width='100%'/>";
                }
                htmlCode += "</tr></table>";
                // 搬入
                $('.comiket-box-outbound-num').append(htmlCode);
                ...
                for(var i = 0; i < data.inbound.length; i++) {
                    ...
                    htmlCode2 += "<tr class = 'box_"+data.inbound[i].size_display+"'><td class='comiket_box_item_name'>" + data.inbound[i].name + "&nbsp;</td><td class='comiket_box_item_value'><input autocapitalize='off' class='number-only comiket_box_item_value_input' maxlength='2' inputmode='numeric' name='comiket_box_inbound_num_ary[" + data.inbound[i].id  + "]' data-pattern='^\d+$' placeholder='例）1' type='" + inputTypeNumber + "' style='min-width:60px;' value='' />枚</td></tr>";
                }
                htmlCode2 += "</table>";

                htmlCode2 += "</td>";
                if($('input[name="comiket_div"]:checked').val() ==  G_DEV_INDIVIDUAL) {
                  //  htmlCode2 += "<img class='dispSeigyoPC' src='/jtb/images/about_boxsize.png' width='100%'/>";
                }
                htmlCode2 += "</tr></table>";
...
//        var detailType = $('input[name="comiket_detail_type_sel"]:checked').val();
    ...
    function dispOutboundColAndDelyDate() {
        ...
        // 搬入-お預かり日時のfrom-toが一致している場合の文言制御
        if(g_eventsubList[eventsubSel]['is_eq_outbound_collect'] == true) {
            ...
            // 搬入-お預かり日時の日付が、from to 同じ場合は、時間帯のみ入力可能にする(要件次第で実装)
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $('select[name="travel_departure_cd_sel"]').on('change', (function () {
        //var $paragraph = $('#cargo_collection_date').find('p'),
        //var str = $(this).find(':selected').first().data('date'),
        var value = $(this).val();
        console.log(value);
        var $paragraph = $('#cargo_collection_date').find('p');
        
        var $select = $('select[name="cargo_collection_date_year_cd_sel"]'),
            $selectMonth = $('select[name="cargo_collection_date_month_cd_sel"]'),
            $selectDay = $('select[name="cargo_collection_date_day_cd_sel"]'),
            $selectYearDelivery = $('select[name="delivery_collection_date_year_cd_sel"]'),
            $selectMonthDelivery = $('select[name="delivery_collection_date_month_cd_sel"]'),
            $selectDayDelivery = $('select[name="delivery_collection_date_day_cd_sel"]'),
            begin,
            end,
            beginYear,
            endYear,
...
//        }
        ...
        if (value == 1 || value == 2) {
            ...
            beginYear = begin.getFullYear();
            endYear = end.getFullYear();
            fillDataDate(beginYear, endYear, $select, 'year');

            beginMonth = begin.getMonth() + 1;
            endMonth =  end.getMonth() + 1;

            fillDataDate(beginMonth, endMonth, $selectMonth, 'month');
            //set Day 
            if (beginMonth == endMonth) {
                beginDay = begin.getDate();
                endDay =  end.getDate();
                fillDataDate(beginDay, endDay, $selectDay, 'day');
            }
            
            $paragraph.text(getDate(begin) + 'から' + getDate(end) + 'まで選択できます。');
            $paragraph.show();
            //fill data delivery 
//            fillDataDate(beginYear, endYear, $selectYearDelivery, 'year');
//            fillDataDate(beginMonth, endMonth, $selectMonthDelivery, 'month');
//            fillDataDate(beginDay, endDay, $selectDayDelivery, 'day');
        } else {
            $paragraph.hide();
            fillDataDateEmpty($select, 'year');
            fillDataDateEmpty($selectMonth, 'month');
            fillDataDateEmpty($selectDay, 'day');
            
        }
        let $paragraphDelivery = $('#delivery_collection_date').find('p');
	$paragraphDelivery.html('&nbsp;');
        $paragraphDelivery.hide();
        fillDataDateEmpty($selectYearDelivery, 'year');
        fillDataDateEmpty($selectMonthDelivery, 'month');
        fillDataDateEmpty($selectDayDelivery, 'day');
            
    })).trigger('change');
    
    $('[name=cargo_collection_date_year_cd_sel]').on('change', function(e) {
        if (!$('[name=cargo_collection_date_year_cd_sel]').val()
                || !$('[name=cargo_collection_date_month_cd_sel]').val()
                || !$('[name=cargo_collection_date_day_cd_sel]').val()) {
            return false;
        }
    ...
    $('[name=cargo_collection_date_month_cd_sel]').on('change', function(e) {
        if (!$('[name=cargo_collection_date_year_cd_sel]').val()
                || !$('[name=cargo_collection_date_month_cd_sel]').val()) {
            return false;
        }
        let year = $('[name=cargo_collection_date_year_cd_sel]').val();
        let month = $('[name=cargo_collection_date_month_cd_sel]').val();
        var $selectDay = $('select[name="cargo_collection_date_day_cd_sel"]');
        
        loadingDateDay(year, month, $selectDay, 1);
    ...
    $('[name=cargo_collection_date_day_cd_sel]').on('change', function(e) {
        if (!$('[name=cargo_collection_date_year_cd_sel]').val()
                || !$('[name=cargo_collection_date_month_cd_sel]').val()
                || !$('[name=cargo_collection_date_day_cd_sel]').val()) {
            return false;
    ...
    //delivery_collection_date_month_cd_sel
    $('[name=delivery_collection_date_month_cd_sel]').on('change', function(e) {
        if (!$('[name=delivery_collection_date_year_cd_sel]').val()
                || !$('[name=delivery_collection_date_month_cd_sel]').val()) {
            return false;
        }
        let year = $('[name=delivery_collection_date_year_cd_sel]').val();
        let month = $('[name=delivery_collection_date_month_cd_sel]').val();
        
        var $selectDay = $('select[name="delivery_collection_date_day_cd_sel"]');
        
        loadingDateDay(year, month, $selectDay, 2);
    });
    //画面初期表示
    initScreen();
}(jQuery));
...
function EnableCaremarkFlg() {
    //#comiket_detail_caremark_flg
    $('#comiket_detail_caremark_flg').prop('disabled',false);
    $('#comiket_detail_caremark_flg_enable').val('1');
}

function EnableCaremarkFlgInbound() {
    $('#comiket_detail_caremark_flg_inbound').prop('disabled',false);
    $('#comiket_detail_caremark_flg_enable_inbound').val('1');
}

function fillDataDate(begin, end, elementType, type) {
    var data = {};
    ...
    var option = '<option value="">' + strFirstOption + '</option>';
    $.each(data, (function () {
        option += '<option value="' + this + '">' + this + '</option>';
    }));
    var val = elementType.val();
    elementType.empty().append(option).val(val);
}

function fillDataDateEmpty(elementType, type) {
    var strFirstOption = '';
    if (type == 'day') {
        strFirstOption = '日を選択';
    } else if (type == 'month') {
    ...
    var option = '<option value="">' + strFirstOption + '</option>';
    elementType.empty().append(option);
}

function loadingDateDelivery() {
    let year = $('[name=cargo_collection_date_year_cd_sel]').val();
    let month = $('[name=cargo_collection_date_month_cd_sel]').val();
    let day = $('[name=cargo_collection_date_day_cd_sel]').val();
    ...
    var $paragraphDelivery = $('#delivery_collection_date').find('p');
    $paragraphDelivery.html('&nbsp;');
    $paragraphDelivery.text(getDate(begin) + 'から' + getDate(end) + 'まで選択できます。');
    $paragraphDelivery.show();
    
    var $selectYearDelivery = $('select[name="delivery_collection_date_year_cd_sel"]'),
    $selectMonthDelivery = $('select[name="delivery_collection_date_month_cd_sel"]'),
    $selectDayDelivery = $('select[name="delivery_collection_date_day_cd_sel"]'),
    beginYear, 
    endYear, 
...
function loadingDateDay(year, month, $selectDay, type) {
    var begin;
    var end = new Date();
    if (type == 1) {
        begin = new Date();
        var value = $('select[name="travel_departure_cd_sel"]').val();
        if (value == 1 || value == 2) {
            if (value == 1) {
                begin.setDate(begin.getDate() + 10);
            } else {
        ...
        let yearCargo = $('[name=cargo_collection_date_year_cd_sel]').val();
        let monthCargo = $('[name=cargo_collection_date_month_cd_sel]').val();
        let dayCargo = $('[name=cargo_collection_date_day_cd_sel]').val();
        let str = yearCargo + '-' + monthCargo + '-' + dayCargo;
        begin = new Date(str);
        begin.setDate(begin.getDate() + 2);
        //let end = new Date();
        end.setDate(begin.getDate() + 7);
    }
        //var year = $('select[name="cargo_collection_date_year_cd_sel"]').val();
    ...
    if (beginMonth != endMonth) {
        if (month == beginMonth) {
            beginDay = begin.getDate();
            endDay =  getDaysInMonth(year, beginMonth);
            fillDataDate(beginDay, endDay, $selectDay, 'day');
        } else {
            beginDay = 1;
            endDay = end.getDate();
...
function initScreen () {
    ...
    begin = new Date();
    begin.setDate(begin.getDate() + 7);//TODO
    end = new Date();
    end.setDate(begin.getDate() + 7);//TODO
    beginYear = begin.getFullYear();
    endYear = end.getFullYear();
    fillDataDate(beginYear, endYear, $select, 'year');
