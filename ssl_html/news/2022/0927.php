...
<meta name="description" content="重要なお知らせ 天候不良に伴う荷物のお届けへの影響について（2022 年 9 月 27 日 9 時現在）">
...
<title>重要なお知らせ 天候不良に伴う荷物のお届けへの影響について（2022 年 9 月 27 日 9 時現在）｜ニュース｜<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/meta-ttl.php'); ?></title>
		...
		<div class="mainBox" data-stt-ignore>
			<article id="conts">
				<div class="titleBox fadeInUp">
					<p class="time">2022.09.27<span class="cat-news">お知らせ</span></p>
					<p class="title">重要なお知らせ<br>天候不良に伴う荷物のお届けへの影響について<br>（2022 年 9 月 27 日 9 時現在）</p>
				</div>
				<div class="wpBox fadeInUp">
					<span style="margin-top: 10px">お客さま各位</span>
						<br>
						<br>
						<span>平素より SG ムービングのサービスをご利用いただき誠にありがとうございます。</span><br>
						<span>台風の影響により、以下の地域での荷物のお届け、お預かりに影響が生じております。</span>
						<br>
						<br>
                 	<span>【荷物のお届け、お預かりが遅れる地域】</span>
                <div style="margin-left: 45px">
                	<span>熊本県</span>
					<div style="margin-left: 25px">
						<span>球磨郡（五木村）</span><br>
					</div>
					<div style="margin-left: 45px">
                	<span>宮崎県</span>
					<div style="margin-left: 25px">
						<span>東臼杵郡（椎葉村、諸塚村）</span><br>
					</div>
					<div style="margin-left: 45px">
                	<span>静岡県</span>
					<div style="margin-left: 25px">
						<span>静岡市（駿河区、葵区、清水区）</span><br>
					</div>
					<span>その他の地域におきましても、天候状況などにより荷物のお届け、お預かりに影響が生じる可能性がございます。</span>
					<span>※上記地域から全国にお届けする荷物についても遅れが生じます</span>
				</div>
				<br>
				<span>お客さまには大変ご不便をおかけしますが、ご了承いただきますよう宜しくお願い申し上げます。</span>
				<br><br>
