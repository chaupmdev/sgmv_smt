...
<?php
            echo Sgmov_View_Yid_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
?>
                                    &nbsp;&nbsp;
                                    </span>
...
<?php
            echo Sgmov_View_Yid_Input::_createPulldown($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel(), $eve001Out->eve_timeover_flg(), $eve001Out->eve_timeover_date());
?>
                                        </select>
...
<?php
            echo Sgmov_View_Yid_Input::_createPulldown($eve001Out->eventsub_cds(), $eve001Out->eventsub_lbls(), $eve001Out->eventsub_cd_sel());
?>
                                        </select>
                                            <br/>
                                            <img src="<?=$dispItemInfo['dispEvent']['logoImg']?>" style="margin:10px 0;width:70%;">
                                                    <div class="sp_dl_area2 paste_tag">
                                                        <div class="eventsub_dl_link paste_tag">
                                                            ...
                                                            <a style="color: blue;" class="paste_tag_link" href="<?=$dispItemInfo['dispEvent']['pasteTag1']?>" target="_blank">配達カード(見本)</a>
                                                        </div>
                                                        <br/>
                                                        <strong class="red eventsub_dl_link paste_tag_link paste_tag">
                                                            ※出荷の際、こちらを荷物に貼り付けて出荷をお願いします。<br/><br/>
                                                            ※お申し込み完了画面で出展者名が記載された配達カードを出力できます。
                                                        </strong>
<?php
...
?>
                                                        ...
                                                        <br/>
                                                        <strong style="color:#C00;">※関⻄・中部・北陸・東北・関東エリアにご在住の⽅は申込受付期間が2/26(月)0:00～3/3(日)12:00まで。</strong>
                                                        <br>
                                                        <br>
                                                        <strong style="color:#C00;">※九州・四国・中国・北海道・ ⻘森・沖縄エリアにご在住の⽅は申込受付期間が2/26(月)0:00～3/2(土)12:00まで。</strong>
                                                        <br>
                                                        <br>
                                                        <strong style="color:#C00;">※3/7(木)の夜に、プリズムホール内の各ブースへお届けいたします。</strong>
                                                        <br/>
                                                        <br/>
                                                        <strong style="color:#C00;"><会場搬出受付期間><br>※3/13(水) 23:00まで</strong>
                                                        </div>
<?php } ?>
                                                    </div>
                                                    <!-- <br/> -->
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_pref')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <select name="comiket_pref_cd_sel">
                                        <option value="">選択してください</option>
<?php
        echo Sgmov_View_Yid_Input::_createPulldown($eve001Out->comiket_pref_cds(), $eve001Out->comiket_pref_lbls(), $eve001Out->comiket_pref_cd_sel());
?>
                                    </select>
                                </dd>
                            </dl>
                            ...
                            <dl class="class_building_name_sel">
                                <dt id="building_name_sel" style=" border-bottom: solid 1px #ccc !important;">
                                    エリア、ブース番号<span class ="hissu">必須</span>
                                </dt>
...
<?php // ホール コンボボックス ?>
                                    <span style="margin-bottom: 4px;display: inline-block">エリア</span>
                                    <span style="margin-left: 19%;margin-bottom: 4px;display: inline-block">ブース番号</span>
                                    <br>
...
<?php
                                    // ブースNo コンボボックス 出力
                                         echo Sgmov_View_Yid_Input::_createPulldown($eve001Out->building_booth_position_ids()
