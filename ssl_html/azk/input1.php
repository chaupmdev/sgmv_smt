    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <p class="sentence" style="margin-bottom: 5px;margin-top: 10px;">
                お申し込みから当日までの流れは<a style="color: #1774bc;" href="/azk/pdf/manual/デザインフェスタvol.53.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">こちら</a><br />
...
?>
            <div class="section other">
                <form action="/azk/check_input" data-feature-id="<?php echo Sgmov_View_Azk_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Azk_Common::GAMEN_ID_AZK001 ?>" method="post">
                    <input name="ticket" type="hidden" value="<?php echo $ticket ?>" />
                    <input name="input_mode" type="hidden" value="<?php echo $eve001Out->input_mode(); ?>" />
                    <input name="shikibetsushi" type="hidden" value="<?php echo $eve001Out->shikibetsushi(); ?>" />
...
?>
                    ...
                    <p class = "sentence" style="border:3px solid red;line-height: 2;">
                        <strong class="red">
《注意事項》<br />
・当日受付時に預かり証をお渡しいたします。引き換えに必要となりますので、大切にお持ちください。<br />
・外装のキズ・損傷等については責任を負いません。<br />
・貴重品については責任をおいかねますのでご自身でお持ちください。<br />
・預かり証を紛失された場合は、公的証明書をご提示ください。<br />
・当日のみの預りになります。万が一、当日中にお引き取りできない場合、当方にて処分いたします。<br />
                        </strong>
                    </p>
...
?>
                    ...
                    <p id="contact" class="sentence">
                        お問い合わせ先 
                        <br />
                        SGムービング 手荷物預かりサービス係　03-5857-2462(10:00～17:00) 
                        <br />
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/common/js/inputConvert.js"></script> 
