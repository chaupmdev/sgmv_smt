...
Sgmov_Lib::useView('zzy/Confirm');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Zzy_Confirm();
$forms = $view->execute();
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <div class="section">
                <form action="/zzy/complete" data-feature-id="<?php echo Sgmov_View_Zzy_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Zzy_Common::GAMEN_ID_ZZY001 ?>" method="post">
...
<?php if($eveOutForm->comiket_div() == Sgmov_View_Zzy_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
    ...
    <?php if ($eveOutForm->comiket_payment_method_cd_sel() == '2') : // クレジット ?>
                        ...
                        <div class="btn_area">
                            <a class="back" href="/zzy/credit_card/">修正する</a>
...
<!--       <h4 class="table_title">電子マネー情報</h4>-->
       ...
       <!-- <strong class="red">※電子マネーでのお支払いは、￥10,000を超える場合はお取り扱い出来ません。</strong> -->
        <div class="btn_area" style="padding-top: 0px !important;">
            <a class="back" href="/zzy/<?php echo $dispItemInfo['back_input_path']; ?>">修正する</a>
            <input id="submit_button" type="submit" name="submit" value="入力内容を送信する" />
        </div>
    <?php endif; ?>
