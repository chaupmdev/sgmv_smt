...
$exceptionFlg = FALSE;
// 処理を実行
$view = new Sgmov_View_Qrc_SizeChangeComplete();
$eveOutForm = array();
$eventData = array();
$eventsubData = array();
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <div class="section" style="<?php if (@$isCancelOnly == true) : ?>display:none;<?php endif; ?>">
                ...
                <?php
                if ($eveOutForm->merchant_result() === '1' || $paymentMethodCd === '3') {
                    // 電子マネー
                ?>
                    ...
                    <?php if ($eventsubData['paste_display'] == '1') : ?>
                        ...
                        <div style="font-size:20px;">
                            <a href="/<?= $dirDiv ?>/paste_tag/<?php echo sprintf('%010d', $eveOutForm->qr_code_string()) . Sgmov_View_Qrc_Common::getChkD2($eveOutForm->qr_code_string()); ?>/" target="_blank" style="color:blue;" download>
                    ...
                    <script>
                        $(function() {
                            $("#qrcode-output").qrcode({
                                text: "<?php echo $eveOutForm->qr_code_string(); ?>"
                            });
                        });
                    </script>
