...
//                                ($eveOutForm->comiket_detail_inbound_service_sel() == "1" || $eveOutForm->comiket_detail_inbound_service_sel() == "2") // 宅配、またはカーゴ
                    ...
                    <div style="font-size:20px;">
                        <a href="/<?=$dirDiv?>/paste_tag/<?php echo sprintf('%010d', $eveOutForm->qr_code_string()) . Sgmov_View_Eve_Common::getChkD2($eveOutForm->qr_code_string()); ?>/" target="_blank" style="color:blue;" download>
...
<?php if ($eventsubData['manual_display'] == '1') { ?>
                ...
                <div style="font-size:20px;">
                    <!--<a class="button_link2" href="/<?=$dirDiv?>/pdf/manual/manual_<?php echo $eveOutForm->eventsub_cd_sel(); ?>.pdf" target="_blank" style="color:blue;">-->
                    <a class="button_link2" href="/<?=$dirDiv?>/pdf/manual/<?php echo $eventData['name']; ?><?php echo $eventsubData['name']; ?>.pdf" target="_blank" style="color:blue;">
