...
<head>
    ...
    <link href="/htl/css/eve.css" rel="stylesheet" type="text/css" />
    <!--[if lt IE 9]>
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <div class="section">
                <form action="/htl/complete" data-feature-id="<?php echo Sgmov_View_Eve_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Eve_Common::GAMEN_ID_EVE001 ?>" method="post">
...
<!--                                                    <br/>
                                                    <div class="sp_dl_area">
                                                        <span class="eventsub_dl_link pasete_tag">
                                                            ...
                                                            <a style="color: blue;" class="paste_tag_link" href="/htl/pdf/paste_tag/paste_tag_<?php echo $eveOutForm->eventsub_cd_sel(); ?>.pdf" target="_blank">貼付票</a>
                                                        </span>
                                                        &nbsp;&nbsp;
                                            ...
                                            <tr>
                                                ...
                                                <td style='padding-top:5px;'>
                                                    <?php if($eveOutForm->comiket_div() == Sgmov_View_Eve_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
                                                        <!--<img src='/htl/images/about_boxsize.png' width='80%'/>-->
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                        </table>
...
<!--                                                <br/>
                                                ...
                                                <br/>
                                                <br/>
                                                <a href="/htl/pdf/example/example_box_size.pdf" target="_blank" style="color:blue;">サイズの目安</a>-->
                                            <?php endif; ?>
                                        </dd>
                                    </dl>
                                <?php endif; ?>
...
<?php if($eveOutForm->comiket_div() == Sgmov_View_Eve_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
    ...
    <?php if ($eveOutForm->comiket_payment_method_cd_sel() === '1') : ?>
                        ...
                        <div class="btn_area">
                            <a class="back" href="/htl/<?php echo $dispItemInfo['back_input_path']; ?>/">修正する</a>
    ...
    <?php if ($eveOutForm->comiket_payment_method_cd_sel() == '2') : // クレジット ?>
                        ...
                        <div class="btn_area">
                            <a class="back" href="/htl/credit_card/">修正する</a>
                            <input id="submit_button" type="submit" name="submit" value="入力内容を送信する" />
                        </div>
    ...
    <?php if ($eveOutForm->comiket_payment_method_cd_sel() == '3') : // 電子マネー ?>
       ...
       <strong class="red">※電子マネーでのお支払いは、￥10,000を超える場合はお取り扱い出来ません。</strong>
        <div class="btn_area">
            <a class="back" href="/htl/input/">修正する</a>
            <input id="submit_button" type="submit" name="submit" value="入力内容を送信する" />
        </div>
    <?php endif; ?>
...
?>
    <!--<script charset="UTF-8" type="text/javascript" src="/htl/js/input.js"></script>-->
    <script>
        $(function() {
