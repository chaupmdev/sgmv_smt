                                    ...
                                    <?php if(!$termFlg):?>
                                        <td colspan = "2">
                                            <?php if($value['expiry_status'] == '0'):?>
                                                <span class="lbl cls-kikan-lbl" class="lbl">申込期間：<div class = "period-div"><?php echo date("Y/m/d H:i",strtotime($value['term_fr']))."～".date("Y/m/d H:i",strtotime($value['term_to']));?></div>
                                                        </span>
                                            <?php else: ?>
