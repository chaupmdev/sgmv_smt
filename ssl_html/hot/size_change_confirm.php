...
// 処理を実行
$view = new Sgmov_View_Dsn_SizeChangeConfirm();
$forms = $view->execute();
...
<head>
    ...
    <title>宿泊ホテルより国内配送受付サービスの個数・サイズ変更お申し込み｜お問い合わせ│ＳＧムービング株式会社＜ＳＧホールディングスグループ＞</title>
...
?>
    <div id="breadcrumb">
        <ul class="wrap">
            ...
            <li class="current">宿泊ホテルより国内配送受付サービスの個数・サイズ変更お申し込み</li>
        </ul>
    </div>
    <div id="main">
        <div class="wrap clearfix">
            <h1 class="page_title">宿泊ホテルより国内配送受付サービスの個数・サイズ変更お申し込み</h1>
            <p class="sentence">
            ...
            <div class="section">
                <form action="/<?=$dirDiv?>/size_change_complete" data-feature-id="<?php echo Sgmov_View_Dsn_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Dsn_Common::GAMEN_ID_HOT001 ?>" method="post">
