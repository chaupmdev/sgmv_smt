...
class Sgmov_Form_Qra001In
{
     ...
     * QRコードパラメータ(GET)
     */
    public $qr_uketsuke_no = '';
    public $qr_toiawase_no = '';
    public $qr_toiban = '';
    public $qr_ark_uketsuke_no = '';
    public $qr_kessai_meisai_id = '';
    public $qr_uriage_kingaku = '';
    public $qr_system_kbn = '';
    public $qr_cd = '';
