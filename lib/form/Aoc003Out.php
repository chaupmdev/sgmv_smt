...
class Sgmov_Form_Aoc003Out
{
    ...
    /**
     * エンティティ化されたキャンペーン適用リストを返します。
     * @return string エンティティ化されたキャンペーン適用リスト
     */
    ...
    /**
     * エンティティ化された登録日付リストを返します。
     * @return string エンティティ化された登録日付エリアリスト
     */
   ...
   /**
     * エンティティ化された更新日付リストを返します。
     * @return 'string エンティティ化された更新日付エリアリスト
     */
