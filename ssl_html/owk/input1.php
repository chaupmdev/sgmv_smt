<?php
/**
 * 催事・イベント配送受付サービスのお申し込み入力画面を表示します。
 * @package    ssl_html
 * @subpackage OWK
 * @author     K.Sawada(SCS)
...
Sgmov_Lib::useView('owk/Input');


// 処理を実行
$view = new Sgmov_View_Owk_Input();
$forms = $view->execute();
...
<head>
    ...
    <meta name="Description" content="rooms41サービスのお申し込みのご案内です。" />
...
?>
                ...
                <p class="under" style="line-height: normal;">
                    ...
                    <?php
                        ...
                        if(strpos($selectedEventNmae,'rooms') !== false){
                            echo 'rooms41係';
                        }
                    ?>
...
?>
            <div class="section other">
                <form action="/owk/check_input" data-feature-id="<?php echo Sgmov_View_Owk_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Owk_Common::GAMEN_ID_OWK001 ?>" method="post">
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/owk/js/input.js?<?php echo $strSysdate; ?>"></script>
