...
Sgmov_Lib::useView('evp/SizeChangeConfirm');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Evp_SizeChangeConfirm();
$forms = $view->execute();
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <div class="section">
                <form action="/evp/size_change_complete" data-feature-id="<?php echo Sgmov_View_Evp_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Evp_Common::GAMEN_ID_EVE001 ?>" method="post">
                                                ...
                                                <tr>
                                                    <td style="padding-right: 20px;">
                                                        ...
                                                        <?php if(empty($comiketId)) : ?>
                                                            <?php
                                                                echo Sgmov_View_Evp_Confirm::_getLabelSelectPulldownData($eveOutForm->building_name_ids(), $eveOutForm->building_name_lbls(), $eveOutForm->building_name_sel());
                                                            ?>
                                                        ...
                                                        <?php else: ?>
                                                                ...
                                                                その他&nbsp;その他&nbsp;0000
                                                                <?php endif; ?>
                                                                <?php echo $eveOutForm->building_name(); ?><span style="font-size: 0.5em;">ホール</span>&nbsp;<?php echo $eveOutForm->building_booth_position(); ?><span style="font-size: 0.5em;">ブロック</span>
                                                        <?php endif; ?>
...
<?php if($eveOutForm->comiket_div() == Sgmov_View_Evp_Common::COMIKET_DEV_BUSINESS) : // 法人 ?>
...
<?php if($eveOutForm->comiket_div() == Sgmov_View_Evp_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
    ...
    <?php if ($eveOutForm->comiket_payment_method_cd_sel() == '2') : // クレジット ?>
                        ...
                        <div class="btn_area">
                            ...
                            <?php if (@empty($dispItemInfo['is_cancel'])) : ?>
                                <a class="back" href="/evp/size_change_credit_card/">修正する</a>
                                <input id="submit_button" type="submit" name="submit" value="入力内容を送信する" />
                            <?php else: ?>
                                <input id="submit_button" type="submit" name="submit" value="キャンセル送信する" />
                            <?php endif; ?>
    ...
    <?php if ($eveOutForm->comiket_payment_method_cd_sel() == '3') : // 電子マネー ?>
       ...
       <strong class="red">※電子マネーでのお支払いは、￥10,000を超える場合はお取り扱い出来ません。</strong>
        <div class="btn_area">
            <a class="back" href="/evp/size_change/">修正する</a>
            <?php if (@empty($dispItemInfo['is_cancel'])) : ?>
                <input id="submit_button" type="submit" name="submit" value="入力内容を送信する" />
            <?php else: ?>
                <input id="submit_button" type="submit" name="submit" value="キャンセル送信する" />
