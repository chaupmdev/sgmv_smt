...
//                var nowI  = nowDate.getMinutes();
//                var dispDay='2022年07月19日（火）'
//
//                var nowS  = nowDate.getSeconds();
//                if(nowD<=15 || (nowD==15 && nowH<12)){
////                if(nowD<=6 || (nowD==7 && nowH<17)){
//                      if(toDt=='2022-07-18'){
//                          dispDay='2022年07月18日（月）';
//                      }
//                    changeMessage= '2022年07月16日（土）から'+dispDay+'まで選択できます。'
//                    var frDt = '2022-07-16';
//                    var toDt = toDt;
//                }
