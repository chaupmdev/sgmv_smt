...
abstract class Sgmov_View_Dsn_Common extends Sgmov_View_Public {
     ...
     * イベントサブID
     */
    const EVENT_SUB_ID = '1200';

    /**
     * DSN001の画面ID
     */
    const GAMEN_ID_DSN001 = 'JNS001';

    /**
     * DSN002の画面ID
     */
    const GAMEN_ID_DSN002 = 'JNS002';

    /**
     * DSN003の画面ID
     */
    const GAMEN_ID_DSN003 = 'JNS003';
...
//        $buildingList = $this->_BuildingService->fetchBuildingByEventId($db, $inForm["event_sel"]);
        $outForm->raw_building_booth_ids = array('25','26');
        $outForm->raw_building_booth_lbls = array('6/25','6/26');
...
//                    $dispItemInfo['dispEvent']['customName']=$v['eventsub_name'] .'係';
                    $dispItemInfo['dispEvent']['customName']='声の教育社係';
    ...
    public function _createComiketInsertDataByInForm($inForm, $id, $type="") {
        ...
        $data = array(
            ...
            "building_name" => @$buildingNameRes['name'].@$buildingInfo['booth_position'],
            "booth_position" => @$inForm['comiket_booth_num'],
            "booth_num" => NULL,
