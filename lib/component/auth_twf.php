...
// 公開開始日時
$openDateStr = '2024/11/12 00:00:00';
...
$prm = array(
    'open' => $openDate,     'event' => $eventName, 'dir'  => 'twf' // evp固定で問題ないです
);
...
function redirectKohkaimae($prm){
    ...
    $message = "テーブルウェア・フェスティバルの宅配便受付システムを使用した一括搬入出の受付サイトは公開前です。<br/>"
            . "受付は11月20日(月)0:00から開始になります。受付締切りは11月28日(火)です。<br/><br/>"
            . "サイト内では案内表示にしたがって必要事項の入力を行い、お申し込みをお願いいします。";
