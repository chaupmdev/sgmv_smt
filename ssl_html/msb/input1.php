...
Sgmov_Lib::useView('msb/Input');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Msb_Input();
$forms = $view->execute();
...
<head>
    ...
    <title>催事・イベント手荷物預かりサービスのお申し込み｜お問い合わせ│ＳＧムービング株式会社＜ＳＧホールディングスグループ＞</title>
<?php
    // キャッシュ対策
...
?>
    ...
    <link href="/msb/css/eve.css?<?php echo $strSysdate; ?>" rel="stylesheet" type="text/css" />
...
?>
    <div id="breadcrumb">
        <ul class="wrap">
            <li><a href="/">ホーム</a></li>
            <li class="current">催事・イベント手荷物預かりサービスのお申し込み</li>
        </ul>
    </div>
    <div id="main">
        <div class="wrap clearfix">
            <h1 class="page_title"  style="margin-bottom:15px !important;">催事・イベント手荷物預かりサービスのお申し込み</h1>
...
?>
                ...
                <p class="under lhn">
                    ...
                    <br/>
                    <?php
                            $selectedEventNmae = Sgmov_View_Msb_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
...
?>
            <div class="section other">
                <form action="/msb/check_input" data-feature-id="<?php echo Sgmov_View_Msb_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Msb_Common::GAMEN_ID_MSB001 ?>" method="post">
...
<?php
                        ...
                        // 荷物預入取出
                        ///////////////////////////////////////////////
                        include_once dirname(__FILE__) . '/parts/input_azuke.php';
?>
                    </div>
...
?>
                    ...
                    <p class="text_center">
                        <input id="submit_button" type="submit" name="submit" value="同意して次に進む（入力内容の確認）" disabled="disabled">
                    </p>
                </form>
            </div>
        </div>
...
?>
    ...
    <!--<script charset="UTF-8" type="text/javascript" src="/common/js/ajax_searchaddress_dll.js"></script> -->
...
?>
    <script charset="UTF-8" type="text/javascript" src="/msb/js/define.js" id="definejs-arg"
    data-G_DEV_INDIVIDUAL="<?php echo Sgmov_View_Msb_Common::COMIKET_DEV_INDIVIDUA; ?>"
    data-G_DEV_BUSINESS="<?php echo Sgmov_View_Msb_Common::COMIKET_DEV_BUSINESS; ?>">
    </script>
    <script charset="UTF-8" type="text/javascript" src="/msb/js/input.js?<?php echo $strSysdate; ?>"></script>
