...
Sgmov_Lib::useView('gmm/SizeChange');

// 処理を実行
$view = new Sgmov_View_Gmm_SizeChange();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/gmm/size_change_check_input" data-feature-id="<?php echo Sgmov_View_Gmm_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Gmm_Common::GAMEN_ID_GMM001; ?>" method="post">
