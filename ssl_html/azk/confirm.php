...
// 処理を実行
$view = new Sgmov_View_Azk_Confirm();
$forms = $view->execute();
...
<head>
    ...
    <title>催事・イベント手荷物預かりサービスのお申し込み（個人用）｜お問い合わせ│ＳＧムービング株式会社＜ＳＧホールディングスグループ＞</title>
   ...
   <!--  <div id="breadcrumb">
    ...
    <div id="main">
        <div class="wrap clearfix">
            <h1 class="page_title">催事・イベント手荷物預かりサービスのお申し込み</h1>
            <p class="sentence">
            ...
            <div class="section">
                <form action="/azk/complete" data-feature-id="<?php echo Sgmov_View_Azk_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Azk_Common::GAMEN_ID_AZK001 ?>" method="post">
...
?>
                    ...
                    <?php if ($eveOutForm->comiket_payment_method_cd_sel() == '2') : // クレジット ?>
                        <div class="btn_area">
                            <a class="back" href="/azk/<?php echo $dispItemInfo['back_input_path']; ?>/<?php echo $eveOutForm->shikibetsushi(); ?>"> 修正する</a>
                        </div>
                        ...
                        <div class="btn_area">
                            <a class="back" href="/azk/credit_card/">修正する</a>
