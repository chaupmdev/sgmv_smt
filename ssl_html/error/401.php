...
<meta name="description" content="401 認証エラー">
...
<title>401 認証エラー｜<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/meta-ttl.php'); ?></title>
...
<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/header.php'); ?>
    <main id="main" role="main">
		<div class="pageTitle style01">
			<div class="comBox">
				<h1 class="topLead">認証エラー<em>401エラー</em></h1>
				<ul id="pagePath">
		...
		<div class="topBox comBox">
			<p class="text fadeInUp">認証エラーが発生しました。</p>
