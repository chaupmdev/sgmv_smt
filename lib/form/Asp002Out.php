...
class Sgmov_Form_Asp002Out
{
     ...
     * @var array
     */
    public $raw_sp_sign_kinds = array();
    ...
    /**
     * エンティティ化された特価編集可否フラグを返します。
     * @return string エンティティ化された特価編集可否フラグ
     */
    public function sp_editable_flag()
    {
        return Sgmov_Component_String::htmlspecialchars($this->raw_sp_editable_flag);
    }

    /**
     * エンティティ化された特価コードを返します。
     * @return string エンティティ化された特価コード
     */
    public function sp_cd()
    {
        return Sgmov_Component_String::htmlspecialchars($this->raw_sp_cd);
    }

    /**
     * エンティティ化された特価タイムスタンプを返します。
     * @return string エンティティ化された特価タイムスタンプ
     */
    public function sp_timestamp()
    {
        return Sgmov_Component_String::htmlspecialchars($this->raw_sp_timestamp);
    }
    ...
    /**
     * エンティティ化された特価料金設定値正負区分リストを返します。
     * @return array エンティティ化された特価料金設定値正負区分リスト
     */
    public function sp_sign_kinds()
    {
        return Sgmov_Component_String::htmlspecialchars($this->raw_sp_sign_kinds);
    }
