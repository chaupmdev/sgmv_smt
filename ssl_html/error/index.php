...
<meta name="description" content="404エラー お探しのページが見つかりませんでした">
...
<title>404エラー お探しのページが見つかりませんでした｜<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/meta-ttl.php'); ?></title>
...
<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/header.php'); ?>
    <main id="main" role="main">
		<div class="pageTitle style01">
			<div class="comBox">
				<h1 class="topLead">お探しのページが見つかりませんでした。<em>404 not found</em></h1>
				<ul id="pagePath">
		...
		<div class="topBox comBox">
			<p class="text fadeInUp">入力されたアドレス（URL）をご確認ください。<br>アドレスが変更になったか、ページが削除された可能性があります。<br class="pc">お手数ですが、下記より該当ページをお探しください。</p>
			<div class="comBtn02 btn01 fadeInUp"><a href="/">トップページ</a></div>
		</div>
