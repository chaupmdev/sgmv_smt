<?php /**********************************************************************************************************************/ ?>
                        <div class="input-outbound-title">搬入</div>
<?php /**********************************************************************************************************************/ ?>
                        <div class="dl_block comiket_block">
                            ...
                            <dl>
                                ...
                                <dd>
<?php
        echo Sgmov_View_Tms_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_pref_cds(), $eve001Out->comiket_detail_outbound_pref_lbls(), $eve001Out->comiket_detail_outbound_pref_cd_sel());
?>
                            ...
                            <dl class="class_comiket_detail_outbound_collect_date2">
                                <dt id="comiket_detail_outbound_collect_date2">
                                    お預かり日時
                                </dt>
...
<?php
        echo Sgmov_View_Tms_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_collect_date_year_cds(), $eve001Out->comiket_detail_outbound_collect_date_year_lbls(), $eve001Out->comiket_detail_outbound_collect_date_year_sel());
?>年
                                        </span>
                                        <span class="comiket_detail_outbound_collect_date">
<?php
        echo Sgmov_View_Tms_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_collect_date_month_cds(), $eve001Out->comiket_detail_outbound_collect_date_month_lbls(), $eve001Out->comiket_detail_outbound_collect_date_month_sel());
?>月
                                        </span>
                                        <span class="comiket_detail_outbound_collect_date">
<?php
            echo Sgmov_View_Tms_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_collect_date_day_cds(), $eve001Out->comiket_detail_outbound_collect_date_day_lbls(), $eve001Out->comiket_detail_outbound_collect_date_day_sel());
?>日
                                        </span>
                                        &nbsp;
                                        <span class="comiket_detail_outbound_collect_time_sel2">
    <?php
            echo Sgmov_View_Tms_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_collect_time_cds(), $eve001Out->comiket_detail_outbound_collect_time_lbls(), $eve001Out->comiket_detail_outbound_collect_time_sel());
    ?>
                                        </span>
                                    </div>
                                </dd>
...
<?php
        echo Sgmov_View_Tms_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_delivery_date_year_cds(), $eve001Out->comiket_detail_outbound_delivery_date_year_lbls(), $eve001Out->comiket_detail_outbound_delivery_date_year_sel());
?>年
                                        </span>
                                        <span class="comiket_detail_outbound_delivery_date">
<?php
        echo Sgmov_View_Tms_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_delivery_date_month_cds(), $eve001Out->comiket_detail_outbound_delivery_date_month_lbls(), $eve001Out->comiket_detail_outbound_delivery_date_month_sel());
?>月
                                        </span>
                                        <span class="comiket_detail_outbound_delivery_date">
<?php
        echo Sgmov_View_Tms_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_delivery_date_day_cds(), $eve001Out->comiket_detail_outbound_delivery_date_day_lbls(), $eve001Out->comiket_detail_outbound_delivery_date_day_sel());
?>日
                                        </span>
                                        &nbsp;
                                        <span class="comiket_detail_outbound_delivery_time_sel">
<?php
        echo Sgmov_View_Tms_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_delivery_time_cds(), $eve001Out->comiket_detail_outbound_delivery_time_lbls(), $eve001Out->comiket_detail_outbound_delivery_time_sel());
?>
                                        </span>
                                    </div>
                                </dd>
 ...
 * 
 */ ?>
                            <dl class="service-outbound-item" service-id="2" style="display:none;">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_cargo_outbound_num_ary')) { echo ' class="form_error"'; } ?> >
                                    <div class="comiket-cargo-outbound-num" div-id="<?php echo Sgmov_View_Tms_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                    </div>
                                    <div class="comiket-cargo-outbound-num" div-id="<?php echo Sgmov_View_Tms_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                    </div>
                                        <div style="">
                            ...
                            <dl class="service-outbound-item" service-id="3" style="display:none;">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_charter_outbound_num')) { echo ' class="form_error"'; } ?>>
                                    <div class="comiket-charter-outbound-num" div-id="<?php echo Sgmov_View_Tms_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
