...
<body>
        ...
        <div class="wrap clearfix">
            ...
            <p class="sentence" style="margin-bottom: 5px;">
                ...
                <span class="red">
                    ...
                    <br>お申し込みはサイズ、個数が確定してからお申し込み下さい。
            ...
            ?>
                <div class="err_msg">
                    ...
                    <p class="under" style="line-height: normal;">
                        ...
                        ?>
                        <br />TEL: 03-5857-2462(受付時間:平日10時～17時)<?php if ($qrc001Out->eventsub_cd_sel() == '4') : ?>※年内は12月28日まで<?php endif; ?>
                    </p>
                </div>
            ...
            <div class="section other">
                <form action="/<?= $dirDiv ?>/check_input" data-feature-id="<?php echo Sgmov_View_Qrc_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Qrc_Common::GAMEN_ID_QRA001 ?>" method="post">
                    <input name="ticket" type="hidden" value="<?php echo $ticket ?>" />
                    <input name="input_mode" type="hidden" value="<?php echo $qrc001Out->input_mode(); ?>" />
    ...
    ?>
    <script charset="UTF-8" type="text/javascript" src="/<?= $dirDiv ?>/js/define.js" id="definejs-arg" data-G_DEV_INDIVIDUAL="<?php echo Sgmov_View_Qrc_Common::COMIKET_DEV_INDIVIDUA; ?>" data-G_DEV_BUSINESS="<?php echo Sgmov_View_Qrc_Common::COMIKET_DEV_BUSINESS; ?>">
    </script>
