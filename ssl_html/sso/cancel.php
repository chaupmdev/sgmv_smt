...
Sgmov_Lib::useView('sso/Cancel');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Sso_Cancel();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/sso/cancel_comp" data-feature-id="<?php echo Sgmov_View_Sso_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Sso_Common::GAMEN_ID_EVE001 ?>" method="post">
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/sso/js/input.js?<?php echo $strSysdate; ?>"></script>
</body>
</html>
