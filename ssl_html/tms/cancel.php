...
Sgmov_Lib::useView('tms/Cancel');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Tms_Cancel();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/tms/cancel_comp" data-feature-id="<?php echo Sgmov_View_Tms_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Tms_Common::GAMEN_ID_EVE001 ?>" method="post">
