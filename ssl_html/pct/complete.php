...
Sgmov_Lib::useView('pct/Complete');
Sgmov_Lib::useForms(array('Error', 'PctSession'));
/**#@-*/

// 処理を実行
$view = new Sgmov_View_Pct_Complete();
$forms = $view->execute();
...
?>
                <p class="sentence br">
                    お申し込み内容の登録が完了いたしましたら、ご記入いただいたメールアドレス<!--[<?php echo $pcr004Out->mail(); ?>]-->宛に自動でメールを送らせていただいています。
