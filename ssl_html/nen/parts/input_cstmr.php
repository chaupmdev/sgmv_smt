                        <div class="dl_block comiket_block">
                            <dl>
                                ...
                                ?>>
                                    ...
                                    <span class="<?php if(empty($inputMode)) :?>comiket_diplay_none<?php endif; ?>" style ="display:none">
<?php
...
?>
                                            ...
                                            <br/>
                                            <img src="<?=$dispItemInfo['dispEvent']['logoImg']?>" style="margin:10px 0;width: 98%">
                                                <div class="sp_dl_area2 paste_tag" style="display: none">
...
?>
                                                        ...
                                                        <br/>
                                                        <div>
                                                        <strong style="color:#C00;">※北海道、青森・中国・四国・九州エリアにご在住の方は申込受付期間が5/16(月）12：00までになります。</strong>
                                                        </div>
<?php } ?>
                                                    </div>
                            ...
                            <?php if ($userType === 1) :?>
                                <dl>
                                    ...
                                    <dd>
                                        <?php echo $_SESSION['NEN_LOGIN']['email'] ?>
                                    </dd>
                                </dl>
                            <?php endif; ?>
                            <!-- END -->
