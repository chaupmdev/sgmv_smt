...
function clickTanshinCargoPlan(clickId) {
	...
	if (clickId == "1_1") {
		...
		if (document.getElementById("1_1").checked) {
			...
			document.getElementById("from_center_0").disabled = true;
			document.getElementById("from_center_0").checked = false;
			document.getElementById("area_from_center_0_0").disabled = true;
			document.getElementById("area_from_center_0_0").checked = false;
			...
			// 出発エリアの沖縄を活性
			document.getElementById("from_center_0").disabled = false;
			document.getElementById("area_from_center_0_0").disabled = false;
			// 到着エリアの沖縄を活性
		...
		if (document.getElementById("1_2").checked) {
			...
			//沖縄県/東京23区/大阪府/福岡県以外の出発エリア・到着エリア非活性化処理
			for (i = 0; i < (allFromAreas.length - 1); i++) {
 ...
 * centerId（1:沖縄県、2:東京23区、3:福岡）がクリックされた場合
 *
 ***************************************************************************/
