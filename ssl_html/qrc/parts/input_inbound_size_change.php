...
<div class="dl_block input-inbound comiket_block">
    <dl>
        ...
        <dd>
            <?php echo $qrc001Out->comiket_detail_inbound_name() ?>
        </dd>
    </dl>
    <dl>
        ...
        <dd>
            〒<?php echo $qrc001Out->comiket_detail_inbound_zip1(); ?>-<?php echo $qrc001Out->comiket_detail_inbound_zip2(); ?>
        </dd>
    </dl>
    <dl>
        ...
        <dd>
            <?php
            echo Sgmov_View_Qrc_Input::_getLabelSelectPulldownData($qrc001Out->comiket_detail_inbound_pref_cds(), $qrc001Out->comiket_detail_inbound_pref_lbls(), $qrc001Out->comiket_detail_inbound_pref_cd_sel());
            ?>
        </dd>
    </dl>
    <dl>
        ...
        <dd>
            <?php echo $qrc001Out->comiket_detail_inbound_address(); ?>
        </dd>
    </dl>
    <dl>
        ...
        <dd>
            <?php echo $qrc001Out->comiket_detail_inbound_building(); ?>
        </dd>
    </dl>
    <dl>
        ...
        <dd>
            <?php echo $qrc001Out->comiket_detail_inbound_tel(); ?>
        </dd>
    </dl>
    <dl>
        ...
        <dd>
            ...
            <div class="comiket_detail_inbound_collect_date_parts" style="display:<?php echo $displaySetting; ?>">
                <?php echo $qrc001Out->comiket_detail_inbound_collect_date_year_sel(); ?>年<?php echo $qrc001Out->comiket_detail_inbound_collect_date_month_sel(); ?>月<?php echo $qrc001Out->comiket_detail_inbound_collect_date_day_sel(); ?>日
                &nbsp;
                <?php
                //echo Sgmov_View_Qrc_Input::_getLabelSelectPulldownData($qrc001Out->comiket_detail_inbound_collect_time_cds(), $qrc001Out->comiket_detail_inbound_collect_time_lbls(), $qrc001Out->comiket_detail_inbound_collect_time_sel());
                ?>
    ...
    <dl class="comiket_detail_inbound_delivery_date">
        ...
        <dd>
            ...
            <div class="comiket_detail_inbound_delivery_date_parts">
                <?php echo $qrc001Out->comiket_detail_inbound_delivery_date_year_sel(); ?>年<?php echo $qrc001Out->comiket_detail_inbound_delivery_date_month_sel(); ?>月<?php echo $qrc001Out->comiket_detail_inbound_delivery_date_day_sel(); ?>日
                &nbsp;
                <span class="comiket_detail_inbound_delivery_time_sel">

                    <?php
                    echo Sgmov_View_Qrc_Input::_getLabelSelectPulldownData($qrc001Out->comiket_detail_inbound_delivery_time_cds(), $qrc001Out->comiket_detail_inbound_delivery_time_lbls(), $qrc001Out->comiket_detail_inbound_delivery_time_sel());
                    ?>
                </span>
    ...
    <dl class="service-inbound-item" service-id="1">
        ...
        <dd <?php if (isset($e) && $e->hasErrorForId('comiket_box_inbound_num_ary')) {
            ...
            <div class="comiket-box-inbound-num1 comiket-box-inbound-num-dmy">
                <!-- 個人・法人 どちらでも -->
            ...
            <div class="outbound_example_boxsize example_boxsize">
                ...
                <strong class="red">※ １申込み４０個を超える場合は、ＳＧムービング/rooms41係り ０３－5８5７－２４6２　もしくはカウンタースタッフへお問い合わせください。</strong><br />
    ...
    <dl class="service-inbound-item" service-id="2">
        ...
        <dd <?php if (isset($e) && $e->hasErrorForId('comiket_cargo_inbound_num_ary')) {
                echo ' class="form_error"';
            } ?>>

            <div class="comiket-cargo-inbound-num" div-id="<?php echo Sgmov_View_Qrc_Common::COMIKET_DEV_INDIVIDUA; ?>">
                <!-- 個人 -->
            </div>
            <div class="comiket-cargo-inbound-num" div-id="<?php echo Sgmov_View_Qrc_Common::COMIKET_DEV_BUSINESS; ?>">
                <!-- 法人 -->
            </div>
            <div class="">
                <input autocapitalize="off" class="number-only boxWid" maxlength="2" inputmode="numeric" name="comiket_cargo_inbound_num_sel" data-pattern="^\d+$" placeholder="例）1" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $qrc001Out->comiket_cargo_inbound_num_sel(); ?>" />台
                <!--                                            <select name="comiket_cargo_inbound_num_sel">
                                                <option value="">カーゴ数量を選択</option>
<?php
echo Sgmov_View_Qrc_Input::_createPulldown($qrc001Out->comiket_cargo_inbound_num_cds(), $qrc001Out->comiket_cargo_inbound_num_lbls(), $qrc001Out->comiket_cargo_inbound_num_sel());
?>
                                            </select>台-->
            </div>
        </dd>
    ...
    <dl class="service-inbound-item" service-id="3">
        ...
        <dd <?php if (isset($e) && $e->hasErrorForId('comiket_charter_inbound_num_ary')) {
                echo ' class="form_error"';
            } ?>>

            <div class="comiket-charter-inbound-num" div-id="<?php echo Sgmov_View_Qrc_Common::COMIKET_DEV_INDIVIDUA; ?>">
                <!-- 個人 -->
                <input autocapitalize="off" class="" style="width:10%;" maxlength="3" inputmode="numeric" name="comiket_charter_inbound_num_ary[0]" data-pattern="^\d+$" placeholder="例）7" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $qrc001Out->comiket_charter_inbound_num_ary("0"); ?>" />台
            </div>
            <div class="comiket-charter-inbound-num" div-id="<?php echo Sgmov_View_Qrc_Common::COMIKET_DEV_BUSINESS; ?>">
                <!-- 法人 -->
                <table>
                    <?php foreach ($dispItemInfo['charter_lbls'] as $key => $val) : ?>
                        <tr>
                            ...
                            <td class='comiket_charter_item_value'>
                                <input autocapitalize="off" class="number-only boxWid" maxlength="2" inputmode="numeric" name="comiket_charter_inbound_num_ary[<?php echo $val["id"]; ?>]" data-pattern="^\d+$" placeholder="例）1" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $qrc001Out->comiket_charter_inbound_num_ary($val["id"]); ?>" />台
                                &nbsp;
                            </td>
                            <!--</div>-->
                        </tr>
    ...
    <dl>
        ...
        <dd>
            <?php echo $qrc001Out->comiket_detail_inbound_note1(); ?>
        </dd>
    </dl>
</div>
