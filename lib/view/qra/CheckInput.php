...
Sgmov_Lib::useForms(array('Error', 'QraSession', 'Qra001In', 'Qra002In'));
 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Qra_CheckInput extends Sgmov_View_Qra_Common
{
    ...
    public function executeInner()
    {
        ...
        // チケットの確認と破棄
        //$session->checkTicket(self::FEATURE_ID, self::GAMEN_ID_QRA001, $this->_getTicket());
    ...
    public function _createInFormFromPost($post, $creditCardForm)
    {
        ...
        if (isset($calcDataInfo['amount_tax'])) {
            ...
            $calcDataInfo['amount'] = ((int)$post['URIAGE_KINGAKU']) / 1.1;
        }
