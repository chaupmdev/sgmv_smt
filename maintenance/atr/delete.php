...
Sgmov_Lib::useView('atr/Delete');
/**#@-*/

// 処理を実行
$view = new Sgmov_View_Atr_Delete();
$forms = $view->execute();
...
/**
 * フォーム
 * @var Sgmov_Form_Atr012Out
 */
$atr012Out = $forms['outForm'];
            ...
            <dl id="globalNav">
                ...
                <dd>
                    <ul>
                        ...
                        <li class="nav02">
<?php if($atr012Out->honsha_user_flag() === '1'){ ?>
...
<?php } ?>
    ...
    <div id="topWrap">
        ...
        <h3 class="register_ttl">ツアー情報の削除</h3>
...
<?php } ?>
                <ul class="register_item" id="travel_item">
                    <li id="travel_item_01" class="clearfix">
                        <fieldset>
                            ...
                            <?php echo $atr012Out->travel_cd() . PHP_EOL; ?>
                        </fieldset>
                    </li>
                    <li id="travel_item_02">
                        <fieldset>
                            <legend>乗船日名</legend>
                            <?php echo $atr012Out->travel_name() . PHP_EOL; ?>
                        </fieldset>
                    </li>
                    <li id="travel_item_03">
                        <fieldset>
                            <legend>船名</legend>
                            <?php echo $atr012Out->travel_agency_name() . PHP_EOL; ?>
                            </select>
                        </fieldset>
                    </li>
                    <li id="travel_item_04">
                        <fieldset>
                            <legend>往復便割引</legend>
                            <?php echo $atr012Out->round_trip_discount() . PHP_EOL; ?>
                            円
                        </fieldset>
                    </li>
                    <li id="travel_item_05">
                        <fieldset>
                            ...
                            <?php echo $atr012Out->repeater_discount() . PHP_EOL; ?>
                            円
                        </fieldset>
                    </li>
                    <li id="travel_item_06">
                        <fieldset>
                            <legend>乗船日</legend>
                            <?php echo $atr012Out->embarkation_date() . PHP_EOL; ?>
                        </fieldset>
                    </li>
                    <li id="travel_item_07">
                        <fieldset>
                            <legend>掲載開始日</legend>
                            <?php echo $atr012Out->publish_begin_date() . PHP_EOL; ?>
                        </fieldset>
                    </li>
                </ul>
                <input id="travel_id" name="travel_id" type="hidden" value="<?php echo $atr012Out->travel_id(); ?>" />
    ...
    <!--<![endif]-->
    <script charset="UTF-8" type="text/javascript" src="/common/js/atrDelete.js"></script>
</body>
</html>