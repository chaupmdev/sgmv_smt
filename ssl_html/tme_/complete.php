...
Sgmov_Lib::useView('tme/Complete');
Sgmov_Lib::useForms(array('Error', 'EveSession'));
/**#@-*/
Sgmov_Component_Log::debug("########################### 111");
$exceptionFlg = FALSE;
// 処理を実行
...
?>
                <ul class="cnv_list">
                    ...
                    <li><a href="/cvs/pc/circleksunkus_econ.html" target="_blank">サークルＫサンクス</a></li>
...
?>
                <ul class="cnv_list">
                    <li><a href="/cvs/pc/dailyamazaki.html" target="_blank">デイリーヤマザキ</a></li>
                </ul>
<?php
                    break;
...
//                                ($eveOutForm->comiket_detail_inbound_service_sel() == "1" || $eveOutForm->comiket_detail_inbound_service_sel() == "2") // 宅配、またはカーゴ
                    ...
                    <div style="font-size:20px;">
                        <a href="/tme/paste_tag/<?php echo sprintf('%010d', $eveOutForm->qr_code_string()) . Sgmov_View_Eve_Common::getChkD2($eveOutForm->qr_code_string()); ?>/" target="_blank" style="color:blue;" download>
...
<?php if ($eventsubData['manual_display'] == '1') { ?>
                ...
                <div style="font-size:20px;">
                    <!--<a class="button_link2" href="/tme/pdf/manual/manual_<?php echo $eveOutForm->eventsub_cd_sel(); ?>.pdf" target="_blank" style="color:blue;">-->
                    <a class="button_link2" href="/tme/pdf/manual/<?php echo $eventData['name']; ?><?php echo $eventsubData['name']; ?>.pdf" target="_blank" style="color:blue;">
