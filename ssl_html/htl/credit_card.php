...
Sgmov_Lib::useView('htl/CreditCard');
/**#@-*/
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <form action="/htl/check_credit_card" method="post">
...
?>
                    ...
                    <div class="btn_area">
                        ...
                        if(empty($comiketId)): ?>
                            <a class="back" href="/htl/input/?clr=1">修正する</a>
                        <?php else: ?>
                            <a class="back" href="/htl/input2/?clr=1">修正する</a>
                        <?php endif; ?>
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/htl/js/credit_card.js"></script>
    <script>
        $(function() {
