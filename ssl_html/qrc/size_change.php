...
// 処理を実行
$view = new Sgmov_View_Qrc_SizeChange();
$forms = $view->execute();
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <div class="section other">
                <form action="/<?= $dirDiv ?>/size_change_check_input" data-feature-id="<?php echo Sgmov_View_Qrc_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Qrc_Common::GAMEN_ID_QRC001 ?>" method="post">
