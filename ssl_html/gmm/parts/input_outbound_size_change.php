...
<?php /**********************************************************************************************************************/ ?>
                        <div class="dl_block input-outbound comiket_block">
                            ...
                            <dl>
                                ...
                                <dd>
<?php
        echo Sgmov_View_Gmm_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_pref_cds(), $eve001Out->comiket_detail_outbound_pref_lbls(), $eve001Out->comiket_detail_outbound_pref_cd_sel());
?>
                            ...
                            <dl class="class_comiket_detail_outbound_collect_date">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_detail_outbound_collect_date')) { echo ' class="form_error"'; } ?> class="comiket_detail_outbound_collect_date_input_part">
                                    ...
                                    <div class="comiket_detail_outbound_collect_date_parts">
                                        <?php 
                                            echo $eve001Out->comiket_detail_outbound_collect_date_year_sel();?>年<?php echo $eve001Out->comiket_detail_outbound_collect_date_month_sel();?>月<?php echo $eve001Out->comiket_detail_outbound_collect_date_day_sel();?>日（<?php echo Sgmov_View_Gmm_Input::_getWeek($eve001Out->comiket_detail_outbound_collect_date_year_sel(), $eve001Out->comiket_detail_outbound_collect_date_month_sel(), $eve001Out->comiket_detail_outbound_collect_date_day_sel()); ?>）
                                        &nbsp;
                                        <span class="comiket_detail_outbound_collect_time_sel">
    <?php
            echo Sgmov_View_Gmm_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_outbound_collect_time_cds(), $eve001Out->comiket_detail_outbound_collect_time_lbls(), $eve001Out->comiket_detail_outbound_collect_time_sel());
    ?>
                                        </span>
                                    </div>
                                </dd>
                            ...
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <div class="comiket_detail_outbound_delivery_date_parts2">
                                        <?php 
                                            echo $eve001Out->comiket_detail_outbound_delivery_date_year_sel();?>年<?php echo $eve001Out->comiket_detail_outbound_delivery_date_month_sel();?>月<?php echo $eve001Out->comiket_detail_outbound_delivery_date_day_sel();?>日（<?php echo Sgmov_View_Gmm_Input::_getWeek($eve001Out->comiket_detail_outbound_delivery_date_year_sel(), $eve001Out->comiket_detail_outbound_delivery_date_month_sel(), $eve001Out->comiket_detail_outbound_delivery_date_day_sel()); ?>）
                                        &nbsp;
                                        <span class="comiket_detail_outbound_delivery_time_sel" style="display: none;">
<?php
        echo Sgmov_View_Gmm_Input::_getTimeFormatSelectPulldownData($eve001Out->comiket_detail_outbound_delivery_time_cds(), $eve001Out->comiket_detail_outbound_delivery_time_lbls(), $eve001Out->comiket_detail_outbound_delivery_time_sel());
?>
                            ...
                            <dl class="service-outbound-item" service-id="2">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_cargo_outbound_num_ary')) { echo ' class="form_error"'; } ?> >
                                    <div class="comiket-cargo-outbound-num" div-id="<?php echo Sgmov_View_Gmm_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                    </div>
                                    <div class="comiket-cargo-outbound-num" div-id="<?php echo Sgmov_View_Gmm_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                    </div>
                                        <div style="">
                            ...
                            <dl class="service-outbound-item" service-id="3">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_charter_outbound_num')) { echo ' class="form_error"'; } ?>>
                                    <div class="comiket-charter-outbound-num" div-id="<?php echo Sgmov_View_Gmm_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
