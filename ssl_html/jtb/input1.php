...
echo '<pre>';
//print_r($eve001Out);
//print_r($eve001Out->comiket_booth_cds());
//print_r($eve001Out->comiket_booth_lbls());
//print_r($eve001Out->comiket_booth_cd_sel());
echo '</pre>';
/**
 * エラーフォーム
...
?>
            <div class="section other">
                <form action="/<?=$dirDiv?>/check_input" data-feature-id="<?php echo Sgmov_View_Jtb_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Jtb_Common::GAMEN_ID_JTB001 ?>" method="post">
