...
Sgmov_Lib::useView('fmt/Cancel');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Fmt_Cancel();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/fmt/cancel_comp" data-feature-id="<?php echo Sgmov_View_Fmt_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Fmt_Common::GAMEN_ID_EVE001 ?>" method="post">
