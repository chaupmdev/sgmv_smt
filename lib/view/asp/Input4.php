...
Sgmov_Lib::useForms(array('AspSession', 'Asp007Out'));
/**#@-*/
 ...
 * @copyright  2009-2010 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Asp_Input4 extends Sgmov_View_Asp_Common
{
    /**
     * 処理を実行します。
     * <ol><li>
    ...
    public function executeInner()
    {
        ...
        $ticket = $session->publishTicket($this->getFeatureId(), self::GAMEN_ID_ASP007);
     ...
     * @return Sgmov_Form_Asp007Out 出力フォーム
     */
    public function _createOutFormBySessionForm($sessionForm)
    {
        $outForm = new Sgmov_Form_Asp007Out();
        ...
        // セッション値の適用
        if (isset($sessionForm->priceset_kbn)) {
            $outForm->raw_priceset_kbn = $sessionForm->priceset_kbn;
        }
