...
Sgmov_Lib::useForms(array('Error', 'AzkSession', 'Azk002Out'));
/**#@-*/
/**
 ...
 */
class Sgmov_View_Azk_CreditCard extends Sgmov_View_Azk_Common {
    ...
    public function executeInner() {
        ...
        // チケットを発行
        $ticket = $session->publishTicket(self::FEATURE_ID, self::GAMEN_ID_AZK002);
     ...
     * @param Sgmov_Form_Msb002In $sessionForm 入力フォーム
     * @return Sgmov_Form_Msb002Out 出力フォーム
     */
    public function _createOutFormByInForm($inForm) {

        $outForm = new Sgmov_Form_Azk002Out();
