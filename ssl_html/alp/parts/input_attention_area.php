...
申し込み完了時にサイトで表示される「受付完了画面」もしくは完了後に配信される「申込み完了メール」のいずれかをご提示下さい。
                                    </dd>
                                </dl>
                                <dl>
                                    <dt>お荷物の破損について：</dt>
                                    <dd>
                                        <p>
                                            ...
                                            <br />
                                            <span style="color:#F00;"><strong>城西営業所　0570-01-0364　(受付時間:平日 8:00～19:00)</strong></span>にご連絡ください。
                                        </p>
                                    </dd>
                                </dl>
                                <dl>
                                    <dt>キャンセル：</dt>
                                    <dd>
                                        配送受付サービスをキャンセルされたい場合は、お手数ですがお客様ご自身でSGムービングにご連絡頂き、キャンセルをお申し出ください。
