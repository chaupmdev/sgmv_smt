...
<?php
        echo Sgmov_View_Twf_Input::_createPulldown($eve001Out->comiket_detail_outbound_pref_cds(), $eve001Out->comiket_detail_outbound_pref_lbls(), $eve001Out->comiket_detail_outbound_pref_cd_sel());
?>
                                    </select>
                                    <br/>
                                    <br/>
    ...
    <?php
            echo Sgmov_View_Twf_Input::_createPulldown($eve001Out->comiket_detail_outbound_collect_time_cds(), $eve001Out->comiket_detail_outbound_collect_time_lbls(), $eve001Out->comiket_detail_outbound_collect_time_sel());
    ?>
                                            </select>
                                        </span>
                                    </div>
                                    ...
                                    <div class="comiket_detail_outbound_delivery_date_parts">
                                        ...
                                        <span class="comiket_detail_outbound_delivery_time_sel">
                                            ...
                                            <select name="comiket_detail_outbound_delivery_time_sel">
                                                <option value="">時間帯を選択</option>
    <?php
            echo Sgmov_View_Twf_Input::_createPulldown($eve001Out->comiket_detail_outbound_delivery_time_cds(), $eve001Out->comiket_detail_outbound_delivery_time_lbls(), $eve001Out->comiket_detail_outbound_delivery_time_sel());
    ?>
                                            </select>
                                        </span>
                                    </div>
