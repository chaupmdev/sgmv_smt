...
Sgmov_Lib::useView('owk/Input2');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Owk_Input2();
$forms = $view->execute();
...
?>
    ...
    <link href="/owk/css/eve.css?<?php echo $strSysdate; ?>" rel="stylesheet" type="text/css" />
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <p class="sentence" style="margin-bottom: 5px;">
                ...
                <br />【沖縄向けをご利用希望のお客様は、カウンタースタッフへお声がけください】
            </p>
...
?>
                ...
                <p class="under">
                    ...
                    <br />
                    <?php
                            $selectedEventNmae = Sgmov_View_Owk_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
...
?>
            <div class="section other">
                <form action="/owk/check_input2" data-feature-id="<?php echo Sgmov_View_Owk_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Owk_Common::GAMEN_ID_OWK001 ?>" method="post">
...
<?php
        ...
        echo $eventName;
        echo '<br><br><img src="/owk/images/logo.png">';
?>
...
<div class="sp_dl_area2">
    ...
    <div class="eventsub_dl_link manual" >
        ...
        <a style="color: blue;" class="manual_link" href="/owk/pdf/manual/<?php echo $eventName; ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">宅配便WEB申込みのご案内</a>
    </div>
</div> -->
<?php endif; ?>
                            ...
                            <?php if ($eve001Out->comiket_div() == Sgmov_View_Owk_Common::COMIKET_DEV_BUSINESS) : // 法人?>
                                <dl>
...
?>
                    ...
                    <?php if ($eve001Out->comiket_div() == Sgmov_View_Owk_Common::COMIKET_DEV_INDIVIDUA) : ?>
...
?>
    <script charset="UTF-8" type="text/javascript" src="/owk/js/define.js" id="definejs-arg"
    data-G_DEV_INDIVIDUAL="<?php echo Sgmov_View_Owk_Common::COMIKET_DEV_INDIVIDUA; ?>"
    data-G_DEV_BUSINESS="<?php echo Sgmov_View_Owk_Common::COMIKET_DEV_BUSINESS; ?>"
    ></script>
    <script charset="UTF-8" type="text/javascript" src="/owk/js/input2.js?<?php echo $strSysdate; ?>"></script>
