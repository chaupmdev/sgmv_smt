...
class AlipayAuthorizeResponseDto extends MdkBaseDto
{
     ...
     * @param qrCodeImgUrl QRコード画像URL（標準）<br>
     */
     ...
     * @param qrCodeSmallImgUrl QRコード画像URL（縮小）<br>
     */
     ...
     * @param qrCodeLargeImgUrl QRコード画像URL（拡大）<br>
     */
