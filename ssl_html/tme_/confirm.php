...
<head>
    ...
    <link href="/tme/css/eve.css" rel="stylesheet" type="text/css" />
    <!--[if lt IE 9]>
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <div class="section">
                <form action="/tme/complete" data-feature-id="<?php echo Sgmov_View_Eve_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Eve_Common::GAMEN_ID_EVE001 ?>" method="post">
...
<!--                                                    <br/>
                                                    <div class="sp_dl_area">
                                                        <span class="eventsub_dl_link pasete_tag">
                                                            ...
                                                            <a style="color: blue;" class="paste_tag_link" href="/tme/pdf/paste_tag/paste_tag_<?php echo $eveOutForm->eventsub_cd_sel(); ?>.pdf" target="_blank">貼付票</a>
                                                        </span>
                                                        &nbsp;&nbsp;
...
<!--                                        <br/>
                                ...
                                <?php if ( Sgmov_View_Eve_Confirm::checkColAndDelDate("outbound", $eveOutForm->comiket_div(), $eveOutForm->comiket_detail_outbound_service_sel(), $dispItemInfo["eventsub_selected_data"]) ) : ?>
                                <dl>
...
<?php
        if ( Sgmov_View_Eve_Confirm::checkColAndDelTime("outbound", $eveOutForm->comiket_div(), $eveOutForm->comiket_detail_outbound_service_sel(), $dispItemInfo["eventsub_selected_data"])) {
...
?>
                                        ...
                                        &nbsp;
<?php
        echo Sgmov_View_Eve_Confirm::_getTimeFormatSelectPulldownData($eveOutForm->comiket_detail_outbound_delivery_time_cds(), $eveOutForm->comiket_detail_outbound_delivery_time_lbls(), $eveOutForm->comiket_detail_outbound_delivery_time_sel());
?>
                                    </dd>
                                </dl>
                                            ...
                                            <tr>
                                                ...
                                                <td style='padding-top:5px;'>
                                                    <?php if($eveOutForm->comiket_div() == Sgmov_View_Eve_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
                                                        <!--<img src='/tme/images/about_boxsize.png' width='80%'/>-->
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                        </table>
...
?>
                                ...
                                <?php if ( Sgmov_View_Eve_Confirm::checkColAndDelDate("inbound", $eveOutForm->comiket_div(), $eveOutForm->comiket_detail_inbound_service_sel(), $dispItemInfo["eventsub_selected_data"]) ) :
//                                        ($eveOutForm->comiket_div() == Sgmov_View_Eve_Common::COMIKET_DEV_INDIVIDUA && !($eveOutForm->comiket_detail_type_sel() == "2" && $eveOutForm->comiket_detail_inbound_service_sel() == "2" ) )
//                                        || ($eveOutForm->comiket_div() == Sgmov_View_Eve_Common::COMIKET_DEV_BUSINESS && $eveOutForm->comiket_detail_inbound_service_sel() == "1")) :
...
?>
                                        ...
                                        &nbsp;
<?php
        if ( Sgmov_View_Eve_Confirm::checkColAndDelTime("inbound", $eveOutForm->comiket_div(), $eveOutForm->comiket_detail_inbound_service_sel(), $dispItemInfo["eventsub_selected_data"]) ) :
...
<!--                                                <br/>
                                                ...
                                                <br/>
                                                <br/>
                                                <a href="/tme/pdf/example/example_box_size.pdf" target="_blank" style="color:blue;">サイズの目安</a>-->
                                            <?php endif; ?>
                                        </dd>
                                    </dl>
                                <?php endif; ?>
...
<?php if($eveOutForm->comiket_div() == Sgmov_View_Eve_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
    ...
    <?php if ($eveOutForm->comiket_payment_method_cd_sel() === '1') : ?>
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        ...
                                        <?php elseif ($eveOutForm->comiket_convenience_store_cd_sel() === '2'): ?>
                                            ローソン、セイコーマート、ファミリーマート、サークルＫサンクス、ミニストップ
                        ...
                        <div class="btn_area">
                            <a class="back" href="/tme/<?php echo $dispItemInfo['back_input_path']; ?>/">修正する</a>
    ...
    <?php if ($eveOutForm->comiket_payment_method_cd_sel() == '2') : // クレジット ?>
                        ...
                        <div class="btn_area">
                            <a class="back" href="/tme/credit_card/">修正する</a>
                            <input id="submit_button" type="submit" name="submit" value="入力内容を送信する" />
                        </div>
    ...
    <?php if ($eveOutForm->comiket_payment_method_cd_sel() == '3') : // 電子マネー ?>
       ...
       <strong class="red">※電子マネーでのお支払いは、￥10,000を超える場合はお取り扱い出来ません。</strong>
        <div class="btn_area">
            <a class="back" href="/tme/input/">修正する</a>
            <input id="submit_button" type="submit" name="submit" value="入力内容を送信する" />
        </div>
    <?php endif; ?>
...
?>
    <!--<script charset="UTF-8" type="text/javascript" src="/tme/js/input.js"></script>-->
    <script>
        $(function() {
