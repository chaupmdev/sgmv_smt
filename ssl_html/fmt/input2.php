...
Sgmov_Lib::useView('fmt/Input2');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Fmt_Input2();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/fmt/check_input2" data-feature-id="<?php echo Sgmov_View_Fmt_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Fmt_Common::GAMEN_ID_EVE001 ?>" method="post">
...
<?php
        ...
        echo '<br><br><img src="/fmt/images/logo.gif">';
        }
?>
...
<br/>
                                    <div>
                                        <?php if ($eve001Out->comiket_customer_kbn_sel() == '1') :?>
                                            出展者様
                                        <?php else :?>
                                            一般のご利用者様（来場者様）
                                        <?php endif;?>
...
<!--    <div class="eventsub_dl_link pasete_tag">
        ...
        <a style="color: blue;" class="paste_tag_link" href="/fmt/pdf/paste_tag/paste_tag_<?php echo $eve001Out->eventsub_cd_sel(); ?>.pdf" target="_blank">貼付票（例）</a>
    </div>
    <br/>
    ...
    <div class="eventsub_dl_link manual" >
        <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
        <a style="color: blue;" class="manual_link" href="/fmt/pdf/manual/<?php echo $eventName; ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">説明書</a>
    </div>
</div>
<?php endif; ?>
<!--                                                </td>
...
<!--                                                    <div class="pc_dl_area">
                                                        ...
                                                        <div class="eventsub_dl_link manual">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;" class="manual_link" href="/fmt/pdf/manual/<?php echo $eventName; ?>.pdf" target="_blank">説明書</a>
                                                        </div>
                                                    </div>-->
                                    <!--</div>-->
<!--                                                </td>
...
<!--                                        <br/>-->
                            ...
                            <?php if ($eve001Out->comiket_div() == Sgmov_View_Fmt_Common::COMIKET_DEV_BUSINESS) : // 法人?>
                                <dl>
...
<!--                    <div class="gray_block">
                    ...
                    <?php if ($eve001Out->comiket_div() == Sgmov_View_Fmt_Common::COMIKET_DEV_INDIVIDUA) : ?>
...
?>
    ...
    ></script>
    <script charset="UTF-8" type="text/javascript" src="/fmt/js/input2.js?<?php echo $strSysdate; ?>"></script>
</body>
</html>
