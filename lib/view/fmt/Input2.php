...
Sgmov_Lib::useServices(array('Comiket','ComiketDetail',));
 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Fmt_Input2 extends Sgmov_View_Fmt_Input {
    ...
    //            }
            ...
            $comiketDetailInfoList = $this->_ComiketDetail->fetchComiketDetailByComiketId($db, $param);
            $comiketDetailInfo = $comiketDetailInfoList[0];
            $inForm["comiket_detail_inbound_binshu_kbn_sel"] = $comiketDetailInfo['binshu_kbn'];
            $collectDateYear = date('Y', strtotime($comiketDetailInfo['collect_date'] . " 00:00:00"));
            $collectDateMonth = date('m', strtotime($comiketDetailInfo['collect_date'] . " 00:00:00"));
            $collectDateDay = date('d', strtotime($comiketDetailInfo['collect_date'] . " 00:00:00"));
            $inForm["comiket_detail_inbound_collect_date_year_sel"] = $collectDateYear;
            $inForm["comiket_detail_inbound_collect_date_month_sel"] = $collectDateMonth;
            $inForm["comiket_detail_inbound_collect_date_day_sel"] = $collectDateDay;
