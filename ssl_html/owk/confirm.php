...
Sgmov_Lib::useView('owk/Confirm');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Owk_Confirm();
$forms = $view->execute();
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <div class="section">
                <form action="/owk/complete" data-feature-id="<?php echo Sgmov_View_Owk_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Owk_Common::GAMEN_ID_OWK001 ?>" method="post">
...
<?php if($eveOutForm->comiket_div() == Sgmov_View_Owk_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
    ...
    <?php if ($eveOutForm->comiket_payment_method_cd_sel() == '2') : // クレジット ?>
                        ...
                        <div class="btn_area">
                            <a class="back" href="/owk/credit_card/">修正する</a>
