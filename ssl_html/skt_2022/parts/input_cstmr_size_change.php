...
<?php
        echo Sgmov_View_Evp_Input::_getLabelSelectPulldownData($eve001Out->comiket_pref_cds(), $eve001Out->comiket_pref_lbls(), $eve001Out->comiket_pref_cd_sel());
?>
                                </dd>
                            </dl>
                            <dl>
                            ...
                            <dl class="class_building_name_sel">
                                ...
                                <dd>
                                    ...
                                    <?php echo $eve001Out->building_name(); ?><span style="font-size: 0.5em;">ホール</span>&nbsp;<?php echo $eve001Out->building_booth_position(); ?><span style="font-size: 0.5em;">ブロック</span>&nbsp;<?php echo $eve001Out->comiket_booth_num(); ?>
                                </dd>
                            </dl>
