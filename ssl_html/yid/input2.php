...
// 処理を実行
$view = new Sgmov_View_Yid_Input2();
$forms = $view->execute();
...
?>
                ...
                <p class="under">
                    ...
                    <br />
                    <?php
                            $selectedEventNmae = Sgmov_View_Yid_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
...
?>
            <div class="section other">
                <form action="/<?=$dirDiv?>/check_input2" data-feature-id="<?php echo Sgmov_View_Yid_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Yid_Common::GAMEN_ID_TWF001 ?>" method="post">
                    ...
                    <div class="section">
                        ...
                        <div class="dl_block comiket_block">
                            <dl>
                                ...
                                ?>>
<?php
        $eventName = Sgmov_View_Yid_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
        echo $eventName;
...
<?php
        $eventsubName = Sgmov_View_Yid_Input::_getLabelSelectPulldownData($eve001Out->eventsub_cds(), $eve001Out->eventsub_lbls(), $eve001Out->eventsub_cd_sel());
        echo $eventsubName;
?>
</span>
...
<?php endif; ?>
                            ...
                            <?php if ($eve001Out->comiket_div() == Sgmov_View_Yid_Common::COMIKET_DEV_BUSINESS) : // 法人?>
                                <dl>
...
?>
                    ...
                    <?php if ($eve001Out->comiket_div() == Sgmov_View_Yid_Common::COMIKET_DEV_INDIVIDUA) : ?>
...
?>
    ...
    data-G_DEV_INDIVIDUAL="<?php echo Sgmov_View_Yid_Common::COMIKET_DEV_INDIVIDUA; ?>"
    data-G_DEV_BUSINESS="<?php echo Sgmov_View_Yid_Common::COMIKET_DEV_BUSINESS; ?>"
    ></script>
