...
?>
    ...
    <link href="/htl/css/eve.css?<?php echo $strSysdate; ?>" rel="stylesheet" type="text/css" />
    <!--[if lt IE 9]>
...
?>
            <div class="section other">
                <form action="/htl/check_input2" data-feature-id="<?php echo Sgmov_View_Eve_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Eve_Common::GAMEN_ID_EVE001 ?>" method="post">
...
<?php
        ...
        echo '<br><br><img src="/htl/images/logo.gif">';
        }
?>
...
<!--    <div class="eventsub_dl_link pasete_tag">
        ...
        <a style="color: blue;" class="paste_tag_link" href="/htl/pdf/paste_tag/paste_tag_<?php echo $eve001Out->eventsub_cd_sel(); ?>.pdf" target="_blank">貼付票（例）</a>
    </div>
    <br/>
    ...
    <div class="eventsub_dl_link manual" >
        <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
        <a style="color: blue;" class="manual_link" href="/htl/pdf/manual/<?php echo $eventName; ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">説明書</a>
    </div>
</div>
<?php endif; ?>
<!--                                                </td>
...
<!--                                                    <div class="pc_dl_area">
                                                        ...
                                                        <div class="eventsub_dl_link manual">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;" class="manual_link" href="/htl/pdf/manual/<?php echo $eventName; ?>.pdf" target="_blank">説明書</a>
                                                        </div>
                                                    </div>-->
                                    <!--</div>-->
<!--                                                </td>
...
?>
    <script charset="UTF-8" type="text/javascript" src="/htl/js/define.js" id="definejs-arg"
    ...
    ></script>
    <script charset="UTF-8" type="text/javascript" src="/htl/js/input2.js?<?php echo $strSysdate; ?>"></script>
</body>
</html>
