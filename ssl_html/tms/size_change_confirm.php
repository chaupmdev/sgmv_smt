...
Sgmov_Lib::useView('tms/SizeChangeConfirm');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Tms_SizeChangeConfirm();
$forms = $view->execute();
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <div class="section">
                <form action="/tms/size_change_complete" data-feature-id="<?php echo Sgmov_View_Tms_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Tms_Common::GAMEN_ID_EVE001 ?>" method="post">
                                                        ...
                                                        <tr>
                                                                <td style="padding-right: 20px;">
                                                                    ...
                                                                    <?php else: ?>
                                                                            ...
                                                                            その他&nbsp;その他&nbsp;0000
                                                                            <?php endif; ?>
                                                                            <?php echo $eveOutForm->building_name(); ?>&nbsp;<?php echo $eveOutForm->building_booth_position(); ?>
                                                                    <?php endif; ?>
...
<?php if($eveOutForm->comiket_div() == Sgmov_View_Tms_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
    ...
    <?php if ($eveOutForm->comiket_payment_method_cd_sel() == '2') : // クレジット ?>
                        ...
                        <div class="btn_area">
                            ...
                            <?php if (@empty($dispItemInfo['is_cancel'])) : ?>
                                <a class="back" href="/tms/size_change_credit_card/">修正する</a>
                                <input id="submit_button" type="submit" name="submit" value="入力内容を送信する" />
                            <?php else: ?>
                                <input id="submit_button" type="submit" name="submit" value="キャンセル送信する" />
                            <?php endif; ?>
    ...
    <?php if ($eveOutForm->comiket_payment_method_cd_sel() == '3') : // 電子マネー ?>
       ...
       <strong class="red">※電子マネーでのお支払いは、￥10,000を超える場合はお取り扱い出来ません。</strong>
        <div class="btn_area">
            <a class="back" href="/tms/size_change/">修正する</a>
            <?php if (@empty($dispItemInfo['is_cancel'])) : ?>
                <input id="submit_button" type="submit" name="submit" value="入力内容を送信する" />
            <?php else: ?>
                <input id="submit_button" type="submit" name="submit" value="キャンセル送信する" />
