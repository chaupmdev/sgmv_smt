...
<?php
        ...
        echo '<br/><img src="/'.$dirDiv.'/images/expo_logo.png" height="80px">';
?>
<?php
    // キャッシュ対策
...
?>
                                                    <div class="sp_dl_area2 paste_tag">
                                                        <div style=";display:none;" class="eventsub_dl_link paste_tag">
                                                            ...
                                                            <a style="color: blue;" class="paste_tag_link" href="/<?=$dirDiv?>/pdf/paste_tag/paste_tag_<?php echo $eve001Out->eventsub_cd_sel(); ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">貼付票（例）</a>
                                                        </div>
                                                        <br/>
...
<?php if ($eve001Out->input_mode() != '002') {  // 入力モードが"002"(コミケ)なら説明書のリンクは表示しない ?>
                                                        ...
                                                        <div class="eventsub_dl_link manual" style="display:none;">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;" class="manual_link" href="/<?=$dirDiv?>/pdf/manual/<?php echo $eventName; ?><?php echo $eventsubName; ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">説明書</a>
                                                        </div>
<?php } ?>
                                                    </div>
                                                    <br/>
...
<!--                                                    <div class="pc_dl_area2">
                                                        <div style="margin-bottom:3px;display:none;" class="eventsub_dl_link pasete_tag">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;" class="paste_tag_link" href="/<?=$dirDiv?>/pdf/paste_tag/paste_tag_<?php echo $eve001Out->eventsub_cd_sel(); ?>.pdf" target="_blank">貼付票</a>
                                                        </div>
                                                        <br/>
                                                        <div class="eventsub_dl_link manual" style="display:none;">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;" class="manual_link" href="/<?=$dirDiv?>/pdf/manual/<?php echo $eventName; ?><?php echo $eventsubName; ?>.pdf" target="_blank">説明書</a>
                                                        </div>
                                                    </div>-->
<!--                                                </td>
                                            </tr>
