                                        ...
                                        <div>
                                                <div style="display: none;">
                                                    <label class="radio-label-comiket_eventsub_sel_rd" for="comiket_eventsub_sel_rd1" style="height: 10px; white-space: normal;">
                                                        <input id="comiket_eventsub_sel_rd1" class="comiket_eventsub_sel_rd" name="eventsub_sel_rd" type="radio" value="<?= Sgmov_View_Sso_Input::$eventsubInfo[0] ?>" checked="checked" style="vertical-align: middle;"
                                                ...
                                                <input type="hidden" name="comiket_customer_kbn_sel" value="<?php echo $eve001Out->comiket_customer_kbn_sel(); ?>"/>
                                        </div>
                                </dd>
                            </dl>
                            <dl>
...
<?php
        echo Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->comiket_pref_cds(), $eve001Out->comiket_pref_lbls(), $eve001Out->comiket_pref_cd_sel());
?>
                                </dd>
                            </dl>
                            <dl style="display: none;">
                            ...
                            <?php if($eve001Out->comiket_customer_kbn_sel() == '1') : // 出展者の場合 ?>
                                ...
                                <dl class="class_building_name_sel">
                                    ...
                                    <dd>
                                        <?php echo $eve001Out->building_booth_position(); ?>
                                        <?php if ($eve001Out->comiket_booth_num() != '0000') : ?>
                                            ブロック&nbsp;<?php echo $eve001Out->comiket_booth_num(); ?>
                                        <?php endif; ?>
                                    </dd>
                                </dl>
                            <?php endif; ?>
