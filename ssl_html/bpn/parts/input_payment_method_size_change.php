    <?php if ($bpn001Out->comiket_payment_method_cd_sel() == '2') : // クレジット ?>
                        ...
                        <h4  style = "margin-top:30px;" class="table_title">クレジットお支払い情報</h4>
                        <div class="dl_block">
                            <dl>
                                <dt>合計金額</dt>
                                <dd>
    ...
    <?php if ($bpn001Out->comiket_payment_method_cd_sel() == '1') : // コンビニ前払い ?>
        <h4 style = "margin-top:30px;"  class="table_title">コンビニ前払い情報</h4>
        <div class="dl_block">
            <dl>
                <dt>合計金額</dt>
    ...
    <?php if ($bpn001Out->comiket_payment_method_cd_sel() == '4') : // コンビニ後払 ?>
