...
// 処理を実行
$view = new Sgmov_View_Dsn_Cancel();
$forms = $view->execute();
...
<head>
    ...
    <meta name="Description" content="宿泊ホテルより国内配送受付サービスのお申し込みのご案内です。" />
    <meta name="author" content="SG MOVING Co.,Ltd" />
    <meta name="copyright" content="SG MOVING Co.,Ltd All rights reserved." />
    <title>宿泊ホテルより国内配送受付サービスのキャンセルお申し込み｜お問い合わせ│ＳＧムービング株式会社＜ＳＧホールディングスグループ＞</title>
<?php
    // キャッシュ対策
...
?>
    <div id="breadcrumb">
        <ul class="wrap">
            ...
            <li class="current">宿泊ホテルより国内配送受付サービスのキャンセルお申し込み</li>
        </ul>
    </div>
    <div id="main">
        <div class="wrap clearfix">
            <h1 class="page_title">宿泊ホテルより国内配送受付サービスのキャンセルお申し込み</h1>
            <p class="sentence">
...
?>
            <div class="section other">
                <form action="/<?=$dirDiv?>/cancel_comp" data-feature-id="<?php echo Sgmov_View_Dsn_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Dsn_Common::GAMEN_ID_HOT001 ?>" method="post">
