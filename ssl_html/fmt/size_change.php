...
Sgmov_Lib::useView('fmt/SizeChange');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Fmt_SizeChange();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/fmt/size_change_check_input" data-feature-id="<?php echo Sgmov_View_Fmt_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Fmt_Common::GAMEN_ID_EVE001; ?>" method="post">
