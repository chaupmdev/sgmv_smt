<?php //javascript:dispPaymentMethod()メソッドで表示制御している ?>
                    ...
                    <div class="payment_method clearfix<?php if (isset($e) && $e->hasErrorForId('payment_method')) { echo ' form_error'; } ?>" id="payment_method">
                        ...
                        <label class="radio-label pay_convenience_store" for="pay_convenience_store">
                        ...
                        <label class="radio-label pay_convenience_store" for="pay_convenience_store_laterpay" > <!--style="color:#999;"-->
                            <!--
...
<!--                            <input<?php if ($eve001Out->comiket_payment_method_cd_sel() == '4') echo ' checked="checked"'; ?> class="radio-btn" id="pay_convenience_store_laterpay" name="comiket_payment_method_cd_sel" type="radio" value="4" />
                        ...
                        <div id="convenience" style="display:none;" class="pay_convenience_store">
...
<!--
                          <strong class="red">※ コンビニ後払いについて：決済時に、お申し込みに時間がかかる場合又は、お申し込みができない場合がございますのでご了承ください。
                          <br>　 その他の決済方法でお申し込みをお願い申し上げます。</strong>
-->
<!--
