...
// 処理を実行
$view = new Sgmov_View_Nss_Confirm();
$forms = $view->execute();
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <div class="section">
                <form action="/<?=$dirDiv?>/complete" data-feature-id="<?php echo Sgmov_View_Nss_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Nss_Common::GAMEN_ID_NSS001 ?>" method="post">
...
<?php
        $eventName = Sgmov_View_Nss_Confirm::_getLabelSelectPulldownData($eveOutForm->event_cds(), $eveOutForm->event_lbls(), $eveOutForm->event_cd_sel());
        echo $eventName;
?>
                                                    &nbsp;
...
<?php
        $eventsubName = Sgmov_View_Nss_Confirm::_getLabelSelectPulldownData($eveOutForm->eventsub_cds(), $eveOutForm->eventsub_lbls(), $eveOutForm->eventsub_cd_sel());
        echo $eventsubName;
?>
                                                    </span>
                                                </td>
                                    ...
                                    <?php foreach($dispItemInfo['comiket_div_lbls'] as $key => $val) : ?>
                                        <?php if ($eveOutForm->comiket_div() == $key) : ?>
                                            <?php if($eveOutForm->event_cd_sel() == '2') :  // コミケの場合?>
                                                ...
                                                <?php if($eveOutForm->comiket_div() == Sgmov_View_Nss_Common::COMIKET_DEV_BUSINESS) : ?>
                                                <?php $val = '請求書にて請求'; ?>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                            <?php echo $val; ?>
                            ...
                            <?php if ($eveOutForm->comiket_div() == Sgmov_View_Nss_Common::COMIKET_DEV_BUSINESS) : // 法人 and 顧客コードを使用する ?>
                                <dl>
                                                ...
                                                <tr>
                                                    <td style="padding-right: 20px;">
                                                        ...
                                                        <?php if(empty($comiketId)) : ?>
                                                            <?php
                                                                $building_name =  Sgmov_View_Nss_Confirm::_getLabelSelectPulldownData($eveOutForm->building_name_ids(), $eveOutForm->building_name_lbls(), $eveOutForm->building_name_sel());
                                                                $boothPosition = Sgmov_View_Nss_Confirm::_getLabelSelectPulldownData($eveOutForm->building_booth_position_ids(), $eveOutForm->building_booth_position_lbls(), $eveOutForm->building_booth_position_sel());
                                                            ?>
                                                        <?php else: ?>
                                                                <?php
                                                            ...
                                                            if($building_name != "その他"): 
                                                                echo "東".$boothPosition; ?>
                                                               <!-- echo $building_name; ?> -->
                                                               <!-- <span style="font-size: 1em;">ホール</span>&nbsp;&nbsp; -->
                                                            <?php endif; ?>
...
<?php /**********************************************************************************************************************/ ?>
                            <div class="dl_block input-outbound comiket_block">
                                ...
                                <dl>
                                    ...
                                    <dd>
<?php
        echo Sgmov_View_Nss_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_detail_outbound_pref_cds(), $eveOutForm->comiket_detail_outbound_pref_lbls(), $eveOutForm->comiket_detail_outbound_pref_cd_sel());
?>
                                    </dd>
                                </dl>
                                <dl>
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        ...
                                        （<?php echo Sgmov_View_Nss_Confirm::_getWeek($eveOutForm->comiket_detail_outbound_collect_date_year_sel(), $eveOutForm->comiket_detail_outbound_collect_date_month_sel(), $eveOutForm->comiket_detail_outbound_collect_date_day_sel()); ?>）
                                        &nbsp;
...
<?php
        if ( $view->checkColAndDelTime("outbound", $eveOutForm->comiket_div(), $eveOutForm->comiket_detail_outbound_service_sel(), $dispItemInfo["eventsub_selected_data"]) ) {
            echo Sgmov_View_Nss_Confirm::_getTimeFormatSelectPulldownData($eveOutForm->comiket_detail_outbound_collect_time_cds(), $eveOutForm->comiket_detail_outbound_collect_time_lbls(), $eveOutForm->comiket_detail_outbound_collect_time_sel());
        }
?>
                                    </dd>
                                </dl>
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        ...
                                        （<?php echo Sgmov_View_Nss_Confirm::_getWeek($eveOutForm->comiket_detail_outbound_delivery_date_year_sel(), $eveOutForm->comiket_detail_outbound_delivery_date_month_sel(), $eveOutForm->comiket_detail_outbound_delivery_date_day_sel()); ?>）
                                        &nbsp;
<?php
        echo Sgmov_View_Nss_Confirm::_getTimeFormatSelectPulldownData($eveOutForm->comiket_detail_outbound_delivery_time_cds(), $eveOutForm->comiket_detail_outbound_delivery_time_lbls(), $eveOutForm->comiket_detail_outbound_delivery_time_sel());
?>
                                    </dd>
                                </dl>
                                        ...
                                        <table>
                                            <tr>
                                                <td class='box_table_td' style='vertical-align: middle;width:40%;'>
                                                    <table>
                                                        <?php // if($eveOutForm->comiket_div() == Sgmov_View_Nss_Common::COMIKET_DEV_INDIVIDUA) : ?>
                                                            <table>
                                                ...
                                                <td style='padding-top:5px;'>
                                                    <?php if($eveOutForm->comiket_div() == Sgmov_View_Nss_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <?php if ($eveOutForm->comiket_detail_outbound_service_sel() == "2") : // カーゴ ?>
                                    <dl class="service-outbound-item" service-id="2">
                                        ...
                                        <dd>
<?php
                                                echo Sgmov_View_Nss_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_cargo_outbound_num_cds(), $eveOutForm->comiket_cargo_outbound_num_lbls(), $eveOutForm->comiket_cargo_outbound_num_sel());
?>台
                                ...
                                <?php if ($eveOutForm->comiket_detail_outbound_service_sel() == "3") : // 貸切 ?>
                                    <dl class="service-outbound-item" service-id="3">
                                        ...
                                        <dd>
                                            ...
                                            <?php elseif($eveOutForm->comiket_div() == Sgmov_View_Nss_Common::COMIKET_DEV_BUSINESS) : // 法人  ?>
                                                <div class="comiket-charter-outbound-num" div-id="<?php echo Sgmov_View_Nss_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                                    <table>
                                ...
                                <!-- GiapLN add 梱包ガイドライン 2022.07.14 END -->
                            </div>
                        <?php endif; // 搬入の場合  ?>
...
<?php /**********************************************************************************************************************/ ?>
                            <div class="dl_block input-inbound comiket_block">
                                ...
                                <dl>
                                    ...
                                    <dd>
<?php
        echo Sgmov_View_Nss_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_detail_inbound_pref_cds(), $eveOutForm->comiket_detail_inbound_pref_lbls(), $eveOutForm->comiket_detail_inbound_pref_cd_sel());
?>
                                    </dd>
                                </dl>
                                <dl>
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        ...
                                        （<?php echo Sgmov_View_Nss_Confirm::_getWeek($eveOutForm->comiket_detail_inbound_collect_date_year_sel(), $eveOutForm->comiket_detail_inbound_collect_date_month_sel(), $eveOutForm->comiket_detail_inbound_collect_date_day_sel()); ?>）
                                        &nbsp;
<?php
        echo Sgmov_View_Nss_Confirm::_getTimeFormatSelectPulldownData($eveOutForm->comiket_detail_inbound_collect_time_cds(), $eveOutForm->comiket_detail_inbound_collect_time_lbls(), $eveOutForm->comiket_detail_inbound_collect_time_sel());
?>
                                    </dd>
                                </dl>
                                <dl style="display: none;">
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        ...
                                        （<?php echo Sgmov_View_Nss_Confirm::_getWeek($eveOutForm->comiket_detail_inbound_delivery_date_year_sel(), $eveOutForm->comiket_detail_inbound_delivery_date_month_sel(), $eveOutForm->comiket_detail_inbound_delivery_date_day_sel()); ?>）
                                        &nbsp;
<?php
        if ( $view->checkColAndDelTime("inbound", $eveOutForm->comiket_div(), $eveOutForm->comiket_detail_inbound_service_sel(), $dispItemInfo["eventsub_selected_data"]) ) :
            echo Sgmov_View_Nss_Confirm::_getTimeFormatSelectPulldownDataForInBound($eveOutForm->comiket_detail_inbound_delivery_time_cds(), $eveOutForm->comiket_detail_inbound_delivery_time_lbls(), $eveOutForm->comiket_detail_inbound_delivery_time_sel());
        endif;
?>
                                        <br/>
                                        <br/>
                                ...
                                <?php if ($eveOutForm->comiket_detail_inbound_service_sel() == "2") : // カーゴ ?>
                                    <dl class="service-outbound-item" service-id="2">
                                        ...
                                        <dd>
<?php
                                                echo Sgmov_View_Nss_Confirm::_getLabelSelectPulldownData($eveOutForm->comiket_cargo_inbound_num_cds(), $eveOutForm->comiket_cargo_inbound_num_lbls(), $eveOutForm->comiket_cargo_inbound_num_sel());
?>台
                                        </dd>
                                    </dl>
                                <?php endif; ?>
...
<?php if($eveOutForm->comiket_div() == Sgmov_View_Nss_Common::COMIKET_DEV_BUSINESS) : // 法人 ?>
