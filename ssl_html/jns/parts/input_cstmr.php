...
?>
                                            ...
                                            <br/>
                                            <img src="<?=$dispItemInfo['dispEvent']['logoImg']?>" style="margin:10px 0;width:100%;">
                                                    <div class="sp_dl_area2 paste_tag">
                                                        <div class="eventsub_dl_link paste_tag">
                                                            ...
                                                            <a style="color: blue;" class="paste_tag_link" href="<?=$dispItemInfo['dispEvent']['pasteTag']?>" target="_blank">貼付票（例）</a>
                                                        </div>
                                                        <br/>
...
-->
                                                        <div>
                                                        <strong style="color:#C00;">※北海道、青森・中国・四国・九州エリアにご在住の方は申込受付期間が6/19(土）12：00までになります。</strong>
                                                        </div>
<?php } ?>
                                                    </div>
                                                    <!-- <br/> -->
...
-->
                                    ...
                                    <select name="building_booth_position_sel">
                                        <option value="">選択してください</option>
<?php
                                         echo Sgmov_View_Dsn_Input::_createPulldown($eve001Out->building_booth_position_ids(), $eve001Out->building_booth_position_lbls(), $eve001Out->building_booth_position_sel());
?>
                                    </select>

<!--
                                    <select  name="comiket_booth_num">
                                        <option value="">選択してください</option>
                                        <?php
                                            echo(Sgmov_View_Dsn_Input::_createPulldown($eve001Out->raw_building_booth_ids
                                                                                    , $eve001Out->raw_building_booth_lbls
                                                                                    , $eve001Out->comiket_booth_num()
                                                                                    )
                                            );
                                        ?>
                                    </select>
-->
                                    ...
                                    <input class="w_30Per" autocapitalize="off" maxlength="4" name="comiket_booth_num" placeholder="例）1234(数値4桁)" type="hidden" value="<?php echo $eve001Out->comiket_booth_num();?>" />
...
-->
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_staff_seimei')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <br/><br/>
                                    <strong class="red">※会場で引取りされる方のお名前を入力してください。<!--、もしくは出荷される方--></strong>
                                </dd>
                            </dl>
                            <dl>
