...
<head>
    ...
    <title>クレジットカード決済エラー│ＳＧムービング株式会社＜ＳＧホールディングスグループ＞</title>
...
<body>
    ...
    <div id="breadcrumb">
        <ul class="wrap">
            <li><a href="/">ホーム</a></li>
            <li class="current">既に精算が完了している決済番号です。</li>
        </ul>
    </div>
    ...
    <div id="main">
        ...
        <div class="wrap clearfix">
            ...
            <h1 class="page_title">URLエラーが発生しました</h1>

            <div class="section">
                <p class="sentence notice">
                    URLを正しく読み込めなかったため処理を中断します。
                    <br />担当営業所又はドライバーにご連絡下さい。
                </p>
