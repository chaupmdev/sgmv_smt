...
<?php
            echo Sgmov_View_Dsn_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
?>
                                    &nbsp;&nbsp;
                                    </span>
...
<?php
            echo Sgmov_View_Dsn_Input::_createPulldown($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel(), $eve001Out->eve_timeover_flg(), $eve001Out->eve_timeover_date());
?>
                                        </select>
...
<?php
            echo Sgmov_View_Dsn_Input::_createPulldown($eve001Out->eventsub_cds(), $eve001Out->eventsub_lbls(), $eve001Out->eventsub_cd_sel());
?>
                                        </select>
                                            <br/>
                                            <img src="<?=$dispItemInfo['dispEvent']['logoImg']?>" style="margin:10px 0;width:80%;">
                                                    <div class="sp_dl_area2 paste_tag">
                                                        <div class="eventsub_dl_link paste_tag">
                                                            ...
                                                            <a style="color: blue;" class="paste_tag_link" href="<?=$dispItemInfo['dispEvent']['pasteTag1']?>" target="_blank">貼付票(1日目)</a>
                                                        </div>
                                                        <br/>
                                                        <div class="eventsub_dl_link paste_tag">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;" class="paste_tag_link" href="<?=$dispItemInfo['dispEvent']['pasteTag2']?>" target="_blank">貼付票(2日目)</a>
                                                        </div>
                                                        <br/>
                                                        <strong class="red eventsub_dl_link paste_tag_link paste_tag">
                                                            ※出荷の際、こちらを荷物に貼り付けて出荷をお願いします。<br/><br/>
                                                            ※お申し込み完了画面でクリエイター名が記載された貼付票を出力できます。
                                                        </strong>
<?php
...
?>
                                                        ...
                                                        <div class="eventsub_dl_link manual" style="display: none">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;" class="manual_link" href="<?=$dispItemInfo['dispEvent']['manual']?>" target="_blank">説明書</a>
                                                        </div>
                                                        <br/>
                                                        <div>
                                                        <strong style="color:#C00;">※関西・中部・北陸・東北・関東・沖縄エリアにご在住の方は申込受付期間が7/9(火）～7/15(月）12：00までになります。</strong>
                                                        <br/><br/>
                                                        <strong style="color:#C00;">※九州・四国・中国・北海道・青森エリアにご在住の方は申込受付期間が7/9(火）～7/14(日）12：00までになります。</strong>
                                                        <br/><br/>
                                                        <strong style="color:#C00;">※引き渡し期間は7/20(土）、7/21(日）になります。</strong>
                                                        </div>
<?php } ?>
                                                    </div>
                                                    <!-- <br/> -->
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_pref')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <select name="comiket_pref_cd_sel">
                                        <option value="">選択してください</option>
<?php
        echo Sgmov_View_Dsn_Input::_createPulldown($eve001Out->comiket_pref_cds(), $eve001Out->comiket_pref_lbls(), $eve001Out->comiket_pref_cd_sel());
?>
                                    </select>
                                </dd>
                            </dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_booth_name')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <br />
                                     <strong class="red lhn">
                                        ※出店者及び関係者の方がご利用の場合は、クリエイター名を忘れずに入力してください。<br />
                            ...
                            <dl class="class_building_name_sel">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('building_name_sel')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <div style="margin-bottom: 2px;">
                                        ...
                                        <span style="font-size: 0.5em;margin-left: 121px;">ブース番号</span>
                                    </div>
...
<?php
                                    // ブースNo コンボボックス 出力
                                         echo Sgmov_View_Dsn_Input::_createPulldown($eve001Out->building_booth_position_ids()
...
<?php // ブース番号テキストボックス ?>
                                    ...
                                    <strong class="red lhn">
                                        ...
                                        ※イベント来場者の方がご利用の場合は、「その他」「0000」と入力してください。
                                    <br/>
                                    <br/>
                            ...
                            <dl>
                                ...
                                ?>>
                                    <div class="comiket_detail_type_sel-dd">
                                        ...
                                        <?php endforeach; ?>
                                    <!--<br/>-->
                                    <!--<strong class="red">※ 搬出のお申込みは2023年1月21日（土）16:00からとなります。</strong>-->
                                    </div>
                                </dd>
                            </dl>
                        </div>