 ...
 */
class Sgmov_View_Azk_CancelComp extends Sgmov_View_Azk_Common {
...
Sgmov_Component_Log::debug ( 'CD不一致' );
     ...
     * @param Sgmov_Form_Azk001In $inForm 入力フォーム
     * @return Sgmov_Form_Azk001Out 出力フォーム
     */
    protected function _createOutFormByInForm($inForm, $param=NULL) {
        ...
        if(!empty($param)) {
            ...
            // $inForm["comiket_detail_delivery_date_year_sel"] = date('Y', strtotime($deliveryDate . " 00:00:00"));
            // $inForm["comiket_detail_delivery_date_month_sel"] = date('m', strtotime($deliveryDate . " 00:00:00"));
            // $inForm["comiket_detail_delivery_date_day_sel"] = date('d', strtotime($deliveryDate . " 00:00:00"));
            // if (@empty($comikeDetailInfo['delivery_st_time'])) {
            //     $inForm["comiket_detail_delivery_time_sel"] = "00";
            // } else {
            //     $inForm["comiket_detail_delivery_time_sel"] = "{$comikeDetailInfo['delivery_st_time']}-{$comikeDetailInfo['delivery_ed_time']}";
            // }
        ...
        $eve001Out = $this->createOutFormByInForm($inForm, new Sgmov_Form_Azk001Out());
