...
<?php
        ...
        //if(strpos($eventName,'デザインフェスタ') !== false){
            echo '<img src="/eve/images/logo.png">';
        //}
?>
<?php
    // キャッシュ対策
...
?>
                                        <div class="sp_dl_area2 paste_tag">
                                                ...
                                                <tr>
                                                    <td style="vertical-align: top;padding-top:20px;width: 70%;">
                                                        <div style=";display:none;" class="eventsub_dl_link paste_tag">
                                                            ...
                                                            <a style="color: blue;font-weight: normal;" class="paste_tag_link" href="/eve/pdf/paste_tag/paste_tag_<?php echo $eve001Out->eventsub_cd_sel(); ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">貼付票（手書用）</a>
                                                        </div>
                                                        <br/>
                                            ...
                                            <!--<div class="eventsub_dl_link manual" style="display:none;">
                                                <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                <a style="color: blue;font-weight: normal;text-decoration: underline;" class="manual_link" href="/eve/pdf/manual/<?php echo $eventName; ?><?php echo $eventsubName; ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">宅配便WEB申込みのご案内</a>
                                            </div>-->
                            ...
                            **/ ?>
                            ...
                            <?php if ($userType === 1) :?>
                                <dl>
                                    ...
                                    <dd>
                                        <?php echo $_SESSION['EVE_LOGIN']['email'] ?>
                                    </dd>
                                </dl>
                            <?php endif; ?>
...
?>
                            ...
                            <dl>
                             ...
                             <!-- 2022-03-10 ToanDD3 implement SMT6-63 -->
                            ...
                            <dl class="class_comiket_booth_name">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_booth_name')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <br/>
                                    <strong class="red">
                                    ※出店者及び関係者の方がご利用の場合は、ブース名を忘れずに入力してください。
                                    <br/>
...
<!--                                     <input type="hidden" name="building_booth_position_sel" value="EVE"/> -->
                                    </div>
                                    ...
                                    <?php if ($eve001Out->event_cd_sel() == '2') : ?>
                                        ...
                                        ※イベント来場者の方がご利用の場合は、「00」と入力してください。
                                    <?php else: ?>
