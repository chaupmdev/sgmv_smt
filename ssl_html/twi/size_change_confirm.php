...
// 処理を実行
$view = new Sgmov_View_Twi_SizeChangeConfirm();
$forms = $view->execute();
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <div class="section">
                <form action="/<?=$dirDiv?>/size_change_complete" data-feature-id="<?php echo Sgmov_View_Twi_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Twi_Common::GAMEN_ID_TWI001 ?>" method="post">
                                                        ...
                                                        <td style="padding-right: 20px;">
                                                            ...
                                                            <?php if(empty($comiketId)) : ?>
                                                                <?php
                                                                    ...
                                                                    $boothPosition = Sgmov_View_Twi_Confirm::_getLabelSelectPulldownData($eveOutForm->building_booth_position_ids(), $eveOutForm->building_booth_position_lbls(), $eveOutForm->building_booth_position_sel());
                                                                ?>
                                                            <?php else: ?>
                                                                    <?php
