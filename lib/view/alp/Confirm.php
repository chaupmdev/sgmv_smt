...
Sgmov_Lib::useForms(array('Error', 'AlpSession', 'Alp003Out'));
/**#@-*/
 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Evp_Confirm extends Sgmov_View_Evp_Common {
     ...
     * @return Sgmov_Form_Alp003Out 出力フォーム
     */
    public function _createOutFormByInForm($inForm, $db) {
        return $this->createOutFormByInForm($inForm, new Sgmov_Form_Alp003Out());
    }
}