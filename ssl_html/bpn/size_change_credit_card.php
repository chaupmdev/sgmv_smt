...
// 開催期間開始日
$termFr=explode('-',$bpn001Out->raw_term_fr);
// クレジットカード有効期限年のカウント
$inputCreditcardCnt=$bpn001Out->input_creditcard_cnt;
?>
<!DOCTYPE html>
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <form action="/bpn/size_change_check_credit_card" method="post">
...
<?php } ?>
                    ...
                    <div class="result02" style="font-size:134%;text-align: center;">
                        ...
                        &nbsp;<span style="white-space: nowrap;"><?php echo number_format($bpn001Out->delivery_charge_buppan()); ?>円（税込）</span>
                    </div>
...
<?php
        echo Sgmov_View_Bpn_CreditCard::_createPulldown($bpn001Out->card_expire_month_cds(), $bpn001Out->card_expire_month_lbls(), $bpn001Out->card_expire_month_cd_sel());
?>
                                </select>
                                月
                            </label>
...
<?php
        echo Sgmov_View_Bpn_CreditCard::_createPulldown($bpn001Out->card_expire_year_cds(), $bpn001Out->card_expire_year_lbls(), $bpn001Out->card_expire_year_cd_sel());
?>
                                    </select>
                                    年
                                </label>
                        ...
                        <dl>
                            ...
                            <dd<?php if (isset($e) && $e->hasErrorForId('top_card_number')) { echo ' class="form_error"'; } ?>>
                                <input autocapitalize="off" class="w_280" id="card_number" inputmode="numeric" maxlength="16" name="card_number" data-pattern="^\d+$" placeholder="例）9999999999999999" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $bpn001Out->card_number(); ?>" />
                            </dd>
                        </dl>
                        <dl>
                            <dt class="condition">
                            ...
                            <dd<?php if (isset($e) && $e->hasErrorForId('top_security_cd')) { echo ' class="form_error"'; } ?>>
                                <input autocapitalize="off" class="w_60" id="security_cd" inputmode="numeric" maxlength="4" name="security_cd" data-pattern="^\d+$" placeholder="例）9999" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $bpn001Out->security_cd(); ?>" />
                    ...
                    <div class="btn_area">
                        <a class="back" href="/bpn/size_change/?clr=1">修正する</a>
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/eve/js/credit_card.js"></script>
    <script>
        $(function() {
