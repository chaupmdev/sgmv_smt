 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Jtb_CheckInput extends Sgmov_View_Jtb_Common {
    ...
    public function executeInner() {
        ...
        // チケットの確認と破棄
        $session->checkTicket(self::FEATURE_ID, self::GAMEN_ID_JTB001, $this->_getTicket());
    ...
    public function _createInFormFromPost($post, $creditCardForm) {
        ...
        $inForm->comiket_booth_cd_sel = filter_input(INPUT_POST, 'comiket_booth_cd_sel');
        $inForm->comiket_box_num = mb_convert_kana(filter_input(INPUT_POST, 'comiket_box_num'), 'rnask', 'UTF-8');
...
//        }
        $inForm->delivery_collection_date_year_cd_sel  = filter_input(INPUT_POST, 'delivery_collection_date_year_cd_sel');
        $inForm->delivery_collection_date_month_cd_sel = filter_input(INPUT_POST, 'delivery_collection_date_month_cd_sel');
        $inForm->delivery_collection_date_day_cd_sel   = filter_input(INPUT_POST, 'delivery_collection_date_day_cd_sel');
