                        <div class="dl_block comiket_block">
                            <dl>
                                ...
                                <dd>
                                    ...
                                    echo '<!--img src="/<?=$dirDiv?>/images/logo.gif"-->';
                                    ?>
                                    <?php
                                    // キャッシュ対策
                            ...
                            <dl style="display: none;">
                                ...
                                <dd>
                                    <?php foreach ($dispItemInfo['comiket_div_lbls'] as $key => $val) : ?>
                                        <?php if ($qrc001Out->comiket_div() == $key) : ?>
                                            <label class="radio-label comiket_div<?php echo $key; ?>" for="comiket_div<?php echo $key; ?>" style="display:none;">
                                                <input<?php if ($qrc001Out->comiket_div() == $key) echo ' checked="checked"'; ?> id="comiket_div<?php echo $key; ?>" name="comiket_div" type="radio" value="<?php echo $key; ?>" style="display: none;" />
                                                <?php echo $val; ?>
                                            </label>
                                            <br />
                                        <?php endif; ?>
                            ...
                            <dl class="comiket-personal-name-seimei" style="display: none;">
                                ...
                                <dd>
                                    <?php echo $qrc001Out->comiket_personal_name_sei(); ?>&nbsp;
                                    <?php echo $qrc001Out->comiket_personal_name_mei(); ?>
                                    <input class="" style="width:30%;" maxlength="8" autocapitalize="off" inputmode="comiket_personal_name_sei" name="comiket_personal_name_sei" data-pattern="" placeholder="例）佐川" type="hidden" value="<?php echo $qrc001Out->comiket_personal_name_sei() ?>" />
                                    <input class="" style="width:30%;" maxlength="8" autocapitalize="off" inputmode="comiket_personal_name_mei" name="comiket_personal_name_mei" data-pattern="" placeholder="例）花子" type="hidden" value="<?php echo $qrc001Out->comiket_personal_name_mei() ?>" />
                            ...
                            <dl>
                                ...
                                <dd>
                                    〒<?php echo $qrc001Out->comiket_zip1(); ?>&nbsp;-&nbsp;<?php echo $qrc001Out->comiket_zip2(); ?>
                                </dd>
                            </dl>
                            <dl>
                                <dt id="comiket_pref">
                                ...
                                <dd>
                                    ...
                                    <?php
                                    echo Sgmov_View_Qrc_Input::_getLabelSelectPulldownData($qrc001Out->comiket_pref_cds(), $qrc001Out->comiket_pref_lbls(), $qrc001Out->comiket_pref_cd_sel());
                                    ?>
                                </dd>
                            </dl>
                            <dl>
                                ...
                                <dd>
                                    <?php echo $qrc001Out->comiket_address(); ?>
                                </dd>
                            </dl>
                            <dl>
                                ...
                                <dd>
                                    <?php echo $qrc001Out->comiket_building(); ?>
                                </dd>
                            </dl>
                            <dl>
                                <dt id="comiket_tel">
                                ...
                                <dd>
                                    <?php echo $qrc001Out->comiket_tel(); ?>
                                </dd>
                            </dl>
                            <dl>
                                <dt id="comiket_mail">
                                ...
                                <dd>
                                    <?php echo $qrc001Out->comiket_mail(); ?>
                                </dd>
                            </dl>
                            <dl>
                                ...
                                <dd>
                                    <div class="comiket_detail_type_sel-dd">
                                        <?php foreach ($dispItemInfo['comiket_detail_type_lbls'] as $key => $val) : ?>
                                            <?php if ($qrc001Out->comiket_detail_type_sel() == $key) : ?>
                                                <label class="radio-label comiket_detail_type_sel-label<?php echo $key; ?>" for="comiket_detail_type_sel<?php echo $key; ?>">
                                                    <input<?php if ($qrc001Out->comiket_detail_type_sel() == $key) echo ' checked="checked"'; ?> id="comiket_detail_type_sel<?php echo $key; ?>" class="comiket_detail_type_sel" name="comiket_detail_type_sel" type="radio" value="<?php echo $key; ?>" style="display: none;" />
                                                    <?php echo $val; ?>
                                                </label>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
