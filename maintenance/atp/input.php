...
Sgmov_Lib::useView('atp/Input');
/**#@-*/

// 処理を実行
$view = new Sgmov_View_Atp_Input();
$forms = $view->execute();
                ...
                <ul class="register_item" id="travel_province_item">
                    <li id="travel_province_item_01" class="clearfix">
                        <fieldset>
                            ...
                            <input autocapitalize="off"<?php if (isset($e) && $e->hasErrorForId('top_travel_province_cd')) { echo ' class="bg_red"'; } ?> id="travel_province_cd" inputmode="numeric" name="travel_province_cd" type="text" value="<?php echo $atp002Out->travel_province_cd(); ?>" />
                        </fieldset>
                    </li>
                    <li id="travel_province_item_02">
                        <fieldset>
                            <legend>ツアーエリア名</legend>
                            <input autocapitalize="off"<?php if (isset($e) && $e->hasErrorForId('top_travel_province_name')) { echo ' class="bg_red"'; } ?> id="travel_province_name" name="travel_province_name" type="text" value="<?php echo $atp002Out->travel_province_name(); ?>" />
                        </fieldset>
                    </li>
...
?>
                            ...
                            <div id="control_btn">
                                <div id="add_btn">
                                    <p>エリアに追加する</p>
                                    <input id="add" name="add" type="button" value="＞追加" />
                                    <br />
                                    <input id="add_all" name="add_all" type="button" value="＞＞全て追加" />
                                </div>
                                <div id="delete_btn">
                                    <p>エリアから削除する</p>
                                    <input id="delete" name="delete" type="button" value="削除＜" />
                                    <br />
                                    <input id="delete_all" name="delete_all" type="button" value="全て削除＜＜" />
                                </div>
                            </div>
                            <fieldset class="travel_province_list">
...
?>
    ...
    <!--<![endif]-->
    <script charset="UTF-8" type="text/javascript" src="/common/js/atpInput.js"></script>
</body>
</html>