...
Sgmov_Lib::useForms(array('Error', 'AlpSession'));
...
// TODO:暫定対応
$dispItemInfo['eventname_all']='AlpenTOKYO';
...
<div id="main">
    <div class="wrap clearfix">
        <h1 class="page_title"><?=$dispItemInfo['eventname_all']?> 購入商品配送受付サービスのお申し込みの完了</h1>
        <div class="section">
            ...
            <div style="clear: both;">
                ...
                <?php if(($eveOutForm->comiket_detail_type_sel() == "1" || $eveOutForm->comiket_detail_type_sel() == "3") // 搬入、もしくは往復
                    ...
                    <div style="font-size:20px;">
                        <a href="/<?=$dirDiv?>/paste_tag/<?php echo sprintf('%010d', $eveOutForm->qr_code_string()) . Sgmov_View_Evp_Common::getChkD2($eveOutForm->qr_code_string()); ?>/" target="_blank" style="color:blue;" download>
...
-->
                ...
                <?php if(($typeSel == "2" || $typeSel == "3") // 2:搬出、3:往復
                    ...
                    <br/><br/>・ ご指定のメールアドレスへQRコードを送信しました
...
<!--
                ...
                <br/><br/>
                <b>引き続き宅配をご利用される方は<a href="/<?=$dirDiv?>/input/<?=$eventsubData['id'];?>" target="_self" style="color:blue;font-weight: bold;text-decoration: underline;">こちら</a></b>
-->
            </div>
             <br/><br/>
...
<?php //申込番号とQRコードの表示  ?>
                ...
                <div class="btn_area">
                    <a class="next" href="/<?=$dirDiv?>/input/<?=$eventsubData['id'];?>">追加申込</a>
                </div>
            </div>
