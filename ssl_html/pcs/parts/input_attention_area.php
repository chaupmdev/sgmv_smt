<div class="attention_area">
    ...
    <div style='width: 100%;text-align: center;font-size: 20px;'>
        <input type="checkbox" id="checkbox_agreement" name="chb_agreement" value="<?php echo $pcs001Out->chb_agreement() ?>" <?php if ($pcs001Out->chb_agreement() == '1') echo ' checked="checked"'; ?> />
