...
Sgmov_Lib::useView('owk/Cancel');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Owk_Cancel();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/owk/cancel_comp" data-feature-id="<?php echo Sgmov_View_Owk_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Owk_Common::GAMEN_ID_OWK001 ?>" method="post">
