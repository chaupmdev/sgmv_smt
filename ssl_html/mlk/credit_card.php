<?php
/**
 * イベント手荷物受付システムのお申込みのクレジットカード入力画面を表示します。
 * @package    ssl_html
 * @subpackage EVE
 * @author     K.Sawada
...
Sgmov_Lib::useView('mlk/CreditCard');
/**#@-*/
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            ?>
            <form action="/mlk/check_credit_card" method="post">
...
<?php } ?>
                    ...
                    <div class="result02" style="font-size:134%;text-align: center;">
                        <span style="white-space: nowrap;">金額：</span>
...
<?php
        echo Sgmov_View_Eve_CreditCard::_createPulldownNoTranslate($eveOutForm->card_expire_month_cds(), $eveOutForm->card_expire_month_lbls(), $eveOutForm->card_expire_month_cd_sel());
?>
                                </select>
                                月
                            </label>
...
<?php
        echo Sgmov_View_Eve_CreditCard::_createPulldownNoTranslate($eveOutForm->card_expire_year_cds(), $eveOutForm->card_expire_year_lbls(), $eveOutForm->card_expire_year_cd_sel());
?>
                                    </select>
                                    年
                                </label>
                    ...
                    <div class="btn_area">
                            <a class="back" href="/mlk/input?tagId=<?php echo $eveOutForm->comiket_id();?>&clr=1&back=1">修正する</a>
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/mlk/js/credit_card.js"></script>
    <script>
        $(function() {
