...
Sgmov_Lib::useView('zzy/SizeChange');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Zzy_SizeChange();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/zzy/size_change_check_input" data-feature-id="<?php echo Sgmov_View_Zzy_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Zzy_Common::GAMEN_ID_ZZY001 ?>" method="post">
