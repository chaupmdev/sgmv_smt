...
// 処理を実行
$view = new Sgmov_View_Unf_Confirm();
$forms = $view->execute();
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <div class="section">
                <form action="/<?=$dirDiv?>/complete" data-feature-id="<?php echo Sgmov_View_Unf_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Unf_Common::GAMEN_ID_UNF001 ?>" method="post">
...
<?php
        $eventName = Sgmov_View_Unf_Confirm::_getLabelSelectPulldownData($eveOutForm->event_cds(), $eveOutForm->event_lbls(), $eveOutForm->event_cd_sel());
        echo $eventName;
?>
                                                    &nbsp;
...
<?php
        $eventsubName = Sgmov_View_Unf_Confirm::_getLabelSelectPulldownData($eveOutForm->eventsub_cds(), $eveOutForm->eventsub_lbls(), $eveOutForm->eventsub_cd_sel());
        echo $eventsubName;
?>
                                                    </span>
                                                </td>
                                    ...
                                    <?php foreach($dispItemInfo['comiket_div_lbls'] as $key => $val) : ?>
                                        <?php if ($eveOutForm->comiket_div() == $key) : ?>
                                            <?php if($eveOutForm->event_cd_sel() == '2') :  // コミケの場合?>
                                                ...
                                                <?php if($eveOutForm->comiket_div() == Sgmov_View_Unf_Common::COMIKET_DEV_BUSINESS) : ?>
                                                <?php $val = '請求書にて請求'; ?>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                            <?php echo $val; ?>
                            ...
                            <dl service-id="1">
                                ...
                                <dd>
                                   <?php foreach($dispItemInfo['box_lbls'] as $key => $val) : ?>
                                        ...
                                        <?php if(!empty($boxNum)) : ?>
                                            <div style="margin-top: 7px;"><?php echo $boxNum;?>個</div>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                </dd>
                            </dl>
                            ...
                            <dl>
                                ...
                                <dd>
                                    ...
                                    （<?php echo Sgmov_View_Unf_Confirm::_getWeek($year, $month, $day); ?>）
                                </dd>
                            </dl>
                        </div>
                    </div>
