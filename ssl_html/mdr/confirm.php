...
Sgmov_Lib::useView('mdr/Confirm');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Mdr_Confirm();
$forms = $view->execute();
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <div class="section">
                <form action="/mdr/complete" data-feature-id="<?php echo Sgmov_View_Mdr_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Mdr_Common::GAMEN_ID_MDR001 ?>" method="post">
...
<?php if($eveOutForm->comiket_div() == Sgmov_View_Mdr_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
    ...
    <?php if ($eveOutForm->comiket_payment_method_cd_sel() == '2') : // クレジット ?>
                        ...
                        <div class="btn_area">
                            <a class="back" href="/mdr/credit_card/">修正する</a>
