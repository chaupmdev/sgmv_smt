...
//console.log("####################### 702");
            ...
            g_eventsubList[currentId]['venue'] = $(this).attr("eventsub-venue");
...
//        return;
        ...
        sgwns.api('/common/php/SearchEventsub.php', getFormData(), (function(data) {
            ...
            for(var i = 0; i < data.ids.length; i++) {
                ...
                g_eventsubList[data.ids[i]]['venue'] = data.list[i].venue;
            }
...
console.log("################## 601-3 eventsub_sel change");
console.log(g_eventsubList);
...
//            $('label.radio-label').show(g_fifoVal);
            ...
            var eventsubId = $('select[name="eventsub_sel"]').val();
            var eventPlace = g_eventsubList[eventsubId]['venue'];
...
console.log('#################### ZZZZZZZZZZZ-1');
console.log(g_eventsubList);
        if(eventsubSel && eventsubSel != "") {
console.log('#################### ZZZZZZZZZZZ-2');
...
console.log('#################### ZZZZZZZZZZZ-3');
//                $('.paste_tag_link').attr("href", "/sso/pdf/paste_tag/paste_tag_" + eventsubSel + ".pdf");
//                $('.manual_link').attr("href", "/sso/pdf/manual/manual_" + eventsubSel + ".pdf");

                $('.manual').show(g_fifoVal);
                eventSelText = eventSelText.replace(/\s+/g, "");
                $('.manual_link').attr("href", "/sso/pdf/manual/" + eventSelText +  ".pdf" + '?' + strCurrentDate);
            } else {
                $('.manual').hide(g_fifoVal);
            }
            if(g_eventsubList[eventsubSel]['is_paste_display']){
                $('.paste_tag').show(g_fifoVal);
                $('.paste_tag_link').attr("href", "/sso/pdf/paste_tag/paste_tag_" + eventsubSel + ".pdf" + '?' + strCurrentDate);
            } else {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
    function dispBoothPosition() {
        ...
        if(g_eventsubList[eventsubId] && g_eventsubList[eventsubId]['is_building_display']) {
            $('.class_building_name_sel').show();
        } else {
            $('.class_building_name_sel').hide();
        }

        if(g_eventsubList[eventsubId] && g_eventsubList[eventsubId]['is_booth_display']) {
...
console.log("###### 888-1");
            // 個人・宅配・往路
            if(g_eventsubList[eventsubSel] && g_eventsubList[eventsubSel]['kojin_box_col_flg'] == '1') {
console.log("###### 888-2");
...
console.log("###### 888-3");
            ...
            // 個人・カーゴ・往路
            if(g_eventsubList[eventsubSel] && g_eventsubList[eventsubSel]['kojin_cag_col_flg'] == '1') {
...
//console.log("###### 888-1");
            // 個人・宅配・往路
            if(g_eventsubList[eventsubSel] && g_eventsubList[eventsubSel]['kojin_box_dlv_flg'] == '1') {
//console.log("###### 888-2");
...
//console.log("###### 888-3");
            ...
            // 個人・カーゴ・往路
            if(g_eventsubList[eventsubSel] && g_eventsubList[eventsubSel]['kojin_cag_dlv_flg'] == '1') {
    ...
    function getBoxData() {
        sgwns.api('/common/php/SearchBox.php', getFormData(), (function(data) {
            ...
            if($('input[name="comiket_detail_type_sel"]:checked').val() == "1" ) { // 搬入
                ...
                if($('input[name="comiket_div"]:checked').val() ==  G_DEV_INDIVIDUAL) {
                    htmlCode += "<img class='dispSeigyoPC' src='/sso/images/about_boxsize.png' width='100%'/>";
                } else {
//                    htmlCode += "<img src='/sso/images/about_boxsize.png' width='100%' style='visibility:hidden;'/>";
                }
                htmlCode += "</td></tr></table>";

                if($('input[name="comiket_div"]:checked').val() ==  G_DEV_INDIVIDUAL && $('.dispSeigyoSP').length === 0) {
                    htmlCode += "<div class='dispSeigyoSP'><img src='/sso/images/about_boxsize.png' width='250px' style='margin-top: 1em;' /></div>";
                }
                ...
                if($('input[name="comiket_div"]:checked').val() ==  G_DEV_INDIVIDUAL) {
                    htmlCode += "<img src='/sso/images/about_boxsize.png' width='100%'/>";
                }
                htmlCode += "</td></tr></table>";
                ...
                if($('input[name="comiket_div"]:checked').val() ==  G_DEV_INDIVIDUAL) {
                    htmlCode2 += "<img src='/sso/images/about_boxsize.png' width='100%'/>";
                }
                htmlCode2 += "</td></tr></table>"

                $('.comiket-box-inbound-num').append(htmlCode2);
            }
//            $('div.comiket-box-outbound-num input.number-only,div.comiket-box-inbound-num input.number-only').on('input', function(e) {
...
//        var detailType = $('input[name="comiket_detail_type_sel"]:checked').val();
        ...
        if(comiketDiv == G_DEV_INDIVIDUAL && serviceSel == '1') {
            if(g_eventsubList[eventsubSel] && g_eventsubList[eventsubSel]['kojin_box_col_date_flg'] == '1' && check == 'date') {
                return true;
            }

            if(g_eventsubList[eventsubSel] && g_eventsubList[eventsubSel]['kojin_box_col_time_flg'] == '1' && check == 'time') {
                return true;
            }
        }
...
//console.log(g_eventsubList[eventsubSel]['kojin_cag_col_time_flg']);
        ...
        // 個人・往路・宅配
        if(comiketDiv == G_DEV_INDIVIDUAL && serviceSel == '1') {
            if(g_eventsubList[eventsubSel] && g_eventsubList[eventsubSel]['kojin_box_col_date_flg'] == '1') {
                $('.class_comiket_detail_outbound_collect_date').show(g_fifoVal);
            } else {
                $('.class_comiket_detail_outbound_collect_date').hide(g_fifoVal);
            }

            if (g_eventsubList[eventsubSel] && g_eventsubList[eventsubSel]['kojin_box_del_date_flg'] == '1') {
                $('span.comiket_detail_outbound_delivery_date').show(g_fifoVal);
            } else {
                $('span.comiket_detail_outbound_delivery_date').hide(g_fifoVal);
            }

            if(g_eventsubList[eventsubSel] && g_eventsubList[eventsubSel]['kojin_box_col_time_flg'] == '1') {
            ...
            if (g_eventsubList[eventsubSel] && g_eventsubList[eventsubSel]['kojin_box_del_time_flg'] == '1') {
...
console.log(g_eventsubList[eventsubSel]['is_eq_inbound_collect']);
...
//                $('.comiket_detail_outbound_collect_time_sel').hide(g_fifoVal);
    ...
    // イベントsub/搬入・搬出変更
    /////////////////////////////////////////////////////////////////////////////////////////////
    $('input.comiket_eventsub_sel_rd').on('click', function() {
        var eventId = $('input[name="eventsub_sel_rd"]:checked').attr('cstm_event_id');
        var eventsubId = $('input[name="eventsub_sel_rd"]:checked').val();
        
        $('select[name="event_sel"]').val(eventId);
        $('select[name="event_sel"]').trigger('change');
        $('select[name="eventsub_sel"]').val(eventsubId);
        ...
        // 搬入ラジオボタン表示チェック
        sgwns.api('/common/php/checkOutBoundCollectCal.php', getFormData(), (function(data) {
            setTimeout(function(){
                if (data.result == '0') {
                    $('.comiket_detail_type_sel-label1').hide(); // ラベル 1
                }
            }, 500);
        }));
    ...
    // 便種区分 - 往路
    /////////////////////////////////////////////////////////////////////////////////////////////
    var clickOutbBinshuSel = function() {
        
        var r = $('input#comiket_detail_outbound_binshu_kbn_sel1:checked').val();
        if (r == '0') {
             $('.outbound_example_boxsize .msg-hikyaku_coolbin').hide();
             $('.outbound_example_boxsize .msg-hikyaku_normalbin').show();
             return;
         }
         var r = $('input#comiket_detail_outbound_binshu_kbn_sel2:checked').val();
         if (r == '1') {
             $('.outbound_example_boxsize .msg-hikyaku_coolbin').show();
             $('.outbound_example_boxsize .msg-hikyaku_normalbin').hide();

             return;
         }
         var r = $('input#comiket_detail_outbound_binshu_kbn_sel3:checked').val();
         if (r == '2') {
             $('.outbound_example_boxsize .msg-hikyaku_coolbin').show();
             $('.outbound_example_boxsize .msg-hikyaku_normalbin').hide();
             return;
    ...
    clickOutbBinshuSel();
    $('input[name=comiket_detail_outbound_binshu_kbn_sel]').on('click', function() {
//        var eventsubId = $('input[name="eventsub_sel_rd"]:checked').val();
//        $('select[name="eventsub_sel"]').val(eventsubId);
//        $('select[name="eventsub_sel"]').trigger('change');
        getBoxData();
        clickOutbBinshuSel();
    });
    ...
    // 便種区分 - 復路
    /////////////////////////////////////////////////////////////////////////////////////////////
    var clickInbBinshuSel = function() {
        
        var r = $('input#comiket_detail_inbound_binshu_kbn_sel1:checked').val();
        if (r == '0') {
             $('.inbound_example_boxsize .msg-hikyaku_coolbin').hide();
             $('.inbound_example_boxsize .msg-hikyaku_normalbin').show();
             return;
         }
         var r = $('input#comiket_detail_inbound_binshu_kbn_sel2:checked').val();
         if (r == '1') {
             $('.inbound_example_boxsize .msg-hikyaku_coolbin').show();
             $('.inbound_example_boxsize .msg-hikyaku_normalbin').hide();

             return;
         }
         var r = $('input#comiket_detail_inbound_binshu_kbn_sel3:checked').val();
         if (r == '2') {
             $('.inbound_example_boxsize .msg-hikyaku_coolbin').show();
             $('.inbound_example_boxsize .msg-hikyaku_normalbin').hide();
             return;
    ...
    clickInbBinshuSel();
    $('input[name=comiket_detail_inbound_binshu_kbn_sel]').on('click', function() {
//        var eventsubId = $('input[name="eventsub_sel_rd"]:checked').val();
//        $('select[name="eventsub_sel"]').val(eventsubId);
//        $('select[name="eventsub_sel"]').trigger('change');
    ...
    $('select[name=building_booth_position_sel]').on('change', function() {
        var selectedBoothPositionSel = $(this).val();
        if (selectedBoothPositionSel == '601'
            || selectedBoothPositionSel == '602'
            || selectedBoothPositionSel == '603'
            || selectedBoothPositionSel == '604'
            || selectedBoothPositionSel == '605') {
            $('input[name=comiket_booth_num').val('');
            $('input[name=comiket_booth_num], .building_booth_position_sel').hide(g_fifoVal);
        } else {
            $('input[name=comiket_booth_num], .building_booth_position_sel').show(g_fifoVal);
        }
    }).trigger('change');
