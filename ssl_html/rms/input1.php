...
Sgmov_Lib::useView('rms/Input');

// 処理を実行
$view = new Sgmov_View_Rms_Input();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/rms/check_input" data-feature-id="<?php echo Sgmov_View_Rms_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Rms_Common::GAMEN_ID_RMS001 ?>" method="post">
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/rms/js/input.js?<?php echo $strSysdate; ?>"></script>
