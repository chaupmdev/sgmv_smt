...
Sgmov_Lib::useForms(array('Bpn001Out'));
/**#@-*/
 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_Form_Bpn002Out extends Sgmov_Form_Bpn001Out {
     ...
     * @var string
     */
    public $raw_delivery_charge_buppan = '';
     ...
     * @return string エンティティ化された送料
     */
    public function delivery_charge_buppan() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_delivery_charge_buppan);
    }
}