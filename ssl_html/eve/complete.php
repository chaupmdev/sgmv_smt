...
Sgmov_Lib::useView('eve/Complete');
...
<!--                        <br /><span style="color: red;">※お支払いはお預かり日時の前日17時までに入金していただきますようお願いいたします。</span><br /><br /><br />-->
                    <?php endif; ?>
                <?php endif; ?>
                ...
                <?php if(($eveOutForm->comiket_detail_type_sel() == "1" || $eveOutForm->comiket_detail_type_sel() == "3") // 搬入、もしくは往復
                    ...
                    <div style="font-size:20px;">
                        <a href="/eve/paste_tag/<?php echo sprintf('%010d', $eveOutForm->qr_code_string()) . Sgmov_View_Eve_Common::getChkD2($eveOutForm->qr_code_string()); ?>/" target="_blank" style="color:blue;" download>
                ...
                <?php if ($eventsubData['manual_display'] == '1') { ?>
                    ...
                    <div style="font-size:20px;">
                        <a class="button_link2" href="/eve/pdf/manual/<?php echo $eventData['name']; ?><?php echo $eventsubData['name']; ?>.pdf" target="_blank" style="color:blue;">
                ...
                <?php if($paymentMethodCd === '3') : ?>
                     <br/>・ イベント当日、受付にて電子マネーでの決済をお願いします。<br/>
                <?php endif; ?>
                
                <?php // if(($typeSel == "2" || $typeSel == "3")) : // 2:搬出、3:往復 ?>
                    <br/>・ イベント開催当日は、宅配カウンターが大変混み合います。お荷物のサイズ、個数がお決まりになられましたら、お早めにお申込みをお済ませ下さい。
                <?php // endif; ?>

                <br/><br/>
                <!-- GiapLN implement SMT6-129 2022/04/12 --> 
                <?php if(!empty($existsComiketId)):?>
                    <b>引き続き搬出申込する方はこちら<a href="/eve/input/<?php echo $existsComiketId; ?>" target="_self" style="color:blue;font-weight: bold;text-decoration: underline;">こちら</a></b>
                <?php else:?>
                    <b>引き継き宅配をご利用される方は<a href="/eve/input" target="_self" style="color:blue;font-weight: bold;text-decoration: underline;">こちら</a></b>
                <?php endif;?>
                <!-- <b>引き続き宅配をご利用される方は<a href="/eve/input" target="_self" style="color:blue;font-weight: bold;text-decoration: underline;">こちら</a></b>-->
            </div>
             <br/><br/>
