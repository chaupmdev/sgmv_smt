...
<?php
        ...
        //echo '<!--img src="/zzy/images/logo.gif"-->';
        //}
?>
<?php
    // キャッシュ対策
                            ...
                            <dl style="display: none;">
                                ...
                                <dd>
                                    <?php foreach($dispItemInfo['comiket_div_lbls'] as $key => $val) : ?>
                                        ...
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                    <div class="attention_customer_cd">
...
<?php
        echo Sgmov_View_Zzy_Input::_getLabelSelectPulldownData($eve001Out->comiket_pref_cds(), $eve001Out->comiket_pref_lbls(), $eve001Out->comiket_pref_cd_sel());
?>
                                </dd>
                            </dl>
                            <dl>
