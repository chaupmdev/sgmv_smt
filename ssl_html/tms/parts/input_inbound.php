<?php /**********************************************************************************************************************/ ?>
                        <div class="input-inbound input-inbound-title">搬出（会場⇒お客様）</div>
<?php /**********************************************************************************************************************/ ?>
...
<?php
        echo Sgmov_View_Tms_Input::_createPulldown($eve001Out->comiket_detail_inbound_pref_cds(), $eve001Out->comiket_detail_inbound_pref_lbls(), $eve001Out->comiket_detail_inbound_pref_cd_sel());
?>
                                    </select>
                                    <br/>
                                    <br/>
...
<?php
                echo Sgmov_View_Tms_Input::_createPulldown($eve001Out->comiket_detail_inbound_collect_date_year_cds(), $eve001Out->comiket_detail_inbound_collect_date_year_lbls(), $eve001Out->comiket_detail_inbound_collect_date_year_sel());
?>
                                            </select>年
                                            <select name="comiket_detail_inbound_collect_date_month_sel">
                                                <option value="">月を選択</option>
<?php
                echo Sgmov_View_Tms_Input::_createPulldown($eve001Out->comiket_detail_inbound_collect_date_month_cds(), $eve001Out->comiket_detail_inbound_collect_date_month_lbls(), $eve001Out->comiket_detail_inbound_collect_date_month_sel());
?>
                                            </select>月
                                            <select name="comiket_detail_inbound_collect_date_day_sel">
                                                <option value="">日を選択</option>
<?php
                echo Sgmov_View_Tms_Input::_createPulldown($eve001Out->comiket_detail_inbound_collect_date_day_cds(), $eve001Out->comiket_detail_inbound_collect_date_day_lbls(), $eve001Out->comiket_detail_inbound_collect_date_day_sel());
?>
                                            </select>日
                                            &nbsp;
...
<?php
                echo Sgmov_View_Tms_Input::_createPulldown($eve001Out->comiket_detail_inbound_collect_time_cds(), $eve001Out->comiket_detail_inbound_collect_time_lbls(), $eve001Out->comiket_detail_inbound_collect_time_sel());
?>
                                                </select>
                                            </span>
                                        </div>
                                        <br>
                                        <strong class="red">※会場での宅配カウンター開設時間は　８月１２日（月）１６：００から１７：３０までです。</strong>
                                </dd>
                            </dl>
<!--                            <dl>
                                <dt>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_detail_inbound_delivery_date')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <div class="comiket_detail_inbound_delivery_date_parts">
                                        <select name="comiket_detail_inbound_delivery_date_year_sel">
                                            <option value="">年を選択</option>
<?php
            echo Sgmov_View_Tms_Input::_createPulldown($eve001Out->comiket_detail_inbound_delivery_date_year_cds(), $eve001Out->comiket_detail_inbound_delivery_date_year_lbls(), $eve001Out->comiket_detail_inbound_delivery_date_year_sel());
?>
                                        </select>年
                                        <select name="comiket_detail_inbound_delivery_date_month_sel">
                                            <option value="">月を選択</option>
<?php
            echo Sgmov_View_Tms_Input::_createPulldown($eve001Out->comiket_detail_inbound_delivery_date_month_cds(), $eve001Out->comiket_detail_inbound_delivery_date_month_lbls(), $eve001Out->comiket_detail_inbound_delivery_date_month_sel());
?>
                                        </select>月
                                        <select name="comiket_detail_inbound_delivery_date_day_sel">
                                            <option value="">日を選択</option>
<?php
            echo Sgmov_View_Tms_Input::_createPulldown($eve001Out->comiket_detail_inbound_delivery_date_day_cds(), $eve001Out->comiket_detail_inbound_delivery_date_day_lbls(), $eve001Out->comiket_detail_inbound_delivery_date_day_sel());
?>
                                        </select>日
                                        &nbsp;
                                        ...
                                        時間帯
                                            <select name="comiket_detail_inbound_delivery_time_sel">
                                                <option value="">時間帯を選択</option>
<?php
            echo Sgmov_View_Tms_Input::_createPulldown($eve001Out->comiket_detail_inbound_delivery_time_cds(), $eve001Out->comiket_detail_inbound_delivery_time_lbls(), $eve001Out->comiket_detail_inbound_delivery_time_sel());
?>
                                            </select>
                                        </span>
                                        <br/>
