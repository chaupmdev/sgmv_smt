...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <div class="section">
                <form action="/<?=$dirDiv?>/size_change_complete" data-feature-id="<?php echo Sgmov_View_Dsn_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Dsn_Common::GAMEN_ID_DSN001 ?>" method="post">
                                                ...
                                                <tr>
                                                        <td style="padding-right: 20px;">
                                                            ...
                                                            <?php 
                                                                ...
                                                                echo trim($building_name).trim($eveOutForm->building_booth_position());
                                                            ?>
