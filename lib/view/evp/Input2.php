 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Evp_Input2 extends Sgmov_View_Evp_Input {
...
//    Sgmov_Component_Log::debug($inForm);
            ...
            //データベースがeveで、URLがevpのケースがある為、修正する。
            if (@!in_array($comiketInfo['event_key'], $m) && $comiketInfo['event_key'] != "eve") {
                Sgmov_Component_ErrorExit::errorExit(Sgmov_Component_ErrorCode::ERROR_VIEW_INVALID_PAGE_ACCESS);
            }
...
//    Sgmov_Component_Log::debug($_SERVER);
    ...
    //            }
            ...
            $inForm["building_cd_and_name_sel"] = $comiketInfo["building_name"];
            ...
            $inForm["comiket_detail_service_selected"] = "1"; // 搬出
        }
