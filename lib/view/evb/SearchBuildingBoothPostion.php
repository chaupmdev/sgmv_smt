 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Evb_SearchBuildingBoothPostion extends Sgmov_View_Public {
...
Sgmov_Component_Log::debug("######################## 501 booth");
...
//        $eventId = filter_input(INPUT_POST, 'event_sel');
        ...
        $buildingCd = filter_input(INPUT_POST, 'building_name_sel');
        
Sgmov_Component_Log::debug("######################## 502 buildingCd = " .$buildingCd . ";eventsub_id = {$eventsubId}" );        
        // チケット確認
...
//Sgmov_Component_Log::debug("######################## 303 booth");
        try {
            ...
            $returnList = $this->_BuildingService->fetchBuildingBoothPostionByBuildingCd($db, $buildingCd, $eventsubId);
