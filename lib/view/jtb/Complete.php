 ...
 */
class Sgmov_View_Jtb_Complete extends Sgmov_View_Jtb_Common {
    ...
    public function __construct() {
        ...
        $this->_BcmView             = new Sgmov_View_Jtb_Bcm();
    ...
    public function executeInner($argBackInputPaht="") {
        ...
        //チケットの確認と破棄 TODO
        $session->checkTicket(self::FEATURE_ID, self::GAMEN_ID_JTB003, $this->_getTicket());
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////
        $toiawaseNo = '0123456789';//$this->getToiawaseNo();
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////
       ...
       // $inForm = $returnResult['inform'];
        ...
        return array(
            ...
            'payment_method_cd' => '1',//$li["treeData"]['payment_method_cd'],
    ...
    protected function registerComiket($db, $inForm, $comiketId, $argBackInputPath){
        ...
        try {
            ...
            $db->rollback();
            $_SESSION["Sgmov_View_Jtb.inputErrorInfo"] = array("db_insert_error" => "・データベースの登録・更新に失敗しました。");
...
Sgmov_Component_Log::debug($pay_limit_convenience_store);
    ...
    public function _createDataByInForm($db, $inForm, $toiawaseNo = '0123456789') {
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////
        $inForm['comiket_toiawase_no_niugoki'] = '0123456789';//$this->getToiawaseNo();
     ...
     * @param Sgmov_Form_Jtb003In $inForm 入力フォーム
