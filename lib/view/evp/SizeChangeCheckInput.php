...
Sgmov_Lib::useView('evp/CheckInput');
 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Evp_SizeChangeCheckInput extends Sgmov_View_Evp_CheckInput {
    ...
    public function _redirectProc($inForm, $errorForm) {
        if ($errorForm->hasError()) {
            Sgmov_Component_Redirect::redirectPublicSsl('/evp/size_change');
        }
        ...
        if (@empty($boxNumTotal)) {
            Sgmov_Component_Redirect::redirectPublicSsl('/evp/size_change_confirm');
        }
        ...
        switch ($inForm->comiket_payment_method_cd_sel) {
            case '1': // コンビニ
                ...
                break;
            case '2': // クレジット
                Sgmov_Component_Redirect::redirectPublicSsl('/evp/size_change_credit_card');
                break;
            default:
                Sgmov_Component_Redirect::redirectPublicSsl('/evp/size_change_confirm');
                break;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if($inForm->comiket_detail_type_sel == "1") { // 往路
            ...
            // 共通チェック
            ////////////////////////////////////////////////////////////////
            $this->checkComiketBoxOutInboundNumAry($inForm, $errorForm, $inForm->comiket_box_outbound_num_ary, "comiket_box_outbound_num_ary", "搬入", false, true);
