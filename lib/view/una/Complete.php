 ...
 */
class Sgmov_View_Una_Complete extends Sgmov_View_Una_Common {
    ...
    public function __construct() {
        ...
        $this->_BcmView             = new Sgmov_View_Una_Bcm();
    ...
    public function executeInner($argBackInputPaht="") {
        ...
        //チケットの確認と破棄 TODO
        $session->checkTicket(self::FEATURE_ID, self::GAMEN_ID_UNA003, $this->_getTicket());
    ...
    protected function registerComiket($db, $inForm, $comiketId, $argBackInputPath){
        ...
        try {
            ...
            $db->rollback();
            $_SESSION["Sgmov_View_Una.inputErrorInfo"] = array("db_insert_error" => "・データベースの登録・更新に失敗しました。");
