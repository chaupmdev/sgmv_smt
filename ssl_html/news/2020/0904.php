...
<meta name="description" content="台風9号、10号による集配への影響について">
...
<title>台風9号、10号による集配への影響について｜ニュース｜<?php require_once($_SERVER['DOCUMENT_ROOT'] . '/include/meta-ttl.php'); ?></title>
		...
		<div class="mainBox" data-stt-ignore>
			<article id="conts">
				<div class="titleBox fadeInUp">
					<p class="time">2020.09.04<span class="cat-news">お知らせ</span></p>
					<p class="title">台風9号、10号による集配への影響について</p>
				</div>
				<div class="wpBox fadeInUp">
					<p>いつもSGムービング株式会社をご利用いただきまして、誠にありがとうございます。台風9号、10号の影響により、一部地域において荷物の集荷・配達業務の遅延が発生しております。</p>
					<br>
					<p>お客さまには大変ご迷惑をおかけいたしますが、ご了承のほど宜しくお願い申し上げます。</p>
