...
Sgmov_Lib::useView('fmt/SizeChangeComplete');
Sgmov_Lib::useForms(array('Error', 'EveSession'));
/**#@-*/

$exceptionFlg = FALSE;
// 処理を実行
$view = new Sgmov_View_Fmt_SizeChangeComplete();
$eveOutForm = array();
$eventData = array();
$eventsubData = array();
...
?>
                <br /><span style="color: red;">※お支払いはお預かり日時の<?php echo $collectDate;?>の前日17時までに入金していただきますようお願いいたします。</span>
<?php
    }
?>
