...
Sgmov_Component_Log::debug($bcmResult);
    ...
    public function errorInformationForSgFinancial($param) {
        ...
        //テンプレートメールを送信する。
        Sgmov_Component_Mail::sendTemplateMail($param, dirname(__FILE__) . '/../../mail_template/mdr_error_for_sgfinancial.txt', $mail_to);
    }
...
Sgmov_Component_Log::debug($pay_limit_convenience_store);
    ...
    public function errorInformation($parm = array())
    {
        ...
        $mail_to = Sgmov_Component_Config::getLogMailTo();
        //テンプレートメールを送信する。
        Sgmov_Component_Mail::sendTemplateMail($parm, dirname(__FILE__) . '/../../mail_template/mdr_error.txt', $mail_to);
    }
