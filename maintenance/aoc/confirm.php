...
Sgmov_Lib::useView('aoc/Confirm');
/**#@-*/

// 処理を実行
$view = new Sgmov_View_Aoc_Confirm();
$forms = $view->execute();
...
<?php if($aoc003Out->honsha_user_flag() === '1'){ ?>
		...
		<td colspan="3" align="right">
			<table>
				...
				<tr>
                    ...
                    <td><a id='back_to_list' href="/aoc/list/othercampaign">← 一覧に戻る</a></td>
					<td><img src="/common/img/spacer.gif" width="10" height="1" alt=""></td>
				</tr>
			</table>
		</td>
				...
				<tr>
					...
					<td>
						<table width="860" class="bdr">
							<tr>
								<th width="150">キャンペーン名称</th>
								<td><?php echo $aoc003Out->oc_name(); ?></td>
							</tr>
							<tr>
								<th>フラグ</th>
								<td><?php echo $aoc003Out->oc_flg(); ?></td>
							</tr>
							<tr>
								<th>内容</th>
								<td><?php echo $aoc003Out->oc_content(); ?></td>
							</tr>
							<tr>
								<th>ステータス</th>
								<td><?php
                                	 if($aoc003Out->oc_application() === '1'){
                                	 	echo "ON";
                                	 }elseif($aoc003Out->oc_application() === '2'){
                                	 	echo "OFF";
                                	 }?></td>
							</tr>
						</table>
	...
	<tr>
		<td colspan="3" align="center">
			<table>
				<tr>
					<td>
						<form method='post' action='/aoc/complete'>
							<input type="image" src="/common/img/aoc/btn_regist.gif" alt="登録する">
							<input type='hidden' name='ticket' value='<?php echo $ticket ?>' />
						</form>
                    </td>
					<td><img src="/common/img/spacer.gif" width="10" height="1" alt=""></td>
					<td><a href="/aoc/input"><img src="/common/img/aoc/btn_back.gif" alt="戻る"></a></td>
				</tr>
			</table>
		</td>
	</tr>
