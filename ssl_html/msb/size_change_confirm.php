...
Sgmov_Lib::useView('dsn/SizeChangeConfirm');
...
<head>
    ...
    <link href="/dsn/css/eve.css" rel="stylesheet" type="text/css" />
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <div class="section">
                <form action="/dsn/size_change_complete" data-feature-id="<?php echo Sgmov_View_Dsn_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Dsn_Common::GAMEN_ID_DSN001 ?>" method="post">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style='padding-top:5px;'>
                                                        <?php if($eveOutForm->comiket_div() == Sgmov_View_Dsn_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
                                                            <!--<img src='/dsn/images/about_boxsize.png' width='80%'/>-->
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
                                            </table>
...
<?php if($eveOutForm->comiket_div() == Sgmov_View_Dsn_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
    ...
    <?php if ($eveOutForm->comiket_payment_method_cd_sel() === '1') : ?>
                        ...
                        <div class="btn_area">
                            <a class="back" href="/dsn/<?php echo $dispItemInfo['back_input_path']; ?>/">修正する</a>
                            <?php if (@empty($dispItemInfo['is_cancel'])) : ?>
    ...
    <?php if ($eveOutForm->comiket_payment_method_cd_sel() == '2') : // クレジット ?>
                        ...
                        <div class="btn_area">
                            ...
                            <?php if (@empty($dispItemInfo['is_cancel'])) : ?>
                                <a class="back" href="/dsn/size_change_credit_card/">修正する</a>
                                <input id="submit_button" type="submit" name="submit" value="入力内容を送信する" />
                            <?php else: ?>
                                <input id="submit_button" type="submit" name="submit" value="キャンセル送信する" />
                            <?php endif; ?>
    ...
    <?php if ($eveOutForm->comiket_payment_method_cd_sel() == '3') : // 電子マネー ?>
       ...
       <strong class="red">※電子マネーでのお支払いは、￥10,000を超える場合はお取り扱い出来ません。</strong>
        <div class="btn_area">
            <a class="back" href="/dsn/size_change/">修正する</a>
            <?php if (@empty($dispItemInfo['is_cancel'])) : ?>
                <input id="submit_button" type="submit" name="submit" value="入力内容を送信する" />
            <?php else: ?>
                <input id="submit_button" type="submit" name="submit" value="キャンセル送信する" />
