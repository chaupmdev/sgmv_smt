...
<div class="dl_block input-inbound comiket_block">
    ...
    <dl>
        ...
        <dd <?php
            ...
            ?>>
            <input class="" style="width:80%;" autocapitalize="off" inputmode="comiket_detail_inbound_name" name="comiket_detail_inbound_name" data-pattern="" placeholder="" type="text" value="<?php echo $qrc001Out->comiket_detail_inbound_name() ?>" />
    ...
    <dl>
        ...
        <dd <?php if (isset($e) && $e->hasErrorForId('comiket_detail_inbound_zip')) {
                echo ' class="form_error"';
            } ?>>
            〒<input autocapitalize="off" class="w_70 number-only" maxlength="3" inputmode="numeric" name="comiket_detail_inbound_zip1" data-pattern="^\d+$" placeholder="例）136" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $qrc001Out->comiket_detail_inbound_zip1(); ?>" />
            -
            <input autocapitalize="off" class="w_70 number-only" maxlength="4" inputmode="numeric" name="comiket_detail_inbound_zip2" data-pattern="^\d+$" placeholder="例）0082" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $qrc001Out->comiket_detail_inbound_zip2(); ?>" />
    ...
    <dl>
        ...
        <dd <?php if (isset($e) && $e->hasErrorForId('comiket_detail_inbound_pref')) {
                echo ' class="form_error"';
            } ?>>
            <select name="comiket_detail_inbound_pref_cd_sel">
                <option value="">選択してください</option>
                <?php
                echo Sgmov_View_Qrc_Input::_createPulldown($qrc001Out->comiket_detail_inbound_pref_cds(), $qrc001Out->comiket_detail_inbound_pref_lbls(), $qrc001Out->comiket_detail_inbound_pref_cd_sel());
                ?>
            </select>
            <br />
            <br />
    ...
    <dl>
        ...
        <dd <?php if (isset($e) && $e->hasErrorForId('comiket_detail_inbound_address')) {
                echo ' class="form_error"';
            } ?>>
            <input class="" style="width:80%;" maxlength="14" autocapitalize="off" name="comiket_detail_inbound_address" placeholder="例）江東区新砂" type="text" value="<?php echo $qrc001Out->comiket_detail_inbound_address(); ?>" />
        </dd>
    </dl>
    <dl>
        ...
        <dd <?php if (isset($e) && $e->hasErrorForId('comiket_detail_inbound_building')) {
                echo ' class="form_error"';
            } ?>>
            <input class="" style="width:80%;" maxlength="30" autocapitalize="off" name="comiket_detail_inbound_building" placeholder="例）1-8-2" type="text" value="<?php echo $qrc001Out->comiket_detail_inbound_building(); ?>" />
        </dd>
    </dl>
    <dl>
        ...
        <dd <?php if (isset($e) && $e->hasErrorForId('comiket_detail_inbound_tel')) {
                echo ' class="form_error"';
            } ?>>
            <input autocapitalize="off" class="number-p-only" style="width:50%;" maxlength="15" name="comiket_detail_inbound_tel" data-pattern="^[0-9-]+$" placeholder="例）075-1234-5678" type="text" value="<?php echo $qrc001Out->comiket_detail_inbound_tel(); ?>" />
    ...
    <dl>
        ...
        <dd <?php if (isset($e) && $e->hasErrorForId('comiket_detail_inbound_collect_date')) {
                echo ' class="form_error"';
            } ?>>
            <?php
            ...
            // 搬出のfrom-toが一致
            if (
                isset($dispItemInfo["eventsub_selected_data"]["is_eq_inbound_collect"])
            ...
            ?>
                ...
                <a style="color: blue;" class="manual_link" href="<?= $pathCounterManual ?>" target="_blank">会場内宅配カウンター開設場所</a>
                <input type="hidden" name="comiket_detail_inbound_collect_date_year_sel" value="<?= @$dispItemInfo["eventsub_selected_data"]["inbound_collect_fr_year"] ?>">
                <input type="hidden" name="comiket_detail_inbound_collect_date_month_sel" value="<?= @$dispItemInfo["eventsub_selected_data"]["inbound_collect_fr_month"] ?>">
                <input type="hidden" name="comiket_detail_inbound_collect_date_day_sel" value="<?= @$dispItemInfo["eventsub_selected_data"]["inbound_collect_fr_day"] ?>">
...
-->
        ...
        <dd <?php
            ...
            <?php foreach ($dispItemInfo['comiket_detail_service_lbls'] as $key => $val) : ?>
                <label class="radio-label" for="comiket_detail_inbound_service_sel<?php echo $key; ?>">
                    <input<?php if ($qrc001Out->comiket_detail_inbound_service_sel() == $key) echo ' checked="checked"'; ?> id="comiket_detail_inbound_service_sel<?php echo $key; ?>" name="comiket_detail_inbound_service_sel" type="radio" value="<?php echo $key; ?>" />
                    <?php echo $val; ?>
                </label>
            <?php endforeach; ?>
    ...
    <dl class="comiket_detail_inbound_delivery_date">
        ...
        <dd <?php if (isset($e) && $e->hasErrorForId('comiket_detail_inbound_delivery_date')) {
                echo ' class="form_error"';
            } ?>>
            ...
            ※北海道、青森、中国、四国、九州エリアの方は2022年02月22日（火） から 2022年02月26日（土） まで選択できます。<br><br>
            ...
            <div class="comiket_detail_inbound_delivery_date_parts" style="white-space: nowrap;">
                <select name="comiket_detail_inbound_delivery_date_year_sel" class="from_to_selectbox_y" _gid="inbound_delivery_date" _from_slctr="#hid_comiket-detail-inbound-delivery-date-from" _to_slctr="#hid_comiket-detail-inbound-delivery-date-to" _selected="<?php echo @$qrc001Out->comiket_detail_inbound_delivery_date_year_sel(); ?>" _first="年を選択">
                </select>年
                <select name="comiket_detail_inbound_delivery_date_month_sel" class="from_to_selectbox_m" _gid="inbound_delivery_date" _selected="<?php echo @$qrc001Out->comiket_detail_inbound_delivery_date_month_sel(); ?>" _first="月を選択">
                </select>月
                <select name="comiket_detail_inbound_delivery_date_day_sel" class="from_to_selectbox_d" _gid="inbound_delivery_date" _selected="<?php echo @$qrc001Out->comiket_detail_inbound_delivery_date_day_sel(); ?>" _first="日を選択">
                </select>日
                &nbsp;
                <span class="comiket_detail_inbound_delivery_time_sel">
                    ...
                    <select name="comiket_detail_inbound_delivery_time_sel">
                        ...
                        <?php
                        echo Sgmov_View_Qrc_Input::_createPulldown($qrc001Out->comiket_detail_inbound_delivery_time_cds(), $qrc001Out->comiket_detail_inbound_delivery_time_lbls(), $qrc001Out->comiket_detail_inbound_delivery_time_sel());
    ...
    <dl class="service-inbound-item" service-id="1">
        ...
        <dd <?php if (isset($e) && $e->hasErrorForId('comiket_box_inbound_num_ary')) {
                echo ' class="form_error"';
            } ?>>
            <div class="comiket-box-inbound-num comiket-box-inbound-num-dmy">
                <!-- 個人・法人 どちらでも -->
                <table>
                    <tr>
                        <td>
                                ...
                                <?php foreach ($dispItemInfo['inbound_box_lbls'] as $key => $val) : ?>
                                    <tr class="box_<?php echo $val['size_display']; ?>">
                                        ...
                                        <td class='comiket_box_item_value'>
                                            <input autocapitalize="off" class="number-only comiket_box_item_value_input" style="" maxlength="2" inputmode="numeric" name="comiket_box_inbound_num_ary[<?php echo $val["id"]; ?>]" data-pattern="^\d+$" placeholder="例）1" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $qrc001Out->comiket_box_inbound_num_ary($val["id"]); ?>" />個
                                            &nbsp;
                                        </td>
                                        <!--</div>-->
                                    </tr>
    ...
    <dl>
        ...
        <dd <?php if (isset($e) && $e->hasErrorForId('comiket_detail_inbound_note')) {
                echo ' class="form_error"';
            } ?>>
            <input autocapitalize="off" class="" style="width:50%;" maxlength="16" inputmode="text" name="comiket_detail_inbound_note1" placeholder="" type="text" value="<?php echo $qrc001Out->comiket_detail_inbound_note1(); ?>" /><br />
        </dd>
    </dl>
</div>
