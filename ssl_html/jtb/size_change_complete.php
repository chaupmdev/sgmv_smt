...
$exceptionFlg = FALSE;
// 処理を実行
$view = new Sgmov_View_Jtb_SizeChangeComplete();
$eveOutForm = array();
$eventData = array();
$eventsubData = array();
...
?>
        ...
        <?php if(($eveOutForm->comiket_detail_type_sel() == "1" || $eveOutForm->comiket_detail_type_sel() == "3") // 搬入、もしくは往復
                    ...
                    <div style="font-size:20px;">
                        <a href="/<?=$dirDiv?>/paste_tag/<?php echo sprintf('%010d', $eveOutForm->qr_code_string()) . Sgmov_View_Jtb_Common::getChkD2($eveOutForm->qr_code_string()); ?>/" target="_blank" style="color:blue;" download>
