...
<?php
        echo Sgmov_View_Yid_Input::_createPulldown($eve001Out->comiket_detail_inbound_pref_cds(), $eve001Out->comiket_detail_inbound_pref_lbls(), $eve001Out->comiket_detail_inbound_pref_cd_sel());
?>
                                    </select>
                                    <br/>
                                    <br/>
...
<?php
                echo Sgmov_View_Yid_Input::_createPulldown($eve001Out->comiket_detail_inbound_collect_time_cds(), $eve001Out->comiket_detail_inbound_collect_time_lbls(), $eve001Out->comiket_detail_inbound_collect_time_sel());
?>
                                                </select>
                                            </span>
                                        </div>
                                        <br>
                                        <div class = "dsp-inblck vat fwb red lhn" style="display: none">
                                        ...
                                        <div class = "dsp-inblck vat fwb red lhn" style="display: none">
                                            <div class = "dsp-inblck"><img src="/images/common/img_icon_pdf.gif" class = "vat" width="18" height="21" alt="">
                                                    <a style="color: blue;" href="<?=$dispItemInfo['dispEvent']['takuhai']?>" target="_blank">宅配カウンターの場所</a></div>
                                        </div>
                                </dd>
                            </dl>
                            ...
                            <dl class="comiket_detail_inbound_delivery_date">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_detail_inbound_delivery_date')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <p class="red" style="margin-top: -15px">※九州・四国・中国・北海道・青森・沖縄エリアは3月16日(土)以降で選択可能です。</p>
                                    ...
                                    <div class="comiket_detail_inbound_delivery_date_parts">
                                        ...
                                        時間帯
                                            <select name="comiket_detail_inbound_delivery_time_sel">
                                                <option value="">時間帯を選択</option>
<?php
            echo Sgmov_View_Yid_Input::_createPulldown($eve001Out->comiket_detail_inbound_delivery_time_cds(), $eve001Out->comiket_detail_inbound_delivery_time_lbls(), $eve001Out->comiket_detail_inbound_delivery_time_sel());
?>
                                            </select>
                                        </span>
                                        <br/>
                            ...
                            <dl>
                                ...
                                >
                                    <div style="margin-top:7px; margin-bottom: 7px;">
                                        <a style="margin-left: 5px;color:blue;text-decoration: underline; font-size: 19px" onclick="EnableCaremarkFlgInbound();" href="https://www.sagawa-exp.co.jp/send/howto-packing/" target="_blank" class="comiket_detail_caremark_flg_link" >梱包ガイドラインについて</a>
                                    </div>
