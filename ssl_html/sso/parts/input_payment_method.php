...
<!--                        <label class="radio-label" for="pay_convenience_store_laterpay" > style="color:#999;"
                    ...
                    <div class="pay_available_attention">
                        ※ご利用可能なクレジットカードは<a href="/sso/pdf/manual/available_card.pdf" target="_blank" style="color:blue;text-decoration: underline;">こちら</a><br/>
                    </div>
                    <br/>
                    <div class="pay_digital_money_attention" style="">
                        ※ご利用可能な電子マネーは<a href="/sso/pdf/manual/available_degital_money.pdf" target="_blank" style="color:blue;text-decoration: underline;">こちら</a><br/><br/>
