...
Sgmov_Lib::useView('zzy/Input');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Zzy_Input();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/zzy/check_input" data-feature-id="<?php echo Sgmov_View_Zzy_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Zzy_Common::GAMEN_ID_ZZY001 ?>" method="post">
...
?>
                    ...
                    <!--▲お支払い方法-->
                    <p class="text_center">
                        <input id="submit_button" type="submit" name="submit" value="同意して次に進む（入力内容の確認）" style="margin-top: 0px !important;">
                    </p>
                    <br>
<?php
                        ///////////////////////////////////////////////
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/zzy/js/input.js?<?php echo $strSysdate; ?>"></script>
