...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            <h1 class="page_title"  style="margin-bottom:15px !important;">宿泊ホテルより国内配送受付サービスのお申し込み</h1>
...
?>
            <div class="section other">
                <form action="/<?=$dirDiv?>/check_input" data-feature-id="<?php echo Sgmov_View_Dsn_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Dsn_Common::GAMEN_ID_HOT001 ?>" method="post">
