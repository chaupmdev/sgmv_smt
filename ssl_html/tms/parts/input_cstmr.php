...
<?php
Sgmov_Component_Log::debug("################## 301-1 _createPulldown pre");
            echo Sgmov_View_Tms_Input::_createPulldown($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel(), $eve001Out->eve_timeover_flg(), $eve001Out->eve_timeover_date());
?>
                                                    </select>
...
<?php
        ...
        echo '<img src="/tms/images/logo.gif">';
        }
?>
<?php
    // キャッシュ対策
                                                            ...
                                                            <tr>
                                                                <td style="vertical-align: top;padding-top:20px;width: 70%;">
                                                                    <div style=";display:none;" class="eventsub_dl_link paste_tag">
                                                                        ...
                                                                        <a style="color: blue;" class="paste_tag_link" href="/tms/pdf/paste_tag/paste_tag_<?php echo $eve001Out->eventsub_cd_sel(); ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">貼付票（例）</a>
                                                                    </div>
                                                                    <br/>
...
<!--                                                        <div style="float: left;">
                                                        ...
                                                        <div style="float: left;margin-left: 10px;">
                                                            <img src="/images/common/hako_haritsuke.png" width="125" height="96" alt="">
                                                        </div>-->
...
<!--                                                        <div class="paste_tag">
                                                        ...
                                                        <div class="eventsub_dl_link manual" style="display:none;">
                                                            <img src="/images/common/img_icon_pdf.gif" width="18" height="21" alt="">
                                                            <a style="color: blue;" class="manual_link" href="/tms/pdf/manual/<?php echo $eventName; ?><?php echo $eventsubName; ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">説明書</a>
...
Sgmov_Component_Log::debug(@$dispItemInfo);
                            ...
                            <?php if ($userType === 1) :?>
                                <dl>
                                    ...
                                    <dd>
                                        <?php echo $_SESSION['TMS_LOGIN']['email'] ?>
                                    </dd>
                                </dl>
                            <?php endif; ?>
                            <!-- END -->
                            ...
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_pref')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <select name="comiket_pref_cd_sel">
                                        <option value="">選択してください</option>
<?php
        echo Sgmov_View_Tms_Input::_createPulldown($eve001Out->comiket_pref_cds(), $eve001Out->comiket_pref_lbls(), $eve001Out->comiket_pref_cd_sel());
?>
                                    </select>
                                </dd>
                            </dl>
...
<!--                                    <select name="building_name_sel">
                                        <option value="">選択してください</option>
<?php
//                                        echo Sgmov_View_Tms_Input::_createPulldown($eve001Out->building_name_ids(), $eve001Out->building_name_lbls(), $eve001Out->building_name_sel());
?>
                                    </select>-->
                                    ...
                                    <select name="building_booth_position_sel">
                                        <option value="">選択してください</option>
<?php
                                         echo Sgmov_View_Tms_Input::_createPulldown($eve001Out->building_booth_position_ids(), $eve001Out->building_booth_position_lbls(), $eve001Out->building_booth_position_sel());
?>
                                    </select>
                                    ...
                                    <strong class="red">
                                    <?php if ($eve001Out->event_cd_sel() == '2') : ?>
                                        ※出展者以外の方がご利用の場合は、「その他」「0000」と、入力してください。<br />
                                        また、複数のブースを使用する出展者は代表ブース番号を入力してください。
                                    <?php else: ?>
                                        ※出展者以外の方がご利用の場合は、「その他」「その他」「0000」と、選択してください。
                                    <?php endif; ?>
                                    </strong>
                                </dd>
                            </dl>
