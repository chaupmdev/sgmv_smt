...
Sgmov_Lib::useView('zzy/Cancel');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Zzy_Cancel();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/zzy/cancel_comp" data-feature-id="<?php echo Sgmov_View_Zzy_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Zzy_Common::GAMEN_ID_ZZY001 ?>" method="post">
