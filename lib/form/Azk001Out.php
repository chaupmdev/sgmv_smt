...
///////////////////////////////////////////////////////////
     ...
     * @var string
     */
    public $raw_eventsub_year_sel = '';

    /**
     * イベントサブコード月選択値
     * @var array
     */
    public $raw_eventsub_year_cds = array();

    /**
     * イベント年ラベルリスト
     * @var array
     */
    public $raw_eventsub_year_lbls = array();

    /**
     * イベントサブコード月選択値
     * @var string
     */
    public $raw_eventsub_month_sel = '';

    /**
     * イベントサブコード月選択値
     * @var array
     */
    public $raw_eventsub_month_cds = array();

    /**
     * イベント月ラベルリスト
     * @var array
     */
    public $raw_eventsub_month_lbls = array();

    /**
     * イベントサブコード月選択値
     * @var string
     */
    public $raw_eventsub_date_sel = '';

    /**
     * イベントサブコード月選択値
     * @var array
     */
    public $raw_eventsub_date_cds = array();

    /**
     * イベント月ラベルリスト
     * @var array
     */
    public $raw_eventsub_date_lbls = array();
...
///////////////////////////////////////////////////////////
     ...
     * @var array
     */
     public $raw_comiket_detail_service_sel = "";
...
////////////////////////////////////////////////////////////////////////////////
     ...
     * @var string
     */
    public $raw_comiket_detail_azukari_kaisu_type_sel = '';

    /**
     * 手荷物預かり-集荷先名
     * @var string
     */
    public $raw_comiket_detail_name = '';
    
    /**
     * 手荷物預かり-集荷先名-姓
     * @var string
     */
    public $raw_comiket_detail_name_sei = '';
    
    /**
     * 手荷物預かり-集荷先名-名
     * @var string
     */
    public $raw_comiket_detail_name_mei = '';

    /**
     * 手荷物預かり-集荷先郵便番号1
     * @var string
     */
    public $raw_comiket_detail_zip1 = '';

    /**
     * 手荷物預かり-集荷先郵便番号2
     * @var string
     */
    public $raw_comiket_detail_zip2 = '';

    /**
     * 手荷物預かり-集荷先都道府県コード選択値
     * @var string
     */
    public $raw_comiket_detail_pref_cd_sel = '';

    /**
     * 手荷物預かり-集荷先都道府県コードリスト
     * @var array
     */
    public $raw_comiket_detail_pref_cds = array();

    /**
     * 手荷物預かり-集荷先都道府県コードラベルリスト
     * @var array
     */
    public $raw_comiket_detail_pref_lbls = array();

    /**
     * 手荷物預かり-集荷先市区町村
     * @var string
     */
    public $raw_comiket_detail_address = '';

    /**
     * 手荷物預かり-集荷先番地・建物名
     * @var string
     */
    public $raw_comiket_detail_building = '';

    /**
     * お預り日時-年 選択値
     * @var string
     */
    public $raw_comiket_detail_collect_date_year_sel = '';

    /**
     * お預り日時-年 リスト
     * @var array
     */
    public $raw_comiket_detail_collect_date_year_cds = array();

    /**
     * お預り日時-年 ラベルリスト
     * @var array
     */
    public $raw_comiket_detail_collect_date_year_lbls = array();

    /**
     * お預り日時-月 選択値
     * @var string
     */
    public $raw_comiket_detail_collect_date_month_sel = '';

    /**
     * お預り日時-月 リスト
     * @var array
     */
    public $raw_comiket_detail_collect_date_month_cds = array();

    /**
     * お預り日時-月 ラベルリスト
     * @var array
     */
    public $raw_comiket_detail_collect_date_month_lbls = array();

    /**
     * お預り日時-日 選択値
     * @var string
     */
    public $raw_comiket_detail_collect_date_day_sel = '';

    /**
     * お預り日時-日 リスト
     * @var array
     */
    public $raw_comiket_detail_collect_date_day_cds = array();

    /**
     * お預り日時-日 ラベルリスト
     * @var array
     */
    public $raw_comiket_detail_collect_date_day_lbls = array();
     ...
     * @var string
     */
    public $raw_comiket_detail_tel = '';

    /**
     * 備考-1行目
     * @var string
     */
    public $raw_comiket_detail_note1 = '';

    /**
     * 備考-2行目
     * @var string
     */
    public $raw_comiket_detail_note2 = '';

    /**
     * 備考-3行目
     * @var string
     */
    public $raw_comiket_detail_note3 = '';

    /**
     * 備考-4行目
     * @var string
     */
    public $raw_comiket_detail_note4 = '';

    /**
     * 手荷物数量
     * @var string
     */
    public $raw_comiket_box_num_ary = array();
...
////////////////////////////////////////////////////////////////////////////////
     ...
     * @return array エンティティ化された都道府県コードラベルリスト
     */
    public function comiket_detail_service_sel() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_service_sel);
    }
...
//////////////////////////////////////////////////////////////////////////
    ...
    /**
     * エンティティ化されたイベント期間-年 選択値を返します。
     * @return string エンティティ化された復路-イベント期間-年 選択値
     */
    public function eventsub_year_sel() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_eventsub_year_sel);
    }

    /**
     * エンティティ化された復路-イベント期間-年 リストを返します。
     * @return string エンティティ化された復路-イベント期間-年 リスト
     */
    public function eventsub_year_cds() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_eventsub_year_cds);
    }

    /**
     * エンティティ化された復路-イベント期間-年 ラベルリストを返します。
     * @return string エンティティ化された復路-イベント期間-年 ラベルリスト
     */
    public function eventsub_year_lbls() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_eventsub_year_lbls);
    }

    /**
     * エンティティ化されたイベント期間-月 選択値を返します。
     * @return string エンティティ化された復路-イベント期間-月 選択値
     */
    public function eventsub_month_sel() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_eventsub_month_sel);
    }

    /**
     * エンティティ化された復路-イベント期間-月 リストを返します。
     * @return string エンティティ化された復路-イベント期間-月 リスト
     */
    public function eventsub_month_cds() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_eventsub_month_cds);
    }

    /**
     * エンティティ化された復路-イベント期間-月 ラベルリストを返します。
     * @return string エンティティ化された復路-イベント期間-月 ラベルリスト
     */
    public function eventsub_month_lbls() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_eventsub_month_lbls);
    }

    /**
     * エンティティ化されたイベント期間-日 選択値を返します。
     * @return string エンティティ化された復路-イベント期間-日 選択値
     */
    public function eventsub_day_sel() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_eventsub_day_sel);
    }

    /**
     * エンティティ化された復路-イベント期間-日 リストを返します。
     * @return string エンティティ化された復路-イベント期間-日 リスト
     */
    public function eventsub_day_cds() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_eventsub_day_cds);
    }

    /**
     * エンティティ化された復路-イベント期間-日 ラベルリストを返します。
     * @return string エンティティ化された復路-イベント期間-日 ラベルリスト
     */
    public function eventsub_day_lbls() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_eventsub_day_lbls);
    }
...
///////////////////////////
    ...
    /**
     * エンティティ化されたお預かり回数区分を返します。
     * @return string エンティティ化された往復区分
     */
    public function comiket_detail_azukari_kaisu_type_sel() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_azukari_kaisu_type_sel);
    }

    /**
     * エンティティ化された手荷物預かり-集荷先名を返します。
     * @return string エンティティ化された手荷物預かり-集荷先名
     */
    public function comiket_detail_name() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_name);
    }
    
    /**
     * エンティティ化された手荷物預かり-集荷先名を返します。
     * @return string エンティティ化された手荷物預かり-集荷先名-姓
     */
    public function comiket_detail_name_sei() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_name_sei);
    }
    
    /**
     * エンティティ化された手荷物預かり-集荷先名を返します。
     * @return string エンティティ化された手荷物預かり-集荷先名-名
     */
    public function comiket_detail_name_mei() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_name_mei);
    }

    /**
     * エンティティ化された手荷物預かり-配送先郵便番号を返します。
     * @return string エンティティ化された手荷物預かり-配送先郵便番号
     */
    public function comiket_detail_zip1() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_zip1);
    }
     ...
     * @return string エンティティ化された手荷物預かり-配送先郵便番号
     */
    public function comiket_detail_zip2() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_zip2);
    }

    /**
     * エンティティ化された手荷物預かり-配送先都道府県コード選択値を返します。
     * @return string エンティティ化された手荷物預かり-配送先都道府県コード選択値
     */
    public function comiket_detail_pref_cd_sel() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_pref_cd_sel);
    }

    /**
     * エンティティ化された手荷物預かり-配送先都道府県コードリストを返します。
     * @return string エンティティ化された手荷物預かり-配送先都道府県コードリスト
     */
    public function comiket_detail_pref_cds() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_pref_cds);
    }

    /**
     * エンティティ化された手荷物預かり-配送先都道府県コードラベルリストを返します。
     * @return string エンティティ化された手荷物預かり-配送先都道府県コードラベルリスト
     */
    public function comiket_detail_pref_lbls() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_pref_lbls);
    }
     ...
     * @return string エンティティ化された手荷物預かり-配送先郵便番号
     */
    public function comiket_detail_address() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_address);
    }
     ...
     * @return string エンティティ化された手荷物預かり-配送先郵便番号
     */
    public function comiket_detail_building() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_building);
    }

    /**
     * エンティティ化された手荷物預かり-集荷先TELを返します。
     * @return string エンティティ化された手荷物預かり-集荷先TEL
     */
    public function comiket_detail_tel() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_tel);
    }

    /**
     * エンティティ化されたお預かり日時-年 選択値を返します。
     * @return string エンティティ化されたお預かり日時-年 選択値
     */
    public function comiket_detail_collect_date_year_sel() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_collect_date_year_sel);
    }

    /**
     * エンティティ化されたお預かり日時-年 リストを返します。
     * @return string エンティティ化されたお預かり日時-年 リスト
     */
    public function comiket_detail_collect_date_year_cds() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_collect_date_year_cds);
    }

    /**
     * エンティティ化されたお預かり日時-年 ラベルリストを返します。
     * @return string エンティティ化されたお預かり日時-年 ラベルリスト
     */
    public function comiket_detail_collect_date_year_lbls() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_collect_date_year_lbls);
    }

    /**
     * エンティティ化されたお預かり日時-月 選択値を返します。
     * @return string エンティティ化されたお預かり日時-月 選択値
     */
    public function comiket_detail_collect_date_month_sel() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_collect_date_month_sel);
    }

    /**
     * エンティティ化されたお預かり日時-月 リストを返します。
     * @return string エンティティ化されたお預かり日時-月 リスト
     */
    public function comiket_detail_collect_date_month_cds() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_collect_date_month_cds);
    }

    /**
     * エンティティ化されたお預かり日時-月 ラベルリストを返します。
     * @return string エンティティ化されたお預かり日時-月 ラベルリスト
     */
    public function comiket_detail_collect_date_month_lbls() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_collect_date_month_lbls);
    }

    /**
     * エンティティ化されたお預かり日時-日 選択値を返します。
     * @return string エンティティ化されたお預かり日時-日 選択値
     */
    public function comiket_detail_collect_date_day_sel() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_collect_date_day_sel);
    }

    /**
     * エンティティ化されたお預かり日時-日 リストを返します。
     * @return string エンティティ化されたお預かり日時-日 リスト
     */
    public function comiket_detail_collect_date_day_cds() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_collect_date_day_cds);
    }

    /**
     * エンティティ化されたお預かり日時-日 ラベルリストを返します。
     * @return string エンティティ化されたお届け日時-日 ラベルリスト
     */
    public function comiket_detail_collect_date_day_lbls() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_collect_date_day_lbls);
    }


    /**
     * エンティティ化された手荷物預かり-備考-1行目を返します。
     * @return string エンティティ化された手荷物預かり-備考
     */
    public function comiket_detail_note1() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_note1);
    }

    /**
     * エンティティ化された手荷物預かり-備考-2行目を返します。
     * @return string エンティティ化された手荷物預かり-備考
     */
    public function comiket_detail_note2() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_note2);
    }

    /**
     * エンティティ化された手荷物預かり-備考-3行目を返します。
     * @return string エンティティ化された手荷物預かり-備考
     */
    public function comiket_detail_note3() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_note3);
    }

    /**
     * エンティティ化された手荷物預かり-備考-4行目を返します。
     * @return string エンティティ化された手荷物預かり-備考
     */
    public function comiket_detail_note4() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comiket_detail_note4);
    }
     ...
     */
    public function comiket_box_num_ary($key="cmp") {
        return Sgmov_Component_String::htmlspecialchars(@$this->raw_comiket_box_num_ary[$key]);
    }

    /**
     * エンティティ化された数量-ラベルリストを返します。
     * @return string エンティティ化されたブース位置-ラベルリスト
     */
