...
// 処理を実行
$view = new Sgmov_View_Nss_Input2();
$forms = $view->execute();
...
$userType = isset($_SESSION['NSS_LOGIN']['user_type']) ? $_SESSION['NSS_LOGIN']['user_type'] : -1;
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <span>
                　お荷物は、260㎝超えるもの、割れ物、壊れやすいもの、高価なものでしょうか。
                <br/>
                　該当するお荷物であれば、宅配便にてお取り扱いできかねます。
                <br/>
                　チャーター便対応となりますので、下記お問い合わせ先までご連絡ください。
                <br/>
                　０３－５８５７ー２４６２(１０：００～１７：００)
                <br/>
                　該当のお荷物がない方は、以下宅配便申し込みへお進みください。
            </span>
                <br />
                <br />
                ...
                <br /><a href="/<?=$dirDiv?>/pdf/logistics_information_packing_guide_0111.pdf" target="_blank" style="color: #1774bc; text-decoration: underline;">#にじそうさく　物流に関するご案内</a>
...
?>
                ...
                <p class="under">
                    ...
                    <br />
                    <?php
                            $selectedEventNmae = Sgmov_View_Nss_Input::_getLabelSelectPulldownData($eve001Out->event_cds(), $eve001Out->event_lbls(), $eve001Out->event_cd_sel());
...
?>
            <div class="section other">
                <form action="/<?=$dirDiv?>/check_input2" data-feature-id="<?php echo Sgmov_View_Nss_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Nss_Common::GAMEN_ID_NSS001 ?>" method="post">
                    ...
                    <?php
                        if (isset($e) && $e->hasError()) {
                    ?>
                        <input name="screen" type="hidden" value="input_back" />
                    <?php
                        } else {
                    ?>
                        <input name="screen" type="hidden" value="input" />
                    <?php
                        }
                    ?>
...
<?php endif; ?>
                            ...
                            <?php if ($eve001Out->comiket_div() == Sgmov_View_Nss_Common::COMIKET_DEV_BUSINESS) : // 法人?>
                                <dl>
...
?>
                    ...
                    <?php if ($eve001Out->comiket_div() == Sgmov_View_Nss_Common::COMIKET_DEV_INDIVIDUA) : ?>
...
?>
    ...
    data-G_DEV_INDIVIDUAL="<?php echo Sgmov_View_Nss_Common::COMIKET_DEV_INDIVIDUA; ?>"
    data-G_DEV_BUSINESS="<?php echo Sgmov_View_Nss_Common::COMIKET_DEV_BUSINESS; ?>"
    ></script>
