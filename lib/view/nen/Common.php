...
abstract class Sgmov_View_Dsn_Common extends Sgmov_View_Public {
     ...
     * 機能ID
     */
    const FEATURE_ID = 'NEN';
    // 2022-03-10 ToanDD3 implement SMT6-69
    const LOGIN_ID = 'NEN_LOGIN';
    ...
    public function setDispEvent(&$dispItemInfo){
        ...
        foreach($dispItemInfo['event_alllist'] as $k=>$v){
            if(isset($dispItemInfo['eventsub_selected_data']['event_id']) && $v['id']==$dispItemInfo['eventsub_selected_data']['event_id']){
                    ...
                    $dispItemInfo['dispEvent']['manual']    ='/'.$this->_DirDiv.'/pdf/manual/manual_'.$dispItemInfo['eventsub_selected_data']['id'].'.pdf'.$cacheStr;
            }
        }
    }
    ...
    */
    ...
    public function sendCompleteMail($comiket, $sendTo2 = '', $sendCc = '', $type = '', $tmplateType = '') {
        ...
        try {
            ...
            //GiapLN fix bug for send mail item 【ブースNO】 2024.07.09
            ...
            foreach ($comiket_detail_list as $k => $comiket_detail) {
                ...
                if ($comiket_detail['type'] == 2) {
                    ...
                    $data['manual_url'] = "【搬出の説明書はこちら】". PHP_EOL . $urlPublicSsl . "/".$this->_DirDiv."/pdf/manual/manual_{$comiket['eventsub_id']}.pdf";
                    ...
                    $data['manual_url'] = "【搬入の説明書はこちら】". PHP_EOL . $urlPublicSsl . "/".$this->_DirDiv."/pdf/manual/manual_{$comiket['eventsub_id']}.pdf";
...
";
            ...
            if (!$isAttachment) {
                ...
                Sgmov_Component_Log::err('Mail teamplate2');
                Sgmov_Component_Log::err($mailTemplate);
                // qrコードファイル出力
                $qr = new Image_QRCode();
                ...
                // 営業所へメール(CCとして設定する用にもっていた変数をToの方へ)
                if ($sendCc !== null && $sendCc !== '') {
                    Sgmov_Component_Log::err('Mail teamplate3');
