...
Sgmov_Lib::useView('mdr/SizeChangeComplete');
Sgmov_Lib::useForms(array('Error', 'EveSession'));
/**#@-*/

$exceptionFlg = FALSE;
// 処理を実行
$view = new Sgmov_View_Mdr_SizeChangeComplete();
$eveOutForm = array();
$eventData = array();
$eventsubData = array();
...
<!--
            ...
            <div class = "fs20px">
                <a class="button_link2" href="/mdr/pdf/manual/<?php echo $eventData['name']; ?><?php echo $eventsubData['name']; ?>.pdf" target="_blank" style="color:blue;">
...
-->
        ...
        <!--決済 -->
        <?php if(($eveOutForm->comiket_detail_type_sel() == "2") // 搬出
                    && (
                            ($eveOutForm->comiket_detail_inbound_service_sel() == "1") // 宅配、またはカーゴ
                       )
                    ) : ?>
                        ...
                        <tr>
                            <td class = "pb10px">
                                ...
                                <table class="default_tbl w_100Per">
                                    <tbody>
                                        <tr>
                                            <th class ="w_30Per wsp-nowrap" scope="row"><b>申込み番号</b></th>
                                            <td><?php echo sprintf('%010d', $eveOutForm->qr_code_string()); ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <br/>
                                <div id="qrcode-output" class = "tac"></div>
                            </td>
                        </tr>
                    </table>
                </div>
