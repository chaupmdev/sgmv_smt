...
Sgmov_Lib::useView('azk/CreditCard');
/**#@-*/

// 処理を実行
$view = new Sgmov_View_Azk_CreditCard();
$forms = $view->execute();
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <form action="/azk/check_credit_card" method="post">
...
<?php
        echo Sgmov_View_Azk_CreditCard::_createPulldown($eveOutForm->card_expire_month_cds(), $eveOutForm->card_expire_month_lbls(), $eveOutForm->card_expire_month_cd_sel());
?>
                                </select>
                                月
                            </label>
...
<?php
        echo Sgmov_View_Azk_CreditCard::_createPulldown($eveOutForm->card_expire_year_cds(), $eveOutForm->card_expire_year_lbls(), $eveOutForm->card_expire_year_cd_sel());
?>
                                    </select>
                                    年
                                </label>
                    ...
                    <div class="btn_area">
                        ...
                        if(empty($comiketId)): ?>
                            <a class="back" href="/azk/input/<?php echo $eveOutForm->shikibetsushi(); ?>?clr=1">修正する</a>
                        <?php else: ?>
                            <a class="back" href="/azk/input2/<?php echo $eveOutForm->shikibetsushi(); ?>/?clr=1">修正する</a>
                        <?php endif; ?>
...
?>
    ...
    <script charset="UTF-8" type="text/javascript" src="/msb/js/credit_card.js"></script>
    <script>
        $(function() {
