 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Zzy_Cancel extends Sgmov_View_Zzy_Input {
    ...
    public function executeInner() {
        ...
        // 情報
        $session->loadForm(self::FEATURE_ID);
        ...
        if(!empty($param)) {
            ...
            if ($comikeDetailInfo['type'] == '2') { // 復路
                ...
                if (@empty($comikeDetailInfo['collect_st_time'])) {
                    ...
                    $comikeDetailInfo['collect_st_time'] = date("H:i", strtotime($comikeDetailInfo['delivery_st_time']));
                    $comikeDetailInfo['collect_ed_time'] = date("H:i", strtotime($comikeDetailInfo['delivery_ed_time']));
