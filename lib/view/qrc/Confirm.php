...
Sgmov_Lib::useForms(array('Error', 'QrcSession', 'Qrc003Out'));
 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Qrc_Confirm extends Sgmov_View_Qrc_Common
{
    ...
    public function executeInner()
    {
        ...
        // $outForm['raw_delivery_charge'] = $inForm['URIAGE_KINGAKU'];
        // チケットを発行
        $ticket = $session->publishTicket(self::FEATURE_ID, self::GAMEN_ID_QRC003);
     ...
     * @param Sgmov_Form_Qrc001In $inForm 入力フォーム
     * @return Sgmov_Form_Qrc003Out 出力フォーム
     */
    public function _createOutFormByInForm($inForm, $db)
    {
        ...
        return $this->createOutFormByInForm($inForm, new Sgmov_Form_Qrc003Out());
    }
}
