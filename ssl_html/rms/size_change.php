...
Sgmov_Lib::useView('rms/SizeChange');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Rms_SizeChange();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/rms/size_change_check_input" data-feature-id="<?php echo Sgmov_View_Rms_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Rms_Common::GAMEN_ID_RMS001 ?>" method="post">
