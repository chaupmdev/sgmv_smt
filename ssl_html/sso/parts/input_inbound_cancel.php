...
<?php
        echo Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_inbound_pref_cds(), $eve001Out->comiket_detail_inbound_pref_lbls(), $eve001Out->comiket_detail_inbound_pref_cd_sel());
?>
                                </dd>
                            </dl>
                            <dl>
...
<?php
                echo Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_inbound_collect_date_year_cds(), $eve001Out->comiket_detail_inbound_collect_date_year_lbls(), $eve001Out->comiket_detail_inbound_collect_date_year_sel());
?>年
<?php
                echo Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_inbound_collect_date_month_cds(), $eve001Out->comiket_detail_inbound_collect_date_month_lbls(), $eve001Out->comiket_detail_inbound_collect_date_month_sel());
?>月
<?php
                echo Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_inbound_collect_date_day_cds(), $eve001Out->comiket_detail_inbound_collect_date_day_lbls(), $eve001Out->comiket_detail_inbound_collect_date_day_sel());
?>日
                
<?php
//                echo Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_inbound_collect_time_cds(), $eve001Out->comiket_detail_inbound_collect_time_lbls(), $eve001Out->comiket_detail_inbound_collect_time_sel());
?>
...
<?php
            echo Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_inbound_delivery_date_year_cds(), $eve001Out->comiket_detail_inbound_delivery_date_year_lbls(), $eve001Out->comiket_detail_inbound_delivery_date_year_sel());
?>年
<?php
            echo Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_inbound_delivery_date_month_cds(), $eve001Out->comiket_detail_inbound_delivery_date_month_lbls(), $eve001Out->comiket_detail_inbound_delivery_date_month_sel());
?>月
<?php
            echo Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_inbound_delivery_date_day_cds(), $eve001Out->comiket_detail_inbound_delivery_date_day_lbls(), $eve001Out->comiket_detail_inbound_delivery_date_day_sel());
?>日
                                        &nbsp;
                                        <span class="comiket_detail_inbound_delivery_time_sel2" >

<?php
            echo Sgmov_View_Sso_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_inbound_delivery_time_cds(), $eve001Out->comiket_detail_inbound_delivery_time_lbls(), $eve001Out->comiket_detail_inbound_delivery_time_sel());
?>
                                        </span>
                                        <?php // var_dump($eve001Out); ?>
                                        <br/>
...
<!--                                        <strong class="red">※ 天災、交通状況の影響により、希望に添えない可能性があります。</strong>-->
                            ...
                            <dl>
                                ...
                                <dd>
                                    <?php if ($eve001Out->comiket_detail_inbound_binshu_kbn_sel() == '0') : ?>
                                        飛脚宅配便
                                    <?php elseif ($eve001Out->comiket_detail_inbound_binshu_kbn_sel() == '1') : ?>
                                        飛脚クール便（冷蔵）
                                    <?php else: ?>
                                        飛脚クール便（冷凍）
                                    <?php endif; ?>
