 ...
 */
class Sgmov_View_Yid_Complete extends Sgmov_View_Yid_Common {
    ...
    public function __construct() {
        ...
        $this->_BcmView             = new Sgmov_View_Yid_Bcm();
    ...
    protected function registerComiket($db, $inForm, $comiketId, $argBackInputPath){
        ...
        try {
            ...
            $db->rollback();
            $_SESSION["Sgmov_View_Yid.inputErrorInfo"] = array("db_insert_error" => "・データベースの登録・更新に失敗しました。");
