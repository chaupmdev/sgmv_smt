...
<?php /**********************************************************************************************************************/ ?>
                        <div class="dl_block input-outbound comiket_block">
                            ...
                            <dl>
                                ...
                                ?>>
                                <input class="" style="width:80%;" maxlength="32" autocapitalize="off" inputmode="comiket_detail_outbound_name" name="comiket_detail_outbound_name" data-pattern="" placeholder="" type="text" value="<?php echo $qrc001Out->comiket_detail_outbound_name() ?>" />
                            ...
                            <dl>
                                ...
                                <dd <?php if (isset($e) && $e->hasErrorForId('comiket_detail_outbound_zip')) { echo ' class="form_error"'; } ?>>
                                    〒<input autocapitalize="off" class="w_70 number-only" maxlength="3" inputmode="numeric" name="comiket_detail_outbound_zip1" data-pattern="^\d+$" placeholder="例）136" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $qrc001Out->comiket_detail_outbound_zip1();?>" />
                                    -
                                    <input autocapitalize="off" class="w_70 number-only" maxlength="4" inputmode="numeric" name="comiket_detail_outbound_zip2" data-pattern="^\d+$" placeholder="例）0082" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $qrc001Out->comiket_detail_outbound_zip2();?>" />
...
<?php
        echo Sgmov_View_Qrc_Input::_createPulldown($qrc001Out->comiket_detail_outbound_pref_cds(), $qrc001Out->comiket_detail_outbound_pref_lbls(), $qrc001Out->comiket_detail_outbound_pref_cd_sel());
?>
                                    </select>
                                    <br/>
                                    <br/>
                            ...
                            <dl>
                                ...
                                <dd <?php if (isset($e) && $e->hasErrorForId('comiket_detail_outbound_address')) { echo ' class="form_error"'; } ?>>
                                    <input class="" style="width:80%;" autocapitalize="off" maxlength="14" name="comiket_detail_outbound_address" placeholder="例）江東区新砂" type="text" value="<?php echo $qrc001Out->comiket_detail_outbound_address();?>" />
                                </dd>
                            </dl>
                            <dl>
                                ...
                                <dd <?php if (isset($e) && $e->hasErrorForId('comiket_detail_outbound_building')) { echo ' class="form_error"'; } ?>>
                                    <input class="" style="width:80%;" autocapitalize="off" maxlength="30" name="comiket_detail_outbound_building" placeholder="例）1-8-2" type="text" value="<?php echo $qrc001Out->comiket_detail_outbound_building();?>" />
                                </dd>
                            </dl>
                            <dl>
                                ...
                                <dd <?php if (isset($e) && $e->hasErrorForId('comiket_detail_outbound_tel')) { echo ' class="form_error"'; } ?>>
                                    <input autocapitalize="off" class="number-p-only" style="width:50%;" maxlength="15" name="comiket_detail_outbound_tel" data-pattern="^[0-9-]+$" placeholder="例）075-1234-5678" type="text" value="<?php echo $qrc001Out->comiket_detail_outbound_tel();?>" />
                                </dd>
                            </dl>
...
<?php
        echo Sgmov_View_Qrc_Input::_createPulldown($qrc001Out->comiket_detail_outbound_collect_date_year_cds(), $qrc001Out->comiket_detail_outbound_collect_date_year_lbls(), $qrc001Out->comiket_detail_outbound_collect_date_year_sel());
?>
                                            </select>年
                                        </span>
                                        <span class="comiket_detail_outbound_collect_date">
...
<?php
        echo Sgmov_View_Qrc_Input::_createPulldown($qrc001Out->comiket_detail_outbound_collect_date_month_cds(), $qrc001Out->comiket_detail_outbound_collect_date_month_lbls(), $qrc001Out->comiket_detail_outbound_collect_date_month_sel());
?>
                                            </select>月
                                        </span>
                                        <span class="comiket_detail_outbound_collect_date">
...
<?php
            echo Sgmov_View_Qrc_Input::_createPulldown($qrc001Out->comiket_detail_outbound_collect_date_day_cds(), $qrc001Out->comiket_detail_outbound_collect_date_day_lbls(), $qrc001Out->comiket_detail_outbound_collect_date_day_sel());
?>
                                            </select>日
                                        </span>
                                        &nbsp;
    ...
    <?php
            echo Sgmov_View_Qrc_Input::_createPulldown($qrc001Out->comiket_detail_outbound_collect_time_cds(), $qrc001Out->comiket_detail_outbound_collect_time_lbls(), $qrc001Out->comiket_detail_outbound_collect_time_sel());
    ?>
                                            </select>
                                        </span>
                                    </div>
                                ...
                                ?>>
                                    ...
                                    <?php foreach($dispItemInfo['comiket_detail_service_lbls'] as $key => $val) : ?>
                                        <label class="radio-label" for="comiket_detail_outbound_service_sel<?php echo $key; ?>">
                                            <input<?php if ($qrc001Out->comiket_detail_outbound_service_sel() == $key) echo ' checked="checked"'; ?> id="comiket_detail_outbound_service_sel<?php echo $key; ?>" name="comiket_detail_outbound_service_sel" type="radio" value="<?php echo $key; ?>" />
                                            <?php echo $val; ?>
                                        </label>
                                    <?php endforeach; ?>
                                    <div>
                                    ...
                                    <div class="comiket_detail_outbound_delivery_date_parts">
                                        <span class="comiket_detail_outbound_delivery_date">
                                            <select name="comiket_detail_outbound_delivery_date_year_sel">
                                                <option value="">年を選択</option>
<?php
        echo Sgmov_View_Qrc_Input::_createPulldown($qrc001Out->comiket_detail_outbound_delivery_date_year_cds(), $qrc001Out->comiket_detail_outbound_delivery_date_year_lbls(), $qrc001Out->comiket_detail_outbound_delivery_date_year_sel());
?>
                                            </select>年
                                        </span>
                                        <span class="comiket_detail_outbound_delivery_date">
                                            <select name="comiket_detail_outbound_delivery_date_month_sel">
                                                <option value="">月を選択</option>
<?php
        echo Sgmov_View_Qrc_Input::_createPulldown($qrc001Out->comiket_detail_outbound_delivery_date_month_cds(), $qrc001Out->comiket_detail_outbound_delivery_date_month_lbls(), $qrc001Out->comiket_detail_outbound_delivery_date_month_sel());
?>
                                            </select>月
                                        </span>
                                        <span class="comiket_detail_outbound_delivery_date">
                                            <select name="comiket_detail_outbound_delivery_date_day_sel">
                                                <option value="">日を選択</option>
<?php
        echo Sgmov_View_Qrc_Input::_createPulldown($qrc001Out->comiket_detail_outbound_delivery_date_day_cds(), $qrc001Out->comiket_detail_outbound_delivery_date_day_lbls(), $qrc001Out->comiket_detail_outbound_delivery_date_day_sel());
?>
                                            </select>日
                                        </span>
                                        &nbsp;
                                        <span class="comiket_detail_outbound_delivery_time_sel">
                                            ...
                                            <select name="comiket_detail_outbound_delivery_time_sel">
                                                <option value="">時間帯を選択</option>
    <?php
            echo Sgmov_View_Qrc_Input::_createPulldown($qrc001Out->comiket_detail_outbound_delivery_time_cds(), $qrc001Out->comiket_detail_outbound_delivery_time_lbls(), $qrc001Out->comiket_detail_outbound_delivery_time_sel());
    ?>
                                            </select>
                                        </span>
                                    </div>
                            ...
                            <dl class="service-outbound-item" service-id="1">
                                ...
                                <dd <?php if (isset($e) && $e->hasErrorForId('comiket_box_outbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                    <div class="comiket-box-outbound-num comiket-box-outbound-num-dmy"> <!-- 個人・法人 両方 -->
                                        <?php // if($qrc001Out->comiket_div() == Sgmov_View_Qrc_Common::COMIKET_DEV_BUSINESS) : ?>
                                        <table>
                                            <tr>
                                                <td>
                                                    <table>
                                                ...
                                                <td class="dispSeigyoPC" style='vertical-align: middle;text-align: right;'>
                                                    <?php if($qrc001Out->comiket_div() == Sgmov_View_Qrc_Common::COMIKET_DEV_INDIVIDUA) : // 個人 ?>
                            ...
                            <dl class="service-outbound-item" service-id="2">
                                ...
                                <dd <?php if (isset($e) && $e->hasErrorForId('comiket_cargo_outbound_num_ary')) { echo ' class="form_error"'; } ?> >
                                    <div class="comiket-cargo-outbound-num" div-id="<?php echo Sgmov_View_Qrc_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                    </div>
                                    <div class="comiket-cargo-outbound-num" div-id="<?php echo Sgmov_View_Qrc_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                    </div>
                                        <div style="">
                                            <input autocapitalize="off" class="number-only boxWid" maxlength="2" inputmode="numeric" name="comiket_cargo_outbound_num_sel" data-pattern="^\d+$" placeholder="例）1" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $qrc001Out->comiket_cargo_outbound_num_sel();?>" />台
<!--                                            <select name="comiket_cargo_outbound_num_sel">
                                                <option value="">カーゴ数量を選択</option>
<?php
                                                echo Sgmov_View_Qrc_Input::_createPulldown($qrc001Out->comiket_cargo_outbound_num_cds(), $qrc001Out->comiket_cargo_outbound_num_lbls(), $qrc001Out->comiket_cargo_outbound_num_sel());
?>
                                            </select>-->
                            ...
                            <dl class="service-outbound-item" service-id="3">
                                ...
                                <dd <?php if (isset($e) && $e->hasErrorForId('comiket_charter_outbound_num')) { echo ' class="form_error"'; } ?>>
                                    <div class="comiket-charter-outbound-num" div-id="<?php echo Sgmov_View_Qrc_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                        <input autocapitalize="off" class="" style="width:10%;" maxlength="2" inputmode="numeric" name="comiket_charter_outbound_num_ary[0]" data-pattern="^\d+$" placeholder="例）7" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $qrc001Out->comiket_charter_outbound_num_ary("0");?>" />台
                                    </div>
                                    <div class="comiket-charter-outbound-num" div-id="<?php echo Sgmov_View_Qrc_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                        <!--<div style="margin-bottom: 10px;">-->
                                            <table>
                                            <?php foreach($dispItemInfo['charter_lbls'] as $key => $val) : ?>
                                                ...
                                                <!--<div style="margin-bottom: 10px;">-->
                                                        ...
                                                        <td class='comiket_charter_item_value'>
                                                            <input autocapitalize="off" class="number-only boxWid" maxlength="2" inputmode="numeric" name="comiket_charter_outbound_num_ary[<?php echo $val["id"]; ?>]" data-pattern="^\d+$" placeholder="例）1" type="<?php echo $inputTypeNumber; ?>" value="<?php echo $qrc001Out->comiket_charter_outbound_num_ary($val["id"]);?>" />台
                                                            &nbsp;
                                                        </td>
                                                <!--</div>-->
                                                    </tr>
                            ...
                            <dl>
                                ...
                                <dd <?php if (isset($e) && $e->hasErrorForId('comiket_detail_outbound_note')) { echo ' class="form_error"'; } ?>>
                                    <input autocapitalize="off" class="" style="width:50%;" maxlength="16" inputmode="text" name="comiket_detail_outbound_note1" placeholder="" type="text" value="<?php echo $qrc001Out->comiket_detail_outbound_note1();?>" /><br/>
                                </dd>
                            </dl>
