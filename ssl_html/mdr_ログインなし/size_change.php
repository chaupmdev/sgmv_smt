...
Sgmov_Lib::useView('mdr/SizeChange');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Mdr_SizeChange();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/mdr/size_change_check_input" data-feature-id="<?php echo Sgmov_View_Mdr_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Mdr_Common::GAMEN_ID_MDR001 ?>" method="post">
