...
class Sgmov_Form_Cms001Out {
    ...
    public $raw_comment_start_date_y = '';
    public $raw_comment_start_date_m = '';
    public $raw_comment_start_date_d = '';
    ...
    public $raw_comment_end_date_y = '';
    public $raw_comment_end_date_m = '';
    public $raw_comment_end_date_d = '';
    ...
    /**
     * エンティティ化されたページインデックスを返します。
     * @return string エンティティ化されたページインデックス
     */
    public function page_index() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_page_index);
    }
    ...
    public function comment_text() {
        return Sgmov_Component_String::nl2br(Sgmov_Component_String::htmlspecialchars($this->raw_comment_text));
    }
     ...
     * @return string エンティティ化されたコメント掲載開始日
     */
    public function comment_start_date_y() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comment_start_date_y);
    }
     ...
     * @return string エンティティ化されたコメント掲載開始日
     */
    public function comment_start_date_m() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comment_start_date_m);
    }
     ...
     * @return string エンティティ化されたコメント掲載開始日
     */
    public function comment_start_date_d() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comment_start_date_d);
    }
     ...
     * @return string エンティティ化されたコメント掲載終了日
     */
    public function comment_end_date_y() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comment_end_date_y);
    }
     ...
     * @return string エンティティ化されたコメント掲載終了日
     */
    public function comment_end_date_m() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comment_end_date_m);
    }
     ...
     * @return string エンティティ化されたコメント掲載終了日
     */
    public function comment_end_date_d() {
        return Sgmov_Component_String::htmlspecialchars($this->raw_comment_end_date_d);
    }
}