 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Rec_SearchOccupation extends Sgmov_View_Public {
...
Sgmov_Component_Log::debug("########################### Sgmov_View_Rec_SearchOccupation");
Sgmov_Component_Log::debug($employ_cd);
