...
<?php
        echo Sgmov_View_Jtb_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_inbound_pref_cds(), $eve001Out->comiket_detail_inbound_pref_lbls(), $eve001Out->comiket_detail_inbound_pref_cd_sel());
?>
                                </dd>
                            </dl>
                            <dl>
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_detail_inbound_collect_date')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <?php endif; ?>
                                        <div class="comiket_detail_inbound_collect_date_parts" style="display:<?php echo $displaySetting; ?>">
                                            <?php echo $eve001Out->comiket_detail_inbound_collect_date_year_sel();?>年<?php echo $eve001Out->comiket_detail_inbound_collect_date_month_sel();?>月<?php echo $eve001Out->comiket_detail_inbound_collect_date_day_sel();?>日（<?php echo Sgmov_View_Jtb_Input::_getWeek($eve001Out->comiket_detail_inbound_collect_date_year_sel(), $eve001Out->comiket_detail_inbound_collect_date_month_sel(), $eve001Out->comiket_detail_inbound_collect_date_day_sel()); ?>）&nbsp;
<?php
                echo Sgmov_View_Jtb_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_inbound_collect_time_cds(), $eve001Out->comiket_detail_inbound_collect_time_lbls(), $eve001Out->comiket_detail_inbound_collect_time_sel());
?>
                            ...
                            <dl class="comiket_detail_inbound_delivery_date">
                                ...
                                <dd>
                                    ...
                                    <div class="comiket_detail_inbound_delivery_date_parts" style="display: flex;">
                                        <?php echo $eve001Out->comiket_detail_inbound_delivery_date_year_sel();?>年<?php echo $eve001Out->comiket_detail_inbound_delivery_date_month_sel();?>月<?php echo $eve001Out->comiket_detail_inbound_delivery_date_day_sel();?>日（<?php echo Sgmov_View_Jtb_Input::_getWeek($eve001Out->comiket_detail_inbound_delivery_date_year_sel(), $eve001Out->comiket_detail_inbound_delivery_date_month_sel(), $eve001Out->comiket_detail_inbound_delivery_date_day_sel()); ?>）
                                        &nbsp;
                                        <span class="comiket_detail_inbound_delivery_time_sel" >

<?php
            echo Sgmov_View_Jtb_Input::_getLabelSelectPulldownData($eve001Out->comiket_detail_inbound_delivery_time_cds(), $eve001Out->comiket_detail_inbound_delivery_time_lbls(), $eve001Out->comiket_detail_inbound_delivery_time_sel());
?>
                                        </span>
                                    </div>
                                </dd>
                            ...
                            <dl class="service-inbound-item" service-id="2">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_cargo_inbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <div class="comiket-cargo-inbound-num" div-id="<?php echo Sgmov_View_Jtb_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                    </div>
                                    <div class="comiket-cargo-inbound-num" div-id="<?php echo Sgmov_View_Jtb_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                    </div>
                                    <div class="">
                            ...
                            <dl class="service-inbound-item" service-id="3">
                                ...
                                <dd<?php if (isset($e) && $e->hasErrorForId('comiket_charter_inbound_num_ary')) { echo ' class="form_error"'; } ?>>
                                    ...
                                    <div class="comiket-charter-inbound-num" div-id="<?php echo Sgmov_View_Jtb_Common::COMIKET_DEV_INDIVIDUA; ?>"> <!-- 個人 -->
                                    ...
                                    <div class="comiket-charter-inbound-num" div-id="<?php echo Sgmov_View_Jtb_Common::COMIKET_DEV_BUSINESS; ?>"> <!-- 法人 -->
                                        <table>
