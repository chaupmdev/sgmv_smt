...
//                 } else {
// //                    htmlCode += "<img src='/dsn/images/about_boxsize.png' width='100%' style='visibility:hidden;'/>";
//                 }
//                 htmlCode += "</td></tr></table>";

//                 if($('input[name="comiket_div"]:checked').val() ==  G_DEV_INDIVIDUAL && $('.dispSeigyoSP').length === 0) {
//                     htmlCode += "<div class='dispSeigyoSP'><img src='/dsn/images/about_boxsize.png' width='250px' style='margin-top: 1em;' /></div>";
//                 }
...
//                 if($('input[name="comiket_div"]:checked').val() ==  G_DEV_INDIVIDUAL) {
//                     htmlCode += "<img src='/dsn/images/about_boxsize.png' width='100%'/>";
//                 }
//                 htmlCode += "</td></tr></table>";
