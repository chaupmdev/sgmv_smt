...
Sgmov_Lib::useView('mdr/Input2');

/**#@-*/

// 処理を実行
$view = new Sgmov_View_Mdr_Input2();
$forms = $view->execute();
...
?>
            <div class="section other">
                <form action="/mdr/check_input2" data-feature-id="<?php echo Sgmov_View_Mdr_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Mdr_Common::GAMEN_ID_MDR001 ?>" method="post">
                    ...
                    <div class="section">
                        ...
                        <div class="dl_block comiket_block">
                            <dl>
                                ...
                                <dd<?php if (isset($e) && ($e->hasErrorForId('event_sel'))) { echo ' class="form_error"'; }?>>
                                    <?php
                                            ...
                                            echo $eventName;
                                            echo '<br><br><img src="/mdr/images/logo.png" style="max-width:60%;">';
                                    ?>
                                    ...
                                    <?php if($eventsubInfo["is_manual_display"]) : ?>
                                        ...
                                        <div class="sp_dl_area2">
                                            <div class="eventsub_dl_link manual" >
                                                ...
                                                <a style="color: blue;" class="manual_link" href="/mdr/pdf/manual/<?php echo $eventName; ?>.pdf<?php echo '?' . $strSysdate; ?>" target="_blank">説明書</a>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                </dd>
                            ...
                            <?php if ($eve001Out->comiket_div() == Sgmov_View_Mdr_Common::COMIKET_DEV_BUSINESS) : // 法人?>
                                <dl>
...
?>
                    ...
                    <?php if ($eve001Out->comiket_div() == Sgmov_View_Mdr_Common::COMIKET_DEV_INDIVIDUA) : ?>
...
?>
    ...
    ></script>
    <script charset="UTF-8" type="text/javascript" src="/mdr/js/input2.js?<?php echo $strSysdate; ?>"></script>
