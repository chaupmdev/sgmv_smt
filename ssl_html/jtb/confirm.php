...
// 処理を実行
$view = new Sgmov_View_Jtb_Confirm();
$forms = $view->execute();
...
?>
    ...
    <div id="main">
        <div class="wrap clearfix">
            ...
            <div class="section">
                <form action="/<?=$dirDiv?>/complete" data-feature-id="<?php echo Sgmov_View_Jtb_Common::FEATURE_ID ?>" data-id="<?php echo Sgmov_View_Jtb_Common::GAMEN_ID_JTB001 ?>" method="post">
                    ...
                    <div class="section">
                        <div class="dl_block comiket_block">
                            <dl>
                                ...
                                <dd>
                                <span class="event-place-lbl" style="font-size: 16pt;">
                                    立山アルペンルートツアー
                                    <?php
                                ...
                                <input style="width:80%;" autocapitalize="off" inputmode="eventsub_tour_name" name="eventsub_tour_name" data-pattern="" placeholder="" type="hidden" value="<?php //echo @$selectedEventData["venue"]; ?>" />
                                </dd>
                            </dl>
                            <dl>
                                <dt id="ryo_kan_name">
                                ...
                                <dd>
                                    <span class="comiket_ryo_kan_name-lbl"><?php echo $eveOutForm->comiket_booth_name(); ?></span>                    
                                </dd>
                            </dl>
                            ...
                            <dl>
                                ...
                                <dd>
                                    <?php echo $eveOutForm->comiket_box_num() ?>
                                </dd>
                            </dl>
                            <dl style="display:none">
                                <dt id="travel_departure">
                                    出発地
                                </dt>
                                <dd>
                                    <?php echo $eveOutForm->travel_departure_nm(); ?>
                                </dd>
                            </dl>
                            <dl>
                                <dt id="cargo_collection_date">
                                    集荷希望日時
                                </dt>
                                <dd>
                                    <?php echo $eveOutForm->cargo_collection_date(); ?><br/>
                                    <?php echo $eveOutForm->cargo_collection_st_time_nm(); ?>
                                </dd>
                            </dl>
                            <dl>
                                <dt id="delivery_collection">
                                    宿泊日（引き渡し希望日）
                                </dt>
                                <dd>
                                    <?php echo $eveOutForm->delivery_collection_date(); ?>
                                </dd>
                            </dl>
                        </div>
