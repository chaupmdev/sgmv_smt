...
class Sgmov_Form_Ain003Out
{
     ...
     * @var string
     */
    public $raw_answer_status_cd_sel = '';

    /**
     * 対応内容状況コードリスト
     * @var array
     */
    public $raw_answer_status_cds = array();

    /**
     * 対応内容状況ラベルリスト
     * @var array
     */
    public $raw_answer_status_lbls = array();
    ...
    /**
     * エンティティ化された顧客登録情報コードを返します。
     * @return string エンティティ化された顧客登録情報コード
     */
    public function inq_cd()
    {
        return Sgmov_Component_String::htmlspecialchars($this->raw_inq_cd);
    }

    /**
     * エンティティ化された顧客登録情報タイムスタンプを返します。
     * @return string エンティティ化された顧客登録情報タイムスタンプ
     */
    public function inq_timestamp()
    {
        return Sgmov_Component_String::htmlspecialchars($this->raw_inq_timestamp);
    }
    ...
    /**
     * エンティティ化された対応内容状況コード選択値を返します。
     * @return string エンティティ化された対応内容状況コード選択値
     */
    public function answer_status_cd_sel()
    {
        return Sgmov_Component_String::htmlspecialchars($this->raw_answer_status_cd_sel);
    }

    /**
     * エンティティ化された対応内容状況コードリストを返します。
     * @return array エンティティ化された対応内容状況コードリスト
     */
    public function answer_status_cds()
    {
        return Sgmov_Component_String::htmlspecialchars($this->raw_answer_status_cds);
    }

    /**
     * エンティティ化された対応内容状況ラベルリストを返します。
     * @return array エンティティ化された対応内容状況ラベルリスト
     */
    public function answer_status_lbls()
    {
        return Sgmov_Component_String::htmlspecialchars($this->raw_answer_status_lbls);
    }

    /**
     * エンティティ化された対応内容コメントを返します。
     * @return string エンティティ化された対応内容コメント
     */
    public function answer_comment()
    {
        return Sgmov_Component_String::htmlspecialchars($this->raw_answer_comment);
    }
    ...
    /**
     * エンティティ化された一覧へ戻るURLを返します。
     * @return string エンティティ化された一覧へ戻るURL
     */
    public function back2list_url()
    {
        return Sgmov_Component_String::htmlspecialchars($this->raw_back2list_url);
    }
