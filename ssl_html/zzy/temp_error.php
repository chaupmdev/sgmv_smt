...
<div id="main">
	...
	<div class="wrap clearfix">
            ...
            <?php if($_REQUEST['param'] == '1') : // ベイクルーズグループ　ファミリーセール?>
                <a href="/zzy/input/?ev=001" style="color:blue;">みどり会登録画面はこちら</a>
            <?php elseif($_REQUEST['param'] == '2') : // コミケ ?>
                <a href="/zzy/input/?ev=002" style="color:blue;">コミックマーケット登録画面はこちら</a>
            <?php endif; ?>
