...
Sgmov_Lib::useView('htl/CheckInput');
 ...
 * @copyright  2018-2018 SAGAWA COMPUTERSYSTEM CO,.LTD. All rights reserved.
 */
class Sgmov_View_Eve_CheckInput2 extends Sgmov_View_Eve_CheckInput {
...
//    }
    ...
    public function _redirectProc($inForm, $errorForm) {
        if ($errorForm->hasError()) {
            Sgmov_Component_Redirect::redirectPublicSsl('/htl/input2');
        }
