...
?>
            ...
            <?php if($_REQUEST['param'] == '1') : // rooms41 ?>
                <a href="/<?=$dirDiv?>/input/?ev=001" style="color:blue;">NEW ENERGY登録画面はこちら</a>
            <?php elseif($_REQUEST['param'] == '2') : // コミケ ?>
                <a href="/<?=$dirDiv?>/input/?ev=002" style="color:blue;">NEW ENERGY登録画面はこちら</a>
            <?php endif; ?>
